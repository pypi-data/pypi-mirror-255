...
T = TypeVar("T", bound="GetSettingsResponse200GitSyncItem")


@_attrs_define
class GetSettingsResponse200GitSyncItem:
    """
    Attributes:
        script_path (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_settings_response_200_git_sync_item = cls(
            script_path=script_path,
            git_repo_resource_path=git_repo_resource_path,
            use_individual_branch=use_individual_branch,
        )

        get_settings_response_200_git_sync_item.additional_properties = d
        return get_settings_response_200_git_sync_item
