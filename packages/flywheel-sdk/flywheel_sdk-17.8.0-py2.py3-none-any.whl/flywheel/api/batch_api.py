...
class BatchApi(object):
    ...
    def cancel_batch_with_http_info(self, batch_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='CancelledBatchOutput',  # noqa: E501
    ...
    def create_batch_job_from_jobs_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'body' in params:
            if 'PremadeJobsBatchProposalInput'.startswith('union'):
                ...
                body_params = flywheel.models.PremadeJobsBatchProposalInput.positional_to_model(params['body'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PremadeJobsBatchProposal',  # noqa: E501
            auth_settings=auth_settings,
            async_=params.get('async_'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_batch_with_http_info(self, batch_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='union[ClassicBatchJobOutput,ClassicBatchJobOutputInflatedJobs,PremadeJobsBatchJobOutput,PremadeJobsBatchJobOutputInflatedJobs]',  # noqa: E501
            auth_settings=auth_settings,
            async_=params.get('async_'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def propose_batch_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'body' in params:
            if 'ClassicBatchProposalInput'.startswith('union'):
                body_type = type(params['body'])
                if getattr(body_type, 'positional_to_model', None):
                    body_params = body_type.positional_to_model(params['body'])
                else:
                ...
                body_params = flywheel.models.ClassicBatchProposalInput.positional_to_model(params['body'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ClassicBatchProposalOutput',  # noqa: E501
            auth_settings=auth_settings,
            async_=params.get('async_'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
