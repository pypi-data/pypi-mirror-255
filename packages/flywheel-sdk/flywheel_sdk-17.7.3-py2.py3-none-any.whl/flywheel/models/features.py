...
class Features(object):
    ...
    def __init__(self, auth0=None, audit_trail=False, cold_job_logs=False, collections=False, copy_by_reference=True, core_api=True, crawler=False, default_viewer_apps=True, deid_log=False, deid_profile=False, dimse=False, elastic_search_primary=False, exchange=False, exchange_admin=False, external_routing=False, gear_access=False, google_analytics=True, healthcare_api=False, job_ask=True, job_prioritization=True, job_tickets=True, jupyter_integration=False, ldap_sync=False, multifactor_auth=False, multipart_signed_url=True, multiproject=False, ohif_multi_subject_view=False, ohif_react=False, ohif_react_beta=False, ohif_slice_order=None, ohif_v3=False, ohif_v3_beta=False, open_tracing=False, project_export=False, project_import=False, project_locking=False, reader_tasks=False, rts_sync=False, sentry_logging=None, session_templates_non_21_cfr=True, shared_projects=False, signed_url=False, study_task_status=False, tagging=False, tags_in_lists=True, task_manager_data_views=True, unsafe_login=False, userpilot=None, validate_classification=False, virus_scan=False, api_enabled_gear_rules=True, project_list_uses_stats=False, ohif_v3_datasource=None):  # noqa: E501
