...
class WorkspacesApi(object):
    ...
    def modify_workspace(self, workspace_id, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_'):
            return self.modify_workspace_with_http_info(workspace_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.modify_workspace_with_http_info(workspace_id, body, **kwargs)  # noqa: E501
            if (
                data
                and hasattr(data, 'return_value')
                and not ignore_simplified_return_value
    ...
    def modify_workspace_with_http_info(self, workspace_id, body, **kwargs):  # noqa: E501
        """Update a workspace
        ...
        if ('workspace_id' not in params or
                params['workspace_id'] is None):
            raise ValueError("Missing the required parameter `workspace_id` when calling `modify_workspace`")  # noqa: E501
        ...
        body_params = None
        if 'body' in params:
            if 'WorkspaceModify'.startswith('union'):
                ...
                body_params = flywheel.models.WorkspaceModify.positional_to_model(params['body'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
