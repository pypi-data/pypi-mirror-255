...
class UidsApi(object):
    ...
    def check_uids_exist_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'body' in params:
            if 'union[UidCheckInputSessions,UidCheckInputAcquisitions]'.startswith('union'):
                ...
                body_params = flywheel.models.union[UidCheckInputSessions,UidCheckInputAcquisitions].positional_to_model(params['body'])
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='UidCheckOutput',  # noqa: E501
