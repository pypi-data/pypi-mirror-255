...
setup(
  name='invoicing-eren',         #* Your package will have this name
  ...
  author='Arun Pandian',                   # Your name
  author_email='arunpandian1058@gmail.com',  # Your email
  url='',              # Homepage of your library (e.g. github or your website)
  keywords=['invoice', 'excel', 'pdf', 'eren'],   # Keywords users can search on pypi.org
