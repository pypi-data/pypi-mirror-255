...
class Sesv2Api:
    ...
    def cancel_export_job(self, context: RequestContext, job_id: JobId) -> CancelExportJobResponse:
    ...
    def get_export_job(self, context: RequestContext, job_id: JobId) -> GetExportJobResponse:
    ...
    def get_message_insights(
        self, context: RequestContext, message_id: OutboundMessageId
    ...
    def put_dedicated_ip_pool_scaling_attributes(
        self, context: RequestContext, pool_name: PoolName, scaling_mode: ScalingMode
