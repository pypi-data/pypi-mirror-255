...
class EksAnywhereSubscriptionLicenseType(str):
    Cluster = "Cluster"


class EksAnywhereSubscriptionStatus(str):
    CREATING = "CREATING"
    ACTIVE = "ACTIVE"
    UPDATING = "UPDATING"
    EXPIRING = "EXPIRING"
...
class EksAnywhereSubscriptionTermUnit(str):
    MONTHS = "MONTHS"
...
class ClusterIssue(TypedDict, total=False):
    ...
    Outpost. You can't use this API with an Amazon EKS cluster on the Amazon
    Web Services cloud.
    """
...
class EksApi:
    ...
    def create_access_entry(
        self, context: RequestContext, request: CreateAccessEntryRequest
    ...
    def delete_access_entry(
        self, context: RequestContext, cluster_name: String, principal_arn: String
    ...
    def delete_pod_identity_association(
        self, context: RequestContext, cluster_name: String, association_id: String
    ...
    def describe_addon_configuration(
        self, context: RequestContext, addon_name: String, addon_version: String
    ...
    def describe_insight(
        self, context: RequestContext, cluster_name: String, id: String
