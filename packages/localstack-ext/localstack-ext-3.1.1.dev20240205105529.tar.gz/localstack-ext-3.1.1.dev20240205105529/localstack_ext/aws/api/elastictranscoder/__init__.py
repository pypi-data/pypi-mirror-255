...
class ElastictranscoderApi:
    ...
    @handler("CancelJob")
    def cancel_job(self, context: RequestContext, id: Id) -> CancelJobResponse:
    ...
    def delete_pipeline(self, context: RequestContext, id: Id) -> DeletePipelineResponse:
    ...
    def delete_preset(self, context: RequestContext, id: Id) -> DeletePresetResponse:
    ...
    def list_pipelines(
        self, context: RequestContext, ascending: Ascending = None, page_token: Id = None
    ...
    @handler("ReadJob")
    def read_job(self, context: RequestContext, id: Id) -> ReadJobResponse:
    ...
    def read_pipeline(self, context: RequestContext, id: Id) -> ReadPipelineResponse:
    ...
    @handler("ReadPreset")
    def read_preset(self, context: RequestContext, id: Id) -> ReadPresetResponse:
    ...
    def update_pipeline_notifications(
        self, context: RequestContext, id: Id, notifications: Notifications
    ...
    def update_pipeline_status(
        self, context: RequestContext, id: Id, status: PipelineStatus
