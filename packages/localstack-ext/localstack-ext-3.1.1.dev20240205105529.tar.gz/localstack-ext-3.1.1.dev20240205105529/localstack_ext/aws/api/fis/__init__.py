...
class AccountTargeting(str):
    single_account = "single-account"
    multi_account = "multi-account"


class EmptyTargetResolutionMode(str):
    fail = "fail"
    skip = "skip"
...
class FisApi:
    ...
    def get_experiment_target_account_configuration(
        self, context: RequestContext, experiment_id: ExperimentId, account_id: TargetAccountId
    ...
    def list_experiment_target_account_configurations(
        self, context: RequestContext, experiment_id: ExperimentId, next_token: NextToken = None
