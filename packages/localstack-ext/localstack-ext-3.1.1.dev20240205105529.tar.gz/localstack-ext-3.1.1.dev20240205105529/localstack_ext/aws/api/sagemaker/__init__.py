...
class SagemakerApi:
    ...
    def delete_cluster(
        self, context: RequestContext, cluster_name: ClusterNameOrArn
    ...
    def delete_context(
        self, context: RequestContext, context_name: ContextName
    ...
    def delete_inference_component(
        self, context: RequestContext, inference_component_name: InferenceComponentName
    ) -> None:
    ...
    def describe_action(
        self, context: RequestContext, action_name: ExperimentEntityNameOrArn
    ...
    def describe_cluster_node(
        self, context: RequestContext, cluster_name: ClusterNameOrArn, node_id: ClusterNodeId
    ...
    def describe_context(
        self, context: RequestContext, context_name: ContextNameOrArn
