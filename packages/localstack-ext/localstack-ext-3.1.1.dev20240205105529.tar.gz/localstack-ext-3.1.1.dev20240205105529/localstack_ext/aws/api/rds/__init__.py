...
class ActivityStreamPolicyStatus(str):
    locked = "locked"
    unlocked = "unlocked"
...
class ClientPasswordAuthType(str):
...
class GlobalClusterMemberSynchronizationStatus(str):
    connected = "connected"
...
class LimitlessDatabaseStatus(str):
    active = "active"
...
class LocalWriteForwardingStatus(str):
    enabled = "enabled"
    disabled = "disabled"
    enabling = "enabling"
    disabling = "disabling"
...
class DBShardGroup(TypedDict, total=False):
    ...
    DBShardGroupIdentifier: Optional[String]
    DBClusterIdentifier: Optional[String]
...
class RdsApi:
    ...
    def create_db_shard_group(
        ...
        (ACUs).
        :param compute_redundancy: Specifies whether to create standby instances for the DB shard group.
    ...
    def delete_db_cluster_automated_backup(
        self, context: RequestContext, db_cluster_resource_id: String
    ...
    def delete_db_shard_group(
        self, context: RequestContext, db_shard_group_identifier: String
    ) -> DBShardGroup:
        """Deletes an Aurora Limitless Database DB shard group.

        :param db_shard_group_identifier: Teh name of the DB shard group to delete.
        :returns: DBShardGroup
    ...
    def delete_integration(
        self, context: RequestContext, integration_identifier: IntegrationIdentifier
    ) -> Integration:
    ...
    def describe_db_shard_groups(
        self,
        context: RequestContext,
        db_shard_group_identifier: String = None,
        filters: FilterList = None,
        marker: String = None,
        max_records: MaxRecords = None,
        ...
        :param db_shard_group_identifier: The user-supplied DB shard group identifier or the Amazon Resource Name
        (ARN) of the DB shard group.
    ...
    def describe_orderable_db_instance_options(
        ...
        :param engine: The name of the engine to describe DB instance options for.
    ...
    def restore_db_instance_from_db_snapshot(
        ...
        :param db_cluster_snapshot_identifier: The identifier for the RDS for MySQL Multi-AZ DB cluster snapshot to
        restore from.
    ...
    def switchover_blue_green_deployment(
        ...
        :param blue_green_deployment_identifier: The unique identifier of the blue/green deployment.
