...
class DescribeTargetHealthInputIncludeEnum(str):
    AnomalyDetection = "AnomalyDetection"
    All = "All"


class EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum(str):
    on = "on"
    off = "off"
...
class MitigationInEffectEnum(str):
    yes = "yes"
    no = "no"
...
class Elbv2Api:
    ...
    def delete_trust_store(
        self, context: RequestContext, trust_store_arn: TrustStoreArn
    ...
    def get_trust_store_revocation_content(
        self, context: RequestContext, trust_store_arn: TrustStoreArn, revocation_id: RevocationId
    ...
    def remove_trust_store_revocations(
        self, context: RequestContext, trust_store_arn: TrustStoreArn, revocation_ids: RevocationIds
