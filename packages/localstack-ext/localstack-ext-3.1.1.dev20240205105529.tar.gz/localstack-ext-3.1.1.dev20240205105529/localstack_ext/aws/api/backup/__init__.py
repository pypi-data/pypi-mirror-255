...
class RestoreDeletionStatus(str):
    DELETING = "DELETING"
    FAILED = "FAILED"
    SUCCESSFUL = "SUCCESSFUL"


class RestoreJobState(str):
    CREATED = "CREATED"
    PENDING = "PENDING"
    RUNNING = "RUNNING"
    ABORTED = "ABORTED"
...
class RestoreTestingRecoveryPointSelectionAlgorithm(str):
    LATEST_WITHIN_WINDOW = "LATEST_WITHIN_WINDOW"
    RANDOM_WITHIN_WINDOW = "RANDOM_WITHIN_WINDOW"


class RestoreTestingRecoveryPointType(str):
    CONTINUOUS = "CONTINUOUS"
    SNAPSHOT = "SNAPSHOT"


class RestoreValidationStatus(str):
    FAILED = "FAILED"
    SUCCESSFUL = "SUCCESSFUL"
    TIMED_OUT = "TIMED_OUT"
...
class BackupSelection(TypedDict, total=False):
    ...
    Specifying your desired ``Conditions``, ``ListOfTags``,
    ``NotResources``, and/or ``Resources`` is recommended. If none of these
    are specified, Backup will attempt to select all supported and opted-in
...
class RestoreTestingRecoveryPointSelection(TypedDict, total=False):
    ...
    specified);ExcludeVaults (list of selectors), defaults to empty list if
    not listed.
    """
...
class BackupApi:
    ...
    def cancel_legal_hold(
        ...
        :param legal_hold_id: Legal hold ID required to remove the specified legal hold on a recovery
        point.
        :param cancel_description: String describing the reason for removing the legal hold.
        :param retain_record_in_days: The integer amount in days specifying amount of days after this API
    ...
    def create_legal_hold(
        ...
        :param title: This is the string title of the legal hold.
        :param description: This is the string description of the legal hold.
        :param idempotency_token: This is a user-chosen string used to distinguish between otherwise
        identical calls.
        :param recovery_point_selection: This specifies criteria to assign a set of resources, such as resource
        types or backup vaults.
    ...
    def create_logically_air_gapped_backup_vault(
        ...
        :param backup_vault_name: This is the name of the vault that is being created.
        :param min_retention_days: This setting specifies the minimum retention period that the vault
        retains its recovery points.
        :param max_retention_days: This is the setting that specifies the maximum retention period that the
        vault retains its recovery points.
        :param backup_vault_tags: These are the tags that will be included in the newly-created vault.
        :param creator_request_id: This is the ID of the creation request.
    ...
    def delete_restore_testing_plan(
        self, context: RequestContext, restore_testing_plan_name: String
    ) -> None:
    ...
    def describe_backup_vault(
        ...
        :param backup_vault_name: The name of a logical container where backups are stored.
        :param backup_vault_account_id: This is the account ID of the specified backup vault.
    ...
    def disassociate_recovery_point_from_parent(
        ...
        :param backup_vault_name: This is the name of a logical container where the child (nested)
        recovery point is stored.
        :param recovery_point_arn: This is the Amazon Resource Name (ARN) that uniquely identifies the
    ...
    def get_legal_hold(self, context: RequestContext, legal_hold_id: string) -> GetLegalHoldOutput:
        ...
        :param legal_hold_id: This is the ID required to use ``GetLegalHold``.
    ...
    def list_backup_job_summaries(
        ...
        :param aggregation_period: This is the period that sets the boundaries for returned results.
    ...
    def list_protected_resources_by_backup_vault(
        ...
        :param backup_vault_name: This is the list of protected resources by backup vault within the
        vault(s) you specify by name.
        :param backup_vault_account_id: This is the list of protected resources by backup vault within the
    ...
    def list_recovery_points_by_legal_hold(
        ...
        :param next_token: This is the next item following a partial list of returned resources.
    ...
    def put_backup_vault_lock_configuration(
        ...
        Assessment. <samples/cohassetreport.zip>`__
    ...
    def put_restore_validation_result(
        ...
        :param restore_job_id: This is a unique identifier of a restore job within Backup.
        :param validation_status: This is the status of your restore validation.
    ...
    def update_restore_testing_plan(
        ...
        :param restore_testing_plan_name: This is the restore testing plan name you wish to update.
    ...
    def update_restore_testing_selection(
        ...
        :param restore_testing_selection_name: This is the required restore testing selection name of the restore
