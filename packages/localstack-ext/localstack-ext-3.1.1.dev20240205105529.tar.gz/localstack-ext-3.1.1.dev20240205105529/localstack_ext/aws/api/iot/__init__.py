...
class CertificateProviderOperation(str):
...
class PackageVersionAction(str):
    PUBLISH = "PUBLISH"
    DEPRECATE = "DEPRECATE"


class PackageVersionStatus(str):
    DRAFT = "DRAFT"
    PUBLISHED = "PUBLISHED"
...
class IotApi:
    ...
    def create_provisioning_template(
        self, context: RequestContext, request: CreateProvisioningTemplateRequest
    ...
    def delete_certificate_provider(
        self, context: RequestContext, certificate_provider_name: CertificateProviderName
    ...
    def delete_package(
        self, context: RequestContext, package_name: PackageName, client_token: ClientToken = None
    ...
    @handler("GetPackage")
    def get_package(self, context: RequestContext, package_name: PackageName) -> GetPackageResponse:
    ...
    def get_package_version(
        self, context: RequestContext, package_name: PackageName, version_name: VersionName
