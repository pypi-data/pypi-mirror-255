...
class ConflictExceptionReason(str):
...
class IdentitystoreApi:
    ...
    @handler("DeleteGroup")
    def delete_group(
        self, context: RequestContext, identity_store_id: IdentityStoreId, group_id: ResourceId
    ) -> DeleteGroupResponse:
    ...
    def delete_group_membership(
        self, context: RequestContext, identity_store_id: IdentityStoreId, membership_id: ResourceId
    ...
    @handler("DeleteUser")
    def delete_user(
        self, context: RequestContext, identity_store_id: IdentityStoreId, user_id: ResourceId
    ) -> DeleteUserResponse:
