...
class ApplicationVisibility(str):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"


class AuthenticationMethodType(str):
    IAM = "IAM"


class FederationProtocol(str):
    SAML = "SAML"
    OAUTH = "OAUTH"
...
class TrustedTokenIssuerType(str):
    OIDC_JWT = "OIDC_JWT"
...
class SsoAdminApi:
    ...
    def delete_application(
        self, context: RequestContext, application_arn: ApplicationArn
    ...
    def delete_application_access_scope(
        self, context: RequestContext, application_arn: ApplicationArn, scope: Scope
    ) -> None:
    ...
    def delete_application_grant(
        self, context: RequestContext, application_arn: ApplicationArn, grant_type: GrantType
    ) -> None:
    ...
    def delete_trusted_token_issuer(
        self, context: RequestContext, trusted_token_issuer_arn: TrustedTokenIssuerArn
    ...
    def describe_application_provider(
        self, context: RequestContext, application_provider_arn: ApplicationProviderArn
    ...
    def list_application_authentication_methods(
        self, context: RequestContext, application_arn: ApplicationArn, next_token: Token = None
    ...
    def update_instance(
        self, context: RequestContext, instance_arn: InstanceArn, name: NameType
