...
class AlternateContactType(str):
    BILLING = "BILLING"
    OPERATIONS = "OPERATIONS"
    SECURITY = "SECURITY"


class RegionOptStatus(str):
    ENABLED = "ENABLED"
    ENABLING = "ENABLING"
    DISABLING = "DISABLING"
    DISABLED = "DISABLED"
...
class AccountApi:
    ...
    def disable_region(
        self, context: RequestContext, region_name: RegionName, account_id: AccountId = None
    ) -> None:
    ...
    def get_contact_information(
        self, context: RequestContext, account_id: AccountId = None
