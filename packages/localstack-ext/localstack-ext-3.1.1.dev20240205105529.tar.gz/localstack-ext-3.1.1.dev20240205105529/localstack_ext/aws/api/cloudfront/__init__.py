...
class ContinuousDeploymentPolicyType(str):
...
class OriginAccessControlOriginTypes(str):
    s3 = "s3"
    mediastore = "mediastore"


class OriginAccessControlSigningBehaviors(str):
    never = "never"
    always = "always"
    no_override = "no-override"


class OriginAccessControlSigningProtocols(str):
    sigv4 = "sigv4"
...
class CloudfrontApi:
    ...
    def create_origin_access_control(
        self, context: RequestContext, origin_access_control_config: OriginAccessControlConfig
    ...
    def delete_key_value_store(
        self, context: RequestContext, if_match: string, name: KeyValueStoreName
    ) -> None:
    ...
    def describe_key_value_store(
        self, context: RequestContext, name: KeyValueStoreName
    ...
    def update_distribution(
        ...
        **To update a web distribution using the CloudFront API**
        ...
        #. Update the distribution configuration that was returned in the
           ...
           -  You must rename the ``ETag`` field to ``IfMatch``, leaving the
              value unchanged. (Set the value of ``IfMatch`` to the value of
