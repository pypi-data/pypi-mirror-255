...
class ReplicationOverwriteProtection(str):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"
...
class TransitionToArchiveRules(str):
...
class AccessPointAlreadyExists(ServiceException):
    ...
    code: str = "AccessPointAlreadyExists"
...
class AccessPointLimitExceeded(ServiceException):
    ...
    code: str = "AccessPointLimitExceeded"
    sender_fault: bool = False
    status_code: int = 403
    ErrorCode: ErrorCode
...
class FileSystemAlreadyExists(ServiceException):
    ...
    code: str = "FileSystemAlreadyExists"
    sender_fault: bool = False
    status_code: int = 409
    ErrorCode: ErrorCode
...
class FileSystemLimitExceeded(ServiceException):
    ...
    code: str = "FileSystemLimitExceeded"
    sender_fault: bool = False
    status_code: int = 403
    ErrorCode: ErrorCode
...
class IncorrectFileSystemLifeCycleState(ServiceException):
    ...
    code: str = "IncorrectFileSystemLifeCycleState"
    sender_fault: bool = False
    status_code: int = 409
    ErrorCode: ErrorCode
...
class IncorrectMountTargetState(ServiceException):
    ...
    code: str = "IncorrectMountTargetState"
    sender_fault: bool = False
    status_code: int = 409
    ErrorCode: ErrorCode
...
class InsufficientThroughputCapacity(ServiceException):
    ...
    code: str = "InsufficientThroughputCapacity"
    sender_fault: bool = False
    status_code: int = 503
    ErrorCode: ErrorCode
...
class NetworkInterfaceLimitExceeded(ServiceException):
    ...
    code: str = "NetworkInterfaceLimitExceeded"
    sender_fault: bool = False
    status_code: int = 409
    ErrorCode: ErrorCode
...
class NoFreeAddressesInSubnet(ServiceException):
    ...
    code: str = "NoFreeAddressesInSubnet"
    sender_fault: bool = False
    status_code: int = 409
    ErrorCode: ErrorCode
...
class SecurityGroupNotFound(ServiceException):
    ...
    code: str = "SecurityGroupNotFound"
    sender_fault: bool = False
    status_code: int = 400
    ErrorCode: ErrorCode
...
class ThrottlingException(ServiceException):
    ...
    and the number of Access Points on the file system is nearing the `limit
    of
    120 <https://docs.aws.amazon.com/efs/latest/ug/limits.html#limits-efs-resources-per-account-per-region>`__.
    """
...
class ThroughputLimitExceeded(ServiceException):
    ...
    code: str = "ThroughputLimitExceeded"
    sender_fault: bool = False
    status_code: int = 400
    ErrorCode: ErrorCode
...
class UnsupportedAvailabilityZone(ServiceException):
    ...
    code: str = "UnsupportedAvailabilityZone"
    sender_fault: bool = False
    status_code: int = 400
    ErrorCode: ErrorCode
...
class LifecyclePolicy(TypedDict, total=False):
    ...
    storage <https://docs.aws.amazon.com/efs/latest/ug/lifecycle-management-efs.html>`__.
...
class EfsApi:
    ...
    def create_replication_configuration(
        ...
        -  **Amazon Web Services Region** – The Amazon Web Services Region in
           ...
           Regions <https://docs.aws.amazon.com/general/latest/gr/rande-manage.html#rande-manage-enable>`__
        ...
        -  **Destination file system configuration** – The configuration of the
           ...
           -  **File system ID** – The ID of the destination file system for the
              ...
              system <https://docs.aws.amazon.com/efs/latest/ug/efs-replication#replicate-existing-destination>`__.
           ...
           -  **Availability Zone** – If you want the destination file system to
              ...
              system
              types <https://docs.aws.amazon.com/efs/latest/ug/storage-classes.html>`__
              in the *Amazon EFS User Guide*.
        ...
        -  **Lifecycle management** – Lifecycle management is not enabled on the
           destination file system. After the destination file system is
    ...
    def delete_replication_configuration(
        ...
        For more information, see `Delete a replication
        configuration <https://docs.aws.amazon.com/efs/latest/ug/delete-replications.html>`__.
    ...
    def describe_file_systems(
        ...
        token, in the response. In this case, you should send a subsequent
        request with the ``Marker`` request parameter set to the value of
        ``NextMarker``.
    ...
    def put_lifecycle_configuration(
        ...
        -  **``TransitionToArchive``** – When to move files in the file system
           from their current storage class (either IA or Standard storage) into
           the Archive storage.
        ...
        -  **``TransitionToPrimaryStorageClass``** – Whether to move files in
           the file system back to primary storage (Standard storage class)
        ...
        -  A ``LifecyclePolicies`` array of ``LifecyclePolicy`` objects that
           define when to move files to IA storage, to Archive storage, and back
           to primary storage.
    ...
    @handler("UpdateFileSystemProtection")
    def update_file_system_protection(
        ...
        :param file_system_id: The ID of the file system to update.
        :param replication_overwrite_protection: The status of the file system's replication overwrite protection.
        :returns: FileSystemProtectionDescription
        :raises BadRequest:
        :raises FileSystemNotFound:
        :raises IncorrectFileSystemLifeCycleState:
        :raises InsufficientThroughputCapacity:
        :raises InternalServerError:
        :raises ThroughputLimitExceeded:
        :raises ReplicationAlreadyExists:
        :raises TooManyRequests:
        """
        raise NotImplementedError
