...
class InputAuthenticationType(str):
    password = "password"
    iam = "iam"
...
class MemorydbApi:
    ...
    def create_cluster(
        ...
        :param engine_version: The version number of the Redis engine to be used for the cluster.
    ...
    @handler("DeleteACL")
    def delete_acl(self, context: RequestContext, acl_name: String) -> DeleteACLResponse:
    ...
    def delete_cluster(
        self, context: RequestContext, cluster_name: String, final_snapshot_name: String = None
    ...
    def delete_subnet_group(
        self, context: RequestContext, subnet_group_name: String
    ...
    @handler("DeleteUser")
    def delete_user(self, context: RequestContext, user_name: UserName) -> DeleteUserResponse:
    ...
    def describe_engine_versions(
        ...
        :param engine_version: The Redis engine version.
    ...
    def failover_shard(
        self, context: RequestContext, cluster_name: String, shard_name: String
    ...
    def list_allowed_node_type_updates(
        self, context: RequestContext, cluster_name: String
    ...
    @handler("ListTags")
    def list_tags(self, context: RequestContext, resource_arn: String) -> ListTagsResponse:
    ...
    @handler("TagResource")
    def tag_resource(
        self, context: RequestContext, resource_arn: String, tags: TagList
    ) -> TagResourceResponse:
    ...
    def untag_resource(
        self, context: RequestContext, resource_arn: String, tag_keys: KeyList
