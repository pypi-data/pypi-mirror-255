...
class DataSourceIntrospectionStatus(str):
    PROCESSING = "PROCESSING"
    FAILED = "FAILED"
    SUCCESS = "SUCCESS"
...
class GraphQLApiIntrospectionConfig(str):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"


class GraphQLApiType(str):
    GRAPHQL = "GRAPHQL"
    MERGED = "MERGED"


class GraphQLApiVisibility(str):
    GLOBAL = "GLOBAL"
    PRIVATE = "PRIVATE"
...
class SourceApiAssociationStatus(str):
...
class AppsyncApi:
    ...
    def disassociate_merged_graphql_api(
        self, context: RequestContext, source_api_identifier: String, association_id: String
    ...
    def disassociate_source_graphql_api(
        self, context: RequestContext, merged_api_identifier: String, association_id: String
    ...
    def start_data_source_introspection(
        self, context: RequestContext, rds_data_api_config: RdsDataApiConfig = None
    ...
    def start_schema_merge(
        self, context: RequestContext, association_id: String, merged_api_identifier: String
