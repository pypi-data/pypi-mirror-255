...
class BatchApi:
    ...
    def cancel_job(
        ...
        or ``PENDING`` are canceled. A job in ``RUNNABLE`` remains in
        ``RUNNABLE`` until it reaches the head of the job queue. Then the job
    ...
    def register_job_definition(
        ...
        definition.
        :param container_properties: An object with various properties specific to Amazon ECS based
        single-node container-based jobs.
        ...
        :param eks_properties: An object with various properties that are specific to Amazon EKS based
        jobs.
    ...
    def submit_job(
        ...
        :param container_overrides: An object with various properties that override the defaults for the job
        ...
        organize your resources.
        :param eks_properties_override: An object that can only be specified for jobs that are run on Amazon EKS
