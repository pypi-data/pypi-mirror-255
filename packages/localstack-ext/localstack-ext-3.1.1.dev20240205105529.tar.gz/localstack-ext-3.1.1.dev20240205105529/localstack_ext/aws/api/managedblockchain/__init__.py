...
class AccessorStatus(str):
    AVAILABLE = "AVAILABLE"
    PENDING_DELETION = "PENDING_DELETION"
    DELETED = "DELETED"


class AccessorType(str):
...
class StateDBType(str):
    LevelDB = "LevelDB"
    CouchDB = "CouchDB"


class ThresholdComparator(str):
...
class ManagedblockchainApi:
    ...
    def delete_accessor(
        self, context: RequestContext, accessor_id: ResourceIdString
    ...
    def delete_member(
        self, context: RequestContext, network_id: ResourceIdString, member_id: ResourceIdString
    ) -> DeleteMemberOutput:
    ...
    @handler("GetNetwork")
    def get_network(
        self, context: RequestContext, network_id: ResourceIdString
    ) -> GetNetworkOutput:
    ...
    @handler("GetProposal")
    def get_proposal(
        self, context: RequestContext, network_id: ResourceIdString, proposal_id: ResourceIdString
    ) -> GetProposalOutput:
    ...
    def reject_invitation(
        self, context: RequestContext, invitation_id: ResourceIdString
    ...
    @handler("TagResource")
    def tag_resource(
        self, context: RequestContext, resource_arn: ArnString, tags: InputTagMap
    ) -> TagResourceResponse:
    ...
    def untag_resource(
        self, context: RequestContext, resource_arn: ArnString, tag_keys: TagKeyList
