...
from localstack.constants import MAVEN_REPO_URL,TEST_AWS_ACCESS_KEY_ID,TEST_AWS_SECRET_ACCESS_KEY
...
HADOOP_FS_S3_PROPS={'fs.s3.awsAccessKeyId':TEST_AWS_ACCESS_KEY_ID,'fs.s3.awsSecretAccessKey':TEST_AWS_SECRET_ACCESS_KEY,'fs.s3.endpoint':_A,'fs.s3.path.style.access':_B,'fs.s3a.awsAccessKeyId':TEST_AWS_ACCESS_KEY_ID,'fs.s3a.awsSecretAccessKey':TEST_AWS_SECRET_ACCESS_KEY,'fs.s3a.access.key':TEST_AWS_ACCESS_KEY_ID,'fs.s3a.secret.key':TEST_AWS_SECRET_ACCESS_KEY,'fs.s3a.endpoint':_A,'fs.s3a.path.style.access':_B,'fs.s3n.awsAccessKeyId':TEST_AWS_ACCESS_KEY_ID,'fs.s3n.awsSecretAccessKey':TEST_AWS_SECRET_ACCESS_KEY,'fs.s3n.endpoint':_A,'fs.s3n.path.style.access':_B}
class HadoopInstaller(ArchiveDownloadAndExtractInstaller):
	...
	def _apply_cve_fixes(E,target):A=target;B=CVEFix(paths=['hadoop/3.3.1/share/hadoop/common/lib/htrace-core4-4.1.0-incubating.jar','hadoop/3.3.1/share/hadoop/hdfs/lib/htrace-core4-4.1.0-incubating.jar','hadoop/3.3.1/share/hadoop/yarn/hadoop-yarn-applications-catalog-webapp-3.3.1.war:WEB-INF/lib/htrace-core4-4.1.0-incubating.jar','hadoop/3.3.1/share/hadoop/yarn/timelineservice/lib/htrace-core-3.1.0-incubating.jar'],strategy=FixStrategyDelete());C=CVEFix(paths=['hadoop/3.3.1/share/hadoop/client/hadoop-client-api-3.3.1.jar'],strategy=FixStrategyDownloadFile(file_url=HTRACE_NOOP_JAR_URL,target_path=os.path.join(A.value,'hadoop/3.3.1/share/hadoop/common')));D=CVEFix(paths=['hadoop/3.3.1/share/hadoop/hdfs/lib/log4j-1.2.17.jar','hadoop/3.3.1/share/hadoop/common/lib/log4j-1.2.17.jarhadoop/3.3.1/share/hadoop/common/lib/slf4j-log4j12-1.7.30.jarpresto/389/plugin/accumulo/log4j-1.2.17.jar'],strategy=FixStrategyDelete());fix_cves_in_jar_files(A,fixes=[B,C,D])
