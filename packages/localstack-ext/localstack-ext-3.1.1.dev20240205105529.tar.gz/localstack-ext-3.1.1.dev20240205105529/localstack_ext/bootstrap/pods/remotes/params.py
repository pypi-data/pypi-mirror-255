...
remotes_protocols={'s3':get_s3_remote_params,'oras':get_oras_remote_params,_A:get_platform_remote_params}
def get_remote_params_callable(url):A=urlparse(url).scheme or _A;return remotes_protocols.get(A,None)