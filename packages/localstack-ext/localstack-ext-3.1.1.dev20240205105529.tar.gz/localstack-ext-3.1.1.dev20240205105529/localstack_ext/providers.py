...
pro_aws_provider=functools.partial(aws_provider,name='pro',should_load=lambda:config.is_env_true(constants.ENV_PRO_ACTIVATED))
@pro_aws_provider()
...
def acm_pca():from localstack.services.moto import MotoFallbackDispatcher as A;from localstack_ext.services.acm_pca.provider import AcmPcaProvider as B;C=B();return Service.for_provider(C,dispatch_table_factory=A)
@pro_aws_provider()
def account():from localstack_ext.services.account.provider import AccountProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
@pro_aws_provider()
def appconfigdata():from localstack_ext.services.appconfigdata.provider import AppconfigDataProvider as A;B=A();return Service.for_provider(B)
...
@pro_aws_provider()
def ce():from localstack_ext.services.ce.provider import CeProvider as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
@pro_aws_provider()
...
@pro_aws_provider()
def ecs():from localstack_ext.services.ecs.provider import ECSProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
def efs():from localstack_ext.services.efs.provider import EfsProvider as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
@pro_aws_provider(api='elasticache',name='legacy')
def elasticache_legacy():from localstack_ext.services.elasticache.legacy.provider import ElasticacheProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
def elastictranscoder():from localstack.services.moto import MotoFallbackDispatcher as A;from localstack_ext.services.elastictranscoder.provider import ElastictranscoderProvider as B;C=B();return Service.for_provider(C,dispatch_table_factory=A)
@pro_aws_provider()
...
def emr_serverless():from localstack_ext.services.emr_serverless.provider import EmrServerlessProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
def identitystore():from localstack_ext.services.identitystore.provider import IdentitystoreProvider as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
@pro_aws_provider()
...
@pro_aws_provider()
def managedblockchain():from localstack_ext.services.managedblockchain.provider import ManagedblockchainProvider as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
@pro_aws_provider()
...
@pro_aws_provider()
def memorydb():from localstack_ext.services.memorydb.provider import MemoryDBProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
def pinpoint():from localstack.services.moto import MotoFallbackDispatcher as A;from localstack_ext.services.pinpoint.provider import PinpointProvider as B;C=B();return Service.for_provider(C,dispatch_table_factory=A)
@pro_aws_provider()
def pipes():from localstack_ext.services.pipes.provider import PipesProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
@pro_aws_provider()
def ram():from localstack_ext.services.ram.provider import RamProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
@pro_aws_provider(api=_B,name=_E)
def lambda_asf():from localstack_ext.services.lambda_.provider import LambdaProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider(api=_B,name=_C)
def lambda_v2():from localstack_ext.services.lambda_.provider import LambdaProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider(api=_B)
def lambda_():from localstack_ext.services.lambda_.provider import LambdaProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
@pro_aws_provider()
def s3():from localstack_ext.services.s3.v3.provider import S3ProviderPro as A;B=A();return Service.for_provider(B)
...
@pro_aws_provider(api=_A,name=_C)
def s3_v2():from localstack_ext.services.s3.provider import S3ProviderPro as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
@pro_aws_provider(api=_A,name='legacy_v2_pro')
def s3_legacy_v2():from localstack_ext.services.s3.provider import S3ProviderPro as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
@pro_aws_provider(api=_A,name='stream_pro')
def s3_stream():from localstack_ext.services.s3.v3.provider import S3ProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider(api=_A,name='v3_pro')
def s3_v3():from localstack_ext.services.s3.v3.provider import S3ProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
@pro_aws_provider(api=_D,name=_C)
...
@pro_aws_provider(api=_D,name='v1_pro')
def stepfunctions_v1():from localstack.services.stepfunctions.legacy.provider_legacy import StepFunctionsProvider as A;from localstack_ext.services.stepfunctions.provider import patch_stepfunctions as B;B();C=A();return Service.for_provider(C,dispatch_table_factory=lambda _provider:HttpFallbackDispatcher(_provider,_provider.get_forward_url))
@pro_aws_provider(api=_D,name='legacy_pro')
def stepfunctions_legacy():from localstack.services.stepfunctions.legacy.provider_legacy import StepFunctionsProvider as A;from localstack_ext.services.stepfunctions.provider import patch_stepfunctions as B;B();C=A();return Service.for_provider(C,dispatch_table_factory=lambda _provider:HttpFallbackDispatcher(_provider,_provider.get_forward_url))
@pro_aws_provider(api='wafv2')
def wafv2():from localstack.services.moto import MotoFallbackDispatcher as A;from localstack_ext.services.wafv2.provider import Wafv2Provider as B;C=B();return Service.for_provider(C,dispatch_table_factory=A)
