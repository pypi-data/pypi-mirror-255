...
################################################################################
## Form generated from reading UI file 'whatsnewElGKzp.ui'
##
...
class Ui_Whatsnew(object):
    def setupUi(self, Whatsnew):
        ...
        self.button_Ok.setMinimumSize(QSize(0, 22))
        self.button_Ok.setMaximumSize(QSize(16777215, 22))
        ...
        self.button_changes.setMinimumSize(QSize(0, 22))
        self.button_changes.setMaximumSize(QSize(16777215, 22))
    ...
    def retranslateUi(self, Whatsnew):
        ...
        self.info.setText(QCoreApplication.translate("Whatsnew", u"<html><head/><body><p><span style=\" font-size:18pt; font-weight:700;\">What's new in PaIRS #.#.#</span></p><p><span style=\" font-size:11pt;\">\u2b50</span></p></body></html>", None))
    # retranslateUi
