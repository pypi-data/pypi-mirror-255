...
class StereoDisp(object):
    ...
    def setCalConst(self, flagCal, numCostCalib, pyCost):
        return _PaIRS_PIV.StereoDisp_setCalConst(self, flagCal, numCostCalib, pyCost)

    def readCalConst(self):
        return _PaIRS_PIV.StereoDisp_readCalConst(self)

    def readPlaneConst(self):
        return _PaIRS_PIV.StereoDisp_readPlaneConst(self)

    def evalCommonZone(self):
        return _PaIRS_PIV.StereoDisp_evalCommonZone(self)
    ...
    SPIVIn = property(_PaIRS_PIV.StereoDisp_SPIVIn_get, _PaIRS_PIV.StereoDisp_SPIVIn_set)
    dataProc = property(_PaIRS_PIV.StereoDisp_dataProc_get, _PaIRS_PIV.StereoDisp_dataProc_set)
    dispAvCo = property(_PaIRS_PIV.StereoDisp_dispAvCo_get, _PaIRS_PIV.StereoDisp_dispAvCo_set)
    vect = property(_PaIRS_PIV.StereoDisp_vect_get, _PaIRS_PIV.StereoDisp_vect_set)
