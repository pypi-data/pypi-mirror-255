...
class ImportType(BaseImportType, ImportAddOnsType):
    pass

# To use when specifying typehints
BaseImportTypeLiteral = Literal[
    "HTTP", "FTP", "SFTP", "GCS", "GOSPORT_SFTP", "SPREADSHEET",
    "ADWORDS_PRODUCT", "GA_ECOMMERCE", "ARCANE_SFTP", "DATALAB",
    "MAGENTO","SHOPIFY", "PRESTASHOP", "UPLOAD_FROM_DEVICE", "GA_4",
    "ARCANE_FTP", "SHOPIFY_API", "PIANO"
]
...
ImportTypeLiteral = Union[BaseImportTypeLiteral, ImportAddOnsTypeLiteral]
...
ChannelType = Enum('ChannelType', [(i.name, i.value) for i in chain(BaseChannelType, ChannelAddOnsType)])
