class HealthCheck:
    ...
    def check_crons(self, all_tasks: dict, started_tasks: dict, completed_tasks: dict, started_tasks_array: dict):
        """
        ...
        started_task_array: list of task ids for tasks which have been started (dict arr    ay)
        ...
        for key, value in all_tasks.items():
            ...
            for task_id in started_task_ids:
                self.check_if_task_delayed(delayed, started_tasks.get(task_id), cron_time)
