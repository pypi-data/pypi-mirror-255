...
PACKAGE_DATA = {
	"orangecontrib.dev_workflow.widgets": ["icons/*", "img/*", "dataset_devellopper/*", "widget_designer/*", "kernel_function/*"], # contenu du dossier 'icons' situé dans 'orangecontrib/dev_workflow/widgets'
}
# /!\ les noms de fichier 'orangecontrib.dev_workflow.widgets' doivent correspondre à l'arborescence

# Dépendances
INSTALL_REQUIRES = ["PyQt5", "shlex", "PyQt5.QtCore", "PyQt5.QtGui"]

# Spécifie le dossier contenant les widgets et le nom de section qu'aura l'addon sur Orange
ENTRY_POINTS = {
	"orange.widgets": (
		"dev_workflow = orangecontrib.dev_workflow.widgets", # 'dev_workflow' sera le nom de la section Orange contenant les widgets
	)
}
# /!\ les noms de fichier 'orangecontrib.dev_workflow.widgets' doivent correspondre à l'arborescence
