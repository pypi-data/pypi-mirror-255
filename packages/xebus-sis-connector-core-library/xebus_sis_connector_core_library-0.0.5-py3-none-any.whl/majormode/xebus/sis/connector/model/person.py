...
class Person:
    ...
    def __eq__(self, other: Person) -> bool:
        ...
        for attribute_name in self.COMPARISON_ATTRIBUTE_NAMES:
            ...
            if this_attribute_value != other_attribute_value:
                logging.debug(
                    f"The value \"{this_attribute_value}\" of the \"{attribute_name}\" "
                    f"attribute of this instance \"{self.__class__.__name__}\" differs from "
                    f"the value \"{other_attribute_value} of the same attribute of instance "
    ...
    def __init__(
        ...
        :param account_id: The Xebus identifier of the person's user account.

        :param contacts: A list of contact information of the person.

        :param languages: The spoken language of this person.
        ...
        self._languages = languages or [DEFAULT_LOCALE]
    ...
    @property
    def nationality(self) -> list[Country]:
