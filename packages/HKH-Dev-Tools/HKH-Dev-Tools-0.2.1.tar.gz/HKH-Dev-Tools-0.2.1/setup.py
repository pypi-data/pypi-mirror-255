...
VERSION = "0.2.1" # la version doit être supérieure à la précédente sinon la publication sera refusée
...
PACKAGE_DATA = {
	"orangecontrib.dev_workflow.widgets": ["icons/*"], # contenu du dossier 'icons' situé dans 'orangecontrib/dev_workflow/widgets'
}
