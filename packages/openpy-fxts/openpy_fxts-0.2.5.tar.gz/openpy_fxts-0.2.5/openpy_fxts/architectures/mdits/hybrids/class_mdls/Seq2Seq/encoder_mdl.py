...
class encoder_lstm2(tkm.Model):
    def __init__(self, n_future=None):
        super(encoder_lstm2, self).__init__()
        self.encoder_l1 = tkl.LSTM(128, return_sequences=True, return_state=True)
        self.encoder_l2 = tkl.LSTM(128, return_state=True)
        self.rep_vec = tkl.RepeatVector(n_future)
...
class encoder_batch2_lstm2_drop2(tkm.Model):

    def __init__(self, n_future=None):
        super(encoder_batch2_lstm2_drop2, self).__init__()
...
class encoder_bilstm_state(tkm.Model):
    def __init__(self, n_future=None):
        super(encoder_bilstm_state, self).__init__()
...
class encoder_bilstm2(tkm.Model):
    def __init__(self, n_future=None):
        super(encoder_bilstm2, self).__init__()
        self.encoder_l1 = tkl.Bidirectional(tkl.LSTM(128, return_sequences=True, return_state=True))
        self.encoder_l2 = tkl.Bidirectional(tkl.LSTM(128, return_state=True))
        self.rep_vec = tkl.RepeatVector(n_future)
...
class encoder_conv1d(tkm.Model):
    def __init__(self, n_future=None):
        super(encoder_conv1d, self).__init__()
        self.conv1d1 = tkl.Conv1D(filters=64, kernel_size=11, activation='relu', padding='causal', dilation_rate=2)
        self.conv1d2 = tkl.Conv1D(filters=64, kernel_size=9, activation='relu', padding='causal')
...
class encoder_multihead_conv1d_lstm(tkm.Model):
    def __init__(self, n_future=None, n_inp_ft=None, i=None):
        super(encoder_multihead_conv1d_lstm, self).__init__()
