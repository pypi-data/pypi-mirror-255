...
from openpy_fxts.preprocessing_data.imputation.prepare_data import pre_processing_data
from openpy_fxts.base_tf import tf, tkm, tkl
from openpy_fxts.models.imputation.utils import _callbacks, _learning_curve
from openpy_fxts.models.imputation.utils import _values_preliminary_2D
from openpy_fxts.models.imputation.utils import _mdl_characteristics
...
class Seq2Seq_LSTM_class(base_class):
...
class Seq2Seq_LSTM2_class(base_class):
...
class Seq2Seq_LSTM_Batch_Drop_class(base_class):
...
class Seq2Seq_BiLSTM_class(base_class):
...
class Seq2Seq_BiLSTM2_class(base_class):
...
class Seq2Seq_Conv1D_BiLSTM_class(base_class):
...
class Seq2Seq_Multi_Head_Conv1D_BiLSTM_class(base_class):
...
class Seq2Seq_BiLSTM_with_Attention_class(base_class):
...
class Seq2Seq_LSTM_with_Luong_Attention_class(base_class):
...
class Seq2Seq_Conv2D_LSTM_class:
    ...
    def train_model(
        ...
        model = Seq2Seq_Conv2D_LSTM_class(self.config_data, self.config_mdl).build_model()
        model.compile(
