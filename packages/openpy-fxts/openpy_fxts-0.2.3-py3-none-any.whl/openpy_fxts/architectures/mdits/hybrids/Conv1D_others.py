...
class conv1d_birnn_dense(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_dict_mdits('Conv1D_BiRNN').config_conv1d()
...
class timedist_conv1d_birnn_dense(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_dict_mdits('TimeDist_Conv1D_BiRNN').config_conv1d()
        self.n_future = n_future,
        self.n_out_ft = n_out_ft,
        self.config = config
...
class conv1d_birnn_attention_dense(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_dict_mdits('Conv1D_BiRNN_Attention').config_conv1d()
        self.n_future = n_future,
        self.n_out_ft = n_out_ft,
        self.config = config
