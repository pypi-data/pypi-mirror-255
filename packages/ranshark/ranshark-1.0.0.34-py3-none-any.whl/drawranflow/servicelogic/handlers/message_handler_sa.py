...
def message_handler(df, item_id):
    ...
    try:
        ...
        rrc_reestablish_res_df = f1ap_df[(f1ap_df['_ws.col.info'] == 'RRC Reestablishment') | (f1ap_df['_ws.col.info'] == 'UEContextReleaseCommand')]
       ...
       #  combined_df.loc[:, 'f1ap.nRCellIdentity'] = combined_df['f1ap.nRCellIdentity'].map(get_gnb_id)
        ...
        xnap_handover_ack_df = xnap_df[
            ((xnap_df['_ws.col.info'] == 'HandoverRequestAcknowledge')| (xnap_df['_ws.col.info'] == 'HandoverPreparationFailure')
        ...
        # print(xnap_df_filtered['local_cell'])
