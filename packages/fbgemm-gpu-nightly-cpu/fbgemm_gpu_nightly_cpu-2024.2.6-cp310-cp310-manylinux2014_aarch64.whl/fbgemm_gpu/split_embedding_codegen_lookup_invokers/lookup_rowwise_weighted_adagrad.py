...
def invoke(
    ...
    warnings.warn(
        f"""\033[93m
        [FBGEMM_GPU] NOTE: The training optimizer 'rowwise_weighted_adagrad' is marked as
    ...
    if (common_args.host_weights.numel() > 0):
        return torch.ops.fbgemm.split_embedding_codegen_lookup_rowwise_weighted_adagrad_function_cpu(
            # common_args
    ...
    return torch.ops.fbgemm.split_embedding_codegen_lookup_rowwise_weighted_adagrad_function(
        # common_args
