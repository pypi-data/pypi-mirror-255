...
import OI.OJHelper.Luogu.Const as Const
...
class Problem():
    def __init__(self, user, problem_id):
        ...
        self.__code_template_conf_path = "{}/OI_System_Profile/Document_Profile".format(os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..")))
