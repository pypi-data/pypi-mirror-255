...
class Problem():
    def __init__(self, user, problem_id):
        ...
        self.__code_template_conf_path = "{}/pomeloabc_OI_System_Profile/Document_Profile".format(os.path.abspath(os.path.jpomeloabc_OIn(os.path.dirname(os.path.abspath(__file__)), "..")))
    ...
    def get(self, contest_id = None, cookie_effective_time = 86400):
        ...
        with sync_playwright() as playwright:
            ...
            if contest_id != None:
                os.chdir(os.path.jpomeloabc_OIn(old_path, ".."))
