...
class User():
    def __init__(self, username, password):
        ...
        self.__user_profile_conf_path = "{}/pomeloabc_OI_System_Profile/User_Profile".format(os.path.abspath(os.path.jpomeloabc_OIn(os.path.dirname(os.path.abspath(__file__)), "../..")))
