...
class Document():
    def __init__(self):
        self.__document_profile_conf_path = "{}/pomeloabc_OI_System_Profile/Document_Profile".format(os.path.abspath(os.path.jpomeloabc_OIn(os.path.dirname(os.path.abspath(__file__)), "..")))
