...
import OI.OJHelper.Luogu.Record as Record
...
class User():
    def __init__(self, username, password):
        ...
        self.__user_profile_conf_path = "{}/OI_System_Profile/User_Profile".format(os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../..")))
