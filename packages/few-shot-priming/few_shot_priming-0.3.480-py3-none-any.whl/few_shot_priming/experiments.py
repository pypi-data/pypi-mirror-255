...
def save_splits_topic_counts():
    ...
    for experiment in ["ibmsc", "vast"]:
        ...
        df_training.to_csv("/home/yamen/tmp/training.csv", sep=",", encoding="utf-8", index=False)
        df_validation.to_csv("/home/yamen/tmp/validation.csv", sep=",", encoding="utf-8", index=False)
