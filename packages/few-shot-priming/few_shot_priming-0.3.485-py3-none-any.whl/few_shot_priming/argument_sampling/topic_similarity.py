...
def sample_similar_examples(test_index, similarities, df_training, few_shot_size, experiment="ibmsc"):
    ...
    for index in items_indices:
        ...
        if experiment == "vast" and neutral_instances_count < class_few_shot_size:
            instances.append(neutral_instances)
            neutral_instances_count = neutral_instances + 1
        ...
        elif len(pro_instance) and pro_instances_count<class_few_shot_size:
