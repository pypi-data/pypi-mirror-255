    ...
    def __init__(
        ...
        if col_wrap is None:
            ...
            if col is None and row is None:
                ...
                axes_dict = dict(list(zip(row_names, axes.flat)))
            elif row is None:
                axes_dict = dict(list(zip(col_names, axes.flat)))
            else:
                facet_product = product(row_names, col_names)
                axes_dict = dict(list(zip(facet_product, axes.flat)))
            ...
            axes_dict = dict(list(zip(col_names, axes)))
