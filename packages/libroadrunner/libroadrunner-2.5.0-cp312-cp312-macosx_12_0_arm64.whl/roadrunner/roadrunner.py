...
class LoadSBMLOptions(BasicDictionary):
    ...
    NO_DEFAULT_STEADY_STATE_SELECTIONS = _roadrunner.LoadSBMLOptions_NO_DEFAULT_STEADY_STATE_SELECTIONS
    r"""Do not create a default steady state selection list when the model is loaded."""
...
class RoadRunnerOptions(object):
    ...
    diffStepSize = property(_roadrunner.RoadRunnerOptions_diffStepSize_get, _roadrunner.RoadRunnerOptions_diffStepSize_set)
    steadyStateThreshold = property(_roadrunner.RoadRunnerOptions_steadyStateThreshold_get, _roadrunner.RoadRunnerOptions_steadyStateThreshold_set)
    fluxThreshold = property(_roadrunner.RoadRunnerOptions_fluxThreshold_get, _roadrunner.RoadRunnerOptions_fluxThreshold_set)
...
class ExecutableModel(object):
    ...
    def setBoundarySpeciesAmounts(self, *args) -> "int":
        return _roadrunner.ExecutableModel_setBoundarySpeciesAmounts(self, *args)
    ...
    def setStoichiometries(self, *args) -> "int":
        return _roadrunner.ExecutableModel_setStoichiometries(self, *args)

    def setStoichiometry(self, *args) -> "int":
        return _roadrunner.ExecutableModel_setStoichiometry(self, *args)

    def getStoichiometry(self, *args) -> "double":
        r"""
    ...
    def getStoichiometryIndex(self, *args) -> "int":
        r"""
        *Overload 1:*
        ...
        *Overload 2:*
        ...
        :return: >= 0 on success, < 0 on failure.
        """
        return _roadrunner.ExecutableModel_getStoichiometryIndex(self, *args)

    def getStoichiometryId(self, index: "size_t") -> "std::string":
        r"""get the name of the specified stoichiometry"""
        return _roadrunner.ExecutableModel_getStoichiometryId(self, index)
    ...
    def getEventRoots(self, time: "double", y: "double const *", gdot: "double *") -> "void":
        ...
        :type y: float, in
        :param y: the state std::vector
        :type gdot: float, out
        :param gdot: result event roots, this is of length numEvents.
        """
        return _roadrunner.ExecutableModel_getEventRoots(self, time, y, gdot)

    def getPiecewiseTriggerRoots(self, time: "double", y: "double const *", gdot: "double *") -> "void":
        return _roadrunner.ExecutableModel_getPiecewiseTriggerRoots(self, time, y, gdot)

    def getNumPiecewiseTriggers(self) -> "int":
        r"""We do root-finding for 'piecewise triggers': those times in a piecewise function that transition from one condition to the next."""
        return _roadrunner.ExecutableModel_getNumPiecewiseTriggers(self)
...
class RoadRunner(object):
    ...
    def loadStateS(self, state: "std::stringstream *") -> "void":
        r"""
        load state from a :type state: std::stringstream
        :param state: stringstream
    ...
    def getIndependentFloatingSpeciesAmountsV(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        Author: Claire
        Returns the independent floating species amounts as an array
        """
        return _roadrunner.RoadRunner_getIndependentFloatingSpeciesAmountsV(self)

    def getDependentFloatingSpeciesAmountsV(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        Author: Claire
        Returns the dependent floating species amounts as an array
        """
        return _roadrunner.RoadRunner_getDependentFloatingSpeciesAmountsV(self)

    def getIndependentFloatingSpeciesConcentrationsV(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        Author: Claire
        Returns the independent floating species concentrations as an array
        """
        return _roadrunner.RoadRunner_getIndependentFloatingSpeciesConcentrationsV(self)

    def getDependentFloatingSpeciesConcentrationsV(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        Author: Claire
        Returns the dependent floating species concentrations as an array
        """
        return _roadrunner.RoadRunner_getDependentFloatingSpeciesConcentrationsV(self)

    def getIndependentFloatingSpeciesAmountsNamedArray(self) -> "ls::DoubleMatrix":
        r"""
        Author: Claire
        Returns the independent floating species amounts as a named array
        """
        return _roadrunner.RoadRunner_getIndependentFloatingSpeciesAmountsNamedArray(self)

    def getDependentFloatingSpeciesAmountsNamedArray(self) -> "ls::DoubleMatrix":
        r"""
        Author: Claire
        Returns the dependent floating species amounts as a named array
        """
        return _roadrunner.RoadRunner_getDependentFloatingSpeciesAmountsNamedArray(self)

    def getIndependentFloatingSpeciesConcentrationsNamedArray(self) -> "ls::DoubleMatrix":
        r"""
        Author: Claire
        Returns the independent floating concentrations amounts as a named array
        """
        return _roadrunner.RoadRunner_getIndependentFloatingSpeciesConcentrationsNamedArray(self)

    def getDependentFloatingSpeciesConcentrationsNamedArray(self) -> "ls::DoubleMatrix":
        r"""
        Author: Claire
        Returns the dependent floating concentrations amounts as a named array
        """
        return _roadrunner.RoadRunner_getDependentFloatingSpeciesConcentrationsNamedArray(self)
    ...
    def getFluxThreshold(self) -> "double":
        r"""
        Get the flux threshold used in getCC
        In the MCA routines, RoadRunner will keep trying to
        converge to a steady state until this threshold is met
        """
        return _roadrunner.RoadRunner_getFluxThreshold(self)

    def setFluxThreshold(self, val: "double") -> "void":
        r"""
        Set the flux threshold used in getCC
        In getCC, RoadRunner will return 0.0 for flux control coefficients if the
        """
        return _roadrunner.RoadRunner_setFluxThreshold(self, val)
    ...
    def _addSpeciesConcentration(self, *args, **kwargs) -> "void":
        ...
        :type hasOnlySubstanceUnits: boolean, optional
        ...
        :type boundaryCondition: boolean, optional
    ...
    def removeInitialAssignment(self, vid: "std::string const &", forceRegenerate: "bool"=True, errIfNotExist: "bool"=True) -> "void":
        r"""
        ...
        :param forceRegenerate:: a boolean value to indicate if the model is regenerated
                                    ...
                                    of editing function
            					       ...
            					       set this flag to true only in the last call of editing
        """
        return _roadrunner.RoadRunner_removeInitialAssignment(self, vid, forceRegenerate, errIfNotExist)
    ...
    def getNumberOfDependentSpecies(self) -> "int":
        r"""Alias for this function on the child model object."""
        return _roadrunner.RoadRunner_getNumberOfDependentSpecies(self)
    ...
    def getGlobalParameterByName(self, param: "std::string const &") -> "double":
        r"""
        Author: ciaran welsh
        get the value of global parameter with id :type param: string
        :param param:
        """
...
class Integrator(Solver):
    ...
    def getAbsoluteToleranceVector(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        ...
        """
        return _roadrunner.Integrator_getAbsoluteToleranceVector(self)
...
class IntegratorException(object):
    r"""The exception class thrown by the Integrator."""
...
class Config(object):
    ...
    """
    METABOLIC_CONTROL_ANALYSIS_FLUX_THRESHOLD = _roadrunner.Config_METABOLIC_CONTROL_ANALYSIS_FLUX_THRESHOLD
    r"""The flux threshold when calculating the scaled control coefficients of fluxes."""
    METABOLIC_CONTROL_ANALYSIS_DIFFERENTIAL_STEP_SIZE = _roadrunner.Config_METABOLIC_CONTROL_ANALYSIS_DIFFERENTIAL_STEP_SIZE
    r"""The differential step size when calculating the scaled control coefficients of fluxes."""
    METABOLIC_CONTROL_ANALYSIS_STEADY_STATE_THRESHOLD = _roadrunner.Config_METABOLIC_CONTROL_ANALYSIS_STEADY_STATE_THRESHOLD
    r"""The differential step size when calculating the scaled control coefficients of fluxes."""
...
class NewtonIteration(KinsolSteadyStateSolver):
    r"""Implementation of the newton iteration form of the kinsol steady state solver."""
...
class CVODEIntegrator(Integrator):
    ...
    def getAbsoluteToleranceVector(self) -> "std::vector< double,std::allocator< double > >":
        ...
        """
        return _roadrunner.CVODEIntegrator_getAbsoluteToleranceVector(self)
