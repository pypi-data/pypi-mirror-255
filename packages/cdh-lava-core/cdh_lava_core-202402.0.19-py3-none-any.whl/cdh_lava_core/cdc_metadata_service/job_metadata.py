...
import cdh_lava_core.cdc_metadata_service.pipeline_metadata as davt_pl_metadata
...
class JobMetaData:
    ...
    def install_cluster_library(config) -> str:
        ...
        cdh_lava_core_python_version = config["cdh_lava_core_python_version"]
        cdh_lava_core_python_version = cdh_lava_core_python_version.replace("v", "")
        library_folder = f"{davt_root_project_url}dist/"
        library_file = f"{library_folder}{cdh_lava_core_python_version}-py3-none-any.whl"
