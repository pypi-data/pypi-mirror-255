...
class TestDatabricksNotebook(unittest.TestCase):
    def setup_config(self, data_product_id, environment):
        ...
        import run_install_cdh_lava_core_python
        ...
        (
            ...
            obj_job_core,
            config,
        ) = run_install_cdh_lava_core_python.setup_core(
            running_local,
            initial_script_dir,
            dbutils,
            spark,
    ...
    def test_run_jobs_cdh_premier_notebook(self):
        ...
        with tracer.start_as_current_span("setup_core"):
            try:
                ...
                notebook_path = "/Workspace/Repos/zfi4@cdc.gov/cdh-dav/cdh_lava_core_lib/cdh/cdh_premier/_run_jobs_cdh_premier.py"
