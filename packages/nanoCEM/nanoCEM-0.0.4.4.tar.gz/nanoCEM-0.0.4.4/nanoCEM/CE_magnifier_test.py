...
def init_parser():
    ...
    parser_f5c.add_argument('--pore', choices=['r9', 'r10'], help='Select pore type', default='r9')
    ...
    parser_f5c.add_argument('-c', "--control",
                            help="control_blow5_path")
    parser_f5c.add_argument('-m','--sig_move_offset', type=int, help='sig_move_offset for squigualiser reform')
    parser_f5c.add_argument('-k','--kmer_length', type=int, help='kmer_length for squigualiser reform')
    add_public_argument(parser_f5c)
    # parser.set_defaults(function='tombo', chrom="NR_103073.1", pos=2251, len=10, strand='+', cpu=8,norm=True,
    ...
    #                         control_fast5='../example/data/reverse/ivt/single/', output='tombo_result_rna',
    #                         subsample_ratio=1, \
    #                         ref="../example/data/23S_rRNA.fasta", \
    #                         basecall_group="RawGenomeCorrected_000", basecall_subgroup="BaseCalled_template", rna=True)
    parser.set_defaults(function='tombo', chrom="17", pos=43281925, len=10, strand='+', cpu=8,norm=True,
    ...
    # parser.set_defaults(function='f5c', chrom="NR_103073.1", pos=2251, len=10, strand='+', cpu=8,norm=True,base_shift=True,
    #                     input='/hdd_data/download/23s_rRNA_A2030/wt/file', \
    #                     control='/hdd_data/download/23s_rRNA_A2030/ivt/file', output='f5c_result_rna',
    #                     subsample_ratio=1,
    #                     ref="../example/data/23S_rRNA.fasta", pore='r9', rna=True)
    # parser.set_defaults(function='move_table', chrom="NR_103073.1", pos=2251, len=10, strand='+', cpu=8,norm=True,
    #                     input='../example/data/wt/basecall',sig_move_offset=0,kmer_length=1,
    #                     control='../example/data/ivt/basecall', output='move_result_rna',
    #                     subsample_ratio=1,
    #                     ref="../example/data/23S_rRNA.fasta", rna=True)
    # parser.set_defaults(function='move_table', chrom="17", pos=43281925, len=10, strand='+', cpu=8,norm=True,
    ...
    # parser.set_defaults(function='f5c', chrom="17", pos=43281925, len=10, strand='+', cpu=8,base_shift=True,norm=True,
    #                     input='../example/dna/hg38_chr17_43281378/WGS_r941/file',
    #                     control='../example/dna/hg38_chr17_43281378/scWGA_941/file', output='f5c_result_dna',
    #                     subsample_ratio=1,rna=False,
    #                     ref="../example/dna/hg38_17.fa", pore='r9')
    # parser.set_defaults(function='f5c', chrom="17", pos=39976063, len=10, strand='-', cpu=8,base_shift=True,norm=True,
    #                     input='../example/dna/hg38_chr17_43281378/WGS_r941/file',
    #                     control='../example/dna/hg38_chr17_43281378/scWGA_941/file', output='f5c_result_dna_rev',
    #                     subsample_ratio=1,rna=False,
    ...
    # parser.set_defaults(function='f5c', chrom="NR_103073.1", pos=2251, len=10, strand='+', cpu=8,norm=True,base_shift=True,pore='r9',
    #                     input='../example/data/wt/file', control='../example/data/ivt/file', output='f5c_result_rna',
    #                     subsample_ratio=1,
    #                     ref="../example/data/23S_rRNA.fasta", rna=True)
    return parser
