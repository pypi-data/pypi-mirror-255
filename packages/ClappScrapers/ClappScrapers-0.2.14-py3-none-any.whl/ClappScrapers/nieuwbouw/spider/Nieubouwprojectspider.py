...
class NieuwbouwprojectspiderSpider(scrapy.Spider):
    ...
    base_url = 'https://www.nieuwbouw-nederland.nl/projecten/?hk[]=k&sort=change_desc&p=1'
    ...
    def get_to_sell_project_page(self,resposne):

        yield scrapy.Request (url = 'https://www.nieuwbouw-nederland.nl/projecten/?fs=&hk[]=k&sort=',callback = self.parse_projects)
    ...
    def parse_projects(self, response):
            ...
            for project in projects:
                ...
                if project.startswith('https://www.nieuwbouw'):         
                    ...
                    yield scrapy.Request(url = project, callback=self.parse_project_page,cb_kwargs={'projects':projects,'project':project,'project_info':project_info,'project_list':project_list})

            next_page_link = response.xpath('//a[contains(text(), "volgende")]/@href').get()

            if next_page_link is not None:

                next_page_url = 'https://www.nieuwbouw-nederland.nl' + next_page_link
