...
from ClappScrapers.funda_scraper.config.core import config
from ClappScrapers.funda_scraper.preprocess import clean_list_date, preprocess_data
from ClappScrapers.funda_scraper.utils import logger
...
class FundaScraper(object):
    ...
    def scrape_one_link(self, link: str) -> List[str]:
        ...
        result.append(self.get_value_from_css(soup, '.object-header__project-info a'))
        return result
