...
class Supernova:
    ...
    def close(self) -> dict:
        ...
        if (self.usbHidDevice is not None) and (self.usbRx is not None):
            ...
            sys_response.code = SystemOpcode.OPEN_CONNECTION_REQUIRED
    ...
    def onEvent(self, callback_func) -> dict:
        ...
        if len(func_parameters) != 2:
            sys_response.code = SystemOpcode.INVALID_CALLBACK_SIGNATURE
    ...
    def i3cInitBus(self, id: int, targetDeviceTable: dict = None) -> dict:
        ...
        ----------
        id : int
            A 2-byte integer representing the initialization ID. The range allowed is [0, 65535].
    ...
    def i3cGetTargetDeviceTable(self, id: int) -> dict:
        ...
        ----------
        id : int
            A 2-byte integer representing the request ID. The range allowed is [0, 65535].
        ...
        dict
            Return the SystemMessage in dictionary format.
        -------
        Note: The retrieved PID for each target is in MSB order
        """
    ...
    def i3cTargetReset(self, id: c_uint16, targetAddress: c_uint8, defByte: c_uint8, isReadOrWrite: TransferDirection, pushPullRate: I3cPushPullTransferRate, openDrainRate: I3cOpenDrainTransferRate) -> dict:
        """
        This method resets a target device on the I3C bus.
        ...
        targetAddress : c_uint8
            The address of the target device to be reset.

        defByte : c_uint8
            The definition byte for the reset operation.

        isReadOrWrite : TransferDirection
            Specifies whether the reset operation is a read or write.

        pushPullRate : I3cPushPullTransferRate
            The push-pull rate for the reset operation.

        openDrainRate : I3cOpenDrainTransferRate
            The open-drain rate for the reset operation.
    ...
    def i3cGETPID(self, id: c_uint16, targetAddress: c_uint8, pushPullRate: I3cPushPullTransferRate, openDrainRate: I3cOpenDrainTransferRate) -> dict:
        """
        This method gets the Provisioned ID (PID) from a target device on the I3C bus.
        ...
        dict
            Return the SystemMessage in dictionary format.
        -------
        Note: The retrieved PID is in MSB order
        """
    ...
    def i3cSETAASA(self, id: c_uint16, pushPullRate: I3cPushPullTransferRate, openDrainRate: I3cOpenDrainTransferRate) -> dict:
        """
        This method set All Addresses to Static Address on the I3C bus.
        ...
        pushPullRate : I3cPushPullTransferRate
            The push-pull rate for setting all addresses.

        openDrainRate : I3cOpenDrainTransferRate
            The open-drain rate for setting all addresses.
    ...
    def i3cBroadcastENDXFER(self, id: c_uint16, pushPullRate: I3cPushPullTransferRate, openDrainRate: I3cOpenDrainTransferRate, definingByte:c_uint8, callback,data:list = []) -> dict:
        ...
        callback : callback
            The callback function triggered after the ENDXFER command.
    ...
    def i3cBroadcastSETXTIME(self, id: c_uint16, pushPullRate: I3cPushPullTransferRate, openDrainRate: I3cOpenDrainTransferRate, subCMDByte:c_uint8, callback, data:list = []) -> dict:
        ...
        callback : callback
            The callback function triggered after the SETXTIME command.
