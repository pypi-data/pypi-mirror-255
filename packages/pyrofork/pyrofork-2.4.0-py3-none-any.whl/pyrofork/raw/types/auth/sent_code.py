...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pyrofork.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pyrofork.raw.base.auth.CodeType>`, *optional*):
            N/A
