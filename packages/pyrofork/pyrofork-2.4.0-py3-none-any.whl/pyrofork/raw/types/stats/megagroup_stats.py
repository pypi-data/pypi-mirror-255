...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        ...
        members (:obj:`StatsAbsValueAndPrev <pyrofork.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <pyrofork.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <pyrofork.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <pyrofork.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <pyrofork.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <pyrofork.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <pyrofork.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <pyrofork.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <pyrofork.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <pyrofork.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <pyrofork.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <pyrofork.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <pyrofork.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <pyrofork.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <pyrofork.raw.base.StatsGroupTopInviter>`):
            N/A

        users (List of :obj:`User <pyrofork.raw.base.User>`):
            N/A
