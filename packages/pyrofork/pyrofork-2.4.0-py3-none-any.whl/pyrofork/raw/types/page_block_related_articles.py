...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <pyrofork.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <pyrofork.raw.base.PageRelatedArticle>`):
            N/A
