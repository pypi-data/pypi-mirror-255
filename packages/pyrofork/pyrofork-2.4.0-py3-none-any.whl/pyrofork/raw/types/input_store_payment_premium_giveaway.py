...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <pyrofork.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <pyrofork.raw.base.InputPeer>`, *optional*):
            N/A
