...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <pyrofork.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pyrofork.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pyrofork.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pyrofork.raw.base.updates.State>`):
            N/A
