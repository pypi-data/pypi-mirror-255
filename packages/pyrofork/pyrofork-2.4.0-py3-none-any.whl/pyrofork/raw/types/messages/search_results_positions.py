...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <pyrofork.raw.base.SearchResultsPosition>`):
            N/A
