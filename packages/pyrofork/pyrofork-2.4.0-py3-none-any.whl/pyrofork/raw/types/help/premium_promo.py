...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pyrofork.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pyrofork.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pyrofork.raw.base.PremiumSubscriptionOption>`):
            N/A
