...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        icons (List of :obj:`AttachMenuBotIcon <pyrofork.raw.base.AttachMenuBotIcon>`):
            N/A
        ...
        peer_types (List of :obj:`AttachMenuPeerType <pyrofork.raw.base.AttachMenuPeerType>`, *optional*):
            N/A
