...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <pyrofork.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <pyrofork.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <pyrofork.raw.base.DataJSON>`):
            N/A
