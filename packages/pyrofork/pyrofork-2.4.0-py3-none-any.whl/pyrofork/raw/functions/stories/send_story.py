...
class SendStory(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputPeer <pyrofork.raw.base.InputPeer>`):
            N/A

        media (:obj:`InputMedia <pyrofork.raw.base.InputMedia>`):
            N/A

        privacy_rules (List of :obj:`InputPrivacyRule <pyrofork.raw.base.InputPrivacyRule>`):
            N/A
        ...
        fwd_from_id (:obj:`InputPeer <pyrofork.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`Updates <pyrofork.raw.base.Updates>`
    """
