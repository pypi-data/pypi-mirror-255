...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~pyrofork.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <pyrofork.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <pyrofork.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~pyrofork.raw.types`
    """
