...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <pyrofork.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <pyrofork.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pyrofork.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <pyrofork.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <pyrofork.raw.base.photos.Photo>`
    """
