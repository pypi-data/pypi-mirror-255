...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <pyrofork.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <pyrofork.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <pyrofork.raw.base.payments.ValidatedRequestedInfo>`
    """
