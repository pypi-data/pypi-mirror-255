...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pyrofork.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pyrofork.raw.base.PhoneConnection>`):
            N/A
