...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <pyrofork.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <pyrofork.raw.base.ThemeSettings>`, *optional*):
            N/A
