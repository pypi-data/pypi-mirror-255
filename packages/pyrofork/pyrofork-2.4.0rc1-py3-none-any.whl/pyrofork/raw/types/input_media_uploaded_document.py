...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <pyrofork.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <pyrofork.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <pyrofork.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <pyrofork.raw.base.InputDocument>`, *optional*):
            N/A
