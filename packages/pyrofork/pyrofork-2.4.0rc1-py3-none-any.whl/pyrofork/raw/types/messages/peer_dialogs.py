...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <pyrofork.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <pyrofork.raw.base.Message>`):
            N/A
