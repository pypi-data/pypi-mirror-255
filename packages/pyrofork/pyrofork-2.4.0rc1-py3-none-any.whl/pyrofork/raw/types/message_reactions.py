...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyrofork.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyrofork.raw.base.MessagePeerReaction>`, *optional*):
            N/A
