...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyrofork.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyrofork.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pyrofork.raw.base.SecureValueError>`):
            N/A
