...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <pyrofork.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <pyrofork.raw.base.Peer>`):
            N/A
