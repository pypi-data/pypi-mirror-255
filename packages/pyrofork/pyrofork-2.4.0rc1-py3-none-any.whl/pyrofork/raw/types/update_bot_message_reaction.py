...
class UpdateBotMessageReaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        actor (:obj:`Peer <pyrofork.raw.base.Peer>`):
            N/A

        old_reactions (List of :obj:`Reaction <pyrofork.raw.base.Reaction>`):
            N/A

        new_reactions (List of :obj:`Reaction <pyrofork.raw.base.Reaction>`):
            N/A
