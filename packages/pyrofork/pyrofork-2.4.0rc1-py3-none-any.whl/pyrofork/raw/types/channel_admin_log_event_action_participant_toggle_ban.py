...
class ChannelAdminLogEventActionParticipantToggleBan(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <pyrofork.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <pyrofork.raw.base.ChannelParticipant>`):
            N/A
