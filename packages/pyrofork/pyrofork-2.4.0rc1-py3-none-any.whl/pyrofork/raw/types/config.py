...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyrofork.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyrofork.raw.base.Reaction>`, *optional*):
            N/A
