...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrofork.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyrofork.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyrofork.raw.base.PopularContact>`):
            N/A
