...
class ImageGenerationRequest(BaseModel):
    ...
    cfg_scale: Optional[Any] = Field(None, description="Floating-point number represeting how closely to adhere to prompt description. Must be a positive number no greater than 50.0.")
    steps: Optional[Any] = Field(None, description="Integer repreenting how many steps of diffusion to run. Must be greater than 0 and less than or equal to 200.")
    num_images: Optional[Any] = Field(None, description="Integer representing how many output images to generate with a single prompt/configuration.")
    ...
    strength: Optional[Any] = Field(None, description="Floating-point number indicating how much creative the Image to Image generation mode should be. Must be greater than 0 and less than or equal to 1.0.")
    style_preset: Optional[PreDefinedStyles] = None
    use_refiner: Optional[Any] = Field(None, description="Whether to enable and apply the SDXL refiner model to the image generation.")
    high_noise_frac: Optional[Any] = Field(None, description="Floating-point number that defines the fraction of steps to perform with the base model. Used only by SD XL. Must be greater than or equal to 0.0 and less than or equal to 1.0.")
    controlnet_conditioning_scale: Optional[Any] = Field(None, description="How strong the effect of the controlnet should be.")
    controlnet_preprocess: Optional[Any] = Field(None, description="Whether to apply automatic ControlNet preprocessing.")
    clip_skip: Optional[ClipSkip] = None
    enable_safety: Optional[Any] = Field(None, description="Boolean defining whether to use safety checker system on generated outputs or not.")
    image_encoding: Optional[ImageEncoding] = None
    force_asset_download: Optional[Any] = Field(None, description="[Internal] Boolean defining if assets must be re-downloaded into the cache even if present.")
    force_asset_gpu_copy: Optional[Any] = Field(None, description="[Internal] Boolean defining if assets must to be copied into the GPU even if present.")
    additional_properties: Dict[str, Any] = {}
    __properties = ["prompt", "prompt_2", "negative_prompt", "negative_prompt_2", "checkpoint", "controlnet", "vae", "textual_inversions", "loras", "sampler", "height", "width", "cfg_scale", "steps", "num_images", "seed", "controlnet_image", "init_image", "mask_image", "strength", "style_preset", "use_refiner", "high_noise_frac", "controlnet_conditioning_scale", "controlnet_preprocess", "clip_skip", "enable_safety", "image_encoding", "force_asset_download", "force_asset_gpu_copy"]
    ...
    def to_dict(self):
        ...
        if self.prompt is None and "prompt" in self.__fields_set__:
            _dict['prompt'] = None

        # set to None if cfg_scale (nullable) is None
        # and __fields_set__ contains the field
        if self.cfg_scale is None and "cfg_scale" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.num_images is None and "num_images" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.use_refiner is None and "use_refiner" in self.__fields_set__:
            _dict['use_refiner'] = None

        # set to None if high_noise_frac (nullable) is None
        # and __fields_set__ contains the field
        if self.high_noise_frac is None and "high_noise_frac" in self.__fields_set__:
            _dict['high_noise_frac'] = None

        # set to None if controlnet_conditioning_scale (nullable) is None
        # and __fields_set__ contains the field
        if self.controlnet_conditioning_scale is None and "controlnet_conditioning_scale" in self.__fields_set__:
            _dict['controlnet_conditioning_scale'] = None

        # set to None if controlnet_preprocess (nullable) is None
        # and __fields_set__ contains the field
        if self.controlnet_preprocess is None and "controlnet_preprocess" in self.__fields_set__:
            _dict['controlnet_preprocess'] = None

        # set to None if enable_safety (nullable) is None
        # and __fields_set__ contains the field
        if self.enable_safety is None and "enable_safety" in self.__fields_set__:
            _dict['enable_safety'] = None

        # set to None if force_asset_download (nullable) is None
        # and __fields_set__ contains the field
        if self.force_asset_download is None and "force_asset_download" in self.__fields_set__:
            _dict['force_asset_download'] = None

        # set to None if force_asset_gpu_copy (nullable) is None
        # and __fields_set__ contains the field
        if self.force_asset_gpu_copy is None and "force_asset_gpu_copy" in self.__fields_set__:
