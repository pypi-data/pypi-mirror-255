...
# Constructor
    def __init__(self, width=Oasys.gRPC.defaultArg, height=Oasys.gRPC.defaultArg, backgroundcolour=Oasys.gRPC.defaultArg):
        ...
        If no arguments are given a None (0 pixels wide by 0 pixels high) is made.
        If 2 arguments are given they are used as the width and height of the image.
        ...
        backgroundcolour : string
            ...
            colour from the X colour database (see /etc/X11/rgb.txt) e.g. "Blue", or #RRGGBB (each of R, G and B is a single hex digit)
            e.g. "#0000FF" for blue
...
# Instance methods
    ...
    def PixelCount(self, colour, tol=Oasys.gRPC.defaultArg):
        ...
        ----------
        colour : string
            A valid colour from the X colour database (see /etc/X11/rgb.txt) e.g. "Blue", or #RRGGBB (each of R, G and B is a single hex digit)
            e.g. "#0000FF" for blue
        tol : integer
