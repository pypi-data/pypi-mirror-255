...
public:
	 ...
	 * @return Error Code generated by function. 0 indicates no error.
	 */
	virtual ErrorCode SetSelectedSensorPosition(double sensorPos, int pidIdx = 0,
			int timeoutMs = 50) = 0;
	 ...
	 * @return Error Code generated by function. 0 indicates no error.
	 */
	virtual ErrorCode ConfigForwardSoftLimitThreshold(double forwardSensorLimit,
			int timeoutMs = 0) = 0;
	/**
	 ...
	 * @return Error Code generated by function. 0 indicates no error.
	 */
	virtual ErrorCode ConfigReverseSoftLimitThreshold(double reverseSensorLimit,
			int timeoutMs = 0) = 0;
	/**
	 ...
	 * @return Error Code generated by function. 0 indicates no error.
	 */
	virtual ErrorCode Config_IntegralZone(int slotIdx, double izone,
			int timeoutMs = 0) = 0;
	/**
	...
	virtual ErrorCode ConfigAllowableClosedloopError(int slotIdx,
			double allowableCloseLoopError, int timeoutMs = 0) = 0;
	/**
	 ...
	 * @return Error Code generated by function. 0 indicates no error.
	 */
	virtual ErrorCode ConfigMotionCruiseVelocity(double sensorUnitsPer100ms,
			int timeoutMs = 0) = 0;
	/**
	 ...
	 * @return Error Code generated by function. 0 indicates no error.
	 */
	virtual ErrorCode ConfigMotionAcceleration(double sensorUnitsPer100msPerSec,
			int timeoutMs = 0) = 0;
