...
def submit(self, fn, /, *args, **kwargs):
    def internal_fn(*args, **kwargs) -> Any:
        with PIH.ERROR.detect():
            return fn(*args, **kwargs)
    super().submit(internal_fn, *args, **kwargs)
"""
...
class Output(OutputBase, OutputStub):
    ...
    def free_marks_by_group_for_result(
        ...
        self.table_with_caption_last_title_is_centered(
            result,
            js(("Свободные карты доступа для группы доступа", j((self.b(group_name), ":")))),
            use_index,
        )
...
class Input(InputBase):
    ...
    def choose_file(
        self, use_search_request: bool | None = None
    ) -> File:
        ...
        with self.output.make_loading(1, "Идет загрузка файлов. Ожидайте"):
            file_list = PIH.RESULT.FILES.get(
                name=(search_request := self.input("Введите поисковый запрос"))
...
class PIH:
        ...
        def create_command_for_start_service(
            ...
            return (
                ...
                if is_local
                    ...
                    python_command,
                    host or local_action(PIH.SERVICE.get_host(role_or_information)),
                    login,
                    password,
                    interactive,
    ...
    class SERVICE:
        ...
        class ADMIN:
            ...
            def start(
                ...
                host: str | None = None,
                host_is_linux: bool | None = None,
                pih_as_standalone: bool | None = None,
                ipih_install: bool = True,
            ) -> bool | None:
                host = host or (
                    EnumTool.get(role_or_information).host
                    if isinstance(role_or_information, ServiceRoles)
                    else role_or_information.host
                )
                if ipih_install:
                ...
                try:
                    ...
                    if e(description.service_path):
                        service_file_path = PIH.PATH.adapt_for_linux(
                            PIH.PATH.join(
                                PATH_FACADE.VALUE,
                                j(
                                    (
                    ...
                    command_list.append(service_file_path)
                ...
                if ne(service_information_list):
                    ...
                    with ThreadPoolExecutor(max_workers=length) as executor:
                        future_to_bool = {
                            executor.submit(
                                PIH.ERROR.wrap(
                                    PIH.SERVICE.check_on_accessibility
                                ),
                                service_descroption,
                            ): service_descroption
    ...
    class DATA(DataTool, StringTool, ListTool, DateTimeTool, EnumTool, FullNameTool):
        ...
        class FORMAT:
            ...
            def variable(
                ...
                return PIH.DATA.VARIABLE.ENVIRONMENT.value(variable_name) if from_environment else PIH.DATA.VARIABLE.value(variable_name) 
    ...
    class CHECK:
        ...
        class RESOURCE:
            ...
            @staticmethod
            def polibase_accessibility(cached: bool = False, test: bool | None = None) -> bool:
                try:
                    if cached:
                        return PIH.RESULT.RESOURCES.get_resource_status(
                            RESOURCES.DESCRIPTIONS.POLIBASE2 if test else RESOURCES.DESCRIPTIONS.POLIBASE1
                        ).accessable
                ...
                class WAPPI:
                    ...
                    def accessibility(
                        ...
                        def internal_accessibility(
                            ...
                            url: str = f"{CONST.MESSAGE.WHATSAPP.WAPPI.URL_GET_STATUS}{profile_value}"
                            headers: dict = {
        ...
        class WHATSAPP:
            class WAPPI:
                ...
                def get_message_list(
                    ...
                    url: str = f"{CONST.MESSAGE.WHATSAPP.WAPPI.URL_GET_MESSAGES}{profile_value}&chat_id={telephone_number}{CONST.MESSAGE.WHATSAPP.WAPPI.CONTACT_SUFFIX}"
                    headers: dict = {
                        "Authorization": CONST.MESSAGE.WHATSAPP.WAPPI.AUTHORIZATION[
                            profile
                        ],
