...
class PATH_FACADE:
    LINUX_MOUNT_POINT: str = "/mnt"
    SHARED_POINT_PATH: str = os.path.join("S$", FACADE.NAME)
    LINUX_MOUNT_POINT_PATH: str = f"{LINUX_MOUNT_POINT}/{FACADE.NAME}/"
    VIRTUAL_ENVIRONMENT_NAME: str = ".venv"
    WINDOWS_VIRTUAL_ENVIRONMENT_FOLDER: str = f"{VIRTUAL_ENVIRONMENT_NAME}/Scripts/"
    

    VALUE: str = f"//{AD.DOMAIN_MAIN}/{FACADE.NAME}/"
    ...
    @staticmethod
    def WINDOWS_VIRTUAL_ENVIRONMENT_PATH() -> str:
        return os.path.join(PATH_FACADE.VALUE, PATH_FACADE.WINDOWS_VIRTUAL_ENVIRONMENT_FOLDER)
...
class PATH_WS_816_SCAN:
    NAME: str = "Scans"
    VALUE: str = r"//" + os.path.join(HOSTS.WS816.NAME, NAME)
