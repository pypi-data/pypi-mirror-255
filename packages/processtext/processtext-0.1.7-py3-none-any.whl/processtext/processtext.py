...
# Defining Exceptions for processtext 
class CleanTextEmptyString(ValueError):
    """Vlaue error for processtext
    """

# Check if stopwords corpus is present, if not, download it
if not nltk.corpus.stopwords.words('english'):
    nltk.download('stopwords')

# Check if wordnet corpus is present, if not, download it
if not nltk.corpus.wordnet.all_synsets():
