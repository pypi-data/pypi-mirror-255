...
class ChatFile(object):
    ...
    def __init__(
        ...
        prompt_template: Union[ChatPromptTemplate, str] = ChatPromptTemplate.from_template(context_prompt_template),
        ...
        **kwargs
        ...
        self.chain = load_qa_chain(
            self.llm,
            chain_type="stuff",
            prompt=prompt_template  # todo: 增加信源
        )
...
if __name__ == '__main__':
    from chatllm.llmchain.prompts.qa import template, strict_template
