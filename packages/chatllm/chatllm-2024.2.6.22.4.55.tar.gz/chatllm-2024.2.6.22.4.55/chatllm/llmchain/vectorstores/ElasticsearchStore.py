...
from langchain.vectorstores.elasticsearch import ElasticsearchStore as _ElasticsearchStore
from langchain.retrievers.elastic_search_bm25 import ElasticSearchBM25Retriever
# ElasticSearchBM25Retriever().get_relevant_documents()
...
if __name__ == '__main__':
    ElasticsearchStore(index_name='test_index').similarity_search(query='nihao')
