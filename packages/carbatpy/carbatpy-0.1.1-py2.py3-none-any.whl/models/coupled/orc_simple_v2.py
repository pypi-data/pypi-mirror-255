...
class OrganicRankineCycle:
    ...
    def calc_orc(self,  verbose=False):
        ...
        # pump------------------------
        w_after_pump, work_pump = cb.compressor_simple.compressor(self.fixed_points["p_high"],
        ...
        evaporator = cb.hex_th.StaticHeatExchanger([w_actual, self.fluids[1]],
                                                   ...
                                                   calc_type="const",
                                                   name="evaporatorORC")
        result_ev = evaporator.find_pinch()
        ...
        w_after_evaporator = self.fluids[0].set_state([w_ev[0][2], w_ev[0][1]], "HP")
        ...
        # expander -----------------------
        w_after_expander, work_expander = cb.compressor_simple.compressor(self.fixed_points["p_low"],
        ...
        q_dot_l = self.fixed_points["Q_dot_h"]*(1-1/self.fixed_points["cop_charging"])
        ...
        condenser = \
            cb.hex_th.StaticHeatExchanger([w_actual,
                                          ...
                                          d_temp_separation_min=self.fixed_points["d_temp_min"],
                                          name="condenserORC")
        h_cond_out = condenser.find_pinch()
    ...
    def hp_plot(self, f_name=_RESULTS_+"last_T_H_dot_plot_orc"):
        """
        ...
        for i_process in range(n_range-1, -1, -1):  # count backwards to shift the env-hex
            h_shift_here = 0
            ...
            cycle_states[:, 2] = cycle_states[:, 2] * m_dots[i_process] + h_shift_here
        ...
        ax.plot(connect_h, connect_temp, "r:")
        ...
        np.savetxt(f_name+".csv", np.concatenate(all_data),delimiter =";", header =";".join(names))
