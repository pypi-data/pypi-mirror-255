...
PACKAGE_DATA = {
	"orangecontrib.development_tools.widgets": ["icons/*", "widget_designer/*"], # contenu du dossier 'icons' situé dans 'orangecontrib/development_tools/widgets'
}
