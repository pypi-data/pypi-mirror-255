...
# TODO: Replace height, width parameters to WordSearch.__init__ with a size
#       parameter. If None, infer and if necessary expand. Else, try max_attempts.
