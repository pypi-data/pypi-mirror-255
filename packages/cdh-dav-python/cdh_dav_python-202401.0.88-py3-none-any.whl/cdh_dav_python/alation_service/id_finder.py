...
Notes:
- This module uses the `cdc_admin_service` and `cdc_tech_environment_service` packages for logging and HTTP requests.
...
from cdh_dav_python.alation_service.endpoint import Endpoint
