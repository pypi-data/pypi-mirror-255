dbutils.widgets.text('yyyy', 'default')
yyyy = dbutils.widgets.get('yyyy')
dbutils.widgets.text('mm', 'default')
mm = dbutils.widgets.get('mm')
dbutils.widgets.text('dd', 'default')
dd = dbutils.widgets.get('dd')
dbutils.widgets.text('transmission_period', 'default')
transmission_period = dbutils.widgets.get('transmission_period')
dict_parameters = {'yyyy':'default','mm':'default','dd':'default','transmission_period':'default','environment':'dev'}
 # COMMAND ----------
sql_command_text = """/**
...
GRANT ALL PRIVILEGES ON VIEW TEMPORARY_OPEN_BRACKETtarget_databaseTEMPORARY_CLOSE_BRACKET.gold_davt_rpt_scan_field_vw TO `TEMPORARY_OPEN_BRACKETadmin_user_or_roleTEMPORARY_CLOSE_BRACKET`;""".format(**dict_parameters) # COMMAND ----------
print(sql_command_text) # COMMAND ----------
execute_results_flag = "(True,)" # COMMAND ----------
