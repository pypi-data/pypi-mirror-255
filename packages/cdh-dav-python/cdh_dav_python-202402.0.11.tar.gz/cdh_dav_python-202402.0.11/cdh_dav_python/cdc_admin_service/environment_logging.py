...
from cdh_dav_python.cdc_admin_service.environment_tracing import TracerSingleton
...
if OS_NAME.lower() == "nt":  # Windows environment
    ...
    LOG_FILENAME = ENV_SHARE_PATH / "cdh_dav_tracing.txt"
    ...
    try:
        ...
        LOG_FILENAME = os.path.join(ENV_SHARE_PATH, "cdh_dav_logging.txt")
