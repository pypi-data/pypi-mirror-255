...
import cdh_dav_python.databricks_service.dataset_core as cdh_ds_core
import cdh_dav_python.cdc_security_service.security_core as cdh_sec_core
import cdh_dav_python.cdc_tech_environment_service.environment_core as cdh_env_core
...
class DataSetConvert:
    ...
    @staticmethod
    def convert_xlsx_to_list(
        data, cols, work_sheet, skip_rows, data_product_id: str, environment: str
    ):
            ...
            try:
                ...
                for i_row, row_item in enumerate(data):
                    ...
                    for j_col, col_item in enumerate(row_item):
                        ...
                        logger.info(f"col_item_updated:{col_item_updated}")
