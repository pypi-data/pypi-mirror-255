...
class BillingAPI:
    ...
    def get_user_subscription(self, unique_id: str, plan_unique_id: str) -> types.Subscription: ...
    def new_user_subscription(self, unique_id: str, plan_unique_id: str, comment: str = "") -> types.Subscription: ...
    def set_subscription_amount(self, unique_id: str, plan_unique_id: str, amount: float): ...
