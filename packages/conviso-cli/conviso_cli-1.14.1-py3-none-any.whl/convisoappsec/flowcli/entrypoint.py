...
@click.option(
    ...
    is_flag=True,
    hidden=True,
    help="Enable auto closing vulnerabilities.",
)
@help_option
...
@pass_flow_context
def cli(flow_context, api_key, api_url, api_insecure, experimental, ci_provider_name, vulnerability_auto_close):
    flow_context.key = api_key
    flow_context.url = api_url
    flow_context.insecure = api_insecure
    flow_context.experimental = experimental
    flow_context.vulnerability_auto_close = vulnerability_auto_close
