...
class ExtraccionBGD():
    ...
    rutas = []
    def __init__(self, estructura, division, mes, año, listado_cuentas, dias, mensuales, columnas, subsector, line_thresh) -> None:
        ...
        with open(os.path.join(os.getcwd(), 'extraccion_log.txt'), 'w') as self._f:
