...
class SetShell(Oasys.gRPC.OasysItem, metaclass=SetShellType):
...
# Static methods
    ...
    def GetAll(model):
        ...
        -------
        array
            Array of :py:class:`SetShell<SetShell>` objects
        """
