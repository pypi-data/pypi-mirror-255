...
# Static methods
    ...
    def GetMultipleData(component, items, options=Oasys.gRPC.defaultArg):
        ...
        -------
        $object
            Dict containing the data. A property is created in the object for each shell with the label. The value of the property is a number if a scalar component or an array if a vector or tensor component (or None if the value cannot be calculated)
        """
