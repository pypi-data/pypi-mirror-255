...
class Contact(Oasys.gRPC.OasysItem, metaclass=ContactType):
    _props = {'aNodes', 'aSegments', 'bNodes', 'bSegments', 'data', 'include', 'index', 'label', 'model', 'name', 'title', 'type'}
...
# Static methods
    ...
    def GetAll(model):
        ...
        -------
        array
            Array of :py:class:`Contact<Contact>` objects
        """
    ...
    def GetMultipleData(component, items, options=Oasys.gRPC.defaultArg):
        ...
        ----------
        component : constant
            :ref:`Component constant ` to get data for
        items : list
        ...
        -------
        $object
            Dict containing the data. A property is created in the object for each contact with the label. The value of the property is a number if a scalar component or an array if a vector or tensor component (or None if the value cannot be calculated)
        """
...
# Instance methods
    ...
    def GetData(self, component, options=Oasys.gRPC.defaultArg):
        ...
        -------
        float|array
            Number if a scalar component, array if a vector or tensor component (or None if the value cannot be calculated)
        """
