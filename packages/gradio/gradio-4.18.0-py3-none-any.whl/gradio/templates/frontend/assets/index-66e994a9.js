    ...
    if (rule instanceof CSSStyleRule) {
      ...
      if (selector) {
        const new_selector = selector.replace(".dark", "").split(",").map(
          (s) => `${is_dark_rule ? ".dark" : ""} gradio-app .gradio-container.gradio-container-${version} .contain ${s.trim()} `
        ).join(",");
...
const ENTRY_CSS = "./assets/index-585c3a65.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-50915c32.js').then(n => n.I),true?["./Index-50915c32.js","./Index-69202a7a.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-66e994a9.js.map
