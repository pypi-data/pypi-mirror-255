...
class SitGenReducer(BaseReducer):
    ...
    def compute(self, composite: TextComponentComposite) -> dict:
        ...
        Args:
            text_compo (TextComponentComposite): Computed composite containing the
                data to be reduced.
        ...
        for weather in composite.weathers:
        ...
        for geo_id in composite.geos:
            bounds = composite.weathers[0].geos.bounds
