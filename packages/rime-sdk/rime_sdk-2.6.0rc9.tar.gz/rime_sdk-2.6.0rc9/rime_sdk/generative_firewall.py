...
def _verify_individual_rules_config(individual_rules_config: Any) -> None:
    """Verify the raw individual rules config provided by the user.
...
class FirewallClient:
    ...
    def create_firewall_instance(
        ...
        # Perform validation on the individual rules config if it is present.
        individual_rules_config = _config.pop("individual_rules_config", None)
        if individual_rules_config:
            _verify_individual_rules_config(individual_rules_config)
