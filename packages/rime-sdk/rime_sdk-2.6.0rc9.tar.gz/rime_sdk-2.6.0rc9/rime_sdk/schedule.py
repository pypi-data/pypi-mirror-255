...
from rime_sdk.swagger.swagger_client import ApiClient, RimeGetScheduleResponse
...
class Schedule:
    ...
    def _get(self) -> ScheduleSchema:
        ...
        with RESTErrorHandler():
            response: RimeGetScheduleResponse = api.schedule_service_get_schedule(
    ...
    def delete(self) -> None:
        ...
        api = ScheduleServiceApi(self._api_client)
        with RESTErrorHandler():
            api.schedule_service_delete_schedule(schedule_id_uuid=self._schedule_id)
            self._schedule_id = ""
