...
class Project:
    ...
    def info(self) -> ProjectInfo:
        ...
        return ProjectInfo(
            ...
            project.run_time_info,
            None
            if project.active_schedule is None
            else project.active_schedule.to_dict(),
        )
    ...
    def create_schedule(
        ...
        with RESTErrorHandler():
            ...
            response = api.schedule_service_create_schedule(body=body)
    ...
    def activate_schedule(
        ...
        with RESTErrorHandler():
            ...
            api = swagger_client.ProjectServiceApi(self._api_client)
            response = api.project_service_activate_schedule_for_project(
                body=body,
                project_id_uuid=self._project_id,
                schedule_id_uuid=schedule_id,
            )

            return response.active_schedule.to_dict()
    ...
    def deactivate_schedule(
        ...
        with RESTErrorHandler():
            ...
            api = swagger_client.ProjectServiceApi(self._api_client)
            api.project_service_deactivate_schedule_for_project(
                body=body,
                project_id_uuid=self._project_id,
                schedule_id_uuid=schedule_id,
            )
