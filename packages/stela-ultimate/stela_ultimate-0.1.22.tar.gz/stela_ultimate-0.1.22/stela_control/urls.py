...
urlpatterns = [
    ...
    path('pro-stela', views.proStela, name="prostela"),
    ...
    #postpro
    path('post-pro', views.postPro, name="post-pro"),
    ...
    path('validations/suspend-account/<int:user_id>/', superfunctions.suspend_user, name="suspend_user"),
    ...
    path('api/prostela/', superfunctions.apiProstela, name="api_prostela"),
 ]   