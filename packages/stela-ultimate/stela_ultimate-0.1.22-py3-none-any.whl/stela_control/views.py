...
from .models import (
    ...
    IGPostMetric, IGCarouselMetric, IGReelMetric, IGStoriesMetric, Company, SocialLinks, Reviews,
...
from .forms import (
    ...
    BillingFormSuscription, LegalProvitionForm,  categForm, 
...
@user_passes_test(lambda u: u.is_superuser, login_url='/')
def proStela(request):
    
    context = {
        
    }

    return render(request, 'stela_control/prostela/index.html', context)
...
def postPro(request):
    ...
    return render(request, 'stela_control/post-pro/index.html', {
