...
_GRAPHTYPE = DESCRIPTOR.enum_types_by_name['GraphType']
GraphType = enum_type_wrapper.EnumTypeWrapper(_GRAPHTYPE)
_SETTYPE = DESCRIPTOR.enum_types_by_name['SetType']
...
_GRAPHSCHEMA = DESCRIPTOR.message_types_by_name['GraphSchema']
_GRAPHSCHEMA_NODESETSENTRY = _GRAPHSCHEMA.nested_types_by_name['NodeSetsEntry']
_GRAPHSCHEMA_EDGESETSENTRY = _GRAPHSCHEMA.nested_types_by_name['EdgeSetsEntry']
_FEATURE = DESCRIPTOR.message_types_by_name['Feature']
_BIGQUERY = DESCRIPTOR.message_types_by_name['BigQuery']
_BIGQUERY_TABLESPEC = _BIGQUERY.nested_types_by_name['TableSpec']
_METADATA = DESCRIPTOR.message_types_by_name['Metadata']
_METADATA_KEYVALUE = _METADATA.nested_types_by_name['KeyValue']
_CONTEXT = DESCRIPTOR.message_types_by_name['Context']
_CONTEXT_FEATURESENTRY = _CONTEXT.nested_types_by_name['FeaturesEntry']
_NODESET = DESCRIPTOR.message_types_by_name['NodeSet']
_NODESET_FEATURESENTRY = _NODESET.nested_types_by_name['FeaturesEntry']
_EDGESET = DESCRIPTOR.message_types_by_name['EdgeSet']
_EDGESET_FEATURESENTRY = _EDGESET.nested_types_by_name['FeaturesEntry']
_ORIGININFO = DESCRIPTOR.message_types_by_name['OriginInfo']
_BIGQUERY_READMETHOD = _BIGQUERY.enum_types_by_name['ReadMethod']
