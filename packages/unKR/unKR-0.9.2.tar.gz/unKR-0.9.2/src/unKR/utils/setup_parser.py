...
def setup_parser():
    ...
    parser.add_argument('--load_config', default=True, action='store_true', help='Load parametes config file.')
    parser.add_argument('--config_path', default="config/TransE_demo_kg.yaml", type=str, help='The config file path.')
