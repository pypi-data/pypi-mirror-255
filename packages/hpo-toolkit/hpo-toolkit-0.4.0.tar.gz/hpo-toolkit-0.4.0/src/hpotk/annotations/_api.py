...
class AnnotatedItem(typing.Generic[ANNOTATION], metaclass=abc.ABCMeta):
    ...
    def present_annotations(self) -> typing.Iterator[ANNOTATION]:
        """
        :return: an iterator over *present* annotations.
        """
        return filter(lambda a: a.is_present, self.annotations)

    def absent_annotations(self) -> typing.Iterator[ANNOTATION]:
        """
        :return: an iterator over *absent* annotations.
        """
...
class AnnotatedItemContainer(typing.Generic[ANNOTATED_ITEM],
    ...
    def item_ids(self) -> typing.Iterator[TermId]:
        """
        :return: an iterator over all item identifiers.
        """
