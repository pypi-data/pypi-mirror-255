...
class Joint(Oasys.gRPC.OasysItem, metaclass=JointType):
    _props = {'cid', 'colour', 'coupl', 'damp', 'exists', 'failure', 'h_angle', 'heading', 'id', 'include', 'jid', 'label', 'lcid', 'local', 'lst', 'mxx', 'myy', 'mzz', 'n1', 'n2', 'n3', 'n4', 'n5', 'n6', 'nxx', 'nyy', 'nzz', 'option', 'parm', 'r1', 'raid', 'rps', 'tfail', 'type'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, model, option, n1, n2, jid=Oasys.gRPC.defaultArg, heading=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, option, n1, n2, jid, heading)
