...
class Curve(Oasys.gRPC.OasysItem, metaclass=CurveType):
    _props = {'dattyp', 'dist', 'exists', 'function', 'heading', 'include', 'label', 'lcid', 'lcint', 'ncurves', 'npoints', 'offa', 'offo', 'sfa', 'sfo', 'sidr', 'tend', 'trise', 'tstart', 'type', 'version', 'vmax'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, load_curve_type, model, lcid, sidr=Oasys.gRPC.defaultArg, sfa=Oasys.gRPC.defaultArg, sfo=Oasys.gRPC.defaultArg, offa=Oasys.gRPC.defaultArg, offo=Oasys.gRPC.defaultArg, dattyp=Oasys.gRPC.defaultArg, heading=Oasys.gRPC.defaultArg, lcint=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, load_curve_type, model, lcid, sidr, sfa, sfo, offa, offo, dattyp, heading, lcint)
        ...
        Parameters
        ----------
        load_curve_type : constant
            Type of load curve. Can be Curve.CURVE,
            Curve.TABLE,
            Note this does not have to be defined. In previous versions
            of Primer you could only construct a basic load curve type,
            therefore the type argument was not used.
            Primer is still backwards compatible with this method of
            load curve creation
        model : Model
        ...
        lcid : integer
            Curve number
        sidr : integer
            Optional. Stress initialisation by dynamic relaxation
        sfa : float
            Optional. Scale factor on abscissa value
        sfo : float
            Optional. Scale factor on ordinate value
        offa : float
            Optional. Offset on abscissa value
        offo : float
            Optional. Offset on ordinate value
        dattyp : integer
            Optional. Data type
        heading : string
