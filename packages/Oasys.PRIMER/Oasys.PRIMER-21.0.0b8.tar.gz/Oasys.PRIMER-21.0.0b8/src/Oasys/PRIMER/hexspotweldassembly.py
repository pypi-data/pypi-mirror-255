...
class HexSpotweldAssembly(Oasys.gRPC.OasysItem, metaclass=HexSpotweldAssemblyType):
    _props = {'eid1', 'eid10', 'eid11', 'eid12', 'eid13', 'eid14', 'eid15', 'eid16', 'eid2', 'eid3', 'eid4', 'eid5', 'eid6', 'eid7', 'eid8', 'eid9', 'exists', 'id', 'include', 'opt', 'title'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, model, id, opt, eid1, eid2, eid3, eid4, title=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, id, opt, eid1, eid2, eid3, eid4, title)
