...
class Belt(Oasys.gRPC.OasysItem, metaclass=BeltType):
    _props = {'acuteAngle', 'curvature', 'elemSet', 'exists', 'friction', 'id', 'include', 'iterations', 'label', 'length', 'meshSegs', 'n2sContact', 'nodeSet', 'nrbFirst', 'nrbLast', 'nsboSet', 'overlap', 'parts', 'penetration', 'pidShell', 'pid_1d', 'pid_2d', 'points', 'projection', 'psiShell', 'psi_2d', 'retractorFirst', 'retractorLast', 'rows', 's2sContact', 'seatbeltFirst', 'seatbeltLast', 'segments', 'shells', 'slen_1d', 'slipringFirst', 'slipringLast', 'solids', 't1Shell', 't1_2d', 't2Shell', 't2_2d', 't3Shell', 't3_2d', 't4Shell', 't4_2d', 'thickFactor', 'thickFlag', 'thickness', 'title', 'tolerance', 'tshells', 'width', 'xsect_pretext', 'xsect_pretext_option', 'xsectionFirst', 'xsectionLast'}
    _rprops = {'model'}
