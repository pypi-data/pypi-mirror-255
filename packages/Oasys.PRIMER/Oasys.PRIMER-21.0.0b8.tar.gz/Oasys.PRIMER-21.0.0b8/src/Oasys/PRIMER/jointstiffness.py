...
class JointStiffness(Oasys.gRPC.OasysItem, metaclass=JointStiffnessType):
    _props = {'cida', 'cidb', 'dlcidal', 'dlcidbt', 'dlcidg', 'dlcidp', 'dlcidph', 'dlcidps', 'dlcidr', 'dlcidt', 'dlcidx', 'dlcidy', 'dlcidz', 'esal', 'esbt', 'esph', 'esps', 'esr', 'est', 'esx', 'esy', 'esz', 'exists', 'fd', 'ffr', 'ffx', 'ffy', 'ffz', 'fmal', 'fmbt', 'fmph', 'fmps', 'fmt', 'fs', 'heading', 'include', 'jid', 'label', 'lcidal', 'lcidbt', 'lcidg', 'lcidph', 'lcidps', 'lcidr', 'lcidt', 'lcidx', 'lcidy', 'lcidz', 'nsabt', 'nsaph', 'nsaps', 'nsat', 'nsdx', 'nsdy', 'nsdz', 'option', 'pida', 'pidb', 'psabt', 'psaph', 'psaps', 'psat', 'psdr', 'psdx', 'psdy', 'psdz', 'rad1', 'rad2', 'rps', 'saal'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, model, option, label, pida, pidb, cida, cidb, jid, lcidph, lcidt, lcidps, dlcidph, dlcidt, dlcidps, esph, fmph, est, fmt, esps, fmps, nsaph, psaph, nsat, psat, nsaps, psaps):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, option, label, pida, pidb, cida, cidb, jid, lcidph, lcidt, lcidps, dlcidph, dlcidt, dlcidps, esph, fmph, est, fmt, esps, fmps, nsaph, psaph, nsat, psat, nsaps, psaps)
        ...
        label : integer
            JointStiffness ID of the JSTF.
            Also see the label argument which is an alternative name for this
        pida : integer
            Part ID #A
        pidb : integer
            Part ID #B
