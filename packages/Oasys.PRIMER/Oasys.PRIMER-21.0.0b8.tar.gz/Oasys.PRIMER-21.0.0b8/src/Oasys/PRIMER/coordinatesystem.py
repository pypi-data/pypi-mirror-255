...
class CoordinateSystem(Oasys.gRPC.OasysItem, metaclass=CoordinateSystemType):
    _props = {'cid', 'cidl', 'dir', 'exists', 'flag', 'heading', 'include', 'label', 'lx', 'ly', 'lz', 'n1', 'n2', 'n3', 'nid', 'option', 'ox', 'oy', 'oz', 'px', 'py', 'pz', 'vx', 'vy', 'vz', 'xx', 'xy', 'xz'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, model, option, cid, n1, n2, n3, flag, dir, heading=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, option, cid, n1, n2, n3, flag, dir, heading)
