...
class Set(Oasys.gRPC.OasysItem, metaclass=SetType):
    _props = {'add', 'collect', 'colour', 'da1', 'da2', 'da3', 'da4', 'exists', 'general', 'generate', 'include', 'intersect', 'its', 'label', 'model', 'sid', 'solver', 'title', 'transparency'}
    _rprops = {'advanced', 'collect_children', 'column', 'general_lines', 'increment', 'smooth', 'total', 'type'}
