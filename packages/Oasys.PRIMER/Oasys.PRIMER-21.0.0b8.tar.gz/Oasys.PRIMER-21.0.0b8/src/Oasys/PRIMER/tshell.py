...
class Tshell(Oasys.gRPC.OasysItem, metaclass=TshellType):
    _props = {'beta', 'beta_angle', 'colour', 'composite', 'eid', 'exists', 'include', 'label', 'n1', 'n2', 'n3', 'n4', 'n5', 'n6', 'n7', 'n8', 'nip', 'nodes', 'pid', 'transparency'}
    _rprops = {'model'}
...
# Static methods
    ...
    def FindTshellInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg, vis_only=Oasys.gRPC.defaultArg):
        ...
        This may include tshells that are ostensibly outside box. The user should apply his/her own test.
