...
# Constructor
    def __init__(self, model, eid, pid, n1, n2, n3, n4, n5=Oasys.gRPC.defaultArg, n6=Oasys.gRPC.defaultArg, n7=Oasys.gRPC.defaultArg, n8=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, eid, pid, n1, n2, n3, n4, n5, n6, n7, n8)
        Oasys.gRPC.OasysItem.__init__(self, self.__class__.__name__, handle)
        """
        Create a new Solid object. Use either 4, 6 or 8 nodes when
        creating a new solid. If you are creating a 4 noded solid either only give 4 nodes or give 8 nodes
        ...
        pid : integer
            Part number
        n1 : integer
            Node number 1 or list containing all nodes (in which case other no other arguement has to be given after this)
        n2 : integer
            Node number 2
        n3 : integer
            Node number 3
...
# Static methods
    ...
    def FindSolidInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg, vis_only=Oasys.gRPC.defaultArg):
        ...
        This may include solids that are ostensibly outside box. The user should apply his/her own test.
