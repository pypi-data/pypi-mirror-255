...
class Beam(Oasys.gRPC.OasysItem, metaclass=BeamType):
    _props = {'cid', 'cid_1', 'colour', 'd1', 'd2', 'd3', 'd4', 'd5', 'd6', 'dofn1', 'dofn2', 'dofns', 'eid', 'elbow', 'exists', 'include', 'iner', 'label', 'local', 'mn', 'n1', 'n2', 'n3', 'nodes', 'offset', 'orientation', 'parm1', 'parm2', 'parm3', 'parm4', 'parm5', 'pid', 'pid1', 'pid2', 'pid_opt', 'rr1', 'rr2', 'rt1', 'rt2', 'scalar', 'scalr', 'section', 'sn1', 'sn2', 'stype', 'thickness', 'transparency', 'vol', 'vx', 'vy', 'vz', 'warpage', 'wx1', 'wx2', 'wy1', 'wy2', 'wz1', 'wz2'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, model, eid, pid, n1, n2, n3):
...
# Static methods
    ...
    def FindBeamInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg, vis_only=Oasys.gRPC.defaultArg):
        ...
        This may include beams that are ostensibly outside box. The user should apply his/her own test.
