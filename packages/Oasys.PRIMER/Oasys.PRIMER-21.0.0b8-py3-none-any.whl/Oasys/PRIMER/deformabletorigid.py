...
class DeformableToRigid(Oasys.gRPC.OasysItem, metaclass=DeformableToRigidType):
    _props = {'code', 'd2r', 'dtmax', 'entno', 'exists', 'include', 'ixx', 'ixx_1', 'ixy', 'ixz', 'iyz', 'izz', 'lrb', 'ncsf', 'nrbf', 'offset', 'paired', 'pid', 'ptype', 'r2d', 'relsw', 'rwf', 'swset', 'time1', 'time2', 'time3', 'tm', 'type', 'xc', 'yc', 'zc'}
    _rprops = {'model'}
