...
class Box(Oasys.gRPC.OasysItem, metaclass=BoxType):
    _props = {'bid', 'brmax', 'brmin', 'cid', 'cx', 'cy', 'cz', 'exists', 'heading', 'idir', 'iflag', 'include', 'label', 'lcid', 'level', 'lidx', 'lidy', 'lidz', 'local', 'ndid', 'nid', 'option', 'pid_adaptive', 'pid_drawbead', 'radius', 'sid', 'stype', 'vd', 'vid', 'xmn', 'xmx', 'xv', 'xx', 'ymn', 'ymx', 'yv', 'yx', 'zmn', 'zmx', 'zv', 'zx'}
    _rprops = {'model'}
