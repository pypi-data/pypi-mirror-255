...
class Shell(Oasys.gRPC.OasysItem, metaclass=ShellType):
    _props = {'beta', 'colour', 'composite', 'composite_long', 'dof', 'edges', 'eid', 'exists', 'include', 'label', 'mcid', 'n1', 'n2', 'n3', 'n4', 'n5', 'n6', 'n7', 'n8', 'nip', 'nodes', 'ns1', 'ns2', 'ns3', 'ns4', 'offset', 'pid', 'shl4_to_shl8', 'thic1', 'thic2', 'thic3', 'thic4', 'thic5', 'thic6', 'thic7', 'thic8', 'thickness', 'transparency'}
    _rprops = {'model'}
...
# Static methods
    ...
    def FindShellInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg, vis_only=Oasys.gRPC.defaultArg):
        ...
        This may return shells that are ostensibly outside box. The user should apply his/her own test on each shell returned.
