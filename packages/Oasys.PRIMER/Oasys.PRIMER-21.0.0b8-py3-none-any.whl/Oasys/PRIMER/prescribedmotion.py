...
class PrescribedMotion(Oasys.gRPC.OasysItem, metaclass=PrescribedMotionType):
    _props = {'birth', 'bndout2dynain', 'death', 'dof', 'exists', 'form', 'heading', 'id', 'include', 'label', 'lcid', 'lrb', 'nbeg', 'nend', 'node1', 'node2', 'offset1', 'offset2', 'prmr', 'sf', 'sfd', 'type', 'typeid', 'vad', 'vid'}
    _rprops = {'model'}
