...
class CrossSection(Oasys.gRPC.OasysItem, metaclass=CrossSectionType):
    _props = {'bsid', 'colour', 'csid', 'dsid', 'exists', 'heading', 'hsid', 'id', 'idset', 'include', 'itype', 'label', 'lenl', 'lenm', 'nsid', 'option', 'psid', 'radius', 'ssid', 'tsid', 'xch', 'xct', 'xhev', 'ych', 'yct', 'yhev', 'zch', 'zct', 'zhev'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, model, option, nsid, hsid, bsid, ssid, tsid, dsid, id=Oasys.gRPC.defaultArg, itype=Oasys.gRPC.defaultArg, csid=Oasys.gRPC.defaultArg, heading=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, option, nsid, hsid, bsid, ssid, tsid, dsid, id, itype, csid, heading)
        ...
        dsid : integer
            Discrete set number
        id : integer
            Optional. Rigid part or accelerometer or
            coordinate system number
        itype : integer
            Optional. Flag for local system type
        csid : integer
