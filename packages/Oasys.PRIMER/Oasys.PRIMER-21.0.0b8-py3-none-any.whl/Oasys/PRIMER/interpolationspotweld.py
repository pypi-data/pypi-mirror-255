...
class InterpolationSpotweld(Oasys.gRPC.OasysItem, metaclass=InterpolationSpotweldType):
    _props = {'alpha1', 'alpha2', 'alpha3', 'bdmodel', 'beta', 'beta2', 'beta3', 'dens', 'exists', 'gamma', 'include', 'intp', 'lcdexp', 'lcf', 'lcupf', 'lcupr', 'mrn', 'mrs', 'nsid', 'pid1', 'pid2', 'pidvb', 'r', 'rn', 'rs', 'scarn', 'scars', 'sropt', 'stf', 'stiff2', 'stiff3', 'stiff4', 'thick', 'upfn', 'upfs', 'uprn', 'uprs'}
    _rprops = {'model'}
