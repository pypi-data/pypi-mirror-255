...
class PrescribedOrientationRigid(Oasys.gRPC.OasysItem, metaclass=PrescribedOrientationRigidType):
    _props = {'birth', 'body', 'death', 'exists', 'heading', 'id', 'include', 'intrp', 'intrp_1', 'iseq', 'ishft', 'lcidc11', 'lcidc12', 'lcidc13', 'lcidc21', 'lcidc22', 'lcidc23', 'lcidc31', 'lcidc32', 'lcidc33', 'lcide1', 'lcide2', 'lcide3', 'lcide4', 'lcidq1', 'lcidq2', 'lcidq3', 'lcids', 'lcidv1', 'lcidv2', 'lcidv3', 'option', 'pida', 'pidb', 'toffset', 'valspin'}
    _rprops = {'model'}
