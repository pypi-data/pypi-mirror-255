...
class DampingFrequencyRange(Oasys.gRPC.OasysItem, metaclass=DampingFrequencyRangeType):
    _props = {'cdamp', 'exists', 'fhigh', 'flow', 'iflg', 'include', 'option', 'pidrel', 'psid'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, model, option=Oasys.gRPC.defaultArg, cdamp=Oasys.gRPC.defaultArg, flow=Oasys.gRPC.defaultArg, fhigh=Oasys.gRPC.defaultArg, psid=Oasys.gRPC.defaultArg, pidrel=Oasys.gRPC.defaultArg, iflg=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, option, cdamp, flow, fhigh, psid, pidrel, iflg)
        ...
        option : constant
            Optional. Damping frequency range type. Must be DampingFrequencyRange.NO_OPT
        cdamp : float
            Optional. Damping in fraction of critical
        flow : float
