...
class ConnectionProperties(Oasys.gRPC.OasysItem, metaclass=ConnectionPropertiesType):
    _props = {'add', 'areaeq', 'con_id', 'd_dg_pr', 'd_dg_prf', 'd_etan', 'd_etanf', 'd_exsb', 'd_exsbf', 'd_exsn', 'd_exsnf', 'd_exss', 'd_exssf', 'd_gfad', 'd_gfadf', 'd_lcsb', 'd_lcsn', 'd_lcss', 'd_rank', 'd_sb', 'd_sbf', 'd_sclmrr', 'd_sigy', 'd_sigyf', 'd_sn', 'd_snf', 'd_ss', 'd_ssf', 'dg_typ', 'exists', 'heading', 'include', 'moarfl', 'proprul'}
    _rprops = {'model'}
