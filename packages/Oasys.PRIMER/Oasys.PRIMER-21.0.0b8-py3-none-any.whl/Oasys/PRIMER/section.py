...
class Section(Oasys.gRPC.OasysItem, metaclass=SectionType):
    _props = {'a', 'aafac', 'aet', 'afac', 'aisc', 'aisc_label', 'ale', 'aleform', 'area', 'baselm', 'bfac', 'ca', 'cdl', 'cfac', 'cid', 'cl', 'cmid', 'cohoff', 'cohthk', 'colour', 'cslh', 'cst', 'd1', 'd2', 'd3', 'd4', 'd5', 'd6', 'death', 'dfac', 'dofn1', 'dofn2', 'domint', 'dr', 'dro', 'ds', 'dx', 'dy', 'dz', 'ecut', 'edgset', 'efac', 'efg', 'elform', 'ellipse', 'end', 'exists', 'failcr', 'fd', 'fs', 'gaskett', 'hmax', 'hmin', 'hxcslh', 'hxini', 'hycslh', 'hyini', 'hzcslh', 'hzini', 'ibr', 'icomp', 'idam', 'idila', 'idim', 'idof', 'iebt', 'iform', 'ihgf', 'iken', 'iloc', 'include', 'iner', 'interaction', 'iovpr', 'iprstr', 'ips', 'irr', 'ispline', 'iss', 'ist', 'itaj', 'itb', 'ithelfm', 'itoff', 'itorm', 'itt', 'iunf', 'iw', 'iwr', 'iyr', 'izr', 'j', 'kd', 'kernel', 'label', 'lcidt', 'lcidvel', 'lcidvolr', 'lcmdot1', 'lcmdot2', 'lcmdot3', 'lcmdot4', 'lcmdot5', 'lcmdot6', 'lcmdot7', 'lcmdot8', 'lmc', 'lprint', 'lscale', 'marea', 'misc', 'mixture', 'nhsv', 'nidlc001', 'nidlc002', 'nidlc003', 'nip', 'nipp', 'nloc', 'nsloc', 'nsm', 'ntloc', 'nxdof', 'offset', 'peri', 'points', 'pr', 'print', 'propcr', 'propt', 'ptype', 'qr', 'rampt', 'rrcon', 'sa', 'scoor', 'secid', 'setyp', 'sf', 'shrf', 'smstep', 'spg', 'sphini', 'srcon', 'start', 'stime', 'stress', 'stretch', 'stype', 'swtime', 't1', 't2', 't3', 't4', 'tdl', 'tensor', 'thermal', 'thick', 'title', 'toldef', 'transparency', 'trcon', 'ts1', 'ts2', 'tshear', 'tt1', 'tt2', 'user', 'v0', 'vol', 'xfem', 'ys', 'zs'}
    _rprops = {'model', 'type'}
