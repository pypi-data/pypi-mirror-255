...
class Vector(Oasys.gRPC.OasysItem, metaclass=VectorType):
    _props = {'cid', 'exists', 'heading', 'include', 'label', 'nodeh', 'nodes', 'nodet', 'vid', 'xh', 'xt', 'yh', 'yt', 'zh', 'zt'}
    _rprops = {'model'}
...
# Constructor
    def __init__(self, model, vid, xt, yt, zt, xh, yh, zh, cid=Oasys.gRPC.defaultArg, heading=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, vid, xt, yt, zt, xh, yh, zh, cid, heading)
