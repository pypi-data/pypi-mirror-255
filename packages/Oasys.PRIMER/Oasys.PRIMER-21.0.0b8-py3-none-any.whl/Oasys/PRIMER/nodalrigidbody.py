...
class NodalRigidBody(Oasys.gRPC.OasysItem, metaclass=NodalRigidBodyType):
    _props = {'cid', 'cmo', 'colour', 'con1', 'con2', 'drflag', 'exists', 'idthrm', 'include', 'inertia', 'iprt', 'ixx', 'ixy', 'ixz', 'iyy', 'iyz', 'izz', 'label', 'nodeid', 'nsid', 'override', 'pid', 'pnode', 'rrflag', 'spc', 'thermal', 'tm', 'vrx', 'vry', 'vrz', 'vtx', 'vty', 'vtz', 'xc', 'xl', 'xlip', 'yc', 'yl', 'ylip', 'zc', 'zl', 'zlip'}
    _rprops = {'model'}
