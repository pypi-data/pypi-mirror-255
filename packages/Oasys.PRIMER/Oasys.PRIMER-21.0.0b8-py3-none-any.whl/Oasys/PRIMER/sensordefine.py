...
class SensorDefine(Oasys.gRPC.OasysItem, metaclass=SensorDefineType):
    _props = {'calc', 'comp', 'crd', 'ctype', 'elemid', 'etype', 'exists', 'ftype', 'func', 'func_sens1', 'func_sens10', 'func_sens11', 'func_sens12', 'func_sens13', 'func_sens14', 'func_sens15', 'func_sens16', 'func_sens2', 'func_sens3', 'func_sens4', 'func_sens5', 'func_sens6', 'func_sens7', 'func_sens8', 'func_sens9', 'i0', 'i1', 'i2', 'i3', 'i4', 'i5', 'include', 'label', 'layer', 'mtype', 'node1', 'node2', 'option', 'pwr', 'sens1', 'sens2', 'sens3', 'sens4', 'sens5', 'sens6', 'sensid', 'setopt', 'sf', 'typeid', 'vid'}
    _rprops = {'model'}
