from src.geo_ng.data.states import states as states_data
from src.geo_ng.data.lgas import lgas as lgas_data
from src.geo_ng.data.towns import towns as towns_data
