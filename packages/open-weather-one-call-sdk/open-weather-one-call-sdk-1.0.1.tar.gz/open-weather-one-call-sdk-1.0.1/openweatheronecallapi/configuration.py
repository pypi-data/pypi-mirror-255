...
class Environment(Enum):
    ...
    # the production url for open weather
    PRODUCTION = 0
...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(
        ...
        # API key to authorize requests. If you don't have an OpenWeatherMap API key, use `0e42a4c3dff34f7e42dbfcd804a5c917`
        self._appid = appid
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: 'https://api.openweathermap.org/data/3.0'
        }
    }
