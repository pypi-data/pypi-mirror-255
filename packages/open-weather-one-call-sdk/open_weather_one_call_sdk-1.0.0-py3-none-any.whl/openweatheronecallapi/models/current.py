...
from openweatheronecallapi.models.current_weather import CurrentWeather
...
class Current(object):
    ...
    Attributes:
        dt (float): Current time, Unix, UTC
        ...
        feels_like (float): Temperature. This temperature parameter accounts
            for the human perception of weather. Units – default: kelvin,
        ...
        wind_speed (float): Wind speed. Wind speed. Units – default:
        ...
        weather (List[CurrentWeather]): current weather details
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('weather') is not None:
            weather = [CurrentWeather.from_dictionary(x) for x in dictionary.get('weather')]
        else:
            weather = APIHelper.SKIP
