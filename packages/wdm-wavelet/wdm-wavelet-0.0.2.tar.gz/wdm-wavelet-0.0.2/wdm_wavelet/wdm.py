...
class WDM:
    ...
    def t2w(self, strain, sample_rate=None, t0=None, MM=-1):
        """
        ...
        if not isinstance(strain, TimeSeries):
            if sample_rate is None:
                raise ValueError("sample_rate must be provided if strain is not a gwpy.TimeSeries object")
            if t0 is None:
                t0 = 0
        else:
        ...
        return time_frequency_map, {"df": df, "dt": dt, "t0": t0}
