...
if (
    ...
    dll_path = os.environ["MECHEYE_DIR"] + "\\API\\dll\\MechEyeApi.dll"
    if os.path.isfile(dll_path):
        ctypes.PyDLL(dll_path, winmode=0)
    else:
        print("Mech-Eye SDK not found! Please install Mech-Eye SDK and set the environment variable 'MECHEYE_DIR' to the installation path.")
