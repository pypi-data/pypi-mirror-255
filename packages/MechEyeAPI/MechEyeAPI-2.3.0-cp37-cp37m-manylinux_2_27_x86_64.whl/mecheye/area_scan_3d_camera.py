...
class CameraInfo(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    model = property(_area_scan_3d_camera.CameraInfo_model_get, _area_scan_3d_camera.CameraInfo_model_set, doc=r""" Device model name, such as Mech-Eye Nano.""")
    serial_number = property(_area_scan_3d_camera.CameraInfo_serial_number_get, _area_scan_3d_camera.CameraInfo_serial_number_set, doc=r""" Device serial number.""")
    hardware_version = property(_area_scan_3d_camera.CameraInfo_hardware_version_get, _area_scan_3d_camera.CameraInfo_hardware_version_set, doc=r""" The version of the hardware which is pre-determined from the factory.""")
    firmware_version = property(_area_scan_3d_camera.CameraInfo_firmware_version_get, _area_scan_3d_camera.CameraInfo_firmware_version_set, doc=r""" The version of the firmware which can be upgraded.""")
...
class DeviceTemperature(object):
    r"""Describes the device temperature information."""
...
class CameraStatus(object):
    r"""Describes the camera running status."""
...
class CameraMatrix(object):
    r"""Describes the camera intrinsic matrix."""
...
class Intrinsics2DCamera(object):
    r"""
    Describes the 2D camera intrinsics mounted on the device represented in the pinhole camera
    model, including camera matrix and camera distortion parameters.
    """
...
class CameraResolutions(object):
    r"""
    Defines the camera resolutions information, including texture image resolution and depth
    map resolution.
    """
...
class Gray(object):
    r"""The pixel element struct in 'GrayScale2DImage' with gray information."""
...
class ColorBGR(object):
    r"""The pixel element struct in 'Color2DImage' with blue, green, and red information."""
...
class Frame2D(object):
    r"""
    Represents the 2D scanning result, which can be obtained by calling
    'Camera.capture2D'. Use a 2D array to represent it while each pixel represents its
    corresponding 2D data. The 2D data can be in the form of 'Gray' and 'ColorBGR'.
    """
    ...
    def image_size(self):
        r"""Gets the image size information of 'Frame2D'."""
    ...
    def color_type(self):
        r"""Gets the color type of the 2D camera mounted on the device."""
        return _area_scan_3d_camera.Frame2D_color_type(self)

    def clear(self):
        r"""Clears the data in 'Frame2D' and releases the related resources."""
        return _area_scan_3d_camera.Frame2D_clear(self)

    def get_gray_scale_image(self):
        r"""
        Gets image data of the 'Frame2D' with 'Gray' pixel format of each point. If
        the camera's color type (according to the return value of 'Frame2D.colorType)' is
        Frame2DColorType.Monochrome, the function gets the origin data. If color type is
        Frame2DColorType.Color, the function converts 'ColorBGR' values to 'Gray' value
        according to the formula: Gray = 0.299 * Red + 0.587 * Green + 0.114 * Blue.
    ...
    def get_color_image(self):
        r"""
        Gets the image data of the 'Frame2D' with 'ColorBGR' pixel format of each point.
        If the camera's color type (according to the return value of 'Frame2D.colorType)' is
        'Frame2DColorType.Color', the function gets the origin data. If color type is
        Frame2DColorType.Monochrome, the function converts 'Gray' value to 'ColorBGR' values
        according to the formula: Blue = Gray, Green = Gray, Red = Gray.
...
class GrayScale2DImage(object):
    ...
    def at(self, row, col):
        r"""
        Returns an element reference to the specified row and column index in the Array2D
        object.
        :type row: int
...
class PointZ(object):
    r"""The pixel element struct in 'DepthMap' with Z information."""
...
class PointXYZ(object):
    r"""The pixel element struct in 'UntexturedPointCloud' with X, Y, and Z information."""
...
class NormalVector(object):
    r"""The pixel element struct with normal vector X, Y, and Z information."""
...
class PointXYZWithNormals(object):
    ...
    normalY, and normalZ information.
    """
...
class Frame3D(object):
    r"""
    Represents the 3D scanning result, which can be obtained by calling
    'Camera.capture3D' or 'Camera.capture3DWithNormal'. Use a 2D array to represent it
    while each pixel represents its corresponding 3D data. The 3D data can be in the form of
    PointZ, 'PointXYZ', 'PointXYZWithNormal'. The class supports saving 3D point cloud data to
    the file.
    """
    ...
    def image_size(self):
        r"""Gets the image size information of 'Frame3D'."""
    ...
    def clear(self):
        r"""Clears the data in 'Frame3D' and releases the related resources."""
        return _area_scan_3d_camera.Frame3D_clear(self)

    def get_untextured_point_cloud(self):
        r"""
        Obtains the organized 3D data map with a 'PointXYZ' pixel data format. Each point
    ...
    def get_untextured_point_cloud_with_normals(self):
        r"""
        Obtains the organized 3D data map with a 'PointXYZWithNormals' pixel data format.
    ...
    def get_depth_map(self):
        r"""
        Obtains the organized 3D data map with a 'PointZ' pixel data format. Each point in
        'DepthMap' contains the Z data represented in the camera coordinate system. If only Z
        information is considered for the application scenario, using 'DepthMap' can be more
        efficient. The depth data unit is in mm, and invalid data is in nan.
    ...
    def get_orthogonal_depth_map(self):
        r"""
        Obtains the 3D data map with the 'PointZ' pixel data format. The 3D data is
        projected under the orthographic projection camera model. Four parameters are provided to
        assist in converting depth pixel positions into coordinate values represented in camera
        coordinate system according to the formula: X = col * xScale + xOffset, Y = row * yScale +
        yOffset.
    ...
    def save_untextured_point_cloud(self, fileFormat, fileName, isOrganized=False):
        ...
        Each point contains X, Y, and Z fields with the unit in mm. Point cloud can be saved in
        organized or unorganized form with ACSII mode.
        :param [in]: fileFormat The output file format, which supports PLY, PCD, and CSV file formats.
            See 'FileFormat' for details.
        :param [in]: fileName The output file name.
        :param [in]: isOrganized An organized point cloud saves all points in order, with invalid data
            as nan, and an unorganized point cloud saves only valid points.
    ...
    def save_untextured_point_cloud_with_normals(self, fileFormat, fileName, isOrganized=False):
        r"""
        Saves the untextured point cloud to a file with input file format and input file name.
        Each point contains X, Y, Z, normalX, normalY, and normalZ fields with the unit in mm.
        Point cloud can be saved in organized or unorganized form with ACSII mode.
        :param [in]: fileFormat The output file format, which supports PLY, PCD, and CSV file formats.
            See 'FileFormat' for details.
        :param [in]: fileName The output file name.
        :param [in]: isOrganized An organized point cloud saves all points in order, with invalid data
    ...
    def save_point_cloud(pointCloud, fileFormat, fileName, isOrganized=False):
        ...
        Each point contains X, Y, and Z fields with the unit in mm. Point cloud can be saved in
        organized or unorganized form with ACSII mode.
        :param [in]: pointCloud The input point cloud. See 'PointCloud' for details.
        :param [in]: fileFormat The output file format, which supports PLY, PCD, and CSV file formats.
            See 'FileFormat' for details.
        :param [in]: fileName The output file name.
        :param [in]: isOrganized An organized point cloud saves all points in order, with invalid data
    ...
    def save_point_cloud_with_normals(pointCloud, fileFormat, fileName, isOrganized=False):
        ...
        Each point contains X, Y, Z, normalX, normalY, and normalZ fields with the unit in mm.
        Point cloud can be saved in organized or unorganized form with ACSII mode.
        :param [in]: pointCloud The input point cloud. See 'PointCloudWithNormals' for details.
        :param [in]: fileFormat The output file format, which supports PLY, PCD, and CSV file formats.
        :param [in]: fileName The output file name.
        :param [in]: isOrganized An organized point cloud saves all points in order, with invalid data
            as nan, and an unorganized point cloud saves only valid points.
...
class PointXYZBGR(object):
    r"""
    The pixel element struct in 'TexturedPointCloud' with X, Y, Z, blue, green, and red
    information.
    """
...
class PointXYZBGRWithNormals(object):
    ...
    red, normalX, normalY, and normalZ information.
    """
...
class Frame2DAnd3D(object):
    r"""
    Represents the 2D and 3D scanning result, which can be obtained by calling
    'Camera.capture2DAnd3D' or 'Camera.captureAll2D3DWithNormal'. Use a 2D array to
    represent it while each pixel represents its corresponding 3D data. The 3D data can be in the
    form of 'PointZ', 'PointXYZ', and 'PointXYZWithNormal'. The class supports saving 3D
    point cloud data to the file.
    """
    ...
    def clear(self):
        r"""Clears the data in 'Frame2DAnd3D' and releases the related resources."""
        return _area_scan_3d_camera.Frame2DAnd3D_clear(self)

    def get_textured_point_cloud(self):
        r"""
        Gets the pixel-aligned 2D and 3D data with the 'PointXYZBGR' pixel data format.
        Each point in 'TexturedPointCloud' contains the X, Y, and Z data represented in the
        camera coordinate system and the texture information. X, Y, and Z data unit is
        in mm, and invalid data is in nan.
    ...
    def save_textured_point_cloud(self, fileFormat, fileName, isOrganized=False):
        ...
        Each point contains X, Y, Z, blue, green, and red fields. The 3D data unit is in mm. Point
        cloud can be saved in organized or unorganized form with ACSII mode.
        :param [in]: fileFormat The output file format, which supports PLY, PCD, and CSV file formats.
            See 'FileFormat' for details.
        :param [in]: fileName The output file name.
        :param [in]: isOrganized An organized point cloud saves all points in order, with invalid data
    ...
    def save_textured_point_cloud_with_normals(self, fileFormat, fileName, isOrganized=False):
        r"""
        Saves the textured point cloud to a file with input file format and input file name.
        Each point contains X, Y, Z, blue, green, red, normalX, normalY, and normalZ fields. The 3D
        data unit is in mm. Point cloud can be saved in organized or unorganized form with ACSII
        mode.
        :param [in]: fileFormat The output file format, which supports PLY, PCD, and CSV file formats.
            See 'FileFormat' for details.
        :param [in]: fileName The output file name.
    ...
    def save_point_cloud(pointCloud, fileFormat, fileName, isOrganized=False):
        ...
        Each point contains X, Y, Z, blue, green, and red fields. The 3D data unit is in mm. Point
        cloud can be saved in organized or unorganized form with ACSII mode.
        :param [in]: pointCloud The input point cloud. See 'TexturedPointCloud' for details.
        :param [in]: fileFormat The output file format, which supports PLY, PCD, and CSV file formats.
        :param [in]: fileName The output file name.
        :param [in]: isOrganized An organized point cloud saves all points in order, with invalid data
            as nan, and an unorganized point cloud saves only valid points.
    ...
    def save_point_cloud_with_normals(pointCloud, fileFormat, fileName, isOrganized=False):
        ...
        data unit is in mm. Point cloud can be saved in organized or unorganized form with ACSII
        mode.
        :param [in]: pointCloud The input point cloud. See 'TexturedPointCloudWithNormals' for
            details.
        :param [in]: fileFormat The output file format, which supports PLY, PCD, and CSV file formats.
        :param [in]: fileName The output file name.
        :param [in]: isOrganized An organized point cloud saves all points in order, with invalid data
...
class Camera(object):
    r"""
    Operates the Mech-Eye Industrial 3D Cameras.
    Use 'Camera.connect' to connect an available camera, and then you can use the camera to
    capture 2D and 3D frames, configure parameters and so on.
    """
    ...
    def discover_cameras():
        r"""
        Discovers all available cameras, and returns the camera
        information list for them. If a camera is not successfully discovered, please check
        the running status and network connection of the camera.
        :rtype: std::vector< mmind::eye::CameraInfo,std::allocator< mmind::eye::CameraInfo > >
        :return: The available camera information list.
        """
    ...
    def connect(self, *args):
        ...
        *Overload 1:*
        ...
        :param [in]: info The camera information. You can use 'Camera.discoverCameras' to find
        ...
        *Overload 2:*
        ...
        :param [in]: ipAddress Valid IP address of the camera, e.g. in "100.100.1.1" format.
        :param [in]: timeoutMs The timeout for connecting a camera in ms unit. If the execution
            time of the connecting process is greater than the timeout, the function will immediately
            return with 'ErrorStatus.MMIND_STATUS_TIMEOUT_ERROR'.
        :rtype: :py:class:`ErrorStatus`
        :return: 
             'ErrorStatus.MMIND_STATUS_SUCCESS' Success.
    ...
    def disconnect(self):
        r"""Disconnects the camera and releases the associated resources."""
    ...
    def get_camera_resolutions(self, resolutions):
        ...
        texture and depth, which correspond to the 2D and 3D scanning results 'Frame2D' and
        Frame3D.
    ...
    def current_user_set(self):
        r"""
        Gets the 'UserSet' currently in effect of the camera. 'UserSet' can access all
        available parameters of the camera related to 2D and 3D acquisition. 'UserSet' can also
        directly set and get the parameter instead of using 'Parameter' interface.
    ...
    def user_set_manager(self):
        ...
        operations to manage all user set saved in the camera, including adding and deleting the user
        set and selecting the user set currently in effect. It is also available to save all user set
        details to a JSON file and read a JSON file to load user set details.
    ...
    def capture_3d(self, frame3D, timeoutMs=5000):
        r"""
        Projects structured light and captures a single 3D frame of the scene. 3D
        information is computed at the camera side. The capture result will be obtained after the
    ...
    def capture_3d_with_normal(self, frame3D, timeoutMs=10000):
        r"""
        Projects structured light and captures a single 3D frame of the scene. 3D
        information and normal vector are computed at the camera side. The capture result will be
        obtained after the above steps are completed.
        :param [out]: frame3D The capture result. See 'Frame3D' for details.
        :param [in]: timeoutMs The timeout for capturing in milliseconds. If the execution time of
            the capturing process is greater than the timeout, the function will immediately return
            'ErrorStatus.MMIND_STATUS_TIMEOUT_ERROR'.
    ...
    def capture_2d(self, frame2D, timeoutMs=5000):
        r"""
        Captures a single 2D frame using 2D camera mounted on camera of the scene. The capture
        result will be obtained after capturing.
    ...
    def capture_2d_and_3d(self, frame2DAnd3D, timeoutMs=10000):
        r"""
        Captures simultaneously a single 2D frame and 3D frame of the scene. 3D
        information is computed at the camera side. Both 2D and 3D capturing results will be
        obtained. This function makes it easy to get a combination of 2D and 3D data to generate
    ...
    def capture_2d_and_3d_with_normal(self, frame2DAnd3D, timeoutMs=15000):
        r"""
        Captures simultaneously a single 2D frame and 3D frame of the scene. 3D
        information and normal vector are computed at the camera side.
        Both 2D and 3D capturing results will be obtained. This function makes it easy to get a
        combination of 2D and 3D data to generate textured point cloud.
        :param [out]: frame2DAnd3D The capture result containing 'Frame2D' and 'Frame3D'. See
            'Frame2DAnd3D' for details.
        :param [in]: timeoutMs The timeout for capturing in milliseconds. If the execution time of
            the capturing process is greater than the timeout, the function will immediately return
    ...
    def capture_stereo_2d(self, left, right, isRectified=False, timeoutMs=5000):
        ...
        :param [in]: isRectified Whether to perform stereo rectification. After the rectification, The
            ...
            returned. If false, the origin images are returned.
        :param [in]: timeoutMs The timeout period for capturing in milliseconds. If no data is
            received within the timeout period, the function will return the error code
            ErrorStatus.MMIND_STATUS_TIMEOUT_ERROR.
        :rtype: :py:class:`ErrorStatus`
        :return: 
             'ErrorStatus.MMIND_STATUS_SUCCESS' Success.
        ...
        Notes: In order to adjust the exposure effect of the stereo 2D images, different models of
        cameras have different adjustment parameters. For DEEP, LSR S, LSR L camera models,
        DepthSourceExposureMode and 'DepthSourceExposureTime' are used, while other camera models
        use 'ExposureMode' and 'ExposureTime'.
        """
...
class LaserFringeCodingMode(object):
    ...
    r"""
    LSR S and LSR L only. Suitable for reflective objects, provides
