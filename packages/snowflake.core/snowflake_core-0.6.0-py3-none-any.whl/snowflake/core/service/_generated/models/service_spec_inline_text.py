...
class ServiceSpecInlineText(ServiceSpecification):
    specification: StrictStr = Field(...)
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        _dict['spec_type'] = ServiceSpecification.get_child_model_discriminator_value('ServiceSpecInlineText')
        return _dict
...
class ServiceSpecInlineTextModel(ServiceSpecificationModel):
    def __init__(
        self,
        specification: str,
        # optional properties
