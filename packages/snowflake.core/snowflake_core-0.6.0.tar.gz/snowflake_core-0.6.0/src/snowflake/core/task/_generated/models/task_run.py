...
class TaskRun(BaseModel):
    ...
    def state_validate_enum(cls, v):
        if v not in ('SCHEDULED', 'EXECUTING', 'SUCCEEDED', 'FAILED', 'CANCELLED'):
            raise ValueError("must validate the enum values ('SCHEDULED', 'EXECUTING', 'SUCCEEDED', 'FAILED', 'CANCELLED')")
        return v
