...
from snowflake.core._internal.pydantic_compatibility import StrictBool, StrictInt, StrictStr, constr, validator
...
class ServiceApi(object):
    ...
    def fetch_service(self, database : constr(strict=True), var_schema : constr(strict=True), name : constr(strict=True), **kwargs) -> Service:  # noqa: E501
        ...
        Fetch a Service using the SHOW command output.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def fetch_service_logs(self, database : constr(strict=True), var_schema : constr(strict=True), name : constr(strict=True), instance_id : Optional[StrictInt] = None, container_name : Optional[StrictStr] = None, **kwargs) -> str:  # noqa: E501
        ...
        >>> thread = api.fetch_service_logs(database, var_schema, name, instance_id, container_name, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_service_logs_with_http_info(database, var_schema, name, instance_id, container_name, **kwargs)  # noqa: E501

    @validate_arguments
    def fetch_service_logs_with_http_info(self, database : constr(strict=True), var_schema : constr(strict=True), name : constr(strict=True), instance_id : Optional[StrictInt] = None, container_name : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        """Fetch the logs for a given service.  # noqa: E501
        ...
        >>> thread = api.fetch_service_logs_with_http_info(database, var_schema, name, instance_id, container_name, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('container_name') is not None:  # noqa: E501
            _query_params.append(('container_name', _params['container_name']))
    ...
    @validate_arguments
    def fetch_service_status(self, database : constr(strict=True), var_schema : constr(strict=True), name : constr(strict=True), timeout : Optional[StrictInt] = None, **kwargs) -> str:  # noqa: E501
    ...
    @validate_arguments
    def fetch_service_status_with_http_info(self, database : constr(strict=True), var_schema : constr(strict=True), name : constr(strict=True), timeout : Optional[StrictInt] = None, **kwargs):  # noqa: E501
        """Fetch the status for a given service.  # noqa: E501
