...
class ServiceSpecification(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Union[ServiceSpecInlineText, ServiceSpecStageFile]:
        ...
        if object_type:
            ...
            raise ValueError("ServiceSpecification failed to lookup discriminator value from " +
...
class ServiceSpecificationModel():
    def __init__(
        self,
        # optional properties
    ...
    @classmethod
    def _from_model(cls, model) -> ServiceSpecificationModel:
    ...
    def from_dict(cls, obj: dict) -> Union(ServiceSpecInlineTextModel, ServiceSpecStageFileModel):
        """Create an instance of ServiceSpecification from a dict"""
        return cls._from_model(ServiceSpecification.from_dict(obj))


ServiceSpecification._model_class = ServiceSpecificationModel
