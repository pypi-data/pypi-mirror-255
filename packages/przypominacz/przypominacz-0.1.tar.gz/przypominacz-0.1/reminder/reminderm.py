...
from reminder import server

__all__ = ['start_task', 'stop_task', 'make_new_remind'] 

current_working_directory = os.getcwd()
log_directory = os.path.join(current_working_directory, 'przypominacz', 'logs')
if not os.path.exists(log_directory):
    os.makedirs(log_directory)
log_file_path = os.path.join(log_directory, 'reminder_logging.log')
...
if __name__ == "__main__":
    config_path = 'Przypominacz\config\configuration.ini'
    new_remind = make_new_remind(config_path)
    new_remind.start_task()
