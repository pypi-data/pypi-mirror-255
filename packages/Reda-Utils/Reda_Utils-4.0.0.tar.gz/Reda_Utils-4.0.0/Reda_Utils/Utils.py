...
def leer_Config(path='/home/agv/catkin_ws/src/navegacion/config/General.yaml'):
    """
...
class Nav_utils(object):
    ...
    """
    config=leer_Config('/home/agv/catkin_ws/src/navegacion/config/General.yaml')
    ...
    def w_wheels_Twist_diferencial(self,wder=float,wizq=float,diametro_rueda =  diametro_rueda,dist_entre_ruedas =  dist_entre_ruedas,vel_lineal_max =  vel_lineal_max,vel_lineal_min =  vel_lineal_min,vel_angular_max =  vel_angular_max,vel_angular_min =  vel_angular_min):
        ...
        vel_linearX=((wizq+wder)/2.0)*(diametro_rueda/2)                     
    ...
    def vels_a_w(self,velL=float,R=float,diametro_rueda =  diametro_rueda,dist_entre_ruedas =  dist_entre_ruedas):
        ...
        ### no es diametro_rueda , sino radio

        wd=(velL+(R*dist_entre_ruedas/2))/(diametro_rueda/2)
        wi=(velL-(R*dist_entre_ruedas/2))/(diametro_rueda/2)
