...
class GenericRelatedModelViewSet(DRFReactBySchemaBaseModelViewSet):
    related_name = None
    parent_model = None
    pagination_class = None if 'PAGINATION_MODE_NESTED_VIEWSETS' not in settings.get('DRF_REACT_BY_SCHEMA', {
    }) or settings['DRF_REACT_BY_SCHEMA']['PAGINATION_MODE_NESTED_VIEWSETS'] != 'server' else DRFReactBySchemaPagination
...
class GenericViewSet(DRFReactBySchemaBaseModelViewSet):
    serializer_list_class = None
    pagination_class = None if 'PAGINATION_MODE' not in settings.get('DRF_REACT_BY_SCHEMA', {
    }) or settings['DRF_REACT_BY_SCHEMA']['PAGINATION_MODE'] != 'server' else DRFReactBySchemaPagination
