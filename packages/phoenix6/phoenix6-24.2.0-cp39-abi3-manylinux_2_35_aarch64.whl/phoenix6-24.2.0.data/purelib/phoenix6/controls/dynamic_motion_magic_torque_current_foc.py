...
class DynamicMotionMagicTorqueCurrentFOC:
    ...
    def __init__(self, position: rotation, velocity: rotations_per_second, acceleration: rotations_per_second_squared, jerk: rotations_per_second_cubed, feed_forward: ampere = 0.0, slot: int = 0, override_coast_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False):
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("class: DynamicMotionMagicTorqueCurrentFOC")
