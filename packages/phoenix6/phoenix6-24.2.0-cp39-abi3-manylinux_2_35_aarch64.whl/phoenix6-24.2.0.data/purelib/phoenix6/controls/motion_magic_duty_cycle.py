...
class MotionMagicDutyCycle:
    ...
    will do its best to adjust the profile.  This control mode is duty cycle based,
    so relevant closed-loop gains will use fractional duty cycle for the numerator: 
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("class: MotionMagicDutyCycle")
