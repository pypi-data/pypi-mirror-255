...
class PositionTorqueCurrentFOC:
    ...
    Request PID to target position with torque current
    feedforward.
    ...
    def __init__(self, position: rotation, velocity: rotations_per_second = 0.0, feed_forward: ampere = 0.0, slot: int = 0, override_coast_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False):
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("class: PositionTorqueCurrentFOC")
