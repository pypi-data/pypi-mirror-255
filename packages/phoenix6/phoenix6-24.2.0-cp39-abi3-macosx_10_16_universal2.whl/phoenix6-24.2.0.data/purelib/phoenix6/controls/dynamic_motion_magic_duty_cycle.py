...
class DynamicMotionMagicDutyCycle:
    ...
    def __init__(self, position: rotation, velocity: rotations_per_second, acceleration: rotations_per_second_squared, jerk: rotations_per_second_cubed, enable_foc: bool = True, feed_forward: float = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False):
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("class: DynamicMotionMagicDutyCycle")
