...
class MotionMagicExpoTorqueCurrentFOC:
    ...
    exponential motion profile.  Users can optionally provide a torque current
    feedforward.
    ...
    This control mode is based on torque current, so relevant closed-loop gains will
    ...
    def __init__(self, position: rotation, feed_forward: ampere = 0.0, slot: int = 0, override_coast_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False):
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("class: MotionMagicExpoTorqueCurrentFOC")
