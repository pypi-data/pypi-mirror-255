...
class Bend:
    ...
    extension_any: Optional[str] = field(
        default=None,
        metadata={
            "name": "ExtensionAny",
            "type": "Element",
...
class DepthRegParameter:
    ...
    bottom_index: Optional[str] = field(
        default=None,
        metadata={
            "name": "BottomIndex",
            "type": "Element",
...
class EtpDataType(Enum):
    """
    Specifies the type of data contained in a channel to facilitate data transfer
    using the Energistics Transfer Protocol (ETP).
...
class IscwsaSurveyToolOperatingCondition:
    """
    Describes the survey acquisition context in which an error model is valid as a
...
class MeasuredDepthCoord:
    ...
    :ivar uom: Unit of measure used by this measured depth coordinate.
...
class Weather:
    ...
    :ivar dtim: Date and time the information is related to.
    :ivar agency: Name of company that supplied the weather data.
...
class WellElevationCoord:
    ...
    :ivar uom: The unit of measure by which the datum is expressed.
    :ivar datum: Defines the vertical datums associated with elevation,
        vertical depth, and measured depth coordinates.
    """
...
class BottomHoleStaticTemperature(AbstractBottomHoleTemperature):
    ...
    e_tim_static: Optional[str] = field(
        default=None,
        metadata={
            "name": "eTimStatic",
            "type": "Element",
...
class ChannelIndex:
    """
    A read-only class that is the union of those channel indexes that are shared by
    all channels in the channel set.
...
class DrillReportStatusInfo:
    ...
    :ivar rop_current: Rate of penetration at the end of the reporting
        period.
    :ivar rig: A pointer to the rig used.
    ...
    :ivar dist_steering: Distance covered while actively steering with a
        steerable drilling assembly.
    :ivar num_pob: Total number of personnel on the rig.
    ...
    md_plug_top: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "MdPlugTop",
            "type": "Element",
    ...
    md_dia_hole_start: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "MdDiaHoleStart",
            "type": "Element",
    ...
    md_dia_pilot_plan: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "MdDiaPilotPlan",
            "type": "Element",
    ...
    tvd_dia_pilot_plan: Optional[WellVerticalDepthCoord] = field(
        default=None,
        metadata={
    ...
    tvd_kickoff: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "TvdKickoff",
            "type": "Element",
    ...
    md_strength_form: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "MdStrengthForm",
            "type": "Element",
    ...
    tvd_strength_form: Optional[WellVerticalDepthCoord] = field(
        default=None,
        metadata={
    ...
    tvd_csg_last: Optional[WellVerticalDepthCoord] = field(
        default=None,
        metadata={
            "name": "TvdCsgLast",
            "type": "Element",
    ...
    tvd_lot: Optional[WellVerticalDepthCoord] = field(
        default=None,
        metadata={
            "name": "TvdLot",
            "type": "Element",
    ...
    elev_kelly: Optional[WellElevationCoord] = field(
        default=None,
        metadata={
            "name": "ElevKelly",
            "type": "Element",
...
class DrillingParams:
    ...
    md_hole_start: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "MdHoleStart",
            "type": "Element",
    ...
    md_hole_stop: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "MdHoleStop",
            "type": "Element",
...
class Equipment:
    ...
    :ivar manufacturer: Manufacturer of this equipment.
...
@dataclass
class Inc(AbstractIscwsaErrorCoefficient):
    """
    Describes what survey measurement or value the error term applies to.

    :ivar inc: Inclination, measured deviation from vertical.
    """

    inc: Optional[str] = field(
        default=None,
        metadata={
            "name": "Inc",
            "type": "Element",
...
class Incident:
    ...
    :ivar cost_loss_gross: Gross estimate of the cost incurred due to
        the incident.
    :ivar responsible_company: Name of the company that caused the
        incident.
    :ivar extension_name_value: Extensions to the schema based on a
        name-value construct.
...
class Inventory:
    ...
    qty_adjustment: Optional[int] = field(
        default=None,
        metadata={
            "name": "QtyAdjustment",
            "type": "Element",
    ...
    qty_received: Optional[int] = field(
        default=None,
        metadata={
            "name": "QtyReceived",
            "type": "Element",
    ...
    qty_returned: Optional[int] = field(
        default=None,
        metadata={
            "name": "QtyReturned",
            "type": "Element",
    ...
    qty_on_location: Optional[int] = field(
        default=None,
        metadata={
            "name": "QtyOnLocation",
            "type": "Element",
...
class IscwsaErrorCoefficient:
    ...
    abstract_iscwsa_error_coefficient: List[
        AbstractIscwsaErrorCoefficient
    ] = field(
        default_factory=list,
        metadata={
...
class IscwsaModelParameters:
    ...
    gyro_initialization: Optional[str] = field(
        default=None,
        metadata={
    ...
    gyro_running_speed: Optional[str] = field(
        default=None,
        metadata={
...
class IscwsaSurveyToolOperatingInterval:
    ...
    sample_rate: Optional[str] = field(
        default=None,
        metadata={
            "name": "SampleRate",
            "type": "Element",
...
class NameTag:
    ...
    :ivar installation_date: When the tag was installed in or on the
        item.
    :ivar installation_company: The name of the company that installed
        the tag.
...
class ObjectContext(AbstractLogDataContext):
    """
    Specifies the range of index values for a log by reference to another object
    (or sub-object) which contains the index range as part of its data.
...
class ReferencePoint:
    ...
    :ivar type_value: The kind of point. For example, 'well reference
        point', 'platform reference point', 'sea surface', 'sea bottom'.
...
class TrajectoryStation:
    ...
    grav_total_uncert: Optional[str] = field(
        default=None,
        metadata={
    ...
    dip_angle_uncert: Optional[str] = field(
        default=None,
        metadata={
            "name": "DipAngleUncert",
            "type": "Element",
    ...
    mag_total_uncert: Optional[str] = field(
        default=None,
        metadata={
            "name": "MagTotalUncert",
            "type": "Element",
    ...
    grav_total_field_reference: Optional[str] = field(
        default=None,
        metadata={
    ...
    mag_total_field_reference: Optional[str] = field(
        default=None,
        metadata={
    ...
    mag_dip_angle_reference: Optional[str] = field(
        default=None,
        metadata={
    ...
    iscwsa_tool_error_model: Optional[str] = field(
        default=None,
        metadata={
...
class WellboreGeometrySection:
    ...
    section_md_interval: Optional[str] = field(
        default=None,
        metadata={
    ...
    section_tvd_interval: Optional[str] = field(
        default=None,
        metadata={
...
class DayCost:
    ...
    :ivar name_vendor: Name of the vendor.
    ...
    name_vendor: Optional[str] = field(
        default=None,
        metadata={
            "name": "NameVendor",
            "type": "Element",
...
class IscwsaErrorTerm:
    ...
    :ivar name: This is the unique mnemonic for this term, e.g., "ABIX"
        or "DECR".
    :ivar type_value: The class of the error source.
    ...
    type_value: Optional[ErrorTermSource] = field(
        default=None,
        metadata={
            "name": "Type",
            "type": "Element",
...
class OpenHoleInterval:
    ...
    :ivar borehole_string_reference_id: Reference to a borehole (the as-
        drilled hole through the earth).
...
class Participant:
    ...
    ext_name_values: List[str] = field(
        default_factory=list,
        metadata={
            "name": "ExtNameValues",
            "type": "Element",
...
class PublicLandSurveySystem:
    ...
    section: Optional[SectionNumber] = field(
        default=None,
        metadata={
            "name": "Section",
            "type": "Element",
    ...
    quarter_section: Optional[PublicLandSurveySystemQuarterSection] = field(
        default=None,
        metadata={
            "name": "QuarterSection",
            "type": "Element",
    ...
    quarter_township: Optional[PublicLandSurveySystemQuarterTownship] = field(
        default=None,
        metadata={
    ...
    footage_ns: Optional[DistanceNorthSouth] = field(
        default=None,
        metadata={
            "name": "FootageNS",
            "type": "Element",
    ...
    footage_ew: Optional[DistanceEastWest] = field(
        default=None,
        metadata={
            "name": "FootageEW",
            "type": "Element",
...
class RotarySteerableTool:
    ...
    :ivar close_pad_od: Outside diameter of the tool when the pads are
        closed.
    :ivar abstract_rotary_steerable_tool:
    :ivar sensor:
    :ivar extension_any:
    """
    ...
    abstract_rotary_steerable_tool: Optional[
        AbstractRotarySteerableTool
    ] = field(
        default=None,
        metadata={
            "name": "AbstractRotarySteerableTool",
            "type": "Element",
            "namespace": "http://www.energistics.org/energyml/data/witsmlv2",
            "required": True,
        },
...
class StimJobDiagnosticSession:
    ...
    md_surface: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "MdSurface",
            "type": "Element",
    ...
    md_bottomhole: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
            "name": "MdBottomhole",
            "type": "Element",
    ...
    md_mid_perforation: Optional[MeasuredDepthCoord] = field(
        default=None,
        metadata={
    ...
    tvd_mid_perforation: Optional[WellVerticalDepthCoord] = field(
        default=None,
        metadata={
...
class MudlogReportInterval:
    """
    The interval at which the report on the mud log was taken, detailing cuttings,
    interpreted geology, and show evaluation.
    ...
    cuttings_geology_interval: Optional[str] = field(
        default=None,
        metadata={
    ...
    interpreted_geology_interval: Optional[str] = field(
        default=None,
        metadata={
    ...
    show_evaluation_interval: Optional[str] = field(
        default=None,
        metadata={
...
class DepthRegLogSection:
    ...
    :ivar index_type: Primary index type. For date-time indexes, any
    ...
    :ivar index_reference: The origin for vertical coordinates on the
        original log. If this is not specified, information about the
        datum should be specified in a comment.
    :ivar log: The ID of the log being referred to by this section.
    :ivar min_interval: Minimum of the range of theindex values.  '@uom'
        must be consistent with '//indexType'.
    :ivar max_interval: Maximum of the range of the index values. '@uom'
        must be consistent with '//indexType'.
    ...
    index_reference: Optional[str] = field(
        default=None,
        metadata={
            "name": "IndexReference",
            "type": "Element",
