...
class Playwright(object):
    ...
    def LaunchBrowserServer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Playwright/LaunchBrowserServer',
            playwright__pb2.Request.Browser.SerializeToString,
            playwright__pb2.Response.String.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CloseBrowserServer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Playwright/CloseBrowserServer',
    ...
    def GetDownloadState(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Playwright/GetDownloadState',
    ...
    def CancelDownload(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Playwright/CancelDownload',
            playwright__pb2.Request.DownloadID.SerializeToString,
            playwright__pb2.Response.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
