...
def get_token(name: str, config: Config, *, create: Literal[False] = False) -> Token | None:
    ...
def __wrapper_func_get_token():
    __get_token_T = TypeVar("__get_token_T", bound = Token | None)
    
    
    def get_token(name: str, config: Config, *, create: bool = False):
        ...
        return None
    return get_token
get_token = __wrapper_func_get_token()
