...
def start_download(link, folder_path):
    video_title, max_resolution = get_video_info(link)
    ...
    # Monitorar progresso
    monitor_thread = threading.Thread(target=monitor_download_progress, args=(folder_path, get_video_title, max_resolution), daemon=True)
    ...
    # Finaliza monitoramento de progresso
    monitor_thread.stop()
    ...
    if os.path.exists(final_output):
      ...
      # Trigger do download do arquivo final
      try:
