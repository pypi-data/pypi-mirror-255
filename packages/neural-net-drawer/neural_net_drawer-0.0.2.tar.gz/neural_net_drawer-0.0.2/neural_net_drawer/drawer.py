...
class NeuralNetworkDiagram:
    def __init__(self, max_n_layers_size=12, max_layer_size=6, show_neuron_numbers=True):
        ...
        Parameters:
        - max_n_layers_size: Максимальное количество отображаемых нейронов на слое.
        - max_layer_size: Максимальное количество отображаемых нейронов в сети.
        - show_neuron_numbers: Отображение номеров нейронов на слое.
