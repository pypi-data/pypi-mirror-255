...
class AnalysisContext:
    ...
    def get_qc_status(self, patient_secret_name=None, ssid=None):
        ...
        data_sessions = self.__comm.send_request(
            "patient_manager/get_patient_list", req_headers={"X-Range": "items=0-1500"}
        )
        ...
        for data_session in data_sessions:
            patient_secret_name = patient_secret_name or data_session["patient_secret_name"]
            ssid = ssid or data_session["ssid"]
            ...
            if str(self.analysis_data["patient_secret_name"]) == str(patient_secret_name) and str(
                ...
                self.logger.info(data_session)
                return data_session["qa_status"], data_session["qa_comments"]
