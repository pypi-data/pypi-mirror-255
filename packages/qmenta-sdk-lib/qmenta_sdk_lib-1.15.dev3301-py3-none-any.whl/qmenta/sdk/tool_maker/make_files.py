...
def build_local_dockerfile() -> None:
    ...
    if not os.path.exists(local_dockerfile):
        with open(local_dockerfile, "w") as w1:
            with open(os.path.join(src_dir, "Dockerfile_schema.py")) as r1:
                w1.write(r1.read())
...
def build_script(code: str) -> None:
    ...
    """
    with open(os.path.join(src_dir, "tool_schema.py")) as r1:
...
def build_description() -> None:
    ...
    """
    with open(os.path.join(src_dir, "description_schema.py")) as r1:
...
def build_test(code: str, tool_folder: str, version: str) -> None:
    ...
    os.chdir("test")
    with open(os.path.join(src_dir, "test_tool_schema.py")) as r1:
