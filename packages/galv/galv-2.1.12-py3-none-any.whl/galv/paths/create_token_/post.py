...
# body param
SchemaForRequestBodyApplicationJson = CreateKnoxTokenRequest
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CreateKnoxTokenRequest
SchemaForRequestBodyMultipartFormData = CreateKnoxTokenRequest


request_body_create_knox_token_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = KnoxTokenFull
...
class BaseApi(api_client.Api):
    ...
    def _create_token_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_knox_token_request.serialize(body, content_type)
...
class CreateTokenCreate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_token_create(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_token_create(
        ...
        return self._create_token_create_oapg(
            body=body,
