...
After installation run `amsdald --help` command from your terminal to see the list of available commands.
In order to view details of specific command use `--help` after command name, for example:
