...
from ytvs.error import ErrorCode, ErrorMessage
from ytvs.exception import PyYouTubeException
from ytvs.models import (
    AccessToken,
    UserProfile,
...
class OfficialApi(object):
    """
    Example usage:
        To create an instance of pyyoutube.Api class:

            >>> import pyyoutube
            >>> api = pyyoutube.OfficialApi(api_key="your api key")
