...
class basis_transform():
    ...
    Heff : callable
        ...
        as a function of k.
    '''
    def __init__(self, qsymm, irrep, nullspace_thresh=1e-4, diagonal=False):
        ...
        residue = 1
        count = 0
        while (residue > 1e-6) and (count < 50):
        ...
        if residue > 1e-6:
            ...
            print(f'ERROR: findU did not converge after {count} trials.')
        else:
            # apply rotation U
