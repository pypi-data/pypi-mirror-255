...
class CloudV2(OldCloud, Generic[IsAsynchronous]):
    ...
    async def _delete_cluster(
        self, cluster_id: int, account: Optional[str] = None, reason: Optional[str] = None
    ) -> None:
        account = account or self.default_account
    ...
    @overload
    def delete_cluster(
        self: Cloud[Sync], cluster_id: int, account: Optional[str] = None, reason: Optional[str] = None
    ) -> None: ...

    @overload
    def delete_cluster(
        self: Cloud[Async], cluster_id: int, account: Optional[str] = None, reason: Optional[str] = None
    ) -> Awaitable[None]: ...
