...
class GaussianDiffusion:
    ...
    def p_sample_loop_cond(
        ...
        final = None
        for sample in self.p_sample_loop_progressive_cond(
            model,
            shape,
            noise=noise,
            clip_denoised=clip_denoised,
    ...
    def p_sample_loop_progressive_cond(
        self,
        model,
        shape,
        noise=None,
        ...
        img_and_cond = th.cat([img, model_kwargs["conditioning"]], dim=1)
        ...
        for i in indices:
            ...
            with th.no_grad():
                ...
                yield out
                img_and_cond = th.cat([out["sample"], img_and_cond[:, 3:]], dim=1)
