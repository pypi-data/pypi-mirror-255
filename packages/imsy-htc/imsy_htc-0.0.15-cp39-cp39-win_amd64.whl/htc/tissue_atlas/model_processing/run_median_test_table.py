...
if __name__ == "__main__":
    ...
    runner.add_argument("--spec-split", default="test")
    ...
    paths = runner.paths
    assert paths is not None, "No paths specified (use either the --input-dir or --spec argument)"
    ...
    dataset = DatasetMedianPixel(paths, config=predictor.config, train=False)
