...
if __name__ == "__main__":
    ...
    for name in runner.args.transformation_name:
        if name == "isolation_0":
            transforms[name] = [{"class": "htc.context.context_transforms>OrganIsolation", "fill_value": "0"}]
        elif name == "isolation_cloth":
            transforms[name] = [{"class": "htc.context.context_transforms>OrganIsolation", "fill_value": "cloth"}]
        elif name == "removal_0":
            transforms[name] = [{"class": "htc.context.context_transforms>OrganRemoval", "fill_value": "0"}]
        elif name == "removal_cloth":
            transforms[name] = [{"class": "htc.context.context_transforms>OrganRemoval", "fill_value": "cloth"}]
        else:
