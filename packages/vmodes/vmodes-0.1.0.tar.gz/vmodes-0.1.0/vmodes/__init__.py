...
the example.
    ...
    >>> icao_hex = np.vectorize(hex)(icao)
...
from .decoder._data import PosDecoderCtx, PosDecoderCarryData, Receiver
...
__all__ = [
    'PosDecoderCtx', 'PosDecoderCarryData', 'Receiver', 'PositionData',
    'Time', 'Message', 'DownlinkFormat', 'TypeCode', 'Icao',
    'Altitude', 'Position',
    'message_array', 'df', 'typecode', 'icao', 'callsign', 'category',
    'cpr_format_type', 'nuc_p', 'position', 'altitude',
    'data_index',
]
