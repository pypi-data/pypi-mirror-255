...
from ._data import PosDecoderCtx, PosDecoderData

def cpr_coordidnates(data: vmt.Message) -> vmt.CprCoordinate: ...

def decode_positions(ctx: PosDecoderCtx, data: PosDecoderData) \
    -> tuple[vmt.BIndex, vmt.Position, vmt.LastPosition, vmt.BIndex]: ...
