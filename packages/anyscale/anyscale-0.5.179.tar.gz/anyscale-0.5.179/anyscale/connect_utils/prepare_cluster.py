...
class PrepareClusterBlock:
    def __init__(  # noqa: PLR0913
        ...
        cluster_compute_version: Optional[int] = None,
    ):
        """
        ...
        self.cluster_compute_version = cluster_compute_version
    ...
    def _get_cluster_compute_id(
        ...
        if cluster_compute_name:
            compute_template_id = self._get_cluster_compute_id_from_name(
                cluster_compute_name, cluster_compute_version
            )
        else:
    ...
    def _get_cluster_compute_id_from_name(
        ...
        cluster_compute_version: Optional[int] = None,  # noqa: ARG002
    ) -> str:
