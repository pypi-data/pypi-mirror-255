...
*DefaultApi* | [**endpoints_redirect_api_v2_users_endpoints_redirect_get**](docs/DefaultApi.md#endpoints_redirect_api_v2_users_endpoints_redirect_get) | **GET** /api/v2/users/endpoints_redirect | Endpoints Redirect
