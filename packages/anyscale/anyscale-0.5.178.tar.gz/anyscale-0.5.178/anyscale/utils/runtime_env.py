...
def _is_python_dependency_tracking_disabled() -> bool:
    """Returns True if the python dependency tracking is disabled.
...
def autopopulate_runtime_env_for_workspace(
    ...
    *,
    ...
    if not _is_python_dependency_tracking_disabled():
