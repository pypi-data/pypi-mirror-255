...
def main(bundles=(), mri=(), mesh=(), args: list[str] = []):
    ...
    For your convenience when using fibervis(), a video showcasing its highlighted features is available through the following
    `link <https://youtu.be/ziNHTFPK1GU?si=H5gQD9kqC5CKC8da>`_. 
