...
class RpmPackage(object):
    ...
    def __init__(self, artifact=None, relative_path=None, file=None, repository=None, upload=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def upload(self):
        """Gets the upload of this RpmPackage.  # noqa: E501

        An uncommitted upload that may be turned into the artifact of the content unit.  # noqa: E501

        :return: The upload of this RpmPackage.  # noqa: E501
        :rtype: str
        """
        return self._upload
    ...
    def upload(self, upload):
        """Sets the upload of this RpmPackage.

        An uncommitted upload that may be turned into the artifact of the content unit.  # noqa: E501

        :param upload: The upload of this RpmPackage.  # noqa: E501
        :type: str
        """
