...
class Figure:
    ...
    def create_add_axis(self, projection: Union[str, None] = None) -> "Axis":
...
class Axis:
    ...
    def __init__(
        ...
        plots: Union[List[Plot], None] = None,
...
class Plot:
    ...
    def __init__(
        self, axis: Union[Axis, None] = None, label: Union[str, None] = None
    ):
        self.axis = axis
        self.label = label
...
class CartesianPlot(Plot):
    ...
    def __init__(
        ...
        xticklabels: Union[List[str], None] = None,
...
class ParallelCoordinatesPlot(Plot):
    ...
    def __init__(
        ...
        xticklabels_tilted: bool = False,
        axis: Union[Axis, None] = None,
        labels: Union[Sequence[Optional[str]], Index, Series, None] = None,
        linestyle: Union[str, None] = None,
        marker: Union[str, None] = None,
        color: Union[str, None] = None,
        alpha: Union[float, None] = None,
...
class BarPlot(CartesianPlot):
    ...
    def __init__(
        ...
        label: Union[str, None] = None,
        width: float = 0.8,
        bottom: Union[List[float], None] = None,
        color: Union[str, None] = None,
        alpha: Union[float, None] = None,
    ):
        CartesianPlot.__init__(
...
class StackedBarPlot(Plot):
    ...
    def __init__(
        ...
        xticklabels_tilted: bool = False,
        axis: Union[Axis, None] = None,
        labels: Union[List[Optional[str]], Index, Series, None] = None,
        width: float = 0.8,
        color: Union[str, None] = None,
        alpha: Union[float, None] = None,
    ):
...
class HorizontalStripes(Plot):
    ...
    def __init__(
        self,
        stripeticks: Union[List[float], None] = None,
        color: Union[str, None] = None,
        alpha: Union[float, None] = None,
...
class RadarPlot(PolarPlot):
    ...
    def __init__(
        ...
        axis: Union[Axis, None] = None,
        label: Union[str, None] = None,
        rlimits: Union[List[float], None] = None,
    ):
