...
from cubicweb_web.views import basecontrollers, management
    ...
    def publish(self, rset=None):
        if "vid" in self._cw.form:
            ...
            if vid not in ("jsonexport", "ejsonexport"):
                self.warning(
                    "vid %s can't be used with jsonp controller, "
                    "falling back to jsonexport",
                    vid,
                )
