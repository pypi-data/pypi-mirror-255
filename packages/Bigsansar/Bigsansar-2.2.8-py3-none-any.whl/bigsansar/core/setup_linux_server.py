...
def init_setup():
        ...
        with open('/var/www/public_html/settings.py', 'r') as fp:
            ...
            for line in lines:
                ...
                elif line.find("DATABASES = {'default': {'ENGINE': 'django.db.backends.sqlite3','NAME': BASE_DIR / 'db.sqlite3',}}") != -1:
                     dbfindindex = lines.index(line)
                     del lines[dbfindindex]
...
def deploy_server():
    ...
    migrate = 'sudo python3 /var/www/manage.py makemigrations && sudo python3 /var/www/manage.py migrate && sudo python3 /var/www/manage.py createsuperuser' 
    os.system(migrate)
