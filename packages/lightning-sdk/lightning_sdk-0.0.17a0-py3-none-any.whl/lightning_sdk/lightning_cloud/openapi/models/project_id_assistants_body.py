...
class ProjectIdAssistantsBody(object):
    ...
    def name(self) -> 'str':
        ...
        :return: The name of this ProjectIdAssistantsBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: 'str'):
        """Sets the name of this ProjectIdAssistantsBody.


        :param name: The name of this ProjectIdAssistantsBody.  # noqa: E501
        :type: str
        """
    ...
    def prompt_template(self) -> 'str':
        ...
        :return: The prompt_template of this ProjectIdAssistantsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def prompt_template(self, prompt_template: 'str'):
        """Sets the prompt_template of this ProjectIdAssistantsBody.


        :param prompt_template: The prompt_template of this ProjectIdAssistantsBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProjectIdAssistantsBody, dict):
    ...
    def __eq__(self, other: 'ProjectIdAssistantsBody') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, ProjectIdAssistantsBody):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ProjectIdAssistantsBody') -> bool:
