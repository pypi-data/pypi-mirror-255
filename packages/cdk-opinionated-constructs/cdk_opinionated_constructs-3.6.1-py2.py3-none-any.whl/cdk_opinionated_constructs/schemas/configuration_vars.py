...
class ApplicationTags(BaseModel):
    ...
    Attributes:
        awsApplication (constr | None): The ARN of the AWS Resource Group, which must match a specific pattern. This field is optional.
    """

    awsApplication: constr(pattern=r"^arn:aws:resource-groups:*") | None = None
