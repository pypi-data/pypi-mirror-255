...
if response.status_code == 200:
    ...
    if version_tags:
        ...
        for version_tag in version_tags:
            ...
            flag += 1
            #print("- 版本:", version_info)
            #print("  日期:", version_date)
    else:
        print("未找到版本信息")
else:
...
def check_for_updates(package_name):
    try:
        ...
        if installed_version != latest_version:
            print('\033[93m'+f"WARNING: Your version of {package_name} ({installed_version}) is outdated. Please update to version {latest_version}."+'\033[0m'
)
