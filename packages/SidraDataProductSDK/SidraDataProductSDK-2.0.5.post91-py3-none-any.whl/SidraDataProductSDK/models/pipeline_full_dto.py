...
class PipelineFullDto(object):
    ...
    def __init__(self, item_id=None, name=None, id_template=None, id_data_factory=None, is_removed=None, id_pipeline_sync_behaviour=None, parameters=None, execution_parameters=None, id=None, valid_from=None, valid_until=None, last_updated=None, last_deployed=None, template_name=None, template_item_id=None):  # noqa: E501
