...
class PipelineApi(object):
    ...
    def api_pipeline_id_pipeline_entities_dynamic_delete(self, id_pipeline, **kwargs):  # noqa: E501
        """Delete entity associations dynamically  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_pipeline_id_pipeline_entities_dynamic_delete(id_pipeline, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id_pipeline: Affected pipeline Id (required)
        :param str changes_on: Resources affected (DsuName/ProviderId/EntityId)
        :param str api_version: The requested API version
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_pipeline_id_pipeline_entities_dynamic_delete_with_http_info(id_pipeline, **kwargs)  # noqa: E501
        else:
            (data) = self.api_pipeline_id_pipeline_entities_dynamic_delete_with_http_info(id_pipeline, **kwargs)  # noqa: E501
            return data

    def api_pipeline_id_pipeline_entities_dynamic_delete_with_http_info(self, id_pipeline, **kwargs):  # noqa: E501
        """Delete entity associations dynamically  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_pipeline_id_pipeline_entities_dynamic_delete_with_http_info(id_pipeline, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id_pipeline', 'changes_on', 'api_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_pipeline_id_pipeline_entities_dynamic_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id_pipeline' is set
        if ('id_pipeline' not in params or
                params['id_pipeline'] is None):
            raise ValueError("Missing the required parameter `id_pipeline` when calling `api_pipeline_id_pipeline_entities_dynamic_delete`")  # noqa: E501
        ...
        query_params = []
        if 'changes_on' in params:
            query_params.append(('changesOn', params['changes_on']))  # noqa: E501
        if 'api_version' in params:
            query_params.append(('api-version', params['api_version']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pipeline/{idPipeline}/entities/dynamic', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_pipeline_id_pipeline_entities_dynamic_put(self, id_pipeline, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id_pipeline: Affected pipeline Id (required)
        :param EntityPipelineDynamicUpsertRequest body: Resources affected (DsuName/ProviderId/EntityId) with extra attributes
        :param str api_version: The requested API version
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
