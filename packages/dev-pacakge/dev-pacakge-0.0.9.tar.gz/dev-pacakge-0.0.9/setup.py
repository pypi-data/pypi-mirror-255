...
PACKAGE_DATA = {
	"orangecontrib.dev.widgets": ["icons/*"], # contenu du dossier 'icons' situé dans 'orangecontrib/dev/widgets'
}
...
ENTRY_POINTS = {
	"orange.widgets": (
		"HKH-Bot = orangecontrib.dev.widgets", # 'HKH-Bot' sera le nom de la section Orange contenant les widgets
	)
}
# /!\ les noms de fichier 'orangecontrib.dev.widgets' doivent correspondre à l'arborescence
