...
def constructs_channel(input, clk, sym_name, default_stages, *, loc=None, ip=None) -> _SubClassValueT:
...
def hlc_linear(outs, clock, *, loc=None, ip=None) -> _SubClassValueT:
...
def systolic_array(pe_outputs, row_inputs, col_inputs, *, loc=None, ip=None) -> _SubClassValueT:
