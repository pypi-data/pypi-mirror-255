...
class _FilterExpression(_message.Message):
    __slots__ = ["and_expression", "equals_expression", "greater_than_expression", "greater_than_or_equal_expression", "less_than_expression", "less_than_or_equal_expression", "list_contains_expression", "not_expression", "or_expression"]
...
class _SearchAndFetchVectorsRequest(_message.Message):
    __slots__ = ["filter_expression", "index_name", "metadata_fields", "no_score_threshold", "query_vector", "score_threshold", "top_k"]
    ...
    filter_expression: _FilterExpression
    index_name: str
    metadata_fields: _MetadataRequest
