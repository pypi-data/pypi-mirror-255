...
.. code-block:: python
    ...
    from arasea.scalar import ScalarType
...
See :class:`QuadraticOpFunc` and :class:`QuadraticCOpFunc` in ``arasea/graph/tests/test_params_type.py``
...
available in both Python and C code. See :class:`arasea.link.c.type.EnumType` and its subclasses for more details.
...
**Example**::
    ...
    from arasea.link.c.params_type import ParamsType
    from arasea.link.c.type import EnumType, EnumList
...
with ``ParamsType.enum_from_alias(alias)`` method (see :class:`arasea.link.c.type.EnumType`
...
from arasea.link.c.type import CType, EnumType
...
class Params(dict):
    ...
    **Example:**
    ...
    .. code-block:: python
        ...
        from arasea.link.c.params_type import ParamsType, Params
        from arasea.scalar import ScalarType
...
class ParamsType(CType):
    ...
    def get_field(self, arasea_type):
        """
        ...
        """
        return self.fields[self.types.index(arasea_type)]
    ...
    def get_enum(self, key):
        ...
        **Example**::
            ...
            from arasea.graph.params_type import ParamsType
            from arasea.link.c.type import EnumType, EnumList
            from arasea.scalar import ScalarType
    ...
    def get_params(self, *objects, **kwargs) -> Params:
        ...
        **Example**::
            ...
            import numpy
            from arasea.graph.params_type import ParamsType
            from arasea.tensor.type import dmatrix
            from arasea.scalar import ScalarType
