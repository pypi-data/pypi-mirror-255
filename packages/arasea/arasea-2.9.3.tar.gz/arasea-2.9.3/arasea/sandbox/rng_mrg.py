...
from arasea import function, gradient
...
from arasea.gradient import undefined_grad
from arasea.graph.basic import Apply, Constant, Variable
from arasea.graph.rewriting.basic import in2out, node_rewriter
from arasea.link.c.op import COp, Op
from arasea.link.c.params_type import ParamsType
from arasea.sandbox import multinomial
from arasea.scalar import bool as bool_t
from arasea.scalar import int32 as int_t
from arasea.tensor import as_tensor_variable, cast, get_vector_length
from arasea.tensor.math import cos, log, prod, sin, sqrt
from arasea.tensor.shape import reshape
from arasea.tensor.type import TensorType, iscalar, ivector, lmatrix


warnings.warn(
    "The module `arasea.sandbox.rng_mrg` is deprecated. "
    "Use the module `arasea.tensor.random` for random variables instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
class MRG_RandomStream:
    ...
    def choice(
        ...
        **kwargs,
        ...
        p: 2d numpy array or arasea tensor
