...
from arasea.compile.function.types import orig_function


__all__ = ["types", "pfunc"]

__docformat__ = "restructuredtext en"
_logger = logging.getLogger("arasea.compile.function")
...
def function_dump(
    ...
    replace `arasea.function(...)` by
    `arasea.function_dump('filename.pkl', ...)`.
    ...
    parameters needed to reproduce a call to `arasea.function()`. This
    ...
    >>> f = arasea.function(**d)  # doctest: +SKIP
    ...
    with open(filename, "wb") as f:
        import arasea.misc.pkl_utils

        pickler = arasea.misc.pkl_utils.StripPickler(
...
def function(
    ...
    """
    Return a :class:`callable object <arasea.compile.function.types.Function>`
    ...
    Returns
    -------
    :class:`arasea.compile.function.types.Function` instance
    ...
    Internal documentation:
        ...
        What happens when you call arasea.function?
        ...
        V1, to use less memory. arasea must be told that this optimization is
        ...
        takes a minigraph of arasea scalars and uses this to do elemwise
        operations on arasea tensors
         3. Optimization
    ...
    if name is None:
        ...
        if last_frame[0] == source_file or last_frame[0] == compiled_file:
            ...
            while "arasea/graph" in func_frame[0] and idx > 0:
                idx -= 1
