...
from arasea import compile
from arasea.compile.ops import ViewOp
from arasea.graph.basic import Constant, Variable
...
from arasea.graph.rewriting.db import RewriteDatabase
from arasea.raise_op import Assert, CheckAndRaise, assert_op
...
from arasea.tensor.extra_ops import broadcast_shape, broadcast_to
from arasea.tensor.math import all as at_all
from arasea.tensor.math import eq
from arasea.tensor.shape import Shape_i
from arasea.tensor.sort import TopKOp
from arasea.tensor.type import DenseTensorType, TensorType
from arasea.tensor.var import TensorConstant
from arasea.utils import NoDuplicateOptWarningFilter
...
_logger = logging.getLogger("arasea.tensor.rewriting.basic")
...
def is_an_upcast(type1, type2):
    ...
    Differs from arasea.scalar.upcast
...
DEPRECATED_NAMES = {
    "ShapeFeature": (
        "`ShapeFeature` is now located in `arasea.tensor.rewriting.shape`.",
        import_ShapeFeature,
    ),
}
