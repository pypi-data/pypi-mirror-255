...
from arasea.compile.mode import get_target_language
from arasea.configdefaults import config
from arasea.graph.basic import Apply, Constant, io_toposort
from arasea.graph.features import ReplaceValidate
from arasea.graph.op import compute_test_value, get_test_value
...
from arasea.tensor.basic import MakeVector, alloc, cast, get_scalar_constant_value
...
from arasea.tensor.rewriting.basic import register_canonicalize, register_specialize
from arasea.tensor.shape import shape_padleft
...
class InplaceElemwiseOptimizer(GraphRewriter):
    ...
    def apply(self, fgraph):
        ...
        # execute!
        # It is the _dfs_toposort() fct in arasea/graph/destroyhandler.py
