...
# Cpu implementation
from arasea.tensor.nnet.conv import ConvOp, conv2d
...
from arasea.tensor.rewriting.basic import register_specialize_device
...
conv_groupopt = arasea.graph.rewriting.db.LocalGroupDB()
