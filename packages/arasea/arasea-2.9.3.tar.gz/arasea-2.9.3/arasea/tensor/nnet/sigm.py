...
from arasea.graph.rewriting.basic import copy_stack_trace, node_rewriter
from arasea.printing import pprint
from arasea.scalar import sigmoid as scalar_sigmoid
from arasea.scalar.math import Sigmoid
from arasea.tensor.basic import constant
from arasea.tensor.elemwise import Elemwise
from arasea.tensor.math import clip, sigmoid
...
arasea.compile.optdb["uncanonicalize"].register(
