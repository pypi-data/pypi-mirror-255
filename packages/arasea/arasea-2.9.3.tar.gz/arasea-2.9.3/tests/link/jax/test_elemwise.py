...
from arasea.tensor import elemwise as at_elemwise
from arasea.tensor.math import all as at_all
from arasea.tensor.math import prod
from arasea.tensor.math import sum as at_sum
from arasea.tensor.special import SoftmaxGrad, log_softmax, softmax
...
def test_logsumexp_benchmark(size, axis, benchmark):
    ...
    X_lse_fn = arasea.function([X], X_lse, mode="JAX")
