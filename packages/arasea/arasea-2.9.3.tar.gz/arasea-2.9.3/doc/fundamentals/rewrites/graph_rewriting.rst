...
* ``Aesara rewrite time: 1.152431e+00s`` means that we spend 1.15s in the rewriting phase of `arasea.function`.
* ``Aesara validate time: 2.790451e-02s`` means that we spent 2.8e-2s in the validation phase of rewriting.
* ``Aesara Linker time (includes C code generation/compiling): 7.893991e-02s`` means that we spent 7.9e-2s in linker phase of `arasea.function`.
