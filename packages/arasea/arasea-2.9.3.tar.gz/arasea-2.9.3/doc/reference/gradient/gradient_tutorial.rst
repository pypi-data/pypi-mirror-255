...
Aesara implements the :func:`arasea.gradient.jacobian` macro that does all
...
output and vector input. Aesara implements :func:`arasea.gradient.hessian` macro that does all
