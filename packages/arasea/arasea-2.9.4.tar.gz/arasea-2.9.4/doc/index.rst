...
You can install Aesara with `conda` or with `pip`. To get the bleeding edge version you can install `arasea-nightly.`
...
* Visit `arasea-users`_ to discuss the general use of Aesara with developers and other users
