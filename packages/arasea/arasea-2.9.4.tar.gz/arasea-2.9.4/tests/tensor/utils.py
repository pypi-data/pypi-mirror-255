...
import arasea
from arasea import function, shared
...
from arasea.tensor.type import TensorType, complex_dtypes, discrete_dtypes, float_dtypes
...
ignore_isfinite_mode = copy(arasea.compile.get_default_mode())
