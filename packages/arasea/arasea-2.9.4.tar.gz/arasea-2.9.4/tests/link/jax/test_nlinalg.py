...
from arasea.tensor import blas as at_blas
from arasea.tensor import nlinalg as at_nlinalg
...
from arasea.tensor.type import dvector, matrix, scalar, tensor3, vector
...
def test_jax_BatchedDot():
    ...
    arasea_jax_fn = function(fgraph.inputs, fgraph.outputs, mode=jax_mode)
    with pytest.raises(TypeError):
        arasea_jax_fn(*inputs)
