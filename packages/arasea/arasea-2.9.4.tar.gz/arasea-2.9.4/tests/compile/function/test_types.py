...
from arasea.compile import shared
from arasea.compile.debugmode import DebugMode, InvalidValueError
from arasea.compile.function import function
from arasea.compile.function.types import Supervisor, UnusedInputError
...
from arasea.graph.basic import Constant
from arasea.graph.fg import FunctionGraph
from arasea.graph.rewriting.basic import OpKeyGraphRewriter, PatternNodeRewriter
from arasea.graph.utils import MissingInputError
from arasea.link.vm import VMLinker
...
from arasea.utils import exc_message
...
class TestFunction:
    ...
    def test_constant_output(self):
        # Test that if the output is a constant, we respect the arasea memory interface
        ...
        # Test that if the output is a constant and borrow, we respect the arasea memory interface
    ...
    def test_composing_function(self):
        # Tests that one can compose two arasea functions when the outputs are
