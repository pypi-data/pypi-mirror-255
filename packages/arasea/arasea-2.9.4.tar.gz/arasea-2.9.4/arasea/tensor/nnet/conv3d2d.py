...
def conv3d(
    ...
    `attachment <https://groups.google.com/d/msg/arasea-users/1S9_bZgHxVw/0cQR9a4riFUJ>`_
    ...
    out_4d = arasea.tensor.nnet.conv2d(
    ...
    if Tf == 1:
        ...
        if Tpad == 0:
            ...
            out_tmp_padded = arasea.tensor.subtensor.set_subtensor(
