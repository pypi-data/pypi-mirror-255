...
from arasea.tensor.basic import as_tensor_variable, get_scalar_constant_value
...
_logger = logging.getLogger("arasea.tensor.nnet.abstract_conv")
...
def abstract_conv2d(
    ...
    Refer to :func:`nnet.conv2d <arasea.tensor.nnet.conv2d>` for a more detailed documentation.
    """
...
class AbstractConv(BaseAbstractConv):
    ...
    Refer to :func:`BaseAbstractConv <arasea.tensor.nnet.abstract_conv.BaseAbstractConv>`
...
class AbstractConv2d_gradWeights(AbstractConv_gradWeights):
    ...
    def grad(self, inp, grads):
        ...
        d_height_width = (arasea.gradient.DisconnectedType()(),)
...
class AbstractConv3d_gradWeights(AbstractConv_gradWeights):
    ...
    def grad(self, inp, grads):
        ...
        d_depth_height_width = (arasea.gradient.DisconnectedType()(),)
    ...
    **kwargs,
    ...
    if "imshp_logical" in kwargs or "kshp_logical" in kwargs:
        raise ValueError(
            ...
            "arasea.tensor.nnet.conv.conv2d() for the time being."
        )
...
def conv2d_transpose(
    ...
    output_shape: tuple/list of len 4 of int or Constant variable
        ...
        are allowed to be ``arasea.tensor.type.scalar`` variables.
