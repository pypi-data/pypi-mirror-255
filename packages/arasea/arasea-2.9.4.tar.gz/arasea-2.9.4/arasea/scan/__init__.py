...
and ``scan`` is the closest that arasea comes to looping. The advantages
...
from arasea import configdefaults


configdefaults.add_scan_configvars()

from arasea.scan import rewriting
from arasea.scan.basic import scan
from arasea.scan.checkpoints import scan_checkpoints
