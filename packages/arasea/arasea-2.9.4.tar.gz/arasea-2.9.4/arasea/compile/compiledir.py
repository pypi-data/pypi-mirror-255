...
It is used by the "arasea-cache" CLI tool, located in the /bin folder of the repository.
"""
import logging
import os
import pickle
...
from arasea.utils import flatten


_logger = logging.getLogger("arasea.compile.compiledir")
...
def print_compiledir_content():
    """
    print list of %d compiled individual ops in the "arasea.config.compiledir"
    """
    ...
    print(
        ...
        "(are they always arasea.scalar ops?)"
    )
...
def basecompiledir_ls():
    """
    Print list of files in the "arasea.config.base_compiledir"
    """
    subdirs = []
    others = []
