...
The first thing you need to do is to define an Arasea Type for your
...
.. note::
   ...
   If you want to have multiple parameters, Arasea provides the convenient class
   :class:`arasea.link.c.params_type.ParamsType` that allows to bundle many parameters into
...
.. testcode::
   ...
   from arasea.scalar import as_scalar
