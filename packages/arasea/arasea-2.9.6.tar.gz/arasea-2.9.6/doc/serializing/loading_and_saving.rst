...
is the pickle_ mechanism. Many Arasea objects can be *serialized* (and
...
the Arasea objects or classes is possible.  For longer-term (such as
saving models from an experiment) you should not rely on pickled Arasea
...
This type of serialization uses some helper functions particular to Arasea. It
...
The main advantage of this approach is that you don't even need Arasea installed
...
might not have Arasea installed, who are using a different Python version, or if
