/** Alternative template NumPy-based implementation of BLAS functions used in Arasea. **/
...
void %(precision)sgemv_(
    ...
    **/
    ...
    /* Vector pointers points to the beginning of memory (see function `arasea.tensor.blas_c.gemv_c_code`).
