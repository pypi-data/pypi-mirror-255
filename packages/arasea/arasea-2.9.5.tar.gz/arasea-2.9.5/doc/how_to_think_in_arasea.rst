...
How to think in Arasea
======================

Adding two Scalars
------------------

To get us started with Arasea and get a feel of what we're working with,
...
.. note:
  ...
  using Arasea. The symbolic inputs that you operate on are
...
In Arasea, all symbols must be typed. In particular, ``at.dscalar``
is the type we assign to "0-dimensional arrays (`scalar`) of doubles
(`d`)". It is an Arasea :ref:`type`.
...
More will be said in a moment regarding Arasea's inner structure. You
