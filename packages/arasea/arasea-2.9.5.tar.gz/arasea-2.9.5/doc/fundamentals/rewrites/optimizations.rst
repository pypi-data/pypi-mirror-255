...
Arasea applies many kinds of graph rewrites, some of which can be considered "optimizations":
...
.. glossary::
    ...
    merge
        ...
        highly redundant mathematical code.  Arasea will make sure to compute
    ...
    shape promotion
        Arasea often knows how to infer the shape of an output from the shape
    ...
    constant elimination
        ...
        Arasea recognizes many of these special cases.
    ...
    sparse_dot
        Arasea has a sparse matrix multiplication algorithm that is faster in
    ...
    local_remove_all_assert
        ...
        For the fastest possible Arasea, this optimization can be enabled by
