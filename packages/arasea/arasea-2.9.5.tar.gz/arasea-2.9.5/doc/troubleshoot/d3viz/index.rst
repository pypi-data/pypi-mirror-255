...
=========================================================================
:mod:`d3viz` -- d3viz: Interactive visualization of Arasea compute graphs
=========================================================================

.. module:: arasea.d3viz
   :platform: Unix, Windows
   :synopsis: Allows to interactively visualize Arasea compute graphs
...
Like Arasea’s printing module, ``d3viz``
requires `graphviz <http://www.graphviz.org/>`__ binary to be available.

Overview
--------

``d3viz`` extends Arasea’s printing module to interactively visualize compute
...
visualize it with :py:func:`arasea.printing.pydotprint` as follows:

.. code:: python

    from arasea.printing import pydotprint
    import os
...
To visualize it interactively, import :py:func:`arasea.d3viz.d3viz.d3viz` from
the the :py:mod:`arasea.d3viz.d3viz` module, which can be called as before:

.. code:: python

    import arasea.d3viz as d3v
...
Arasea allows function profiling via the ``profile=True`` flag. After at least
...
Here, we used the :py:class:`arasea.d3viz.formatting.PyDotFormatter` class to
...
.. automodule:: arasea.d3viz.d3viz
  :members:

PyDotFormatter
--------------

.. autoclass:: arasea.d3viz.formatting.PyDotFormatter
  :members: __call__
  :special-members:
  :private-members:
