...
Even without taking Arasea's rewrites into account, it is likely
...
Use Arasea's high order :class:`Op`\s when applicable
-----------------------------------------------------

Arasea provides some generic :class:`Op` classes which allow you to generate a
...
are mostly tensor-related, as this is Arasea's specialty.
