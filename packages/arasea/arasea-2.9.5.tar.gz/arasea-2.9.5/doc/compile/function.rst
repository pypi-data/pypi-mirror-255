...
===========================================
:mod:`function` - defines arasea.function
===========================================

.. module:: arasea.compile.function
   :platform: Unix, Windows
   :synopsis: defines arasea.function and related classes
.. moduleauthor:: LISA

Guide
=====

This module provides :func:`function`, commonly accessed as `arasea.function`,
...
>>> import arasea
>>> x = arasea.tensor.dscalar()
>>> f = arasea.function([x], 2*x)
>>> f(4)
array(8.0)
...
Arasea supports functions with multiple outputs. For example, we can
...
>>> abs_diff = abs(diff)
>>> diff_squared = diff**2
>>> f = arasea.function([a, b], [diff, abs_diff, diff_squared])
...
Copying functions
=================
Arasea functions can be copied, which can be useful for creating similar
functions but with different shared variables or updates. This is done using
the :func:`arasea.compile.function.types.Function.copy` method of :class:`Function` objects.
...
>>> state = arasea.shared(0)
>>> inc = at.iscalar('inc')
>>> accumulator = arasea.function([inc], state, updates=[(state, state+inc)])
...
.. function:: function(inputs, outputs, mode=None, updates=None, givens=None, no_default_updates=False, accept_inplace=False, name=None, rebuild_strict=True, allow_input_downcast=None, profile=None, on_unused_input='raise')
    ...
    Return a :class:`callable object <arasea.compile.function.types.Function>` that will calculate `outputs` from `inputs`.
    ...
    :rtype: :class:`Function <arasea.compile.function.types.Function>`
            instance
    ...
    :doc:`arasea.config <../config>`.  The mode
...
.. autofunction:: arasea.compile.function.function_dump

.. autoclass:: arasea.compile.function.types.Function
