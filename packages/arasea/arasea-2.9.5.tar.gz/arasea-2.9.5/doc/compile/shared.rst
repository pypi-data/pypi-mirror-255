...
===========================================
:mod:`shared` - defines arasea.shared
===========================================

.. module:: arasea.compile.sharedvalue
   :platform: Unix, Windows
   :synopsis: defines arasea.shared and related classes
.. moduleauthor:: LISA
...
The other new thing in this code is the ``updates`` parameter of :func:`arasea.function`.
...
``givens`` parameter of :func:`arasea.function` which replaces a particular node in a graph
...
.. note::
    ...
    Arasea shared variable broadcast pattern default to ``False`` for each
    ...
    ``arasea.shared(..., broadcastable=(True, False))``
...
.. note::
    ...
    For example, ``arasea.shared(..., shape=(1, None))``.
