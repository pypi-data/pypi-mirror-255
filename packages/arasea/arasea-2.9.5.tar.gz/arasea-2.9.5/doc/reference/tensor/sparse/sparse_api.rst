...
The sparse submodule is not loaded when we import Arasea. You must
import ``arasea.sparse`` to enable it.
...
sparse formats of SciPy supported by Arasea.

.. Changes to this section should also result in changes to tutorial/sparse.txt.

Arasea supports two *compressed sparse formats*: ``csc`` and ``csr``,
...
- Moving from and to sparse
    - :func:`dense_from_sparse <arasea.sparse.basic.dense_from_sparse>`.
      Both grads are implemented. Structured by default.
    - :func:`csr_from_dense <arasea.sparse.basic.csr_from_dense>`,
      :func:`csc_from_dense <arasea.sparse.basic.csc_from_dense>`.
      The grad implemented is structured.
    - Arasea SparseVariable objects have a method ``toarray()`` that is the same as
      :func:`dense_from_sparse <arasea.sparse.basic.dense_from_sparse>`.

- Construction of Sparses and their Properties
    - :class:`CSM <arasea.sparse.basic.CSM>` and ``CSC``, ``CSR`` to construct a matrix.
      The grad implemented is regular.
    - :func:`csm_properties <arasea.sparse.basic.csm_properties>`.
      to get the properties of a sparse matrix.
      The grad implemented is regular.
    - csm_indices(x), csm_indptr(x), csm_data(x) and csm_shape(x) or x.shape.
    - :func:`sp_ones_like <arasea.sparse.basic.sp_ones_like>`.
      The grad implemented is regular.
    - :func:`sp_zeros_like <arasea.sparse.basic.sp_zeros_like>`.
      The grad implemented is regular.
    - :func:`square_diagonal <arasea.sparse.basic.square_diagonal>`.
      The grad implemented is regular.
    - :func:`construct_sparse_from_list <arasea.sparse.basic.construct_sparse_from_list>`.
      The grad implemented is regular.

- Cast
    - :func:`cast <arasea.sparse.basic.cast>` with ``bcast``, ``wcast``, ``icast``, ``lcast``,
      ``fcast``, ``dcast``, ``ccast``, and ``zcast``.
      The grad implemented is regular.

- Transpose
    - :func:`transpose <arasea.sparse.basic.transpose>`.
      The grad implemented is regular.

- Basic Arithmetic
    - :func:`neg <arasea.sparse.basic.neg>`.
      The grad implemented is regular.
    - :func:`eq <arasea.sparse.basic.eq>`.
    - :func:`neq <arasea.sparse.basic.neq>`.
    - :func:`gt <arasea.sparse.basic.gt>`.
    - :func:`ge <arasea.sparse.basic.ge>`.
    - :func:`lt <arasea.sparse.basic.lt>`.
    - :func:`le <arasea.sparse.basic.le>`.
    - :func:`add <arasea.sparse.basic.add>`.
      The grad implemented is regular.
    - :func:`sub <arasea.sparse.basic.sub>`.
      The grad implemented is regular.
    - :func:`mul <arasea.sparse.basic.mul>`.
      The grad implemented is regular.
    - :func:`col_scale <arasea.sparse.basic.col_scale>` to multiply by a vector along the columns.
      The grad implemented is structured.
    - :func:`row_scale <arasea.sparse.basic.row_scale>` to multiply by a vector along the rows.
      The grad implemented is structured.
...
- Dot Product
    - :func:`dot <arasea.sparse.basic.dot>`.
    ...
    - :func:`structured_dot <arasea.sparse.basic.structured_dot>`.
        ...
        - Returns a sparse grad for sparse inputs and dense grad for
          dense inputs.
    - :func:`true_dot <arasea.sparse.basic.true_dot>`.
    ...
    - :func:`sampling_dot <arasea.sparse.basic.sampling_dot>`.
    ...
    - :func:`usmm <arasea.sparse.basic.usmm>`.

        - You *shouldn't* insert this op yourself!
           - There is a rewrite that transforms a
             :func:`dot <arasea.sparse.basic.dot>` to :class:`Usmm` when possible.
...
- Slice Operations
    ...
    - :func:`diag <arasea.sparse.basic.diag>`.
      The grad implemented is regular.

- Concatenation
    - :func:`hstack <arasea.sparse.basic.hstack>`.
      The grad implemented is regular.
    - :func:`vstack <arasea.sparse.basic.vstack>`.
      The grad implemented is regular.

- Probability
    `There is no grad implemented for these operations.`

    - :class:`Poisson <arasea.sparse.basic.Poisson>` and ``poisson``
    - :class:`Binomial <arasea.sparse.basic.Binomial>` and ``csc_fbinomial``, ``csc_dbinomial``
      ``csr_fbinomial``, ``csr_dbinomial``
    - :class:`Multinomial <arasea.sparse.basic.Multinomial>` and ``multinomial``

- Internal Representation
    `They all have a regular grad implemented.`

    - :func:`ensure_sorted_indices <arasea.sparse.basic.ensure_sorted_indices>`.
    - :func:`remove0 <arasea.sparse.basic.remove0>`.
    - :func:`clean <arasea.sparse.basic.clean>` to resort indices and remove zeros
...
.. automodule:: arasea.sparse.basic
    :members:

.. autofunction:: arasea.sparse.sparse_grad
