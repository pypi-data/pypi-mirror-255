...
Like NumPy, Arasea distinguishes between *basic* and *advanced* indexing.
Arasea fully supports basic indexing
...
= b`` or ``a[5]+=b``, see :func:`arasea.tensor.subtensor.set_subtensor` and
:func:`arasea.tensor.subtensor.inc_subtensor` below.
