...
:func:`arasea.scan` comes with bells and whistles that are not always all necessary, which is why Arasea provides several other functions to create a :class:`Scan` operator:
