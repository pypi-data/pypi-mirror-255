...
.. testcode::
   ...
   f_switch = arasea.function([a, b, x, y], z_switch,
                              mode=arasea.compile.mode.Mode(linker='vm'))
   f_lazyifelse = arasea.function([a, b, x, y], z_lazy,
                                  mode=arasea.compile.mode.Mode(linker='vm'))
...
.. note::
   ...
   any changes during the execution of the compiled Arasea function.
