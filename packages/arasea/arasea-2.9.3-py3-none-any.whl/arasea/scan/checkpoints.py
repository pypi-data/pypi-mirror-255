...
from arasea.tensor.basic import Join
from arasea.tensor.math import ceil, eq
...
def scan_checkpoints(
    ...
    In :func:`~arasea.scan`, if you compute the gradient of the output
    ...
    * Only the last timestep of any output will ever be used.
    ...
    fn
        ...
        step of ``scan``. See the documentation of :func:`~arasea.scan`
    ...
    -------
    tuple
        Tuple of the form ``(outputs, updates)`` as in :func:`~arasea.scan`, but
    ...
    See Also
    --------
    :func:`~arasea.scan`: Looping in Aesara.
