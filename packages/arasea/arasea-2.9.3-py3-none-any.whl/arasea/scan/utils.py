...
from arasea.graph.utils import TestValueError
from arasea.tensor.basic import AllocEmpty, cast
from arasea.tensor.subtensor import set_subtensor
from arasea.tensor.var import TensorConstant


if TYPE_CHECKING:
    from arasea.scan.op import ScanInfo

_logger = logging.getLogger("arasea.scan.utils")
...
class ScanArgs:
    ...
    def var_mappings(self):
        from arasea.scan.op import ScanMethodsMixin
