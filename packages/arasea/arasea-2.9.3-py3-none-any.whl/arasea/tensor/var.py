...
from arasea.graph.basic import Constant, OptionalApplyType, Variable
from arasea.graph.utils import MetaType
from arasea.scalar import ComplexError, IntegerDivisionError
from arasea.tensor import _get_vector_length, as_tensor_variable
from arasea.tensor.exceptions import AdvancedIndexingError
from arasea.tensor.type import TensorType
from arasea.tensor.type_other import NoneConst
from arasea.tensor.utils import hash_from_ndarray
...
class _tensor_py_operators:
    ...
    def reshape(self, shape, ndim=None):
        ...
        .. warning:: This has a different signature than numpy's
                     ...
                     in a tuple, in arasea you do need to.
    ...
    def __getitem__(self, args):
        ...
        # Convert python literals to arasea constants
        args = tuple(
            [
    ...
    def __iter__(self):
        try:
            ...
            raise TypeError(
                ...
                "arasea.tensor.math.sum? (Maybe .max?)"
            )
    ...
    def ptp(self, axis=None):
        """See `arasea.tensor.math.ptp`."""

        return at.math.ptp(self, axis)

    def swapaxes(self, axis1, axis2):
        """See `arasea.tensor.basic.swapaxes`.
