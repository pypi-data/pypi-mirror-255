...
from arasea.tensor.math import Sum
from arasea.tensor.shape import Reshape
from arasea.tensor.subtensor import AdvancedIncSubtensor, AdvancedSubtensor
...
def shape_parameter_as_tuple(fgraph, node):
    ...
    """
    from arasea.link.jax.dispatch.shape import JAXShapeTuple
