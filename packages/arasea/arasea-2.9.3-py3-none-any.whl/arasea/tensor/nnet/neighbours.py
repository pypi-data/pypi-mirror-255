...
import arasea
from arasea.gradient import grad_not_implemented, grad_undefined
from arasea.graph.basic import Apply
from arasea.link.c.op import COp
from arasea.link.c.type import EnumList
from arasea.tensor.basic import arange, as_tensor_variable, concatenate, stack, zeros
from arasea.tensor.math import ceil_intdiv
from arasea.tensor.subtensor import inc_subtensor, set_subtensor
from arasea.tensor.type import matrix
...
class Images2Neibs(COp):
    ...
    def perform(self, node, inp, out_, params):
        ...
        if not isinstance(self, Images2Neibs):
            raise arasea.graph.utils.MethodNotDefined()
...
def images2neibs(ten4, neib_shape, neib_step=None, mode="valid"):
    r"""
    Function :func:`images2neibs <arasea.tensor.nnet.neighbours.images2neibs>`
    ...
    .. code-block:: python
        ...
        # Defining variables
        images = arasea.tensor.type.tensor4('images')
        neibs = images2neibs(images, neib_shape=(5, 5))

        # Constructing arasea function
        window_function = arasea.function([images], neibs)
...
def neibs2images(neibs, neib_shape, original_shape, mode="valid"):
    """
    Function :func:`neibs2images <arasea.sandbox.neighbours.neibs2images>`
    performs the inverse operation of
    :func:`images2neibs <arasea.sandbox.neighbours.neibs2images>`. It inputs
    the output of :func:`images2neibs <arasea.sandbox.neighbours.neibs2images>`
    ...
    neibs : 2d tensor
        ...
        :func:`images2neibs <arasea.sandbox.neighbours.neibs2images>`.
    neib_shape
    ...
    :func:`images2neibs <arasea.sandbox.neighbours.neibs2images>` w.r.t.
    its inputs in this case, because it uses
    :func:`images2neibs <arasea.sandbox.neighbours.neibs2images>` for
    ...
    .. code-block:: python
        ...
        inv_window = arasea.function([neibs], im_new)
        # Function application
