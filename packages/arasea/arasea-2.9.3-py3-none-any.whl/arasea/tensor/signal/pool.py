...
from arasea.link.c.op import OpenMPOp
from arasea.link.c.params_type import ParamsType
from arasea.scalar import bool as bool_t
from arasea.tensor.type import TensorType, int_dtypes


warnings.warn(
    "The module `arasea.tensor.signal` is deprecated and will "
...
def max_pool_2d_same_size(input, patch_size):
    ...
    Parameters
    ----------
    input : 4-D arasea tensor of input images
        Input images. Max pooling will be done over the 2 last dimensions.
    patch_size : tuple of length 2 or arasea vector of ints of size 2.
...
def pool_2d(
    ...
    Parameters
    ----------
    input : N-D arasea tensor of input images
        Input images. Max pooling will be done over the 2 last dimensions.
    ws : tuple of length 2 or arasea vector of ints of size 2.
    ...
    ignore_border : bool (default None, will print a warning and set to False)
        ...
        (3,3) otherwise.
    stride : tuple of two ints or arasea vector of ints of size 2.
    ...
    pad : tuple of two ints or arasea vector of ints of size 2.
...
def pool_3d(
    ...
    ws : tuple of length 3 or arasea vector of ints of size 3
    ...
    ignore_border : bool (default None, will print a warning and set to False)
        ...
        (3,3,3) otherwise.
    st : tuple of three ints or arasea vector of ints of size 3
    ...
    pad : tuple of two ints or arasea vector of ints of size 3
