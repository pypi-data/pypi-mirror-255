...
from arasea.tensor.nnet import conv
...
_logger = logging.getLogger("arasea.tensor.signal.conv")
...
def conv2d(
    ...
    **kargs,
    ...
    Parameters
    ----------
    input   : Symbolic arasea tensor for images to be filtered.
              Dimensions: ([num_images], image height, image width)
    filters : Symbolic arasea tensor for convolution filter(s).
    ...
    kwargs
        See arasea.tensor.nnet.conv.conv2d.
