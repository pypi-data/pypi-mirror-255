...
from arasea.tensor.math import exp, lt, outer, tensordot
from arasea.tensor.shape import shape
...
class Fourier(Op):
    """
    WARNING: for officially supported FFTs, use arasea.tensor.fft, which
    ...
    def grad(self, inputs, cost_grad):
        ...
        # This would be simpler but not implemented by arasea:
