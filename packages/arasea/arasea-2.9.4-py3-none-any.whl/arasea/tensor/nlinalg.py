...
from arasea.tensor import math as tm
from arasea.tensor.basic import as_tensor_variable, extract_diag
from arasea.tensor.type import dvector, lscalar, matrix, scalar, vector
