...
warnings.warn(
    "The module `arasea.tensor.nnet` is deprecated and will "
    "be removed from Aesara in version 2.9.0",
    DeprecationWarning,
    stacklevel=2,
)

import arasea.tensor.nnet.rewriting
...
from arasea.tensor.nnet.basic import (
    binary_crossentropy,
...
from arasea.tensor.nnet.batchnorm import batch_normalization
from arasea.tensor.nnet.sigm import hard_sigmoid, ultra_fast_sigmoid
