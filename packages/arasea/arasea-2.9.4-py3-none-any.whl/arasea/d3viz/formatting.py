...
import arasea
from arasea.compile import Function, builders
from arasea.graph.basic import Apply, Constant, Variable, graph_inputs
from arasea.graph.fg import FunctionGraph
from arasea.printing import pydot_imported, pydot_imported_msg


try:
    from arasea.printing import pd
except ImportError:
    pass
...
class PyDotFormatter:
    ...
    def __call__(self, fct, graph=None):
        ...
        Parameters
        ----------
        fct : arasea.compile.function.types.Function
        ...
        for node in topo:
            ...
            for id, var in enumerate(node.inputs):
                ...
                if var.owner is None:
                    ...
                    elif isinstance(var, arasea.tensor.sharedvar.TensorSharedVariable):
