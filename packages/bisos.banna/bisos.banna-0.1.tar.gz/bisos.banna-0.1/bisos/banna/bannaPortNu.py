...
""" #+begin_org
* ~[Summary]~ :: =CS-Lib= PortNu Registrar of BANA (Bisos Assigned Numbers Authority)
#+end_org """
...
** [[elisp:(org-cycle)][| *DocStr* |]] Examples of Service Access Instance Commands.
    ...
    cmnd('portNuOf', args="csSiteRegBox.cs")
    cmnd('portNuOf', args="csSiteRegContainer.cs")
    cmnd('portNuOf', args="csSiteRegistrars.cs")
...
: ['22222001']
#+begin_src sh :results output :session shared
  csSiteRegistrars.cs -i portNuOf csSiteRegistrars
#+end_src
#+RESULTS:
:
...
*****  [[elisp:(org-cycle)][| *Note:* | ]] Incomplete, needs to look up the port from /bisos/admin/BxANA/portNumbers/transportPortNumberRegistry.txt
            ...
            portNu: str = ""
            if svcName == 'csSiteRegBox.cs':
                portNu = "22222001"
            elif svcName == 'csSiteRegContainer.cs':
                portNu = "22222002"
            elif svcName == 'csSiteRegistrars.cs':
                portNu = "22222003"
            else:
