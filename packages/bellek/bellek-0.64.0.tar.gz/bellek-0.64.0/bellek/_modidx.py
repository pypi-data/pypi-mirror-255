...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'bellek'},
  'syms': { 'bellek.hf.transformers.experiment': { 'bellek.hf.transformers.experiment._load_tokenizer_model': ( 'hf.transformers.experiment.html#_load_tokenizer_model',
                                                                                                                'bellek/hf/transformers/experiment.py'),
                                                   'bellek.hf.transformers.experiment.evalu8': ( 'hf.transformers.experiment.html#evalu8',
                                                                                                 'bellek/hf/transformers/experiment.py'),
                                                   ...
                                                   'bellek.hf.transformers.experiment.preprocess_config': ( 'hf.transformers.experiment.html#preprocess_config',
                                                                                                            'bellek/hf/transformers/experiment.py')},
            'bellek.hf.transformers.llama': { 'bellek.hf.transformers.llama.chat2text': ( 'hf.transformers.llama.html#chat2text',
            ...
            'bellek.jerx.prompt': { 'bellek.jerx.prompt.JERXChatFormatter': ('jerx.prompt.html#jerxchatformatter', 'bellek/jerx/prompt.py'),
                                    ...
                                    'bellek.jerx.prompt.JERXChatFormatter._choose_few_shot_examples': ( 'jerx.prompt.html#jerxchatformatter._choose_few_shot_examples',
                                                                                                        'bellek/jerx/prompt.py'),
            ...
            'bellek.llama_index.obs': { 'bellek.llama_index.obs.TraceRecorder': ( 'llama_index.obs.html#tracerecorder',
                                                                                  'bellek/llama_index/obs.py'),
                                        'bellek.llama_index.obs.TraceRecorder.__call__': ( 'llama_index.obs.html#tracerecorder.__call__',
                                                                                           'bellek/llama_index/obs.py'),
                                        'bellek.llama_index.obs.TraceRecorder.__init__': ( 'llama_index.obs.html#tracerecorder.__init__',
                                                                                           'bellek/llama_index/obs.py'),
