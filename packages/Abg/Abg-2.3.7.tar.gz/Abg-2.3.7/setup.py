...
setuptools.setup(
    ...
    version="2.3.7",
    description="add-on for Pyrofork || Telegram bot helpers || Easy botting",
    ...
    keywords="add-on Pyrofork bots telegram bot chat messenger mtproto api client library python conversation keyboard userbot patch https",
    project_urls={
