...
class TestLangchain:
    ...
    def test_01_llm_chain(self, model_type):
    ...
    @pytest.mark.parametrize("model_type", available_models)
    def test_02_llm_chain_model_with_params(self, model_type):
        params = {
    ...
    @pytest.mark.parametrize("model_type", available_models)
    def test_03_sequential_chain(self, model_type):
    ...
    @pytest.mark.parametrize("model_type", available_models)
    def test_04_simple_sequential_chain(self, model_type):
        params = {
    ...
    @pytest.mark.parametrize("model_type", available_models)
    def test_05_transformation_chain(self, model_type):
    ...
    @pytest.mark.parametrize("model_type", available_models)
    def test_07_conversation_buffer_memory_chain(self, model_type):
        model = Model(
            model_id=model_type,
            credentials=self.wml_credentials,
            project_id=self.project_id)
    ...
    def test_08_math_chain(self, model_type):
        model = Model(
            model_id=model_type,
            credentials=self.wml_credentials,
            project_id=self.project_id)
    ...
    @pytest.mark.parametrize("model_type", available_models)
    def test_09_to_langchain_wrapper(self, model_type):
        prompt_template = "What color is the {flower}?\n"
        model = Model(
            model_id=model_type,
            credentials=self.wml_credentials,
