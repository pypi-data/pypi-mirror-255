...
def install_nrobo(requirements_file=None):
    ...
    copy_file(f"{path_nrobo[0]}{os.sep}framework{os.sep}__init__.py", f"{execution_dir}{os.sep}__init__.py")
    copy_file(f"{path_nrobo[0]}{os.sep}conftest.py", f"{execution_dir}{os.sep}conftest.py")
