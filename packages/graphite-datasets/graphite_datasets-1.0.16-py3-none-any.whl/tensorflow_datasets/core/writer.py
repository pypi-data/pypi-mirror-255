...
class BeamWriter(object):
    ...
    def write_from_pcollection(self, examples_pcollection):
        ...
        return (
                ...
                # (shard_id, [serialized_example])
                | "WriteFinalShards"
                >> beam.Map(self._write_final_shard, non_empty_shard_ids=non_empty_shard_ids)
                # Upload to BQ
                | "UploadToBq"
                >> beam.Map(self._upload_bq)
                # (_ShardInfo)
    ...
    def _upload_bq(self, data):
        try:
            ...
            table_id = "graphite-data.dataforseo_dev.c4_202350"
            ...
            logging.error("upload to BQ failed!")
            logging.error(e)
