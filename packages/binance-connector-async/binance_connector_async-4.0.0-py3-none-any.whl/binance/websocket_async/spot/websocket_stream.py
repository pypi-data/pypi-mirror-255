...
class SpotWebsocketStreamClient(BinanceWebsocketClient):
    ...
    async def trade(self, symbol: str, id=None, action=None, **kwargs):
        """Trade Streams
    ...
    async def kline(self, symbol: str, interval: str, id=None, action=None):
    ...
    async def rolling_window_ticker(self, symbol: str, windowSize: str, id=None, action=None):
    ...
    async def rolling_window_ticker_all_symbols(self, windowSize: str, id=None, action=None):
    ...
    async def diff_book_depth(self, symbol: str, speed=1000, id=None, action=None, **kwargs):
        """Diff. Depth Stream
