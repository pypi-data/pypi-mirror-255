...
async def get_order(self, symbol: str, **kwargs):
    """Get order (USER_DATA)
...
async def new_oco_order(self, symbol: str, side: str, price, quantity, **kwargs):
...
async def cancel_oco_order(self, symbol: str, **kwargs):
    """Cancel OCO order
...
async def get_open_oco_orders(self, **kwargs):
    """Get open OCO orders
