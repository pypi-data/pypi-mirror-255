...
async def ping_connectivity(self, id=None):
...
async def server_time(self, id=None):
    """Check server time
...
async def exchange_info(self, **kwargs):
...
async def order_book(self, symbol: str, **kwargs):
    """Order book
...
async def recent_trades(self, symbol: str, **kwargs):
    """Recent trades
...
async def historical_trades(self, symbol: str, apiKey: str, **kwargs):
    """Historical trades
...
async def aggregate_trades(self, symbol: str, **kwargs):
    """Aggregate trades
...
async def avg_price(self, symbol: str, **kwargs):
...
async def ticker_24hr(self, **kwargs):
...
async def ticker_price(self, **kwargs):
    """Symbol price ticker
...
async def ticker_book(self, **kwargs):
