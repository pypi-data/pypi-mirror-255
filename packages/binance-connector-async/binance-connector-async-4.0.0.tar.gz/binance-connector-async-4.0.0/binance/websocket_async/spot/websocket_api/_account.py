...
async def order_rate_limit(self, **kwargs):
...
async def oco_history(self, **kwargs):
...
async def my_trades(self, **kwargs):
...
async def prevented_matches(self, symbol: str, **kwargs):
