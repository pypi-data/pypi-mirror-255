...
class CMFuturesWebsocketClient(BinanceWebsocketClient):
    ...
    async def agg_trade(self, symbol: str, id=None, action=None, **kwargs):
        ...
        await self.send_message_to_server(stream_name, action=action, id=id)

    async def index_price(self, pair: str, id=None, speed=1, action=None, **kwargs):
        """Index Price Streams
    ...
    async def mark_price(self, symbol: str, speed=1, id=None, action=None, **kwargs):
        """Mark Price Streams
    ...
    async def pair_mark_price(self, pair: str, speed=1, id=None, action=None, **kwargs):
    ...
    async def kline(self, symbol: str, interval: str, id=None, action=None, **kwargs):
    ...
    async def index_kline(self, pair: str, interval: str, id=None, action=None, **kwargs):
    ...
    async def mark_kline(self, symbol: str, interval: str, id=None, action=None, **kwargs):
        """Kline/Candlestick chart intervals Streams
    ...
    async def mini_ticker(self, symbol=None, id=None, action=None, **kwargs):
    ...
    async def ticker(self, symbol=None, id=None, action=None, **kwargs):
    ...
    async def book_ticker(self, symbol, id=None, action=None, **kwargs):
    ...
    async def diff_book_depth(self, symbol: str, speed=100, id=None, action=None, **kwargs):
        """Diff. Depth Stream
        ...
        await self.send_message_to_server(
    ...
    async def liquidation_order(self, symbol: str, id=None, action=None, **kwargs):
        ...
        await self.send_message_to_server(stream_name, id=id, action=action)

    async def user_data(self, listen_key: str, id=None, action=None, **kwargs):
