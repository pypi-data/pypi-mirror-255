...
def Pick(pick_title,listc,multiselect=False,auto_choose=[],highlight_color=Fore.GREEN,popup_animation=False,key={"UP":"w","DOWN":"s","SUBMIT":"enter","MULTISELECT_CHOOSE":"space"}):
