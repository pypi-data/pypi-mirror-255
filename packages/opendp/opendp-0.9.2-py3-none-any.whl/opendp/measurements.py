...
def make_alp_queryable(
    ...
    [make_alp_queryable in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_alp_queryable.html)
...
def make_base_discrete_gaussian(
    ...
    [make_base_discrete_gaussian in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_base_discrete_gaussian.html)
...
def make_base_discrete_laplace(
    ...
    [make_base_discrete_laplace in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_base_discrete_laplace.html)
...
def make_base_discrete_laplace_cks20(
    ...
    [make_base_discrete_laplace_cks20 in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_base_discrete_laplace_cks20.html)
...
def make_base_discrete_laplace_linear(
    ...
    [make_base_discrete_laplace_linear in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_base_discrete_laplace_linear.html)
...
def make_base_gaussian(
    ...
    [make_base_gaussian in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_base_gaussian.html)
...
def make_base_geometric(
    ...
    [make_base_geometric in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_base_geometric.html)
...
def make_base_laplace(
    ...
    [make_base_laplace in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_base_laplace.html)
...
def make_base_laplace_threshold(
    ...
    [make_base_laplace_threshold in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_base_laplace_threshold.html)
...
def make_gaussian(
    ...
    [make_gaussian in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_gaussian.html)
...
def make_laplace(
    ...
    [make_laplace in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_laplace.html)
...
def make_randomized_response(
    ...
    [make_randomized_response in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_randomized_response.html)
...
def make_randomized_response_bool(
    ...
    [make_randomized_response_bool in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_randomized_response_bool.html)
    ...
    **Proof Definition:**
    ...
    [(Proof Document)](https://docs.opendp.org/en/v0.9.2/proofs/rust/src/measurements/randomized_response/make_randomized_response_bool.pdf)
...
def make_report_noisy_max_gumbel(
    ...
    [make_report_noisy_max_gumbel in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_report_noisy_max_gumbel.html)
    ...
    **Proof Definition:**
    ...
    [(Proof Document)](https://docs.opendp.org/en/v0.9.2/proofs/rust/src/measurements/gumbel_max/make_report_noisy_max_gumbel.pdf)
