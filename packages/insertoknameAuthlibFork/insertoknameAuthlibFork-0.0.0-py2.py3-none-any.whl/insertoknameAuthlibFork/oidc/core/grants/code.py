"""
    insertoknameAuthlibFork.oidc.core.grants.code
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
import logging
from insertoknameAuthlibFork.oauth2.rfc6749 import OAuth2Request
from .util import (
    is_openid_scope,
    validate_nonce,
...
class OpenIDToken:
    ...
    def generate_user_info(self, user, scope):
        ...
        MUST implement this method in subclass, e.g.::
            ...
            from insertoknameAuthlibFork.oidc.core import UserInfo
        ...
        :return: ``insertoknameAuthlibFork.oidc.core.UserInfo`` instance
        """
        raise NotImplementedError()
