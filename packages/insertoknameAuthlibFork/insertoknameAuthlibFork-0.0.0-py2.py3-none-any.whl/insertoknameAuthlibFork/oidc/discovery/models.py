from insertoknameAuthlibFork.oauth2.rfc8414 import AuthorizationServerMetadata
from insertoknameAuthlibFork.oauth2.rfc8414.models import validate_array_value
