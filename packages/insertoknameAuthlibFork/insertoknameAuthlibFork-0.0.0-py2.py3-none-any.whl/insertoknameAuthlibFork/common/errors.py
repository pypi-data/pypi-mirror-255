...
class insertoknameAuthlibForkBaseError(Exception):
    """Base Exception for all errors in insertoknameAuthlibFork."""
...
class insertoknameAuthlibForkHTTPError(insertoknameAuthlibForkBaseError):
    #: HTTP status code
    status_code = 400
...
class ContinueIteration(insertoknameAuthlibForkBaseError):
    pass
