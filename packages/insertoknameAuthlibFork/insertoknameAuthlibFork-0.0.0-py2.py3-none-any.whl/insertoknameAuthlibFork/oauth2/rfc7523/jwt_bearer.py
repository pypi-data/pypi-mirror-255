import logging
from insertoknameAuthlibFork.jose import jwt, JoseError
...
class JWTBearerGrant(BaseGrant, TokenEndpointMixin):
    ...
    def resolve_client_key(self, client, headers, payload):
        ...
        "jwks" column on client table, e.g.::
            ...
            def resolve_client_key(self, client, headers, payload):
                # from insertoknameAuthlibFork.jose import JsonWebKey
        ...
        :return: ``insertoknameAuthlibFork.jose.Key`` instance
        """
        raise NotImplementedError()
