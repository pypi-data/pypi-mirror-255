...
from insertoknameAuthlibFork.common.errors import ContinueIteration
from insertoknameAuthlibFork.consts import default_json_headers
from insertoknameAuthlibFork.jose.errors import ExpiredTokenError
from insertoknameAuthlibFork.jose.errors import InvalidClaimError
from insertoknameAuthlibFork.oauth2.rfc6750.errors import InvalidTokenError
from insertoknameAuthlibFork.oauth2.rfc9068.token_validator import JWTBearerTokenValidator


class JWTIntrospectionEndpoint(IntrospectionEndpoint):
    '''
    JWTIntrospectionEndpoint inherits from :ref:`specs/rfc7662`
    :class:`~insertoknameAuthlibFork.oauth2.rfc7662.IntrospectionEndpoint` and implements the machinery
    ...
    :param \\*\\*kwargs: Other parameters are inherited from
        :class:`~insertoknameAuthlibFork.oauth2.rfc7662.introspection.IntrospectionEndpoint`.
