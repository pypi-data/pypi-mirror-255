...
from insertoknameAuthlibFork.oauth1 import ResourceProtector as _ResourceProtector
from insertoknameAuthlibFork.oauth1.errors import OAuth1Error
...
class ResourceProtector(_ResourceProtector):
    ...
    And for ``exists_nonce``, if using cache, we have a built-in hook to create this method::
        ...
        from insertoknameAuthlibFork.integrations.flask_oauth1 import create_exists_nonce_func
    ...
    def acquire_credential(self):
        ...
        g.insertoknameAuthlibFork_server_oauth1_credential = req.credential
...
def _get_current_credential():
    return g.get('insertoknameAuthlibFork_server_oauth1_credential')
