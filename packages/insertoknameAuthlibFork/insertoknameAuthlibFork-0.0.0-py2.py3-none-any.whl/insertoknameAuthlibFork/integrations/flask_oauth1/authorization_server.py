...
from insertoknameAuthlibFork.oauth1 import (
    OAuth1Request,
    AuthorizationServer as _AuthorizationServer,
)
from insertoknameAuthlibFork.common.security import generate_token
from insertoknameAuthlibFork.common.urls import url_encode

log = logging.getLogger(__name__)


class AuthorizationServer(_AuthorizationServer):
    """Flask implementation of :class:`insertoknameAuthlibFork.rfc5849.AuthorizationServer`.
    ...
    :param query_client: A function to get client by client_id. The client
        ...
        :class:`~insertoknameAuthlibFork.oauth1.rfc5849.ClientMixin`.
