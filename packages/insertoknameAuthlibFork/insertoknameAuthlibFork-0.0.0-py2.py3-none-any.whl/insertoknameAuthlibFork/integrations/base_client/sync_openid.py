from insertoknameAuthlibFork.jose import jwt, JsonWebToken, JsonWebKey
from insertoknameAuthlibFork.oidc.core import UserInfo, CodeIDToken, ImplicitIDToken
...
class OpenIDMixin:
    ...
    def parse_id_token(self, token, nonce, claims_options=None, leeway=120):
        ...
        # https://github.com/lepture/insertoknameAuthlibFork/issues/259
