...
from insertoknameAuthlibFork.oauth2 import (
    AuthorizationServer as _AuthorizationServer,
)
from insertoknameAuthlibFork.oauth2.rfc6750 import BearerTokenGenerator
from insertoknameAuthlibFork.common.security import generate_token as _generate_token
from insertoknameAuthlibFork.common.encoding import json_dumps
...
class AuthorizationServer(_AuthorizationServer):
    """Django implementation of :class:`insertoknameAuthlibFork.oauth2.rfc6749.AuthorizationServer`.
    Initialize it with client model and token model::

        from insertoknameAuthlibFork.integrations.django_oauth2 import AuthorizationServer
    ...
    def __init__(self, client_model, token_model):
        self.config = getattr(settings, 'insertoknameAuthlibFork_OAUTH2_PROVIDER', {})
