...
from insertoknameAuthlibFork.common.security import generate_token
from .requests import FlaskOAuth2Request, FlaskJsonRequest
from .signals import client_authenticated, token_revoked


class AuthorizationServer(_AuthorizationServer):
    """Flask implementation of :class:`insertoknameAuthlibFork.oauth2.rfc6749.AuthorizationServer`.
    ...
    def create_bearer_token_generator(self, config):
        ...
        :class:`insertoknameAuthlibFork.oauth2.rfc6750.BearerToken`.
