...
from insertoknameAuthlibFork.oauth2.rfc6749 import (
...
class ResourceProtector(_ResourceProtector):
    ...
    decorator easily with ResourceProtector::
        ...
        from insertoknameAuthlibFork.oauth2.rfc6750 import BearerTokenValidator
    ...
    def acquire_token(self, scopes=None, **kwargs):
        ...
        g.insertoknameAuthlibFork_server_oauth2_token = token
        return token
...
def _get_current_token():
    return g.get('insertoknameAuthlibFork_server_oauth2_token')
