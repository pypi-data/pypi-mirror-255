"""
    insertoknameAuthlibFork.oauth1.rfc5849.errors
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    RFC5849 has no definition on errors. This module is designed by
    insertoknameAuthlibFork based on OAuth 1.0a `Section 10`_ with some changes.

    .. _`Section 10`: https://oauth.net/core/1.0a/#rfc.section.10
"""
from insertoknameAuthlibFork.common.errors import insertoknameAuthlibForkHTTPError
from insertoknameAuthlibFork.common.security import is_secure_transport


class OAuth1Error(insertoknameAuthlibForkHTTPError):
