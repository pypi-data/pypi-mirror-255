...
def setup_quick():
    ...
    shutil.copy2(os.path.join(source_path.parent, "host.py"), os.path.join(Path.cwd()))
    shutil.copy2(os.path.join(source_path.parent, "host.bat"), os.path.join(Path.cwd()))
    shutil.copy2(os.path.join(source_path.parent, "shell.py"), os.path.join(Path.cwd()))
    ...
    os.system("python main-setup.py --reg main,crispy_bootstrap5")
