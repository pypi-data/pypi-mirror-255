...
# Query params
AddInternalMetadataSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'addInternalMetadata': typing.Union[AddInternalMetadataSchema, bool, ],
...
request_query_add_internal_metadata = api_client.QueryParameter(
    name="addInternalMetadata",
    style=api_client.ParameterStyle.FORM,
    schema=AddInternalMetadataSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _list_metadata_oapg(
        ...
        for parameter in (
            request_query_add_internal_metadata,
...
class ListMetadata(BaseApi):
    ...
    def list_metadata(
        ...
        return self._list_metadata_oapg(
