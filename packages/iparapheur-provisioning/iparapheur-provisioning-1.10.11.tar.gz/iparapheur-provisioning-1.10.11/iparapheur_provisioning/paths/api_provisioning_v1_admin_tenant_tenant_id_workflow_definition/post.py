...
SchemaFor201ResponseBodyApplicationJson = WorkflowDefinitionDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_workflow_definition_oapg(
        self,
...
class CreateWorkflowDefinition(BaseApi):
    ...
    def create_workflow_definition(
        ...
        return self._create_workflow_definition_oapg(
            body=body,
