        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WorkflowDefinitionRepresentation']:
                        return WorkflowDefinitionRepresentation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['WorkflowDefinitionRepresentation'], typing.List['WorkflowDefinitionRepresentation']],
