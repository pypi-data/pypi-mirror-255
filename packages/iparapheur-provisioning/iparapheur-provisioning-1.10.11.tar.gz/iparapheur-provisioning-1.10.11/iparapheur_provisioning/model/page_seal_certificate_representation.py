        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SealCertificateRepresentation']:
                        return SealCertificateRepresentation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SealCertificateRepresentation'], typing.List['SealCertificateRepresentation']],
