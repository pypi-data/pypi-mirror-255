...
from .api.exact import (
    ...
    delete_entries_exact_entries_hard_delete_delete,
    delete_entries_exact_entries_soft_delete_delete,
    delete_entries_by_file_exact_entries_by_file_hard_delete_delete,
    delete_entries_by_file_exact_entries_by_file_soft_delete_delete,
    delete_collection_exact_collection_soft_delete_delete,
    delete_collection_exact_collection_hard_delete_delete,
...
from .models.body_delete_entries_exact_entries_hard_delete_delete import BodyDeleteEntriesExactEntriesHardDeleteDelete
from .models.body_delete_entries_by_file_exact_entries_by_file_hard_delete_delete import BodyDeleteEntriesByFileExactEntriesByFileHardDeleteDelete
from .models.body_delete_entries_exact_entries_soft_delete_delete import BodyDeleteEntriesExactEntriesSoftDeleteDelete
from .models.body_delete_entries_by_file_exact_entries_by_file_soft_delete_delete import BodyDeleteEntriesByFileExactEntriesByFileSoftDeleteDelete
...
class LectricClient:
    ...
    def hard_drop_collection(self, name: str, exact: bool=False) -> None:
        ...
        if not exact:
            ...
            return delete_collection_exact_collection_hard_delete_delete.sync_detailed(client=self.client, name=name)

    @propagate_exception
    def soft_drop_collection(self, name: str, exact: bool=False, deleter: str=None) -> None:
        """_summary_
        ...
        if not exact:
            ...
            return delete_collection_exact_collection_soft_delete_delete.sync_detailed(client=self.client, name=name, deleter=deleter)
    ...
    def soft_delete_entities(self, collection_name: str,
        ...
        if is_approx:
            ...
            # Exact
            if ids:
                return delete_entries_exact_entries_soft_delete_delete.sync_detailed(
                    client=self.client, collection_name=collection_name, soft_deleter=deleter,
                    json_body=BodyDeleteEntriesExactEntriesSoftDeleteDelete(entry_ids=ids)
                )
            if urls:
                return delete_entries_exact_entries_soft_delete_delete.sync_detailed(
                    client=self.client, collection_name=collection_name, soft_deleter=deleter,
                    json_body=BodyDeleteEntriesExactEntriesSoftDeleteDelete(urls=urls),
                )
            if file:
                return delete_entries_by_file_exact_entries_by_file_soft_delete_delete.sync_detailed(
                    client=self.client, collection_name=collection_name, soft_deleter=deleter,
                    multipart_data=BodyDeleteEntriesByFileExactEntriesByFileSoftDeleteDelete(
    ...
    def hard_delete_entities(self, collection_name: str,
        ...
        if is_approx:
            ...
            # Exact
            if ids:
                return delete_entries_exact_entries_hard_delete_delete.sync_detailed(
                    client=self.client, collection_name=collection_name,
                    json_body=BodyDeleteEntriesExactEntriesHardDeleteDelete(entry_ids=ids)
                )
            if urls:
                return delete_entries_exact_entries_hard_delete_delete.sync_detailed(
                    client=self.client, collection_name=collection_name,
                    json_body=BodyDeleteEntriesExactEntriesHardDeleteDelete(urls=urls),
                )
            if file:
                return delete_entries_by_file_exact_entries_by_file_hard_delete_delete.sync_detailed(
                    client=self.client, collection_name=collection_name,
                    multipart_data=BodyDeleteEntriesByFileExactEntriesByFileHardDeleteDelete(
                        file=fastAPIFile(payload=get_tmp_file(file), file_name=str(uuid4()),
                                                mime_type="image/jpg")
                    )
                )
