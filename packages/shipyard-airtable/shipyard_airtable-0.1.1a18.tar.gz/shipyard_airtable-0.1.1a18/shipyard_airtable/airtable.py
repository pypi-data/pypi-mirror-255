...
class AirtableClient(Spreadsheets):
    ...
    def upload(self, upload_method: str, base: str, table: str, data: list, key_fields: list = None,
               typecast: bool = True) -> None:
        """
        ...
        if upload_method == "append":
            self.batch_create_records(base,
                                      table,
                                      data,
                                      key_fields,
                                      typecast)
        elif upload_method == "upsert":
            self.batch_upsert_records(base,
                                      table,
                                      data,
                                      key_fields,
                                      typecast)
        elif upload_method == "replace":
            self.clear_table(base, table)
            self.batch_create_records(base,
                                      table,
                                      data,
                                      key_fields,
    ...
    def batch_create_records(self, base: str,
                             table: str,
                             data: list,
                             key_fields: list,
                             typecast: bool = True) -> None:
    ...
    def batch_upsert_records(self, base: str,
                             table: str,
                             data: list,
                             key_fields: list,
                             typecast: bool = True) -> None:
