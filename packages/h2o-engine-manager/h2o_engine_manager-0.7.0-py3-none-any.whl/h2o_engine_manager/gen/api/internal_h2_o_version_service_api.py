...
class InternalH2OVersionServiceApi(object):
    ...
    def internal_h2_o_version_service_delete_internal_h2_o_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_h2_o_version_service_delete_internal_h2_o_version(name_4, async_req=True)
        >>> result = thread.get()

        Args:
            name_4 (str): InternalH2OVersion resource name.
    ...
    def internal_h2_o_version_service_get_internal_h2_o_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_h2_o_version_service_get_internal_h2_o_version(name_11, async_req=True)
        >>> result = thread.get()

        Args:
            name_11 (str): InternalH2OVersion resource name.
    ...
    def internal_h2_o_version_service_update_internal_h2_o_version(
        ...
        **kwargs
        ...
        Args:
            ...
            update_mask (str): The list of paths referencing which fields to update. Update mask must be non-empty.  Allowed field paths are: {version, deprecated, image, image_pull_policy, image_pull_secrets, gpu_resource_name, annotations}.  To update all allowed fields, specify exactly one path with value \"*\".
