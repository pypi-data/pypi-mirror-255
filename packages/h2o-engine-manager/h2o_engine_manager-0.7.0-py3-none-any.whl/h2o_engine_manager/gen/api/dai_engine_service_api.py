...
class DAIEngineServiceApi(object):
    ...
    def d_ai_engine_service_get_dai_engine(
        ...
        **kwargs
        ...
        >>> thread = api.d_ai_engine_service_get_dai_engine(name_2, async_req=True)
        >>> result = thread.get()

        Args:
            name_2 (str): DAIEngine resource name. Format: workspaces/{workspace}/daiEngines/{dai_engine}
