...
class FCRDataModel:
    ...
    def __init__(self, config: Config):
        ...
        if self.run_type == RunMode.SIMULATION:
            ...
            self.has_censoring = config.has_censoring
...
class Runner:
    def __init__(self, dataModel):
        ...
        # todo: re-consider the gh process # points_for_gauss_hermite, weights_for_gauss_hermite = get_pts_wts2(competing_risks=n_competing_risks, gauss_hermite=np.polynomial.hermite.hermgauss(N_P))#todo:reconsider the python implementation
