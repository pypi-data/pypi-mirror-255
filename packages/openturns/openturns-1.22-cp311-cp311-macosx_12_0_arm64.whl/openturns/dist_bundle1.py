...
class Dirichlet(openturns.model_copula.ContinuousDistribution):
    ...
    theta : sequence of float, :math:`\theta_i > 0, i = 1, \ldots, n+1`
            ...
            :math:`\vect{theta}` must be at least bidimensional.
...
class GeneralizedExtremeValueFactory(openturns.model_copula.DistributionFactoryImplementation):
    ...
    def buildMethodOfProfileLikelihoodMaximizationEstimator(self, sample):
        r"""
        ...
        result : :class:`~openturns.ProfileLikelihoodResult`
            The result class.
        """
        return _dist_bundle1.GeneralizedExtremeValueFactory_buildMethodOfProfileLikelihoodMaximizationEstimator(self, sample)

    def buildMethodOfProfileLikelihoodMaximization(self, sample):
        r"""
        ...
        """
        return _dist_bundle1.GeneralizedExtremeValueFactory_buildMethodOfProfileLikelihoodMaximization(self, sample)
