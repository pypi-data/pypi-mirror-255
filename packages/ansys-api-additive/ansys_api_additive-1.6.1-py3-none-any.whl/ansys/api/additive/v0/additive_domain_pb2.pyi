...
class InitialMicrostructureInput(google.protobuf.message.Message):
    ...
    x_dimension: builtins.float = ...
    y_dimension: builtins.float = ...
    z_dimension: builtins.float = ...
    def __init__(self,
        *,
        number_of_random_nuclei : builtins.int = ...,
        x_dimension : builtins.float = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["number_of_random_nuclei",b"number_of_random_nuclei","x_dimension",b"x_dimension","y_dimension",b"y_dimension","z_dimension",b"z_dimension"]) -> None: ...
...
class Microstructure3DInput(google.protobuf.message.Message):
    ...
    THERMAL_DOMAIN_DEPTH_FIELD_NUMBER: builtins.int
    ...
    THERMAL_DATA_FILE_TYPE_FIELD_NUMBER: builtins.int
    MS_X_ORIGIN_FIELD_NUMBER: builtins.int
    MS_Y_ORIGIN_FIELD_NUMBER: builtins.int
    MS_Z_ORIGIN_FIELD_NUMBER: builtins.int
    x_dimension: builtins.float = ...
    y_dimension: builtins.float = ...
    z_dimension: builtins.float = ...
    ...
    thermal_data_file_type: typing.Text = ...
    ms_x_origin: builtins.float = ...
    """microstructure domain origin x"""

    ms_y_origin: builtins.float = ...
    """microstructure domain origin y"""

    ms_z_origin: builtins.float = ...
    """microstructure domain origin z"""
    ...
    def __init__(self,
        *,
        ...
        thermal_domain_depth : typing.Optional[builtins.float] = ...,
        ...
        thermal_data_file_type : typing.Optional[typing.Text] = ...,
        ms_x_origin : typing.Optional[builtins.float] = ...,
        ms_y_origin : typing.Optional[builtins.float] = ...,
        ms_z_origin : typing.Optional[builtins.float] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_deposit_layer_thickness",b"_deposit_layer_thickness","_first_deposit_layer",b"_first_deposit_layer","_initial_euler_angle_data",b"_initial_euler_angle_data","_initial_grain_data",b"_initial_grain_data","_initial_microstructure_input",b"_initial_microstructure_input","_machine",b"_machine","_material",b"_material","_max_bulk_nucleation_density",b"_max_bulk_nucleation_density","_ms_x_origin",b"_ms_x_origin","_ms_y_origin",b"_ms_y_origin","_ms_z_origin",b"_ms_z_origin","_num_deposit_layers",b"_num_deposit_layers","_run_initial_microstructure",b"_run_initial_microstructure","_thermal_data_file_type",b"_thermal_data_file_type","_thermal_domain_depth",b"_thermal_domain_depth","_use_provided_initial_microstructure_data",b"_use_provided_initial_microstructure_data","_use_transient_bulk_nucleation",b"_use_transient_bulk_nucleation","_x_origin",b"_x_origin","_x_thermal_domain_grid_spacing",b"_x_thermal_domain_grid_spacing","_y_origin",b"_y_origin","_y_thermal_domain_grid_spacing",b"_y_thermal_domain_grid_spacing","_z_origin",b"_z_origin","_z_thermal_domain_grid_spacing",b"_z_thermal_domain_grid_spacing","deposit_layer_thickness",b"deposit_layer_thickness","first_deposit_layer",b"first_deposit_layer","initial_euler_angle_data",b"initial_euler_angle_data","initial_grain_data",b"initial_grain_data","initial_microstructure_input",b"initial_microstructure_input","machine",b"machine","material",b"material","max_bulk_nucleation_density",b"max_bulk_nucleation_density","ms_x_origin",b"ms_x_origin","ms_y_origin",b"ms_y_origin","ms_z_origin",b"ms_z_origin","num_deposit_layers",b"num_deposit_layers","run_initial_microstructure",b"run_initial_microstructure","thermal_data_file_type",b"thermal_data_file_type","thermal_domain_depth",b"thermal_domain_depth","use_provided_initial_microstructure_data",b"use_provided_initial_microstructure_data","use_transient_bulk_nucleation",b"use_transient_bulk_nucleation","x_origin",b"x_origin","x_thermal_domain_grid_spacing",b"x_thermal_domain_grid_spacing","y_origin",b"y_origin","y_thermal_domain_grid_spacing",b"y_thermal_domain_grid_spacing","z_origin",b"z_origin","z_thermal_domain_grid_spacing",b"z_thermal_domain_grid_spacing"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_deposit_layer_thickness",b"_deposit_layer_thickness","_first_deposit_layer",b"_first_deposit_layer","_initial_euler_angle_data",b"_initial_euler_angle_data","_initial_grain_data",b"_initial_grain_data","_initial_microstructure_input",b"_initial_microstructure_input","_machine",b"_machine","_material",b"_material","_max_bulk_nucleation_density",b"_max_bulk_nucleation_density","_ms_x_origin",b"_ms_x_origin","_ms_y_origin",b"_ms_y_origin","_ms_z_origin",b"_ms_z_origin","_num_deposit_layers",b"_num_deposit_layers","_run_initial_microstructure",b"_run_initial_microstructure","_thermal_data_file_type",b"_thermal_data_file_type","_thermal_domain_depth",b"_thermal_domain_depth","_use_provided_initial_microstructure_data",b"_use_provided_initial_microstructure_data","_use_transient_bulk_nucleation",b"_use_transient_bulk_nucleation","_x_origin",b"_x_origin","_x_thermal_domain_grid_spacing",b"_x_thermal_domain_grid_spacing","_y_origin",b"_y_origin","_y_thermal_domain_grid_spacing",b"_y_thermal_domain_grid_spacing","_z_origin",b"_z_origin","_z_thermal_domain_grid_spacing",b"_z_thermal_domain_grid_spacing","deposit_layer_thickness",b"deposit_layer_thickness","first_deposit_layer",b"first_deposit_layer","initial_euler_angle_data",b"initial_euler_angle_data","initial_grain_data",b"initial_grain_data","initial_microstructure_input",b"initial_microstructure_input","machine",b"machine","material",b"material","max_bulk_nucleation_density",b"max_bulk_nucleation_density","ms_x_origin",b"ms_x_origin","ms_y_origin",b"ms_y_origin","ms_z_origin",b"ms_z_origin","num_deposit_layers",b"num_deposit_layers","run_initial_microstructure",b"run_initial_microstructure","thermal_data_file_type",b"thermal_data_file_type","thermal_domain_depth",b"thermal_domain_depth","use_provided_initial_microstructure_data",b"use_provided_initial_microstructure_data","use_transient_bulk_nucleation",b"use_transient_bulk_nucleation","x_dimension",b"x_dimension","x_origin",b"x_origin","x_thermal_domain_grid_spacing",b"x_thermal_domain_grid_spacing","y_dimension",b"y_dimension","y_origin",b"y_origin","y_thermal_domain_grid_spacing",b"y_thermal_domain_grid_spacing","z_dimension",b"z_dimension","z_origin",b"z_origin","z_thermal_domain_grid_spacing",b"z_thermal_domain_grid_spacing"]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_ms_x_origin",b"_ms_x_origin"]) -> typing.Optional[typing_extensions.Literal["ms_x_origin"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_ms_y_origin",b"_ms_y_origin"]) -> typing.Optional[typing_extensions.Literal["ms_y_origin"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_ms_z_origin",b"_ms_z_origin"]) -> typing.Optional[typing_extensions.Literal["ms_z_origin"]]: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_thermal_data_file_type",b"_thermal_data_file_type"]) -> typing.Optional[typing_extensions.Literal["thermal_data_file_type"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_thermal_domain_depth",b"_thermal_domain_depth"]) -> typing.Optional[typing_extensions.Literal["thermal_domain_depth"]]: ...
    @typing.overload
