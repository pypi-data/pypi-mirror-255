...
class IBLModel:
    ...
    def load_prompt_templates(self, objective: str) -> None:
        ...
        model_prompt_mapping = {
            "gpt-4-0125-preview": "prompt_templates.gpt-4-0125-preview.ibl",
            "gemini-pro": "prompt_templates.gemini-pro.ibl"
        }
        ...
        with pkg_resources.open_text(iblm.model_prompt_mapping[self.model_name], task_prompt_mapping[self.objective]) as file:
        ...
        with pkg_resources.open_text(iblm.model_prompt_mapping[self.model_name], task_prompt_mapping["interpret"]) as file:
