...
//#include <cstdint>
 ...
 void templatenest_init(void * * object);
  void templatenest_set_parameters(void* object, char* defaults, char* template_dir, char* template_ext, char* defaults_namespace_char, char** comment_delims,
	char** token_delims, int64_t show_labels, char* name_label, int64_t fixed_indent, int64_t die_on_bad_params, char* escape_char);

 void templatenest_set_jsonparameters(void* object, char* defaults, char* template_dir, char* template_ext, char* defaults_namespace_char, char** comment_delims,
	char** token_delims, int64_t show_labels, char* name_label, int64_t fixed_indent, int64_t die_on_bad_params, char* escape_char);
