# Template-Nestdll Templating System
...
Template-Nestdll is far simpler, and makes far more sense!
...
So here Template-Nestdll will look in `template_dir` for `some_js_file.js`.
