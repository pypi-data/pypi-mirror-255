...
from google.api_core import retry as _retry, exceptions
...
def retry(func):
    nonretryable_exceptions = exceptions.NotFound
    ...
    @_retry.Retry(
        predicate=_retry.if_exception_type(retryable_exceptions),
        initial=1,
        maximum=5,
        timeout=30,
    )
