...
class ModelJobStatusesApi(object):
    ...
    def model_job_status_controller_bulk_update_project_id(self, body, **kwargs):  # noqa: E501
        """model_job_status_controller_bulk_update_project_id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_job_status_controller_bulk_update_project_id(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ModelJobStatusUpdateProjectIdDto body: (required)
        :return: ModelJobStatus
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.model_job_status_controller_bulk_update_project_id_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.model_job_status_controller_bulk_update_project_id_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def model_job_status_controller_bulk_update_project_id_with_http_info(self, body, **kwargs):  # noqa: E501
        """model_job_status_controller_bulk_update_project_id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_job_status_controller_bulk_update_project_id_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method model_job_status_controller_bulk_update_project_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `model_job_status_controller_bulk_update_project_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/model-job-statuses/bulk-update-project-id', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
