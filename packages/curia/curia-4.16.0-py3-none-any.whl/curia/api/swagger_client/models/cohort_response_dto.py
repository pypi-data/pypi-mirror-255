...
class CohortResponseDto(object):
    ...
    """
    swagger_types = {
        'model_jobs': 'list[CohortJoinedModelJobResponseDto]',
        'train_cohort': 'CohortJoinedCohortResponseDto',
        'prediction_cohorts': 'list[CohortJoinedCohortResponseDto]',
        'id': 'str',
        'name': 'str',
        'model_id': 'str',
        'train_cohort_id': 'str',
    ...
    def model_jobs(self):
        ...
        :rtype: list[CohortJoinedModelJobResponseDto]
        """
    ...
    def model_jobs(self, model_jobs):
        ...
        :type: list[CohortJoinedModelJobResponseDto]
        """
    ...
    def prediction_cohorts(self):
        ...
        :rtype: list[CohortJoinedCohortResponseDto]
        """
    ...
    def prediction_cohorts(self, prediction_cohorts):
        ...
        :type: list[CohortJoinedCohortResponseDto]
        """
