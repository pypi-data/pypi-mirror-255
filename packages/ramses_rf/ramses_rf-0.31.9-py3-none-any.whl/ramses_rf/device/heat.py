...
PRIORITY_LOW = {SZ_PRIORITY: Priority.LOW}  # TODO:  deprecate QoS in kwargs
PRIORITY_MID = {SZ_PRIORITY: Priority.HIGH}  # TODO: deprecate QoS in kwargs
PRIORITY_MAX = {SZ_PRIORITY: Priority.HIGH, SZ_NUM_REPEATS: 3}  # deprecate QoS...
...
class OtbGateway(Actuator, HeatDemand):  # OTB (10): 3220 (22D9, others)
    ...
    def _handle_code(self, msg: Message) -> None:
        ...
        if msg.code == Code._3EF0 and msg.verb == I_:
            ...
            # self._send_cmd(
            #     Command.get_opentherm_data(self.id, "00"), **PRIORITY_MID
            # )  # FIXME: deprecate QoS in kwargs
            return
