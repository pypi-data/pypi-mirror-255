...
def all_reduce(input, dim, kind, *, loc=None, ip=None) -> _SubClassValueT:
...
def sem_alloc(result, *, loc=None, ip=None) -> _SubClassValueT:
...
def assume_layout(result, input, *, loc=None, ip=None) -> _SubClassValueT:
...
class AssumeMultipleOp(_ods_ir.OpView):
  ...
  def __init__(self, value, multiple, *, loc=None, ip=None):
    ...
    issubclass(type(multiple), _ods_ir.Attribute) or
...
def assume_multiple(value, multiple, *, loc=None, ip=None) -> _SubClassValueT:
...
def bitcast(output, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def bitcast_vreg(output, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def broadcast_in_sublanes(output, source, lane, *, loc=None, ip=None) -> _SubClassValueT:
...
def concatenate(output, sources, dimension, *, loc=None, ip=None) -> _SubClassValueT:
...
def create_mask(output, low, high, *, loc=None, ip=None) -> _SubClassValueT:
...
def create_subelement_mask(output, from_, to, num_subelems, *, loc=None, ip=None) -> _SubClassValueT:
...
def device_id(*, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_gather(output, source, indices, dimension, *, loc=None, ip=None) -> _SubClassValueT:
...
def enqueue_dma(source, target, target_semaphore, *, source_semaphore=None, device_id=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(EnqueueDMAOp(source=source, target=target, target_semaphore=target_semaphore, source_semaphore=source_semaphore, device_id=device_id, loc=loc, ip=ip))
...
def erase_memref_layout(result, operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def gather(output, source, indices, dimension, *, loc=None, ip=None) -> _SubClassValueT:
...
def sem_barrier(semaphore, *, loc=None, ip=None) -> _SubClassValueT:
...
def iota(output, *, dimension=None, loc=None, ip=None) -> _SubClassValueT:
...
def load(result, base, indices, sublane_mask, *, sublane_stride=None, loc=None, ip=None) -> _SubClassValueT:
...
def mask_cast(result, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def matmul(result, lhs, rhs, acc, *, transpose_lhs=None, transpose_rhs=None, precision=None, loc=None, ip=None) -> _SubClassValueT:
...
def memref_slice(result, mem_ref, base_idx, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(MemRefSliceOp(result=result, mem_ref=mem_ref, base_idx=base_idx, loc=loc, ip=ip))
...
def memref_squeeze(result, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def pack_subelements(output, sources, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(PackSubelementsOp(output=output, sources=sources, loc=loc, ip=ip))
...
def region(results_, *, loc=None, ip=None) -> _SubClassValueT:
...
def reinterpret_cast(result, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def repeat(output, source, dimension, times, *, loc=None, ip=None) -> _SubClassValueT:
...
def roll_vectors(output, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def rotate(value, amount, dimension, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(RotateOp(value=value, amount=amount, dimension=dimension, loc=loc, ip=ip))
...
def sem_signal(semaphore, amount, *, device_id=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(SemaphoreSignalOp(semaphore=semaphore, amount=amount, device_id=device_id, loc=loc, ip=ip))
...
def trace(results_, message, level, *, loc=None, ip=None) -> _SubClassValueT:
...
def unpack_subelements(output, source, index, *, loc=None, ip=None) -> _SubClassValueT:
...
def unroll_vectors(output, input, *, loc=None, ip=None) -> _SubClassValueT:
