...
def abs(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def add(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def after_all(inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def all_gather(result, operand, all_gather_dim, replica_groups, *, channel_handle=None, use_global_device_ids=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AllGatherOp(result=result, operand=operand, all_gather_dim=all_gather_dim, replica_groups=replica_groups, channel_handle=channel_handle, use_global_device_ids=use_global_device_ids, loc=loc, ip=ip))
...
def all_reduce(result, operand, replica_groups, *, channel_handle=None, use_global_device_ids=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AllReduceOp(result=result, operand=operand, replica_groups=replica_groups, channel_handle=channel_handle, use_global_device_ids=use_global_device_ids, loc=loc, ip=ip))
...
def all_to_all(operand, split_dimension, concat_dimension, split_count, replica_groups, *, channel_handle=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AllToAllOp(operand=operand, split_dimension=split_dimension, concat_dimension=concat_dimension, split_count=split_count, replica_groups=replica_groups, channel_handle=channel_handle, loc=loc, ip=ip))
...
def atan2(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def batch_norm_grad(operand, scale, mean, variance, grad_output, epsilon, feature_index, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def batch_norm_inference(operand, scale, offset, mean, variance, epsilon, feature_index, *, loc=None, ip=None) -> _SubClassValueT:
...
def batch_norm_training(operand, scale, offset, epsilon, feature_index, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def bitcast_convert(result, operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def broadcast_in_dim(result, operand, broadcast_dimensions, *, loc=None, ip=None) -> _SubClassValueT:
...
def broadcast(operand, broadcast_sizes, *, loc=None, ip=None) -> _SubClassValueT:
...
def case(result, index, num_branches, *, loc=None, ip=None) -> _SubClassValueT:
...
def cbrt(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def ceil(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def cholesky(a, *, lower=None, loc=None, ip=None) -> _SubClassValueT:
...
def clamp(min, operand, max, *, loc=None, ip=None) -> _SubClassValueT:
...
def count_leading_zeros(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def collective_broadcast(operand, replica_groups, *, channel_handle=None, loc=None, ip=None) -> _SubClassValueT:
...
def collective_permute(operand, source_target_pairs, *, channel_handle=None, loc=None, ip=None) -> _SubClassValueT:
...
def compare(lhs, rhs, comparison_direction, *, compare_type=None, loc=None, ip=None) -> _SubClassValueT:
...
def complex(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def compute_reshape_shape(result, num_elements, dynamic_shape, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ComputeReshapeShapeOp(result=result, num_elements=num_elements, dynamic_shape=dynamic_shape, loc=loc, ip=ip))
...
def concatenate(inputs, dimension, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ConcatenateOp(inputs=inputs, dimension=dimension, loc=loc, ip=ip))
...
def convert(result, operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def convolution(result, lhs, rhs, dimension_numbers, feature_group_count, batch_group_count, *, window_strides=None, padding=None, lhs_dilation=None, rhs_dilation=None, window_reversal=None, precision_config=None, loc=None, ip=None) -> _SubClassValueT:
...
def cosine(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def create_token(*, loc=None, ip=None) -> _SubClassValueT:
...
def cross_replica_sum(operand, replica_groups, *, loc=None, ip=None) -> _SubClassValueT:
...
def cstr_reshapable(num_elements, dynamic_shape, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CstrReshapableOp(num_elements=num_elements, dynamic_shape=dynamic_shape, loc=loc, ip=ip))
  ...
  def __init__(self, result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_652')) else
          _ods_ir.AttrBuilder.get('anonymous_652')(output_operand_aliases, context=_ods_context))
    results.extend(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def custom_call(result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None) -> _SubClassValueT:
...
def divide(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def dot_general(result, lhs, rhs, dot_dimension_numbers, *, precision_config=None, loc=None, ip=None) -> _SubClassValueT:
...
def dot(result, lhs, rhs, *, precision_config=None, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_broadcast_in_dim(result, operand, output_dimensions, broadcast_dimensions, *, known_expanding_dimensions=None, known_nonexpanding_dimensions=None, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_conv(result, lhs, rhs, d_padding, dimension_numbers, feature_group_count, batch_group_count, *, window_strides=None, padding=None, lhs_dilation=None, rhs_dilation=None, window_reversal=None, precision_config=None, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_gather(operand, start_indices, slice_sizes, dimension_numbers, *, indices_are_sorted=None, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_iota(result, output_shape, iota_dimension, *, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_pad(result, operand, padding_value, edge_padding_low, edge_padding_high, interior_padding, *, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_reshape(result, operand, output_shape, *, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_slice(operand, start_indices, slice_sizes, *, loc=None, ip=None) -> _SubClassValueT:
...
def dynamic_update_slice(operand, update, start_indices, *, loc=None, ip=None) -> _SubClassValueT:
...
def einsum(result, lhs, rhs, einsum_config, *, loc=None, ip=None) -> _SubClassValueT:
...
def exponential(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def exponential_minus_one(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def fft(operand, fft_type, fft_length, *, loc=None, ip=None) -> _SubClassValueT:
...
def floor(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def gather(operand, start_indices, dimension_numbers, slice_sizes, *, indices_are_sorted=None, loc=None, ip=None) -> _SubClassValueT:
...
def get_dimension_size(operand, dimension, *, loc=None, ip=None) -> _SubClassValueT:
...
def get_tuple_element(operand, index, *, loc=None, ip=None) -> _SubClassValueT:
...
def if_(result, pred, *, loc=None, ip=None) -> _SubClassValueT:
...
def imag(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def infeed(result, token, *, infeed_config=None, layout=None, loc=None, ip=None) -> _SubClassValueT:
...
def iota(output, iota_dimension, *, loc=None, ip=None) -> _SubClassValueT:
...
def is_finite(x, *, loc=None, ip=None) -> _SubClassValueT:
...
def log_plus_one(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def log(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def logistic(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def map(result, inputs, dimensions, *, loc=None, ip=None) -> _SubClassValueT:
...
def maximum(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def minimum(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def multiply(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def negate(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def not_(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def optimization_barrier(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def outfeed(inputs, token, *, outfeed_config=None, loc=None, ip=None) -> _SubClassValueT:
...
def pad(operand, padding_value, edge_padding_low, edge_padding_high, interior_padding, *, loc=None, ip=None) -> _SubClassValueT:
...
def partition_id(*, loc=None, ip=None) -> _SubClassValueT:
...
def popcnt(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def power(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def real_dynamic_slice(result, operand, start_indices, limit_indices, strides, *, loc=None, ip=None) -> _SubClassValueT:
...
def real(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def recv(result, token, channel_handle, *, is_host_transfer=None, loc=None, ip=None) -> _SubClassValueT:
...
def reduce(result, inputs, init_values, dimensions, *, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_precision(operand, exponent_bits, mantissa_bits, *, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_scatter(result, operand, scatter_dimension, replica_groups, *, channel_handle=None, use_global_device_ids=None, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_window(result, inputs, init_values, window_dimensions, *, window_strides=None, base_dilations=None, window_dilations=None, padding=None, loc=None, ip=None) -> _SubClassValueT:
...
def remainder(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def replica_id(*, loc=None, ip=None) -> _SubClassValueT:
...
def reshape(result, operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def reverse(operand, dimensions, *, loc=None, ip=None) -> _SubClassValueT:
...
def rng_bit_generator(output_state, output, rng_algorithm, initial_state, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def rng(a, b, shape, rng_distribution, *, loc=None, ip=None) -> _SubClassValueT:
...
def round_nearest_even(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def round_nearest_afz(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def rsqrt(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def scatter(result, inputs, scatter_indices, updates, scatter_dimension_numbers, *, indices_are_sorted=None, unique_indices=None, loc=None, ip=None) -> _SubClassValueT:
...
def select_and_scatter(result, operand, source, init_value, *, window_dimensions=None, window_strides=None, padding=None, loc=None, ip=None) -> _SubClassValueT:
...
def select(pred, on_true, on_false, *, loc=None, ip=None) -> _SubClassValueT:
...
def send(inputs, token, channel_handle, *, is_host_transfer=None, loc=None, ip=None) -> _SubClassValueT:
...
def set_dimension_size(operand, size, dimension, *, loc=None, ip=None) -> _SubClassValueT:
...
def shift_left(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def shift_right_arithmetic(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def shift_right_logical(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def sign(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def sine(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def slice(operand, start_indices, limit_indices, strides, *, loc=None, ip=None) -> _SubClassValueT:
...
def sort(result, inputs, *, dimension=None, is_stable=None, loc=None, ip=None) -> _SubClassValueT:
...
def sqrt(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def subtract(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def tanh(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def torch_index_select(result, operand, index, dim, batch_dims, *, loc=None, ip=None) -> _SubClassValueT:
...
def transpose(operand, permutation, *, loc=None, ip=None) -> _SubClassValueT:
...
def triangular_solve(a, b, left_side, lower, unit_diagonal, transpose_a, *, loc=None, ip=None) -> _SubClassValueT:
...
def tuple(val, *, loc=None, ip=None) -> _SubClassValueT:
...
def unary_einsum(result, operand, einsum_config, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(UnaryEinsumOp(result=result, operand=operand, einsum_config=einsum_config, loc=loc, ip=ip))
...
def uniform_dequantize(operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def uniform_quantize(result, operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def while_(result, operand, *, loc=None, ip=None) -> _SubClassValueT:
