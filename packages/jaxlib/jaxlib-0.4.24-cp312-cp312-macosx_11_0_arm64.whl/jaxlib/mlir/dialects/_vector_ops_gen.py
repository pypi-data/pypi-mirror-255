...
def vscale(*, loc=None, ip=None) -> _SubClassValueT:
...
def bitcast(result, source, *, loc=None, ip=None) -> _SubClassValueT:
...
def broadcast(vector, source, *, loc=None, ip=None) -> _SubClassValueT:
...
def constant_mask(result, mask_dim_sizes, *, loc=None, ip=None) -> _SubClassValueT:
...
def contract(result, lhs, rhs, acc, indexing_maps, iterator_types, *, kind=None, loc=None, ip=None) -> _SubClassValueT:
...
def create_mask(result, operands_, *, loc=None, ip=None) -> _SubClassValueT:
...
def expandload(result, base, indices, mask, pass_thru, *, loc=None, ip=None) -> _SubClassValueT:
...
def extractelement(vector, *, position=None, loc=None, ip=None) -> _SubClassValueT:
...
class ExtractOp(_ods_ir.OpView):
  ...
  def __init__(self, vector, dynamic_position, static_position, *, loc=None, ip=None):
    ...
    issubclass(type(static_position), _ods_ir.Attribute) or
...
def extract(vector, dynamic_position, static_position, *, loc=None, ip=None) -> _SubClassValueT:
...
def extract_strided_slice(result, vector, offsets, sizes, strides, *, loc=None, ip=None) -> _SubClassValueT:
...
def fma(lhs, rhs, acc, *, loc=None, ip=None) -> _SubClassValueT:
...
def flat_transpose(res, matrix, rows, columns, *, loc=None, ip=None) -> _SubClassValueT:
...
def gather(result, base, indices, index_vec, mask, pass_thru, *, loc=None, ip=None) -> _SubClassValueT:
...
def insertelement(source, dest, *, position=None, loc=None, ip=None) -> _SubClassValueT:
...
def insert(source, dest, dynamic_position, static_position, *, loc=None, ip=None) -> _SubClassValueT:
...
def insert_strided_slice(source, dest, offsets, strides, *, loc=None, ip=None) -> _SubClassValueT:
...
def load(result, base, indices, *, nontemporal=None, loc=None, ip=None) -> _SubClassValueT:
...
def mask(results_, mask, *, passthru=None, loc=None, ip=None) -> _SubClassValueT:
...
def maskedload(result, base, indices, mask, pass_thru, *, loc=None, ip=None) -> _SubClassValueT:
...
def matrix_multiply(res, lhs, rhs, lhs_rows, lhs_columns, rhs_columns, *, loc=None, ip=None) -> _SubClassValueT:
...
def multi_reduction(kind, source, acc, reduction_dims, *, loc=None, ip=None) -> _SubClassValueT:
...
def outerproduct(result, lhs, rhs, *, acc=None, kind=None, loc=None, ip=None) -> _SubClassValueT:
...
class PrintOp(_ods_ir.OpView):
  ...
  def __init__(self, *, source=None, punctuation=None, stringLiteral=None, loc=None, ip=None):
    ...
    if punctuation is not None: attributes["punctuation"] = (punctuation if (
        issubclass(type(punctuation), _ods_ir.Attribute) or
...
def reduction(dest, kind, vector, *, acc=None, fastmath=None, loc=None, ip=None) -> _SubClassValueT:
...
def reshape(result, vector, input_shape, output_shape, fixed_vector_sizes, *, loc=None, ip=None) -> _SubClassValueT:
...
def scalable_extract(res, source, pos, *, loc=None, ip=None) -> _SubClassValueT:
...
def scalable_insert(source, dest, pos, *, loc=None, ip=None) -> _SubClassValueT:
...
def scan(kind, source, initial_value, reduction_dim, inclusive, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def shape_cast(result, source, *, loc=None, ip=None) -> _SubClassValueT:
...
def shuffle(v1, v2, mask, *, loc=None, ip=None) -> _SubClassValueT:
...
def splat(aggregate, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def transfer_read(vector, source, indices, permutation_map, padding, *, mask=None, in_bounds=None, loc=None, ip=None) -> _SubClassValueT:
...
def transfer_write(result, vector, source, indices, permutation_map, *, mask=None, in_bounds=None, loc=None, ip=None) -> _SubClassValueT:
...
def transpose(result, vector, permutation, *, loc=None, ip=None) -> _SubClassValueT:
...
def type_cast(result, memref, *, loc=None, ip=None) -> _SubClassValueT:
...
def warp_execute_on_lane_0(results_, laneid, warp_size, args, *, loc=None, ip=None) -> _SubClassValueT:
