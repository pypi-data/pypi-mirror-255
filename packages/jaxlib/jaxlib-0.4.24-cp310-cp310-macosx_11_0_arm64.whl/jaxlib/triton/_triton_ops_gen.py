...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_584')) else
      _ods_ir.AttrBuilder.get('anonymous_584')(function_type, context=_ods_context))
...
def addptr(result, ptr, offset, *, loc=None, ip=None) -> _SubClassValueT:
...
def advance(result, ptr, offsets, *, loc=None, ip=None) -> _SubClassValueT:
...
class AtomicCASOp(_ods_ir.OpView):
  ...
  def __init__(self, result, ptr, cmp, val, sem, scope, *, loc=None, ip=None):
    ...
    issubclass(type(sem), _ods_ir.Attribute) or
    ...
    issubclass(type(scope), _ods_ir.Attribute) or
...
def atomic_cas(result, ptr, cmp, val, sem, scope, *, loc=None, ip=None) -> _SubClassValueT:
...
class AtomicRMWOp(_ods_ir.OpView):
  ...
  def __init__(self, result, atomic_rmw_op, ptr, val, sem, scope, *, mask=None, loc=None, ip=None):
    ...
    issubclass(type(atomic_rmw_op), _ods_ir.Attribute) or
...
def atomic_rmw(result, atomic_rmw_op, ptr, val, sem, scope, *, mask=None, loc=None, ip=None) -> _SubClassValueT:
...
class BitcastOp(_ods_ir.OpView):
  ...
  def __init__(self, result, from_, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def bitcast(result, from_, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BitcastOp(result=result, from_=from_, loc=loc, ip=ip))
...
def broadcast(result, src, *, loc=None, ip=None) -> _SubClassValueT:
...
def cat(result, lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
class ClampFOp(_ods_ir.OpView):
  ...
  def __init__(self, x, min, max, propagateNan, *, loc=None, ip=None):
    ...
    issubclass(type(propagateNan), _ods_ir.Attribute) or
...
def clampf(x, min, max, propagate_nan, *, loc=None, ip=None) -> _SubClassValueT:
...
class DotOp(_ods_ir.OpView):
  ...
  def __init__(self, a, b, c, allowTF32, maxNumImpreciseAcc, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    _ods_context = _ods_get_default_loc_context(loc)
    attributes["allowTF32"] = (allowTF32 if (
    issubclass(type(allowTF32), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('BoolAttr')) else
      _ods_ir.AttrBuilder.get('BoolAttr')(allowTF32, context=_ods_context))
    attributes["maxNumImpreciseAcc"] = (maxNumImpreciseAcc if (
    issubclass(type(maxNumImpreciseAcc), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('I32Attr')) else
  ...
  @builtins.property
  def allowTF32(self):
    return self.operation.attributes["allowTF32"]

  @allowTF32.setter
  def allowTF32(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["allowTF32"] = value
...
def dot(a, b, c, allow_tf32, max_num_imprecise_acc, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DotOp(a=a, b=b, c=c, allowTF32=allow_tf32, maxNumImpreciseAcc=max_num_imprecise_acc, loc=loc, ip=ip))
...
def elementwise_inline_asm(result, asm_string, constraints, pure, packed_element, args, *, loc=None, ip=None) -> _SubClassValueT:
...
def expand_dims(src, axis, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExpandDimsOp(src=src, axis=axis, loc=loc, ip=ip))

@_ods_cext.register_operation(_Dialect)
class ExperimentalInterleaveOp(_ods_ir.OpView):
  OPERATION_NAME = "tt.experimental_interleave"
...
def experimental_interleave(result, lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExperimentalInterleaveOp(result=result, lhs=lhs, rhs=rhs, loc=loc, ip=ip))
...
class ExternElementwiseOp(_ods_ir.OpView):
  ...
  def __init__(self, result, args, libname, libpath, symbol, pure, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def extern_elementwise(result, args, libname, libpath, symbol, pure, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExternElementwiseOp(result=result, args=args, libname=libname, libpath=libpath, symbol=symbol, pure=pure, loc=loc, ip=ip))
...
class FpToFpOp(_ods_ir.OpView):
  ...
  def __init__(self, result, from_, *, rounding=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if rounding is not None: attributes["rounding"] = (rounding if (
        issubclass(type(rounding), _ods_ir.Attribute) or
...
def fp_to_fp(result, from_, *, rounding=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FpToFpOp(result=result, from_=from_, rounding=rounding, loc=loc, ip=ip))
...
def get_num_programs(axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def get_program_id(axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def histogram(result, input, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(HistogramOp(result=result, input=input, loc=loc, ip=ip))
...
def int_to_ptr(result, from_, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(IntToPtrOp(result=result, from_=from_, loc=loc, ip=ip))
...
class LoadOp(_ods_ir.OpView):
  ...
  def __init__(self, result, ptr, cache, evict, isVolatile, *, mask=None, other=None, boundaryCheck=None, padding=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if boundaryCheck is not None: attributes["boundaryCheck"] = (boundaryCheck if (
        issubclass(type(boundaryCheck), _ods_ir.Attribute) or
    ...
    issubclass(type(cache), _ods_ir.Attribute) or
    ...
    attributes["evict"] = (evict if (
    issubclass(type(evict), _ods_ir.Attribute) or
    ...
    issubclass(type(isVolatile), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('BoolAttr')) else
  ...
  def boundaryCheck(self):
    if "boundaryCheck" not in self.operation.attributes:
      return None
  ...
  def boundaryCheck(self, value):
    ...
    elif "boundaryCheck" in self.operation.attributes:
      del self.operation.attributes["boundaryCheck"]

  @boundaryCheck.deleter
  def boundaryCheck(self):
    del self.operation.attributes["boundaryCheck"]
...
def load(result, ptr, cache, evict, is_volatile, *, mask=None, other=None, boundary_check=None, padding=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(LoadOp(result=result, ptr=ptr, cache=cache, evict=evict, isVolatile=is_volatile, mask=mask, other=other, boundaryCheck=boundary_check, padding=padding, loc=loc, ip=ip))
...
def make_range(result, start, end, *, loc=None, ip=None) -> _SubClassValueT:
...
def make_tensor_ptr(result, base, shape, strides, offsets, order, *, loc=None, ip=None) -> _SubClassValueT:
...
class PrintOp(_ods_ir.OpView):
  ...
  def __init__(self, prefix, args, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def print_(prefix, args, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(PrintOp(prefix=prefix, args=args, loc=loc, ip=ip))
...
def ptr_to_int(result, from_, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(PtrToIntOp(result=result, from_=from_, loc=loc, ip=ip))
...
class ReduceOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operands_, axis, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def reduce(result, operands_, axis, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ReduceOp(result=result, operands_=operands_, axis=axis, loc=loc, ip=ip))
...
class ReshapeOp(_ods_ir.OpView):
  ...
  def __init__(self, result, src, allow_reorder, *, efficient_layout=None, loc=None, ip=None):
    ...
    issubclass(type(allow_reorder), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('BoolAttr')) else
...
def reshape(result, src, allow_reorder, *, efficient_layout=None, loc=None, ip=None) -> _SubClassValueT:
...
def scan(result, operands_, axis, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ScanOp(result=result, operands_=operands_, axis=axis, loc=loc, ip=ip))
...
def splat(result, src, *, loc=None, ip=None) -> _SubClassValueT:
...
def trans(src, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TransOp(src=src, loc=loc, ip=ip))
