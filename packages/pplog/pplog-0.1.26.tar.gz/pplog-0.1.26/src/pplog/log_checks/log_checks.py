...
from pplog.errors import (
    DatabricksEnvironmentNotAvailable,
    GreatExpectationsNotAvailable,
)
...
class GreatExpectationsSparkDFCheck(SingleCheck):
    ...
    def __init__(self, identifier: str, sdf: SparkDF, params: dict) -> None:
        ...
        if not IS_GREAT_EXPECTATIONS_AVAILABLE:
            raise GreatExpectationsNotAvailable(f"Cannot use '{__class__.__name__}'")
