...
from .practice import (
    ...
    validate_tillage_site_type, validate_tillage_values, validate_liveAnimal_system, validate_pastureGrass_key_termType,
...
def validate_cycle(cycle: dict, node_map: dict = {}):
    ...
    other_sites = [_find_linked_node(node_map, s) for s in cycle.get('otherSites', [])]
    return flatten([
