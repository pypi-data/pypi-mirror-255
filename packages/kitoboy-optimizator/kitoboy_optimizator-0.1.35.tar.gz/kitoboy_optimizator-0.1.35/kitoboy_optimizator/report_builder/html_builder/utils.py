...
def create_bootstrap_folder(base_dir: str):
    bootstrap_dir = os.path.join(base_dir, "bootstrap")
    if not os.path.exists(bootstrap_dir):
        os.makedirs(bootstrap_dir)
    bootstrap_css_filepath = os.path.join(bootstrap_dir, "bootstrap.css")
    bootstrap_js_filepath = os.path.join(bootstrap_dir, "bootstrap.js")
    with open(bootstrap_css_filepath, "w") as f:
            f.write(get_bootstrap_css_file_content())
    with open(bootstrap_js_filepath, "w") as f:
            f.write(get_bootstrap_js_file_content())
    


def get_bootstrap_css_file_content() -> str:
...
def get_bootstrap_js_file_content() -> str:
    return """/*!
 * Bootstrap v5.3.0-alpha3 (https://getbootstrap.com/)
