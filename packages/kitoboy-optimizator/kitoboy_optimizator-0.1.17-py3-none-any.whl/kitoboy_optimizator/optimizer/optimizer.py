...
class Optimizer:
    ...
    def process_results(self):
        ...
        html_file_path = os.path.join(f"{self.results_dir}/{self.strategy_name}/{self.exchange_name}", f"{self.symbol_params.get('symbol')}_{self.interval}_{timestamp_now}.html")
