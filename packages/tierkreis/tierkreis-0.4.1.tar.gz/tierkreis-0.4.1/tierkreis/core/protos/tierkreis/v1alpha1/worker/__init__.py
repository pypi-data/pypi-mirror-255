...
from ...v1alpha import graph as __v1_alpha_graph__
from .. import runtime as _runtime__
...
class RunFunctionRequest(betterproto.Message):
    function: "__v1_alpha_graph__.FunctionName" = betterproto.message_field(1)
    inputs: "__v1_alpha_graph__.StructValue" = betterproto.message_field(2)
    loc: "__v1_alpha_graph__.Location" = betterproto.message_field(3)
    callback: "_runtime__.Callback" = betterproto.message_field(4)


@dataclass(eq=False, repr=False)
class RunFunctionResponse(betterproto.Message):
    outputs: "__v1_alpha_graph__.StructValue" = betterproto.message_field(1)
