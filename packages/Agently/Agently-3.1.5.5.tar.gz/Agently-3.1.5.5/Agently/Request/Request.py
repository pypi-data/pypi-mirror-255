...
class Request(object):
    ...
    async def get_event_generator(self, request_type: str=None):
        ...
        if request_type == "prefix_test":
            def prefix_test_response_generator(request_data):
                yield({ "event": "response:done", "data": request_data })
            return prefix_test_response_generator(request_data)
        # Cache simple prompt
