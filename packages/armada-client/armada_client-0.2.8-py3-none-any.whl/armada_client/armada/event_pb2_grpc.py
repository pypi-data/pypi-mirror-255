...
class EventStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReportMultiple = channel.unary_unary(
                ...
                request_serializer=armada_dot_event__pb2.EventList.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.Report = channel.unary_unary(
                '/api.Event/Report',
                request_serializer=armada_dot_event__pb2.EventMessage.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
...
def add_EventServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReportMultiple': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=armada_dot_event__pb2.EventList.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'Report': grpc.unary_unary_rpc_method_handler(
                    servicer.Report,
                    request_deserializer=armada_dot_event__pb2.EventMessage.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
...
class Event(object):
    ...
    def ReportMultiple(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.Event/ReportMultiple',
            armada_dot_event__pb2.EventList.SerializeToString,
    ...
    def Report(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.Event/Report',
            armada_dot_event__pb2.EventMessage.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
