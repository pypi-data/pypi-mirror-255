...
@typing_extensions.final
class QueueInfoRequest(google.protobuf.message.Message):
    """swagger:model"""
...
global___QueueInfoRequest = QueueInfoRequest
...
class QueueInfo(google.protobuf.message.Message):
    ...
    NAME_FIELD_NUMBER: builtins.int
    ACTIVE_JOB_SETS_FIELD_NUMBER: builtins.int
    name: builtins.str
    @property
    def active_job_sets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___JobSetInfo]: ...
    def __init__(
        self,
        *,
        name: builtins.str = ...,
        active_job_sets: collections.abc.Iterable[global___JobSetInfo] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["active_job_sets", b"active_job_sets", "name", b"name"]) -> None: ...

global___QueueInfo = QueueInfo
