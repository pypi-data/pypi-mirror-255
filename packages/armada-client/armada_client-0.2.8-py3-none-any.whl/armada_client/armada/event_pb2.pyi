...
class JobSubmittedEvent(google.protobuf.message.Message):
    ...
    @property
    def job(self) -> armada.queue_pb2.Job: ...
    def __init__(
        self,
        *,
        job_id: builtins.str = ...,
...
class EventList(google.protobuf.message.Message):
    ...
    @property
    def events(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___EventMessage]: ...
    def __init__(
        self,
        *,
        events: collections.abc.Iterable[global___EventMessage] | None = ...,
    ) -> None: ...
...
class JobSetRequest(google.protobuf.message.Message):
    ...
    FORCE_NEW_FIELD_NUMBER: builtins.int
    id: builtins.str
    watch: builtins.bool
