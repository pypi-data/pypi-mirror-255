...
class SubmitStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetQueueInfo = channel.unary_unary(
                ...
                request_serializer=armada_dot_submit__pb2.QueueInfoRequest.SerializeToString,
                response_deserializer=armada_dot_submit__pb2.QueueInfo.FromString,
                )
...
def add_SubmitServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetQueueInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=armada_dot_submit__pb2.QueueInfoRequest.FromString,
                    response_serializer=armada_dot_submit__pb2.QueueInfo.SerializeToString,
            ),
...
class Submit(object):
    ...
    def GetQueueInfo(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.Submit/GetQueueInfo',
            armada_dot_submit__pb2.QueueInfoRequest.SerializeToString,
            armada_dot_submit__pb2.QueueInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
