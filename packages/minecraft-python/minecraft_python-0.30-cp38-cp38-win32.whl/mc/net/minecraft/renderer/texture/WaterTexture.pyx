...
from mc.net.minecraft.renderer.texture.DynamicTexture cimport DynamicTexture
from mc.net.minecraft.level.tile.Tiles import tiles
from mc.cCompatibilityShims cimport Random

cdef class WaterTexture(DynamicTexture):
    ...
    def __init__(self):
        DynamicTexture.__init__(self, tiles.water.tex)
    ...
    cpdef tick(self):
        ...
        for i2 in range(256):
            ...
            self.pixels[i2 << 2] = <char>r
            self.pixels[(i2 << 2) + 1] = <char>g
            self.pixels[(i2 << 2) + 2] = <char>b
            self.pixels[(i2 << 2) + 3] = <char>a
