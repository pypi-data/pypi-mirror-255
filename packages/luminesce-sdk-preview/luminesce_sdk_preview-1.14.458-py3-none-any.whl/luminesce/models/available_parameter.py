...
class AvailableParameter(object):
    ...
    def provider_name(self, provider_name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                provider_name is not None and len(provider_name) > 256):
            raise ValueError("Invalid value for `provider_name`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                provider_name is not None and len(provider_name) < 0):
            raise ValueError("Invalid value for `provider_name`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def parameter_name(self, parameter_name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                parameter_name is not None and len(parameter_name) > 256):
            raise ValueError("Invalid value for `parameter_name`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                parameter_name is not None and len(parameter_name) < 0):
            raise ValueError("Invalid value for `parameter_name`, length must be greater than or equal to `0`")  # noqa: E501
