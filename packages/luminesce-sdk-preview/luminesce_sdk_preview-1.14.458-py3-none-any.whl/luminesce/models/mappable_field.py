...
"""
    ...
    The version of the OpenAPI document: 1.14.458
...
class MappableField(object):
    ...
    def sample_values(self, sample_values):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                sample_values is not None and len(sample_values) > 256):
            raise ValueError("Invalid value for `sample_values`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                sample_values is not None and len(sample_values) < 0):
            raise ValueError("Invalid value for `sample_values`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def allowed_values(self, allowed_values):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                allowed_values is not None and len(allowed_values) > 256):
            raise ValueError("Invalid value for `allowed_values`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                allowed_values is not None and len(allowed_values) < 0):
            raise ValueError("Invalid value for `allowed_values`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def mandatory_for_actions(self, mandatory_for_actions):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                mandatory_for_actions is not None and len(mandatory_for_actions) > 256):
            raise ValueError("Invalid value for `mandatory_for_actions`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                mandatory_for_actions is not None and len(mandatory_for_actions) < 0):
            raise ValueError("Invalid value for `mandatory_for_actions`, length must be greater than or equal to `0`")  # noqa: E501
