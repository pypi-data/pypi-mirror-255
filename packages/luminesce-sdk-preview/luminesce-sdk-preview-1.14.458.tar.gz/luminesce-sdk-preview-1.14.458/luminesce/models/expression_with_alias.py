...
class ExpressionWithAlias(object):
    ...
    def expression(self, expression):
        ...
        if (self.local_vars_configuration.client_side_validation and
                expression is not None and len(expression) > 256):
            raise ValueError("Invalid value for `expression`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                expression is not None and len(expression) < 0):
            raise ValueError("Invalid value for `expression`, length must be greater than or equal to `0`")  # noqa: E501
