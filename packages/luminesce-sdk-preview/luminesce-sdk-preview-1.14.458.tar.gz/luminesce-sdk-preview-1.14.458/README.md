...
- API version: 1.14.458
- Package version: 1.14.458
...
*SqlExecutionApi* | [**put_sql_to_writer_design**](docs/SqlExecutionApi.md#put_sql_to_writer_design) | **PUT** /api/Sql/towriterdesign | [EXPERIMENTAL] PutSqlToWriterDesign: Generates a SQL-writer-design object from SQL string, if possible.
...
*SqlExecutionApi* | [**put_writer_design_to_sql**](docs/SqlExecutionApi.md#put_writer_design_to_sql) | **PUT** /api/Sql/fromwriterdesign | [EXPERIMENTAL] PutWriterDesignToSql: Generates writer SQL from a valid writer-design structure
