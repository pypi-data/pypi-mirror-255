...
from PyQt6.QtWidgets import QTableWidgetItem, QCheckBox, QSpinBox,QTableWidget,QStyledItemDelegate, QMessageBox, QLineEdit, QComboBox, QLabel, QSlider, QDoubleSpinBox,QGridLayout, QVBoxLayout, QGroupBox, QHBoxLayout, QWidget, QPushButton, QFileDialog
...
class ZernikeTab(QWidget):
    ...
    def __init__(self, pattern_generator, settings_manager, hologram_manager):
        ...
        self.ZernikeLayout.addWidget(self.make_group("Load from file", self.loadZernikebutton, self.saveZernikebutton))
