            ...
            <div class="form-row">
              <div class="col-md-4 mb-2 mb-md-0">
                <div class="input-group input-group-sm">
                  ...
                  <select class="custom-select" v-model="resourceConfig.creator">
              ...
              <div class="col-md-4 mb-2 mb-md-0">
                <div class="input-group input-group-sm">
                  ...
                  <select class="custom-select" v-model="resourceConfig.visibility">
  ...
  mounted() {
    ...
    for (const resourceConfig of this.field.data) {
      if (!currentResourceTypes.includes(resourceConfig.resource)) {
        // Accomodate for properties that were added later on.
