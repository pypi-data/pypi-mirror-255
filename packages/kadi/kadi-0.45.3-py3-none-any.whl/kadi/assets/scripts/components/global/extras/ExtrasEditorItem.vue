...
<template>
  <div class="form-group" tabindex="-1">
    <div class="form-row mr-0" :class="{'drag': extra.isDragging}">
      <!-- Type selection. -->
      <div class="custom-col-2 custom-mb" :class="{'custom-mr': nestedType}">
      ...
      <div class="custom-col-4 custom-mb" :class="{'custom-mr': nestedType}">
        <div class="input-group input-group-sm">
          <tooltip-item class="input-group-prepend" :title="extra.description.value" v-if="extra.description.value">
            <span class="input-group-text">
              <i class="fa-solid fa-circle-info text-default"></i>
            </span>
          </tooltip-item>
          <tooltip-item class="input-group-prepend stretched-link-container"
                        :title="extra.term.value"
                        v-if="extra.term.value">
            <span class="input-group-text">
              <a target="_blank"
          ...
          <div class="input-group-append" v-if="editingMode">
            <button type="button"
                    ...
                    @click="editDetails">
              <i class="fa-solid fa-angle-up" v-if="extra.editDetails"></i>
      ...
      <div class="custom-mb" :class="valueContainerClasses">
        <div class="input-group input-group-sm">
          <tooltip-item class="input-group-prepend" :title="valueTooltip" v-if="valueTooltip">
            <span class="input-group-text">
              <i class="fa-solid fa-circle-info text-default"></i>
            </span>
          </tooltip-item>
          ...
          <date-time-picker :class="[valueInputClass,
          ...
          <!-- Validation toggle. -->
          <div class="input-group-append" v-if="editingMode && !isNestedType">
            <button type="button"
                    class="input-group-text btn btn-light"
                    tabindex="-1"
      ...
      <div class="custom-col-2 custom-mb" :class="{'custom-mr': nestedType}" v-show="isNumericType">
        <div class="input-group input-group-sm">
          <div class="input-group-prepend">
      ...
      <div class="custom-col-2" :class="{'custom-mr': nestedType}" v-if="editingMode || isInList">
        <div class="btn-group btn-group-sm w-100">
          ...
          <span class="btn btn-light disabled sort-handle" tabindex="-1" :title="$t('Move extra')">
    ...
    <div class="mt-1 mr-1" v-show="editingMode && extra.editDetails && !extra.isDragging">
      <div class="card">
        <div class="mx-2">
          <div class="form-row align-items-center my-2">
            ...
            <div class="col-md-10">
              ...
              <div class="invalid-feedback" v-for="error in extra.description.errors" :key="error">{{ error }}</div>
            </div>
          </div>
          <div class="form-row align-items-center my-2">
            <div class="col-md-2 text-muted">
    ...
    <div class="mt-1 mr-1" v-show="editingMode && extra.editValidation && !isNestedType && !extra.isDragging">
...
export default {
  ...
  computed: {
    ...
    valueContainerClasses() {
      let cols = this.isNumericType ? 2 : 4;
