...
class LocalStorage(BaseStorage):
    ...
    def _create_filepath(self, identifier):
        ...
        return os.path.join(self._root_directory, filepath)
    ...
    def _remove_empty_parent_dirs(self, filepath):
        ...
        while (
            ...
            and not os.path.samefile(self._root_directory, current_dir)
        ):
            try:
