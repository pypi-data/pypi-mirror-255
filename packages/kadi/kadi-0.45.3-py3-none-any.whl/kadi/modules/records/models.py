...
class File(SimpleReprMixin, StateTimestampMixin, db.Model):
    ...
    def identifier(self):
        ...
        Mainly used in correspondence with the file's storage.
        """
        return str(self.id)
    ...
    def create(
        ...
        *,
        ...
        :param magic_mimetype: (optional) The MIME type of the file based on its
            content.
        :param storage (optional): The storage of the file, see :attr:`storage`.
...
class Upload(SimpleReprMixin, StateTimestampMixin, db.Model):
    ...
    def identifier(self):
        ...
        Mainly used in correspondence with the upload's storage.
        """
        return str(self.id)
    ...
    def create(
        ...
        *,
        ...
        :param chunk_count: (optional) The chunk count of the upload.
        :param storage (optional): The storage of the upload, see :attr:`storage`.
            Defaults to the local storage.
        ...
        if chunk_count is None:
            chunk_count = math.ceil(size / const.UPLOAD_CHUNK_SIZE) if size > 0 else 1
...
class Chunk(SimpleReprMixin, db.Model):
    ...
    def identifier(self):
        ...
        Mainly used in correspondence with the storage of the chunk's upload.
        """
