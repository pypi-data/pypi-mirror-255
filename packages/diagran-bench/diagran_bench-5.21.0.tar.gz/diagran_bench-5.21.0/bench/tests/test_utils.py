...
class TestUtils(unittest.TestCase):
	def test_app_utils(self):
		git_url = "https://github.com/diagranhub/frappe"
		branch = "develop"
	...
	def test_is_valid_frappe_branch(self):
		with self.assertRaises(InvalidRemoteException):
			is_valid_frappe_branch(
				"https://github.com/diagranhub/frappe.git", frappe_branch="random-branch"
			)
			is_valid_frappe_branch(
		...
		is_valid_frappe_branch(
			"https://github.com/diagranhub/frappe.git", frappe_branch="develop"
		)
		is_valid_frappe_branch(
			"https://github.com/diagranhub/frappe.git", frappe_branch="v13.29.0"
		)
