...
def FOF_track_pic(product,start_date,end_date,prv_alter_date):
    ...
    def prv_fund_attr_resoning(jjdm_list,last_month,last_week,end_date,core_pool):
        ...
        return [summary.drop(['基金池月收益贡献','BMK月收益贡献','基金池周收益贡献'],axis=1),barra_exp,barra_ret,\
            ...
            summary_style.drop(['基金池月收益贡献','BMK月收益贡献','基金池周收益贡献'],axis=1),barra_exp_style,barra_ret_style]
    ...
    mutual_funds_alert=pd.read_excel(r"E:\GitFolder\docs\基金池跟踪\公募基金跟踪池.xlsx",sheet_name='个基预警',header=17)
    ...
    mutual_funds_alert.loc[mutual_funds_alert['基金名称'].isnull(),'最大回撤']='基金已经被移除核心池，请经理尽快调整'
    ...
    prv_total_w=prv_core_pool['权重'].sum()
    prv_core_pool['权重']=\
        prv_core_pool['权重']/prv_total_w

    jjdm_list=\
        prv_core_pool[prv_core_pool['基金代码'].notnull()]['基金代码'].unique().tolist()

    prv_attr_list=prv_fund_attr_resoning(jjdm_list,util._shift_date(util.str_date_shift(str(end_date),91,'-'))
    ...
    print('')
    import xlwings as xw
    filename=r"E:\GitFolder\docs\基金池跟踪\FOF跟踪表\大类配置FOF跟踪表.xlsx"
    app = xw.App(visible=False)
    wb =app.books.open(filename)
...
if __name__ == '__main__':
    ...
    # FOF_track_pic('大类配置', '20230525', '20230825','20231229')
    # cta_track('20231229',r"E:\GitFolder\docs\To虚怀\业绩统计(fof&池）\基金池\数据源\基金池202312\量化基金池202312.xlsx")
    ...
    prv_pool_picture(latest_date='20240202',style_date='20231231',latest_HB1001_spjg=1940.48347653)
    ...
    #mutual_pool_picture('公募核心池','20230630', '20230831', '20240201',fool_version=True)
    #mutual_pool_picture('公募30池偏股基金', '20230630', '20230831', '20240201',fool_version=True)
    # mutual_pool_picture('公募机构池', '20230630', '20230831', '20240201',fool_version=True)
    # mutual_pool_picture('牛基宝进取型', '20230630', '20230831', '20240201',fool_version=True,if_portfolio=True)
    #mutual_pool_picture('牛基宝全股型', '20230630', '20230831', '20240201',fool_version=True,if_portfolio=True)
