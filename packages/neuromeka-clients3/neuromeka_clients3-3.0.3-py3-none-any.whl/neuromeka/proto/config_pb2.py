...
_CONFIG = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='Nrmk.IndyFramework.Config.SetFTsensorFrame',
    index=4,
    containing_service=None,
    input_type=config__msgs__pb2._FTSENSORFRAME,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    full_name='Nrmk.IndyFramework.Config.GetFTsensorFrame',
    index=5,
    containing_service=None,
    input_type=common__msgs__pb2._RESPONSE,
    output_type=config__msgs__pb2._FTSENSORFRAME,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SetCollTuning',
    full_name='Nrmk.IndyFramework.Config.SetCollTuning',
    index=42,
    containing_service=None,
    input_type=config__msgs__pb2._COLLTUNINGCONFIG,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
