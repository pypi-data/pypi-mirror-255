...
def generate_video(img, interrogators=None, interrogators_data=None, name="test", nx=32, dt=0.01, c=None, verbose=False):
    """
    ...
    for i in tqdm(range(len(img))):
        if interrogators:
            ...
            fig, ax = plt.subplots(1, 1, figsize=(5, 5), gridspec_kw={'width_ratios': [1, 1]})
            if c != None:
