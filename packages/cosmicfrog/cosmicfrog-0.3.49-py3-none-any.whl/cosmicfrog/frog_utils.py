...
HYPNOTOAD_URL = os.getenv("HYPNOTOAD_URL") or "https://api.cosmicfrog.optilogic.app/hypnotoad/cosmicfrog/v0.2"
...
class FrogUtils:
    ...
    @staticmethod
    def geocode_table(model_name: str, table_name: str, app_key: str, geoprovider: str = "MapBox", geoapikey: str = None, ignore_low_confidence: bool = True):
        """
