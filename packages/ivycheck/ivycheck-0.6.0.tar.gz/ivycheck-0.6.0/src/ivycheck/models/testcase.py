...
class TestCase:
    ...
    input: Optional[TestCaseInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('input') }})
    ...
    segments: Optional[TestCaseSegments] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('segments') }})
    info: Optional[TestCaseInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('info') }})
