...
downloadParams = [
    ...
    DownloadParams(
        display_name="nof0-tsu_e1500.pt",
        url="https://huggingface.co/wok000/vcclient_model/resolve/main/easy-vc/nof0-tsu_e1500.pt",
        saveTo="./models/pretrained/easy-vc/nof0-tsu_e1500.pt",
        hash="ef3a84f26e4fe616bc9adf849b2e86b6117f865e3278473f77feec75550c344b",
    ),
]
...
def run_server(
    ...
    c.register_functions(
        [
            ...
            JsonApiFunc("onnx_download", "download", "onnx_download", "GET", "/onnx_download", functools.partial(onnx_download, ipython=ipython, display=display)),
            # JsonApiFunc("onnx_download", "download", "onnx_download", "GET", "/onnx_download", functools.partial(onnx_download, ipython=ipython)),
        ]
    )
    ...
    c.mount_static_folder("/front2", static_files_path)
