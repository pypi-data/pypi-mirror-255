...
def setup(app):
    ...
    app.add_event('format-evas-target-add-sub')
    app.connect('format-evas-target-add-sub', sub.add_sub)
...
class StringSubstituter:
    """ Allows for string substitution of target related strings
        ...
        Provides, and listens to the `format-evas-target-add-sub`-event, which can be used to add custom substitutions
    ...
    TOOLCHAIN_PREFIX = {'esp8266': 'xtensa-lx106-elf',
                        ...
                        'esp32c3': 'riscv32-evas-elf',
                        'esp32h2': 'riscv32-evas-elf',
                        'esp32c2': 'riscv32-evas-elf',
                        'esp32c5': 'riscv32-evas-elf',
                        'esp32c6': 'riscv32-evas-elf',
                        'esp32p4': 'riscv32-evas-elf'
                        }
