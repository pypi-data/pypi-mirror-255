...
evas_docs_dir = os.path.abspath(os.path.dirname(__file__))
...
extensions = ['breathe',
              ...
              'evas_docs.generic_extensions.html_redirects',
              'evas_docs.generic_extensions.toctree_filter',
              'evas_docs.generic_extensions.list_filter',
              'evas_docs.generic_extensions.google_analytics',
              'evas_docs.generic_extensions.add_warnings',

              'evas_docs.evas_extensions.format_evas_target',
              'evas_docs.evas_extensions.include_build_file',
              'evas_docs.evas_extensions.latex_builder',
              'evas_docs.evas_extensions.link_roles',
              'evas_docs.evas_extensions.exclude_docs',
...
# context used by sphinx_rtd_theme
html_context = {
...
latest_branch_name = os.environ.get('EVAS_DOCS_LATEST_BRANCH_NAME', 'master')
...
latex_template_dir = os.path.join(evas_docs_dir, 'latex_templates')
...
# the title page.
latex_logo = os.path.join(evas_docs_dir, '_static', 'evas-logo.pdf')
...
def setup(app):
    ...
    app.add_config_value('latex_template_dir', os.path.join(evas_docs_dir, 'latex_templates'), 'env')

    app.config.breathe_projects = {'evas-docs': os.path.join(app.config.build_dir, 'xml_in/')}
    app.config.breathe_default_project = 'evas-docs'
...
def setup_html(app, config):
    ...
    evas_docs_static_path = os.path.join(config.config_dir, '_static')
    app.config.html_static_path.append(evas_docs_static_path)

    # The name of an image file (relative to this directory) to place at the top
    # of the sidebar.
    app.config.html_logo = os.path.join(evas_docs_static_path, 'evas-logo.svg')
