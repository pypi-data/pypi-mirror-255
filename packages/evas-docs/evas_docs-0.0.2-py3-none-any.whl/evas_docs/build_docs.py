...
#
# Copyright 2024 EVAS Intelligence Co., Ltd
#
...
# https://github.com/espressif/evas-idf/tree/
# https://github.com/espressif/evas-idf/blob/
# https://github.com/espressif/evas-idf/raw/
GH_LINK_RE = r'https://github.com/espressif/evas-idf/(?:tree|blob|raw)/[^\s]+'

# we allow this one doc, because we always want users to see the latest support policy
GH_LINK_ALLOWED = ['https://github.com/espressif/evas-idf/blob/master/SUPPORT_POLICY.md',
                   'https://github.com/espressif/evas-idf/blob/master/SUPPORT_POLICY_CN.md']
