...
class Dna(PhysicalEntity) :
    ...
    Class Dna 
      ...
      monophosphates; a deoxyribonucleic acid. Usage: DNA should be used for pools of
      individual DNA molecules. For describing subregions on those molecules use
      DNARegion. Examples: a chromosome, a plasmid. A specific example is chromosome 7
      of Homo sapiens.
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.rdf_type="http://www.biopax.org/release/biopax-level3.owl#Dna"
...
##########setter
    ...
    @validator(value='biopax.EntityReference')  
