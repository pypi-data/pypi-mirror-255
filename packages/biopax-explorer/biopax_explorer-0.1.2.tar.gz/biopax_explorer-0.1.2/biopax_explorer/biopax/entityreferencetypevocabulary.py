...
class EntityReferenceTypeVocabulary(ControlledVocabulary) :
    ...
    Class EntityReferenceTypeVocabulary 
      ...
      the writing of this documentation, there is no standard ontology of these terms,
      though a common type is ‘homology’.
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.rdf_type="http://www.biopax.org/release/biopax-level3.owl#EntityReferenceTypeVocabulary"
