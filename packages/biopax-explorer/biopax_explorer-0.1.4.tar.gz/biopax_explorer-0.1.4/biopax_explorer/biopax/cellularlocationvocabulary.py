...
class CellularLocationVocabulary(ControlledVocabulary) :
    ...
    Class CellularLocationVocabulary 
              ...
              Definition: A reference to the Gene Ontology Cellular Component (GO CC)
      ontology. Homepage at http://www.geneontology.org.  Browse at
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.rdf_type="http://www.biopax.org/release/biopax-level3.owl#CellularLocationVocabulary"
