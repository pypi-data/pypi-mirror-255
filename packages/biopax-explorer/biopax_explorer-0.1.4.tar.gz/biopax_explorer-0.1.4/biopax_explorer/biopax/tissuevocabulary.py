...
class TissueVocabulary(ControlledVocabulary) :
    ...
    Class TissueVocabulary 
              ...
              Definition: A reference to the BRENDA (BTO). Homepage at http://www.brenda-
      enzymes.info/.  Browse at http://www.ebi.ac.uk/ontology-
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.rdf_type="http://www.biopax.org/release/biopax-level3.owl#TissueVocabulary"
