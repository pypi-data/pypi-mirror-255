...
class MultiPeriodEnv(Environment, ABC):
    def __init__(self,
        ...
        print("average demand:", self.avg_demand)
        ...
        self.holding_cost = self.convert_to_numpy_array(holding_cost)
        ...
        self.lead_time = self.convert_to_numpy_array(lead_time)
        self.lead_time_variance = self.convert_to_numpy_array(lead_time)
