...
class DeviceConfigs(object):
    ...
    async def get(self, provider_uuid, region_uuid, id, **kwargs):
        ...
        return DeviceConfig(self.proximl, **resp)
    ...
    async def list(self, provider_uuid, region_uuid, **kwargs):
        ...
        device_configs = [
            DeviceConfig(self.proximl, **device_config)
    ...
    async def create(
        ...
        **kwargs,
        ...
        if not data.get("model_project_uuid"):
            data["model_project_uuid"] = self.proximl.active_project
        ...
        device_config = DeviceConfig(self.proximl, **resp)
        logging.info(
...
class DeviceConfig:
    ...
    def __repr__(self):
        return f"DeviceConfig( proximl , **{self._device_config.__repr__()})"
