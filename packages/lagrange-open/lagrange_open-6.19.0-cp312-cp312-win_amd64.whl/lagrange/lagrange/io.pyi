...
class LoadOptions:
    ...
    @property
    def load_object_id(self) -> bool:
        ...
    @load_object_id.setter
    def load_object_id(self, arg: bool, /) -> None:
        ...
...
def load_scene(*args, **kwargs):
    """
    load_scene(filename: os.PathLike, options: lagrange.io.LoadOptions = <lagrange.io.LoadOptions object at 0x00000203D113C7B0>) -> lagrange.scene.Scene
...
def save_scene(*args, **kwargs):
    """
    save_scene(filename: os.PathLike, scene: lagrange.scene.Scene, options: lagrange.io.SaveOptions = <lagrange.io.SaveOptions object at 0x00000203D1139230>) -> None
