...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'etrc.atyp': {},
            ...
            'etrc.enum': { 'etrc.enum.CatOrder': ('enum.html#catorder', 'etrc/enum.py'),
                           ...
                           'etrc.enum.DimChars': ('enum.html#dimchars', 'etrc/enum.py'),
                           'etrc.enum.DimName': ('enum.html#dimname', 'etrc/enum.py'),
                           'etrc.enum.DimName.get': ('enum.html#dimname.get', 'etrc/enum.py'),
                           'etrc.enum.DimType': ('enum.html#dimtype', 'etrc/enum.py'),
