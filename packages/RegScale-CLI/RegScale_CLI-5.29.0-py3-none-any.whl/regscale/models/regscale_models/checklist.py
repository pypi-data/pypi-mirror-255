...
class Checklist(RegScaleModel):
    ...
    @classmethod
    def get_checklists_by_asset(
        cls, api: Api, asset_id: int  # noqa
    ) -> list["Checklist"]:
        """
    ...
    @staticmethod
    def get_checklists(parent_id: int, parent_module: str = "components") -> list[Any]:
        """
        Return all checklists for a given RegScale parent id and parent module
