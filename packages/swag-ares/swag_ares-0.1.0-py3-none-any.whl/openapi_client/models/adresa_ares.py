...
class AdresaAres(BaseModel):
    ...
    platnost_do: Optional[date] = Field(default=None, description="Platnost údaje od data", alias="platnostDo")
    __properties: ClassVar[List[str]] = ["sidlo", "primarniZaznam", "platnostOd", "platnostDo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdresaAres from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdresaAres from a dict"""
        if obj is None:
            return None
