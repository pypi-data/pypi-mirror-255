...
class EkonomickySubjektRzpAdresa(BaseModel):
    """
    ...
    typ_adresy: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="Typ adresy  - kód (ciselnikKod: TypAdresy, zdroj: rzp) ", alias="typAdresy")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EkonomickySubjektRzpAdresa from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EkonomickySubjektRzpAdresa from a dict"""
        if obj is None:
            return None
