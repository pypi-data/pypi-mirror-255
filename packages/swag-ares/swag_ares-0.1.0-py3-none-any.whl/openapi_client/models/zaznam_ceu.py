...
class ZaznamCeu(BaseModel):
    ...
    typ_subjektu: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="Typ subjektu  (ciselnikKod: TypSubjektu, zdroj: Ceu) ", alias="typSubjektu")
    adresy: Optional[List[AdresaCeu]] = None
    jmeno_prijmeni: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Jméno, příjmení fyzické osoby", alias="jmenoPrijmeni")
    upadek: Optional[List[UpadekCeuVerejny]] = None
    __properties: ClassVar[List[str]] = ["ico", "obchodniJmeno", "sidlo", "pravniForma", "financniUrad", "datumVzniku", "datumZaniku", "datumAktualizace", "dic", "typSubjektu", "adresy", "jmenoPrijmeni", "upadek"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ZaznamCeu from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.adresy:
            ...
            _dict['adresy'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in upadek (list)
        _items = []
        if self.upadek:
            for _item in self.upadek:
                if _item:
                    _items.append(_item.to_dict())
            _dict['upadek'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ZaznamCeu from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "adresy": [AdresaCeu.from_dict(_item) for _item in obj["adresy"]] if obj.get("adresy") is not None else None,
            "jmenoPrijmeni": obj.get("jmenoPrijmeni"),
            "upadek": [UpadekCeuVerejny.from_dict(_item) for _item in obj["upadek"]] if obj.get("upadek") is not None else None
        })
        return _obj
