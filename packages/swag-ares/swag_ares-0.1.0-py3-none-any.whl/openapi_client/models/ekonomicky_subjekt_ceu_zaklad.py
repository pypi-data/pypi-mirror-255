...
class EkonomickySubjektCeuZaklad(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ico", "obchodniJmeno", "sidlo", "pravniForma", "financniUrad", "datumVzniku", "datumZaniku", "datumAktualizace", "dic", "typSubjektu", "adresy", "jmenoPrijmeni"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EkonomickySubjektCeuZaklad from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EkonomickySubjektCeuZaklad from a dict"""
        if obj is None:
            return None
