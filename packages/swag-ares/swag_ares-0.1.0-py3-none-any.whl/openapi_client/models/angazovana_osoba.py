...
class AngazovanaOsoba(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["jmeno", "prijmeni", "titulPredJmenem", "titulZaJmenem", "datumNarozeni"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AngazovanaOsoba from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AngazovanaOsoba from a dict"""
        if obj is None:
            return None
