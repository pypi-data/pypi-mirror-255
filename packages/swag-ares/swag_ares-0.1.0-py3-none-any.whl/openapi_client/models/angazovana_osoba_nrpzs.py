...
class AngazovanaOsobaNrpzs(BaseModel):
    """
    ...
    typ_angazma: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="Typ angažmá osoby  - kód (ciselnikKod: TypAngazma, zdroj: nrpzs) ", alias="typAngazma")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AngazovanaOsobaNrpzs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AngazovanaOsobaNrpzs from a dict"""
        if obj is None:
            return None
