...
class TestZaznamRes(unittest.TestCase):
    """ZaznamRes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZaznamRes:
        """Test ZaznamRes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZaznamRes`
        """
        model = ZaznamRes()
        if include_optional:
            return ZaznamRes(
                ...
                dic = '',
                pravni_forma_ros = '048012',
                cz_nace = [
                    '0'
                    ],
                doplnkove_pravni_formy = [
                    '048012'
                    ],
                statisticke_udaje = openapi_client.models.statisticke_udaje.StatistickeUdaje(
                    institucionalni_sektor2010 = '0480701234', 
                    kategorie_poctu_pracovniku = '048012', ),
                zakladni_uzemni_jednotka = '048072012345',
