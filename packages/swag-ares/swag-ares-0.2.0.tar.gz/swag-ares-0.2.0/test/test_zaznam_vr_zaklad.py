...
class TestZaznamVrZaklad(unittest.TestCase):
    """ZaznamVrZaklad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZaznamVrZaklad:
        """Test ZaznamVrZaklad
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZaznamVrZaklad`
        """
        model = ZaznamVrZaklad()
        if include_optional:
            return ZaznamVrZaklad(
                akcie = [
