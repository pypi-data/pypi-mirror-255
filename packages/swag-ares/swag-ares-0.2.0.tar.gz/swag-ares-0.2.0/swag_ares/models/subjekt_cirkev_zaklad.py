...
class SubjektCirkevZaklad(BaseModel):
    """
    SubjektCirkevZaklad
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["datumRegistracePrav", "cisloRegistracePrav", "icoNastupce", "datumZruseniRegistracePrav", "pravoZvlastni", "cisloZruseniRegistracePrav"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubjektCirkevZaklad from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubjektCirkevZaklad from a dict"""
        if obj is None:
            return None
