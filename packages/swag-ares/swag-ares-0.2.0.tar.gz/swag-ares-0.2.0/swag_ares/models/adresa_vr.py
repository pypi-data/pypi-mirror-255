...
class AdresaVr(BaseModel):
    ...
    typ_adresy: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="Typ typu adresy - kód (ciselnikKod: TypAdresy, zdroj:vr) ", alias="typAdresy")
    __properties: ClassVar[List[str]] = ["datumZapisu", "datumVymazu", "adresa", "typAdresy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdresaVr from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdresaVr from a dict"""
        if obj is None:
            return None
