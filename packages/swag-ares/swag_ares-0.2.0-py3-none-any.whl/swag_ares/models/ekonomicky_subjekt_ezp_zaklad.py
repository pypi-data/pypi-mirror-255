...
class EkonomickySubjektEzpZaklad(BaseModel):
    """
    ...
    odkaz: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="URL odkaz na záznam zdrojového IS.")
    __properties: ClassVar[List[str]] = ["ico", "obchodniJmeno", "sidlo", "pravniForma", "financniUrad", "datumVzniku", "datumZaniku", "datumAktualizace", "dic", "odkaz"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EkonomickySubjektEzpZaklad from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EkonomickySubjektEzpZaklad from a dict"""
        if obj is None:
            return None
