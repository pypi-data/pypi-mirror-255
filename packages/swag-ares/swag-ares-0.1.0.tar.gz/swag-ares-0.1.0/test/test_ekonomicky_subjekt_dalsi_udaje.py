...
class TestEkonomickySubjektDalsiUdaje(unittest.TestCase):
    """EkonomickySubjektDalsiUdaje unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EkonomickySubjektDalsiUdaje:
        """Test EkonomickySubjektDalsiUdaje
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EkonomickySubjektDalsiUdaje`
        """
        model = EkonomickySubjektDalsiUdaje()
        if include_optional:
            return EkonomickySubjektDalsiUdaje(
                obchodni_jmeno = [
    ...
    def testEkonomickySubjektDalsiUdaje(self):
        """Test EkonomickySubjektDalsiUdaje"""
