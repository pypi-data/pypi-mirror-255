...
class TestAdresaAres(unittest.TestCase):
    """AdresaAres unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdresaAres:
        """Test AdresaAres
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdresaAres`
        """
        model = AdresaAres()
        if include_optional:
            return AdresaAres(
