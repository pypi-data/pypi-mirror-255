...
class TestZaznamCeu(unittest.TestCase):
    """ZaznamCeu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZaznamCeu:
        """Test ZaznamCeu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZaznamCeu`
        """
        model = ZaznamCeu()
        if include_optional:
            return ZaznamCeu(
                ...
                jmeno_prijmeni = '',
                upadek = [
                    openapi_client.models.upadek_ceu_verejny.UpadekCeuVerejny()
                    ]
            )
        else:
            return ZaznamCeu(
