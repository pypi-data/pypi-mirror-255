...
class TestAdresaRcns(unittest.TestCase):
    """AdresaRcns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdresaRcns:
        """Test AdresaRcns
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdresaRcns`
        """
        model = AdresaRcns()
        if include_optional:
            return AdresaRcns(
