...
class TestZaznamRcnsZaklad(unittest.TestCase):
    """ZaznamRcnsZaklad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZaznamRcnsZaklad:
        """Test ZaznamRcnsZaklad
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZaznamRcnsZaklad`
        """
        model = ZaznamRcnsZaklad()
        if include_optional:
            return ZaznamRcnsZaklad(
