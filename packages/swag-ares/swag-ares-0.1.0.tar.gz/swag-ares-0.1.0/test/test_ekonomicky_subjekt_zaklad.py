...
class TestEkonomickySubjektZaklad(unittest.TestCase):
    """EkonomickySubjektZaklad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EkonomickySubjektZaklad:
        """Test EkonomickySubjektZaklad
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EkonomickySubjektZaklad`
        """
        model = EkonomickySubjektZaklad()
        if include_optional:
            return EkonomickySubjektZaklad(
    ...
    def testEkonomickySubjektZaklad(self):
        """Test EkonomickySubjektZaklad"""
