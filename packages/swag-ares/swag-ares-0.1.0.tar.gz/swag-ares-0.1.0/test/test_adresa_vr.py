...
class TestAdresaVr(unittest.TestCase):
    """AdresaVr unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdresaVr:
        """Test AdresaVr
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdresaVr`
        """
        model = AdresaVr()
        if include_optional:
            return AdresaVr(
