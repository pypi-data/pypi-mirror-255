...
class MPI:
	...
	def run(self,*args,**kwargs):
		...
		return xme.gfun(status,xme.Array(tpids),xme.Array(Task_Connector),garg=args,gargs=kwargs)[0][0]
	...
	def acquire(self, status, connets, funid, args=(), kwargs={}, to=ANY_PROCESS,block=False):
