...
class RecommendDrops:
    """
                @class: Drop Recommendation
                @createdBy: Meet Sheth
                @createdDate: 03/13/2020
                @lastModifiedBy: Meet Sheth
                @lastModifiedDate: -
                @type: file
                @desc: logical class for Optimised Drop Recommendation
            """
    ...
    def get_pack_fill_analysis(self):
        try:
            ...
            # self.quadrant_drugs = {1: {'drugs': {'710930132##13318'}, 'combinations': [['009046751##16995'], ['605053140##41027', '710930132##13318'], ['317220537##44633'], ['605053140##41027', '317220537##44633', '009046751##16995', '710930132##13318'], ['317220537##44633', '009046751##16995'], ['009046751##16995', '710930132##13318'], ['317220537##44633', '605053140##41027'], ['317220537##44633', '710930132##13318'], ['710930132##13318'], ['317220537##44633', '605053140##41027', '009046751##16995'], ['317220537##44633', '605053140##41027', '710930132##13318'], ['605053140##41027', '009046751##16995', '710930132##13318'], ['605053140##41027'], ['605053140##41027', '317220537##44633', '009046751##16995']], 'slots': 0}, 2: {'drugs': {'317220537##44633'}, 'combinations': [['009046751##16995'], ['605053140##41027', '710930132##13318'], ['317220537##44633'], ['605053140##41027', '317220537##44633', '009046751##16995', '710930132##13318'], ['317220537##44633', '009046751##16995'], ['009046751##16995', '710930132##13318'], ['317220537##44633', '605053140##41027'], ['317220537##44633', '710930132##13318'], ['710930132##13318'], ['317220537##44633', '605053140##41027', '009046751##16995'], ['317220537##44633', '605053140##41027', '710930132##13318'], ['605053140##41027', '009046751##16995', '710930132##13318'], ['605053140##41027'], ['605053140##41027', '317220537##44633', '009046751##16995']], 'slots': 0}, 3: {'drugs': {'605053140##41027'}, 'combinations': [['009046751##16995'], ['605053140##41027', '710930132##13318'], ['317220537##44633'], ['605053140##41027', '317220537##44633', '009046751##16995', '710930132##13318'], ['317220537##44633', '009046751##16995'], ['009046751##16995', '710930132##13318'], ['317220537##44633', '605053140##41027'], ['317220537##44633', '710930132##13318'], ['710930132##13318'], ['317220537##44633', '605053140##41027', '009046751##16995'], ['317220537##44633', '605053140##41027', '710930132##13318'], ['605053140##41027', '009046751##16995', '710930132##13318'], ['605053140##41027'], ['605053140##41027', '317220537##44633', '009046751##16995']], 'slots': 0}, 4: {'drugs': {'009046751##16995'}, 'combinations': [['009046751##16995'], ['605053140##41027', '710930132##13318'], ['317220537##44633'], ['605053140##41027', '317220537##44633', '009046751##16995', '710930132##13318'], ['317220537##44633', '009046751##16995'], ['009046751##16995', '710930132##13318'], ['317220537##44633', '605053140##41027'], ['317220537##44633', '710930132##13318'], ['710930132##13318'], ['317220537##44633', '605053140##41027', '009046751##16995'], ['317220537##44633', '605053140##41027', '710930132##13318'], ['605053140##41027', '009046751##16995', '710930132##13318'], ['605053140##41027'], ['605053140##41027', '317220537##44633', '009046751##16995']], 'slots': 0}}
            ...
            pack_to_set_id_dict = {}
            logger.info("get_pack_fill_analysis pack_slot_drug analysis")
            ...
            matrix_pattern_data = {}
            logger.info("get_pack_fill_analysis pack_slot_drug {}".format(self.pack_slot_drug))
            column, row = get_total_column_and_row_from_pack_grid(column=True, row=True)
            for pack, slot_drugs in self.pack_slot_drug.items():
                self.node_limit = settings.NODE_LIMIT
                ...
                if len(similar_pack_set_dict[pack_to_set_id_dict[pack]] & set(self.pack_slot_drop_info_dict.keys())):
                    processed_packs = similar_pack_set_dict[pack_to_set_id_dict[pack]] & set(self.pack_slot_drop_info_dict.keys())
                ...
                for slot,quad in self.slot_quadrant_data.items():
                    if type(quad) != tuple:
                        total_included_quads.update(quad)
                ...
                if max(self.slot_quadrant_data) - min(self.slot_quadrant_data) == 20 and len(self.slot_quadrant_data) == 14:
                    self.node_limit = 10
                ...
                if len(self.leaf_node_dict) == 0:
                    ...
                    # one extra arg slot_drugs is given to the below function as part of solution of bug
                    # complete description of bug is provided inside of the below function
                    ...
                    for id,pack_data in self.leaf_node_dict.items():
                        ...
                        self.final_slot_group_independent_quad_slots = self.get_drop_data_for_independent_quad_slots(
                            slot_gruop_defined=deepcopy(pack_data['pattern_slot_group_dict']), slot_group_address=deepcopy(pack_data['pattern_slot_group_address']), address_to_slots=deepcopy(pack_data['add_to_slots']))
                        self.final_slot_group_multiple_quad_slots = self.get_drop_data_for_multiple_quad_slots()
                        self.edge_slots = self.get_edge_slot_drops()
                        self.drop_slots_dict, self.slot_drop_id_dict, drops = self.get_final_drop_details()
                        # one extra arg slot_drugs is given to the below function as part of solution of bug
                        ...
                        if len(drops) < min_drops:
                            ...
                            self.drops = drops
                            final_matrix = self.pack_mat_final
                        if node_count == self.node_limit or len(drops) <= math.ceil(len(self.slot_drop_id_dict)/len(total_included_quads)):
                            break
                pack_wise_time[pack] = {'drops': self.drops, 'time_in_sec.': len(self.drops) * 10}
                logger.info("get_pack_fill_analysis pack wise time {}".format(pack_wise_time))
                total_time += pack_wise_time[pack]['time_in_sec.']
                self.pack_origin_final_matrix[pack]['final'] = final_matrix
            logger.info(
                "Output of get_pack_fill_analysis self.pack_slot_drop_info_dict {} and pack_slot_drug_config_id_dict {} and self.pack_slot_drug_quad_id_dict {}".format(
                    self.pack_slot_drop_info_dict,
                    self.pack_slot_drug_config_id_dict,
                    self.pack_slot_drug_quad_id_dict))

            return pack_wise_time, total_time, self.pack_slot_drop_info_dict, self.pack_slot_drug_config_id_dict, \
                   self.pack_slot_drug_quad_id_dict,self.unique_matrix_list,self.unique_matrix_data_list
        except Exception as e:
            logger.error("Error in get_pack_fill_analysis {}".format(e))
            raise
        ...
        for pattern in slot_group_address.keys():
            ...
            if type(pattern) == str:
                if '_' in pattern:
                    ...
                    add_pattern_dict = self.find_quad_with_best_match(ptrn_list,slot_group_address,address_to_slots,pattern)
            ...
            for add in pattern_slot_groups:
                ...
                for pattern2 in slot_group_address.keys():
                    ...
                    Pattern2 should be subset of remaining quadrants
                    """
                    is_valid_match,pattern2_array = self.find_subset_in_oring_of_slots(pattern2_array, remaining_pattern,pattern2)
                    if not is_valid_match:
                        continue
                    # if not pattern2_array.issubset(remaining_pattern):
                    #     continue
                    ...
                    if min_distance_slot not in slot_group_address_copy[pattern2_array]:
                        slot_group_address_copy[pattern2_array].append(min_distance_slot)
                        slot_gruop_defined_copy[pattern2_array].append({self.pack_slot_id_mat[min_distance_slot[0][0]][min_distance_slot[0][1]]})
    ...
    def get_drop_data_for_independent_quad_slots(self, slot_gruop_defined, slot_group_address, address_to_slots):
        ...
        try:
            pattern2_array = []
            done_slots = []
            slot_gruop_defined, slot_group_address, address_to_slots = self.modify_group_dicts(slot_gruop_defined, slot_group_address, address_to_slots)
            for slots in slot_gruop_defined.values():
                for grp in slots:
                    self.reserved_slots.update(grp)

            slot_group_address,slot_gruop_defined,address_to_slots = self.finalize_group_dicts(slot_gruop_defined, slot_group_address, address_to_slots)
            final_slot_group = []
            selected_count = 0
                ...
                for add in pattern_slot_groups:
                    ...
                    for pattern2 in slot_group_address.keys():
                        ...
                        if add in slot_group_address[pattern]:
                            slot_group_address[pattern].remove(add)
                        if type(pattern) == str:
                            self.selected_slot_quadrant[next(iter(address_to_slots[add[0]]))] = int(pattern) if type(pattern) == str else pattern
                        ...
                        for i in range(len(pattern2_array)):
                            for slot in slot_gruop_defined[pattern2_array][selected_count]:
                                if int(slot) in done_slots:
                                    continue
                                # self.selected_slot_quadrant[self.pack_slot_id_mat[min_distance_slot[0][0]][min_distance_slot[0][1]]] = int(pattern2_array) if type(pattern2_array) == str else pattern2_array
                                # self.pack_mat_final[min_distance_slot[0][0]][min_distance_slot[0][1]] = int(pattern2_array) if type(pattern2_array) == str else pattern2_array
                                self.selected_slot_quadrant[int(slot)] = int(pattern2_array) if type(pattern2_array) == str else pattern2_array[i]
                                self.pack_mat_final[slot_group_address[pattern2_array][selected_count][i][0]][slot_group_address[pattern2_array][selected_count][i][1]] = int(pattern2_array) if type(pattern2_array) == str else pattern2_array[i]
                    ...
                    for slot in group_set:
                        if slot not in self.selected_slot_quadrant and len(group_set) == 1:
                            ...
                            self.pack_mat_final[add[0][0]][add[0][1]] = int(pattern) if type(pattern) == str else pattern
            return final_slot_group
        except Exception as e:
            print("Error in get_drop_data_for_independent_quad_slots")
            print(e)
    ...
    def get_drop_data_for_multiple_quad_slots(self):
        ...
        self.slot_quads = {}
        indep_quad_slots = defaultdict(set)
        ...
        for slot_grp in self.final_slot_group_independent_quad_slots:
            ...
            if len(slot_grp) == 2:
                for slot in slot_grp:
                    quads.add(int(self.pack_mat_final[self.pack_slot_id_mat == slot]))
                    indep_resvered.add(slot)
                    # self.slot_quads[slot] = {int(self.pack_mat_final[self.pack_slot_id_mat == slot])}
                quads_list = list(quads)
                quads_list.sort()
                all_slot_quadrants.append(quads)
                indep_quad_slots[tuple(quads_list)].add(tuple(slot_grp))
        ...
        try:
            ...
            for i in range(row):
                for j in range(column):
                    ...
                    if type(self.pack_mat_final[i][j]) == set:
                        ...
                        if self.pack_slot_id_mat[i][j] not in indep_resvered:
            ...
            for slot, quads in self.slot_quads.items():
                ...
                for slot_tpl in quads:
                    slot_set = set(quads) if type(slot_tpl) == int else set(slot_tpl)
                    # rem_quad = tuple(total_quadrants - slot_set)
                    rem_quad = total_quadrants - slot_set
                    group_set.add(slot)
                    if rem_quad in all_slot_quadrants:
                        rem_quad_list = list(rem_quad)
                        rem_quad_list.sort()
                        rem_quad_list = tuple(rem_quad_list)
                        if rem_quad_list in indep_quad_slots:
                            slt = indep_quad_slots[rem_quad_list].pop()
                            slt_set = set(slt)
                            group_set.update(slt_set)
                            reserved_slot_multiple.update(slt_set)
                            self.final_slot_group_independent_quad_slots.remove(slt_set)
                            if len(indep_quad_slots[rem_quad_list]) == 0:
                                del indep_quad_slots[rem_quad_list]
                        else:
                            for slt in self.quad_slots[tuple(rem_quad) if len(rem_quad) > 1 else next(iter(rem_quad))]:
                                ...
                                self.selected_slot_quadrant[slt] = rem_quad
                                self.pack_mat_final[self.pack_slot_id_mat == int(slot)] = {slot_tpl}
                                self.pack_mat_final[self.pack_slot_id_mat == int(slt)] = {tuple(rem_quad)} if len(rem_quad) > 1 else next(iter(rem_quad))
                ...
                if slot not in self.selected_slot_quadrant:
                    self.selected_slot_quadrant[slot] = quads[0] if quads and len(quads) else None
                final_slot_group_multiple_quad_slots.append(group_set)
                group_set = set()
            return final_slot_group_multiple_quad_slots
        except Exception as e:
            print("Error in get_drop_data_for_multiple_quad_slots")
            print(e)
    ...
    def get_configuration_id_for_edge_slots(self, pack, slot_drugs):
        ...
        try:
            ...
            # edge_slot_group_wise_conf_mapping = {1: {1: 2, 4: 3}, 2: {1: 3, 2: 3, 4: 3}, 3: {1: 3, 2: 4}, 4: {2: 1, 3: 4},
            #                                      5: {1: 4, 2: 4, 3: 4}}
            ...
            for slot in self.edge_slots:
                ...
                """
                This change resolve the blocker bug of canister recommendation.
                bug: In some cases recommendation algorithm was not able to set the configuration of some drugs.
                     because of that in the further calculation can not find the configuration of that drug 
                     and whole recommendation got the error.
                reasons: In some cases we can get the multiple possible group of quadrant to fill one slots from the 
                         different quadrants.
                         example: > In the 7th slot of any pack there are total 3 drugs d1, d2, d3 in order. Canisters of 
                                    these drugs are allocated in the quadrants be like in 1st quadrant one canister of 
                                    d3 drug, in 2nd quadrant one canister of d1 drug and one canister of d3 drug and in
                                    the 3rd quadrant one canister of d1 drug and one canister of d2 drug available.
                                  > So according to this allocation of canisters we can fill the 7th slot of pack from 
                                    the (1st and 3rd) quadrants or from the (2nd and 3rd) quadrants.
                                  > We fetch both the group of quadrants and update the self.slot_quad_drugs dict according 
                                    to all the patterns.
                                  > While set the configuration of drugs we fetch the one pattern among all the pattern
                                    means in the above example from (1,3) and (2,3) we fetch only (1,3) group of quadrant.
                                  > Now self.slot_quad_drugs dict is updated according to the some other group of
                                    quadrant so we can not get the configuration of all the drugs in some times.
                solution: While fetch the group of quadrants we check that which group can be used to get the configuration
                          of all the drugs.
                """
                if len(quads) > 1:
                ...
                quads = next(iter(quads)) if quads and type(next(iter(quads))) != int else quads
    ...
    def find_possible_patterns_for_indepandent_quadrants(self):
        ...
        for pattern in settings.PATTERNS:
            try:
                ...
                print("Error in finding possible combinations")
                print(e)
    ...
    def get_slot_to_quad_mapping(self, slot, drugs):
        ...
        First we try to find if the slot can be filled from whole one quadrant, if yes then pick it otherwise go for multiple quadrant.
            ...
            for qd1 in settings.TOTAL_QUADRANTS:
                for qd2 in settings.TOTAL_QUADRANTS:
                    if len(self.quad_to_drugs_dict[qd] | self.quad_to_drugs_dict[qd1] | self.quad_to_drugs_dict[
                        ...
                        self.slot_quad_drugs[slot][qd1] = (self.quad_to_drugs_dict[qd] | self.quad_to_drugs_dict[qd1]) - \
            ...
            for qd1 in settings.TOTAL_QUADRANTS:
                for qd2 in settings.TOTAL_QUADRANTS:
                    for qd3 in settings.TOTAL_QUADRANTS:
                        if len(self.quad_to_drugs_dict[qd] | self.quad_to_drugs_dict[qd1] | self.quad_to_drugs_dict[qd2] |
                            ...
                            self.slot_quad_drugs[slot][qd2] = (self.quad_to_drugs_dict[qd] | self.quad_to_drugs_dict[
    ...
    def make_tree(self,box_id_to_connected_box_dict, box_id_slots_dict, graph_box_ids_dicts, box_id_add_dict, pattern,
                  pattern_dict, box_id_pattern_add_dict,box_id_add_quad,box_id_add_slots,reserved_address=[],leaf_node_dict={}):
        """
        ...
        if len(box_id_to_connected_box_dict) == 0:
            ...
            return leaf_node_dict['leaf_nodes'], leaf_node_dict['reserved_addresses_group_list'],leaf_node_dict['combination_wise_address'] ,leaf_node_dict["leaf_node_data_dict"]
        ...
        while not qu.isEmpty():
            ...
            if max_edge <= 1:
                ...
                for combination in final_nodes:
                    ...
                    leaf_node_data_dict[self.leaf_node_id] = {'pattern_slot_group_dict':pattern_slot_group_dict,'pattern_slot_group_address':pattern_slot_group_address,'add_quad_dict':add_quad_dict,'add_to_slots':add_to_slots}
    ...
    def find_possible_graph_for_pattern(self,pack_mat_final, pattern, pattern_dict, reserved_address=[] , leaf_node_dict={}):
        """
                ...
                for row in range(len(pack_mat_final)):
                    for col in range(len(pack_mat_final[row])):
                        ...
                        if col + 1 < (len(pack_mat_final[row])) and row + 1 < len(pack_mat_final):
                            if pattern_id == 1:
                                data_list.append(pack_mat_final[row][col])
                                if len({} if pack_mat_final[row][col] is None else pack_mat_final[row][col] & self.valid_slot_quadrant[self.pack_slot_id_mat[row][col]]) == 0 or \
                                    len({} if pack_mat_final[row][col+1] is None else pack_mat_final[row][col+1] & self.valid_slot_quadrant[self.pack_slot_id_mat[row][col+1]]) == 0:
                                    continue
                                slots.append(self.pack_slot_id_mat[row][col])
                                addr_list.append((row, col))
                                data_list.append(pack_mat_final[row][col + 1])
                                ...
                                addr_list.append((row, col + 1))
                            if pattern_id == 2:
                                if len({} if pack_mat_final[row+1][col+1] is None else pack_mat_final[row+1][col+1] & self.valid_slot_quadrant[self.pack_slot_id_mat[row+1][col+1]]) == 0 or \
                                    len({} if pack_mat_final[row+1][col] is None else pack_mat_final[row+1][col] & self.valid_slot_quadrant[self.pack_slot_id_mat[row+1][col]]) == 0:
                                    continue
                                data_list.append(pack_mat_final[row + 1][col + 1])
                                slots.append(self.pack_slot_id_mat[row + 1][col + 1])
                                addr_list.append((row + 1, col + 1))
                ...
                for row in range(len(pack_mat_final)):
                    for col in range(len(pack_mat_final[row])):
                        ...
                        if col + 1 < (len(pack_mat_final[row])) and row + 1 < len(pack_mat_final):
                            if pattern_id == 1:
                                if len({} if pack_mat_final[row][col] is None else pack_mat_final[row][col] & self.valid_slot_quadrant[self.pack_slot_id_mat[row][col]]) == 0 or \
                                    len({} if pack_mat_final[row+1][col+1] is None else pack_mat_final[row+1][col+1] & self.valid_slot_quadrant[self.pack_slot_id_mat[row+1][col+1]]) == 0:
                                    continue
                                data_list.append(pack_mat_final[row][col])
                                slots.append(self.pack_slot_id_mat[row][col])
                                addr_list.append((row, col))
                                ...
                                if len({} if pack_mat_final[row+1][col] is None else pack_mat_final[row+1][col] & self.valid_slot_quadrant[self.pack_slot_id_mat[row+1][col]]) == 0 or \
                                    len({} if pack_mat_final[row][col+1] is None else pack_mat_final[row][col+1] & self.valid_slot_quadrant[self.pack_slot_id_mat[row][col+1]]) == 0:
                                    continue
                                data_list.append(pack_mat_final[row][col + 1])
                                slots.append(self.pack_slot_id_mat[row][col + 1])
    ...
    def process_pattern(self, pack_mat,pattern, pattern_dict, reserved_addresses_group_list,leaf_node_dict):
        ...
        if len(reserved_addresses_group_list) == 0:
            ...
            leaf_nodes, reserved_group_with_addresses, combination_add_dict,leaf_node_data_dict = self.make_tree(box_id_to_connected_box_dict,
                                                                                        box_id_slots_dict,
                                                                                        graph_box_ids_dicts,
            ...
            # if settings.V3_TEST:
            #     self.make_test_data(box_id_add_dict, box_id_to_connected_box_dict, graph_box_ids_dicts, box_id_slots_dict, box_id_pattern_add_dict,box_id_add_quad,box_id_add_slots)
            leaf_node_dict[leaf_node_id] = {'leaf_node_list': leaf_nodes, 'box_add_dict': box_id_add_dict,
                                            'combination_wise_address': combination_add_dict,'leaf_node_data_dict':leaf_node_data_dict}
        else:
            for reserved_address in reserved_addresses_group_list:
                ...
                leaf_nodes, reserved_group_with_addresses, combination_add_dict,leaf_node_data_dict = self.make_tree(
                    ...
                    pattern_dict, box_id_pattern_add_dict,box_id_add_quad,box_id_add_slots, reserved_address=reserved_address,leaf_node_dict=leaf_node_dict[leaf_node_id])
                # leaf_node_id += 1
                # leaf_node_list.extend(leaf_nodes)
                # if settings.V3_TEST:
    ...
    def select_leaf_node_to_process(self,leaf_node_dict,pack_mat_copy):
        ...
        for id, leaf_node_data in leaf_node_dict.items():
            ...
            for node_id,leaf_node in leaf_node_data['leaf_node_data_dict'].items():
                ...
                combination_wise_address[tuple(leaf_node_to_process_list)] = leaf_node_data['combination_wise_address'][tuple(leaf_node_to_process_list)]
                leaf_node_dict_updated[core_id] = {'leaf_nodes':leaf_node_to_process_copy,'combination_wise_address':combination_wise_address,'reserved_addresses_group_list':reserved_addresses_group_list,'pattern_slot_group_dict':leaf_node_data['leaf_node_data_dict'][node_id]['pattern_slot_group_dict'],'pattern_slot_group_address':leaf_node_data['leaf_node_data_dict'][node_id]['pattern_slot_group_address'],'add_quad_dict':add_quad_dict,'add_to_slots':add_to_slots,'pack_mat':pack_mat_final,"leaf_node_data_dict":leaf_node_data_dict}
                if len(leaf_node_to_process) >= 10:
                    loop_break = 1
                    break
            if loop_break:
                break
    ...
    def get_pack_with_possible_pattern_for_independent_slots(self):
        """
        This function find out the possible pattern from pack matrix with all available quadrants.
        :return:
        """
        reserved_addresses_group_list = []
        pattern_data_dict = {}
        ...
        for pattern in settings.EVERY_PATTERN:
            '''
            Iterating loop on every possible pattern and find out all the available pattern from pack matrix
            '''
            leaf_node_dict = self.process_pattern(self.pack_mat,pattern, pattern_dict, reserved_addresses_group_list,leaf_node_dict_updated)
            if len(leaf_node_dict) > 0:
                reserved_addresses_group_list, leaf_node_to_process,leaf_node_dict_updated = self.select_leaf_node_to_process(leaf_node_dict,pack_mat_copy)
    ...
    def make_output_data_format(self,pack):
        ...
        for slot in self.total_slots:
            if slot in self.slot_drop_id_dict and slot in self.selected_slot_quadrant:
    ...
    def get_static_data_for_testing(self):
        ...
        self.pack_mat = [[None, None, None, None, None, None, None],
                         ...
                         [{(1,4),(2,3)}, {(2, 4)}, {(1,2,3)}, {(1,2,3),(2,3,4)}, {(2, 3, 4)}, {(1, 2, 3, 4)}, {(1,2)}],
