...
from .property import get_node_property_value_converted
...
def get_feed_content(model: str, cycle: dict = {}, inputs: list = [], prop: str = 'energyContentHigherHeatingValue'):
    return list_sum([
        get_node_property_value_converted(model, input, prop) for input in (inputs or get_feed_inputs(cycle))
    ])
