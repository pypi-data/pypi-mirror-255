...
class GeneralContact:
    ...
    @overload
    def GetSphereMarkerBased(self, localIndex: int, addData: bool) -> dict: ...
    @overload
    def SetSphereMarkerBased(self, localIndex: int, contactStiffness: float, contactDamping: float, radius: float, frictionMaterialIndex: int) -> None: ...
    @overload
    def GetTriangleRigidBodyBased(self, localIndex: int) -> dict: ...
    @overload
    def SetTriangleRigidBodyBased(self, localIndex: int, points: NDArray[Shape2D[3,3], float], contactRigidBodyIndex: int) -> None: ...
    @overload
...
class MainSystem:
    ...
    @overload
    def GetPreStepUserFunction(self, asDict: bool) -> Callable[[MainSystem, float],bool]: ...
    @overload
    def SetPostStepUserFunction(self, value: Callable[[MainSystem, float],bool]) -> None: ...
    @overload
    def GetPostStepUserFunction(self, asDict: bool) -> Callable[[MainSystem, float],bool]: ...
    @overload
    def SetPostNewtonUserFunction(self, value: Callable[[MainSystem, float],[float,float]]) -> None: ...
    @overload
    def GetPostNewtonUserFunction(self, asDict: bool) -> Callable[[MainSystem, float],bool]: ...
    @overload
