...
class PetClient:
    ...
    def upload_file(self, pet_id: int, *, additional_metadata: typing.Optional[str] = None) -> ApiResponse:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            params=remove_none_from_dict({"additionalMetadata": additional_metadata}),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
...
class AsyncPetClient:
    ...
    async def upload_file(self, pet_id: int, *, additional_metadata: typing.Optional[str] = None) -> ApiResponse:
        """
