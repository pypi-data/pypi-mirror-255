__all__ = ("CliCommandTestCase",)

import typing as t
from unittest.mock import Mock

from ingots.apps.cli.commands import CliCommand
from ingots.tests.unit.apps.base import test_commands

if t.TYPE_CHECKING:
    ...


TestedClassTypeVar = t.TypeVar("TestedClassTypeVar", bound=CliCommand)


class CliCommandTestCase(
    test_commands.BaseCommandTestCase[TestedClassTypeVar],
    t.Generic[TestedClassTypeVar],
):
    """Contains tests for CliCommand class."""

    tst_cls: type[TestedClassTypeVar] = CliCommand
