...
class _LockState:
    ...
    def __init__(
        ...
        initiallyLockedByDelegateUuid: str,
        ...
        self.initiallyLockedByDelegateUuid = initiallyLockedByDelegateUuid
        self.liveUpdateDataFromDelegateUuid: str = initiallyLockedByDelegateUuid
    ...
    def _lock(
        ...
        lockState = lockStateByDataSelector.get(
            ...
            _LockState(
                ...
                initiallyLockedByDelegateUuid=tupleAction.delegateUuid,
