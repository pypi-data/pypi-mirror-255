# coding=utf-8
"""
This module contains the TupleType class
"""
...
# =================================
class TupleType(BaseDocstringType):
    """
    This class represents tuple docstrings
    ...
    :ivar __subtypes: the subtypes of the tuple.
    """
    __scope_chars = ["(", "["]
    ...
    def __init__(self, str_data):
        """
        Initialization of a TupleType instance
    ...
    def __get_tokens(self):
        """
        This method is designed to get the parts for the subtypes of the tuple

        :rtype: list[str]
        :return: the parts for the subtypes of the tuple
        """
        tokens = []
        tmp_chars = []
        scopes = []
        for char in self.get_str_data()[1:-1]:
    ...
    def rebuild_docstring(self):
        ...
        """
        res = "(%s)" % ", ".join([elem.rebuild_docstring() for elem in self.__subtypes])
