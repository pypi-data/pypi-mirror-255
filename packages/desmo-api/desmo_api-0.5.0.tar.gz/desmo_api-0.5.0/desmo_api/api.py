...
async def create_prisonf_from_file(
    ...
    try:
        await database.insert_v1_prison(
            name=name,
        ...
        logger.warning("Prison %s already exists", name)
        raise HTTPException(409, "Prison already exists")
    except Exception as e:
        logger.error("Failed to cerate prison", exc_info=e)
        raise HTTPException(500, "Failed to create prison")
