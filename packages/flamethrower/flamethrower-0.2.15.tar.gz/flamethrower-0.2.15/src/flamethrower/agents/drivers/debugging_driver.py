...
Here are some points to take note:
  ...
  - If you don't know the answer right away, **strongly consider entering a debugging mindset, and write a set of effective print statements** to identify the root cause.
