...
class XykService:
    ...
    def get_pools(self, chain_name: Union[chain, Chains, chain_id], dex_name: str, page_size: Optional[int] = None, page_number: Optional[int] = None) -> Response[PoolResponse]:
        """
