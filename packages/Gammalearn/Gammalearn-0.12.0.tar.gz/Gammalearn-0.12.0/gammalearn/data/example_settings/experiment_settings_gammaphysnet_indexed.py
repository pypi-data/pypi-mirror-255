...
from gammalearn.callbacks import (LogGradientNorm, LogModelWeightNorm, LogModelParameters,
                                  ...
                                  LogGradientNormPerTask, LogLossWeighting, LogGradientCosineSimilarity)
    ...
    'parameters': {
        'backbone': {
            ...
            'parameters': {
                ...
                # 'normalization': (torch.nn.InstanceNorm2d, {}),
                # 'normalization': (torch.nn.GroupNorm, {'num_groups': 4}),
                # 'normalization': (nets.BNDA, {}),
                'num_channels': 2,
...
training_callbacks = [
    ...
    # LogReLUActivations(), # Not compatible with wandb
    # LogLinearGradient(), # Not compatible with wandb
