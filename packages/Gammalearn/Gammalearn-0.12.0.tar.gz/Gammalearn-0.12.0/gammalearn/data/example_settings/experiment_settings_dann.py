...
from gammalearn.callbacks import (LogGradientNorm, LogModelWeightNorm, LogModelParameters,
                                  ...
                                  WriteAccuracyDomain, LogGradientNormPerTask, LogLossWeighting)
...
from gammalearn.constants import GAMMA_ID, PROTON_ID, ELECTRON_ID, SOURCE, TARGET, REAL_DATA_ID
...
targets = collections.OrderedDict({
    ...
    'domain_class': {
        'loss': criterions.DANNLoss(training_class=[particle_dict[PROTON_ID], REAL_DATA_ID]),
        'loss_weight': 1,
        'metrics': {
...
loss_balancing_options = {
    'log_var_coefficients': [2, 2, 2, 0.5, 0.5],  # for uncertainty
