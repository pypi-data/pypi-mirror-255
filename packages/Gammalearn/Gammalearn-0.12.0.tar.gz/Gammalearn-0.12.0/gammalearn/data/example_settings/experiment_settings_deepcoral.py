...
loss_balancing_options = {
    'log_var_coefficients': [2, 2, 2, 0.5, 2],  # for uncertainty
...
loss_balancing = criterions.UncertaintyWeighting(targets)
...
training_step = steps.get_training_step_deepcoral(**experiment_hparams)
...
eval_step = steps.get_eval_step_deepcoral(**experiment_hparams)
