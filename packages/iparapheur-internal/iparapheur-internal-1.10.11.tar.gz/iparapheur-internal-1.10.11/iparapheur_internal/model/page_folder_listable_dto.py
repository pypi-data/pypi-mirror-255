        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FolderListableDto']:
                        return FolderListableDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FolderListableDto'], typing.List['FolderListableDto']],
                ...
                def __getitem__(self, i: int) -> 'FolderListableDto':
