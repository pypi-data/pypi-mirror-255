...
class PageHierarchisedDeskRepresentation(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['HierarchisedDeskRepresentation']:
                        return HierarchisedDeskRepresentation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['HierarchisedDeskRepresentation'], typing.List['HierarchisedDeskRepresentation']],
                ...
                def __getitem__(self, i: int) -> 'HierarchisedDeskRepresentation':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalPages", "totalElements", "pageable", "numberOfElements", "first", "last", "size", "content", "number", "sort", "empty", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalPages", "totalElements", "pageable", "numberOfElements", "first", "last", "size", "content", "number", "sort", "empty", ], str]):
