        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['LayerRepresentation']:
                        return LayerRepresentation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['LayerRepresentation'], typing.List['LayerRepresentation']],
                ...
                def __getitem__(self, i: int) -> 'LayerRepresentation':
