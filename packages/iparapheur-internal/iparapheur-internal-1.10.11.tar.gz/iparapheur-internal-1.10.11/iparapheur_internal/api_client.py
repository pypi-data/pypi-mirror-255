...
from iparapheur_internal.exceptions import ApiTypeError, ApiValueError
from iparapheur_internal.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.10.11/python'
