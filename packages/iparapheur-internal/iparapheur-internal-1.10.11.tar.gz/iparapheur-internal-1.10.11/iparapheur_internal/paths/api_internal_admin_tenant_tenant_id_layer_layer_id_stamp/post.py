...
LayerIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'tenantId': typing.Union[TenantIdSchema, str, ],
        'layerId': typing.Union[LayerIdSchema, str, ],
    }
)
...
class SchemaForRequestBodyMultipartFormData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def stamp() -> typing.Type['StampDto']:
                return StampDto
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stamp"]) -> 'StampDto': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["stamp", "file", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stamp"]) -> 'StampDto': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["stamp", "file", ], str]):
...
SchemaFor201ResponseBodyApplicationJson = StampDto
...
class CreateFileStamp(BaseApi):
    ...
    def create_file_stamp(
        ...
        return self._create_file_stamp_oapg(
            body=body,
