...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'folderId': typing.Union[FolderIdSchema, str, ],
    }
)
...
SchemaFor201ResponseBodyApplicationJson = ErrorResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _generate_document_signature_verification_oapg(
        self,
...
class GenerateDocumentSignatureVerification(BaseApi):
    ...
    def generate_document_signature_verification(
        ...
        return self._generate_document_signature_verification_oapg(
