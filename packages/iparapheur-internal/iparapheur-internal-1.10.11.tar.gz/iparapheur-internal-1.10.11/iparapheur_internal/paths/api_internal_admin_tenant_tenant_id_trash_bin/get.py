...
SchemaFor200ResponseBodyApplicationJson = PageFolderListableDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_trash_bin_listable_folders_oapg(
        self,
...
class ListTrashBinListableFolders(BaseApi):
    ...
    def list_trash_bin_listable_folders(
        ...
        return self._list_trash_bin_listable_folders_oapg(
