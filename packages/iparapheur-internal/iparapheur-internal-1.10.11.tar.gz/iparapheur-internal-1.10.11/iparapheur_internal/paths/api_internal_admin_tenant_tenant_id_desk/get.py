...
SchemaFor200ResponseBodyApplicationJson = PageHierarchisedDeskRepresentation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_hierarchic_desks_oapg(
        self,
...
class ListHierarchicDesks(BaseApi):
    ...
    def list_hierarchic_desks(
        ...
        return self._list_hierarchic_desks_oapg(
