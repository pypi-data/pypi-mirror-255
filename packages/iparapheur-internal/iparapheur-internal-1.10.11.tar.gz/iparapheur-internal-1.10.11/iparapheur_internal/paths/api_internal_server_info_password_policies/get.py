...
SchemaFor200ResponseBodyApplicationJson = PasswordPolicies
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_password_policies_oapg(
        self,
...
class GetPasswordPolicies(BaseApi):
    ...
    def get_password_policies(
        ...
        return self._get_password_policies_oapg(
