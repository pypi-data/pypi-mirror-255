...
SchemaFor200ResponseBodyApplicationJson = ValidationServiceConfigurationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_chorus_configuration_oapg(
        self,
...
class GetChorusConfiguration(BaseApi):
    ...
    def get_chorus_configuration(
        ...
        return self._get_chorus_configuration_oapg(
