...
# body param
SchemaForRequestBodyApplicationJson = LayerDto


request_body_layer_dto = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LayerDto
...
SchemaFor200ResponseBodyApplicationJson = LayerDto
...
class BaseApi(api_client.Api):
    ...
    def _update_layer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_layer_dto.serialize(body, content_type)
...
class UpdateLayer(BaseApi):
    ...
    def update_layer(
        ...
        return self._update_layer_oapg(
            body=body,
