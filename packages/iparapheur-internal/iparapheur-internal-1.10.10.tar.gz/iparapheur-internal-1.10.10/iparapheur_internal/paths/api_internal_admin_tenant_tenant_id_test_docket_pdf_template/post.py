...
# body param
SchemaForRequestBodyApplicationJson = MailTemplateTestRequest


request_body_mail_template_test_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _test_docket_pdf_template_oapg(
        self,
    ...
    def _test_docket_pdf_template_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_mail_template_test_request.serialize(body, content_type)
...
class TestDocketPdfTemplate(BaseApi):
    ...
    def test_docket_pdf_template(
        ...
        return self._test_docket_pdf_template_oapg(
            body=body,
