...
def handler(event, context):
    ...
    # 로그인을 수행하는 API
    if cmd == 'controller.sample_login.login':
        import controller.sample_login
        return controller.sample_login.login(
    ...
    if cmd == 'l1_task.admin.admin_manager.login.login_step_2':
        import controller.sample_login
        return controller.sample_login.get_me(
            session_id
        )
