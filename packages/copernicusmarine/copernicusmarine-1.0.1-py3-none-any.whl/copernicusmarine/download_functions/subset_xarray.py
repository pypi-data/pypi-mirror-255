...
def check_dataset_subset_bounds(
    ...
    for coordinate_label in COORDINATES_LABEL["latitude"]:
        if coordinate_label in dataset.dims:
            ...
            _check_coordinate_overlap(
                dimension="latitude",
                user_minimum_coordinate_value=dataset_subset.minimum_latitude
                or latitudes.min(),
                user_maximum_coordinate_value=dataset_subset.maximum_latitude
                or latitudes.max(),
    ...
    for coordinate_label in COORDINATES_LABEL["time"]:
        if coordinate_label in dataset.dims:
            ...
            _check_coordinate_overlap(
                dimension="time",
                user_minimum_coordinate_value=dataset_subset.start_datetime
                or dataset_minimum_coordinate_value,
                user_maximum_coordinate_value=dataset_subset.end_datetime
