...
Javascript('''
window.open('https://www.example.com', '_blank', 'width=500,height=400,scrollbars=yes');
''')

def configure() : 
    notebook_name = requests.get("http://172.28.0.12:9000/api/sessions").json()[0]["name"] #.removesuffix(".ipynb")
    html_code = """
