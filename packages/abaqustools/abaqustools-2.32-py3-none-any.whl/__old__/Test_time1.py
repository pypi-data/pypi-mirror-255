...
for n in range(1000000):
    ...
    # u_norm2=u/s2;
    u_norm2=u/numtools.norm_fast(u)
numtools.toc(t0)
...
# t0=numtools.tic()
# for n in range(1000000):
#     u_norm4 = normalize(u.reshape(1, -1), axis=1).ravel()
# numtools.toc(t0)
...
t0=numtools.tic()
for n in range(1000000):
    u_norm5=transformations.unit_vector(u)
numtools.toc(t0)
