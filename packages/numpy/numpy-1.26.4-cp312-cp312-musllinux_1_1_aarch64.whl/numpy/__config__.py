...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "openblas configuration": r"USE_64BITINT=1 DYNAMIC_ARCH=1 DYNAMIC_OLDER= NO_CBLAS= NO_LAPACK= NO_LAPACKE= NO_AFFINITY=1 USE_OPENMP= NEOVERSEN1 MAX_THREADS=2",
                "pc file directory": r"/usr/local/lib/pkgconfig",
            },
            "lapack": {
                "name": "dep281472826204016",
                "found": bool("True".lower().replace("false", "")),
                "version": "1.26.4",
