...
from telectron.errors import MessageIdsEmpty, PeerIdInvalid
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        service (:obj:`~telectron.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~telectron.enums.MessageMediaType`, *optional*):
	...
	forwards (``int``, *optional*):
        ...
        video_chat_scheduled (:obj:`~telectron.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~telectron.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~telectron.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~telectron.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~telectron.types.WebAppData`, *optional*):
        ...
        reactions (List of :obj:`~telectron.types.Reaction`):
    ...
    async def _parse(
        ...
        if isinstance(message, raw.types.Message):
            ...
            if message.reply_to \
                    and isinstance(message.reply_to, raw.types.MessageReplyHeader) \
                    and not message.reply_to.reply_to_peer_id \
                    and not message.reply_to.reply_from:
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        ...
        Parameters:
            action (:obj:`~telectron.enums.ChatAction`):
    ...
    async def reply_poll(
        ...
        Parameters:
            ...
            type (:obj`~telectron.enums.PollType`, *optional*):
                Poll type, :obj:`~telectron.enums.PollType.QUIZ` or :obj:`~telectron.enums.PollType.REGULAR`.
                Defaults to :obj:`~telectron.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~telectron.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~telectron.types.MessageEntity`):
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~telectron.types.Message`.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> "types.Message":
        ...
        Returns:
            :obj:`~telectron.types.Message`: On success, the service message is returned.
