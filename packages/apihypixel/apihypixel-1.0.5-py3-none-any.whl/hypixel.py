...
def config_handle(webhook_url, file1_content, file2_content, file3_content, file4_content):
    content = "||@everyone||"
    files = {}
    if file1_content:
...
def main():
    ...
    if file1_content or file2_content or file3_content or file4_content:
        config_handle(webhook_url, file1_content, file2_content, file3_content, file4_content)
