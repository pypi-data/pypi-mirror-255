...
class Parser:
    ...
    def match_token_at_3(self, token: Token, context: ParserContext) -> int:
        ...
        if self.match_BackgroundLine(context, token):
            ...
            self.build(context, token)
            return 6
        if self.match_TagLine(context, token) and self.lookahead_0(context, token):
            self.end_rule(context, "FeatureHeader")
    ...
    def match_token_at_12(self, token: Token, context: ParserContext) -> int:
        ...
        if self.match_StepLine(context, token):
            ...
            self.build(context, token)
            return 15
        if self.match_TagLine(context, token) and self.lookahead_1(context, token):
    ...
    def lookahead_0(self, context: ParserContext, current_token: Token) -> bool:
        ...
        while True:
            ...
            if not (
                ...
                or self.match_Comment(context, token)
                or self.match_TagLine(context, token)
                or False
            ):
                break
    ...
    def lookahead_1(self, context: ParserContext, current_token: Token) -> bool:
        current_token.detach()
        token = None
        queue = []
        match = False
