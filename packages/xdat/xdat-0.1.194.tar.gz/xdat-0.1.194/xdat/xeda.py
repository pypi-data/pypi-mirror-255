...
def x_explore_predictive(df, target_col, feature_cols=None, pipes=None, pipes_limit=None, treat_int_as_float=True, prs=None):
    print(f"- {target_col}")
    ...
    for pipe_name, pipe in pipes:
        ...
        top_fis = fis[fis > fis.median()][:3].index.values.tolist()
