...
class Config:
    ...
    mcd_agent_ecr_registry_id: Optional[str] = None
    mcd_agent_ecr_repo: Optional[str] = None
    ...
    def read(self) -> Optional[Config]:
        ...
        try:
            return Config(
                ...
                aws_profile=self._config.get(
                    self._profile_name, "aws_profile", fallback=None
                ),
                aws_region=self._config.get(
                    self._profile_name, "aws_region", fallback=None
                ),
