...
class CloudResourceService:
    ...
    @manage_errors
    def create_role(self, path_to_policy_doc: str, dc_id: Optional[str] = None) -> None:
        """
        ...
        try:
            ...
            account_id = self._get_aws_account_id(dc_id=dc_id)
    ...
    def _get_aws_account_id(self, dc_id: Optional[str] = None) -> str:
        """
