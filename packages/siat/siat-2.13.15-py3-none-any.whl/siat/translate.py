...
def codetranslate0(code):
    ...
    codedict=pd.DataFrame([
        ...
        #有问题：EXPRUS与EXPYUS的差别是什么？
        ['TRBNCN.M','中国贸易差额(百万美元)'],
        ['EXPRCN.M','中国出口增速%(同比)'],['IMPRCN.M','中国进口增速%(同比)'],
        ['EXPRJP.M','日本出口增速%(同比)'],['IMPRJP.M','日本进口增速%(同比)'],
        ['EXPRSG.M','新加坡出口增速%(同比)'],['IMPRSG.M','新加坡进口增速%(同比)'],
        ['EXPRMY.M','马来西亚出口增速%(同比)'],['IMPRMY.M','马来西亚进口增速%(同比)'],
        ['EXPRPH.M','菲律宾出口增速%(同比)'],['IMPRPH.M','菲律宾进口增速%(同比)'],
        ['EXPRIN.M','印度出口增速%(同比)'],['IMPRIN.M','印度进口增速%(同比)'],
        ['EXPRTR.M','土耳其出口增速%(同比)'],['IMPRTR.M','土耳其进口增速%(同比)'],
        ['EXPRAU.M','澳大利亚出口增速%(同比)'],['IMPRAU.M','澳大利亚进口增速%(同比)'],
        ['EXPRNZ.M','新西兰出口增速%(同比)'],['IMPRNZ.M','新西兰进口增速%(同比)'],
        ['EXPRZA.M','南非出口增速%(同比)'],['IMPRZA.M','南非进口增速%(同比)'],
        ['EXPRUS.M','美国出口增速%(同比)'],
        ['EXPYUS.M','美国出口增速%(同比)'],['IMPRUS.M','美国进口增速%(同比)'],
        ['EXPRCA.M','加拿大出口增速%(同比)'],['IMPRCA.M','加拿大进口增速%(同比)'],
        ['EXPRMX.M','墨西哥出口增速%(同比)'],['IMPRMX.M','墨西哥进口增速%(同比)'],
        
        
        
        
        ['CNYUSD=X','人民币/美元'],['CNYUSD','人民币/美元'],
        ['JPYUSD=X','日元/美元'],['JPYUSD','日元/美元'],
        ['KRWUSD=X','韩元/美元'],['KRWUSD','韩元/美元'],
        ['HKDUSD=X','港币/美元'],['HKDUSD','港币/美元'],
        ['TWDUSD=X','新台币/美元'],['TWDUSD','新台币/美元'],
        ['PHPUSD=X','菲律宾比索/美元'],['PHPUSD','菲律宾比索/美元'],
        ['IDRUSD=X','印尼盾/美元'],['IDRUSD','印尼盾/美元'],
        ['THBUSD=X','泰铢/美元'],['THBUSD','泰铢/美元'],
        ['MYRUSD=X','马来西亚林吉特/美元'],['MYRUSD','马来西亚林吉特/美元'],
        ['SGDUSD=X','新加坡币/美元'],['SGDUSD','新加坡币/美元'],
        ['INRUSD=X','印度卢比/美元'],['INRUSD','印度卢比/美元'],
        ['AUDUSD=X','澳大利亚元/美元'],['AUDUSD','澳大利亚元/美元'],
        ['NZDUSD=X','新西兰元/美元'],['NZDUSD','新西兰元/美元'],
        ['TRYUSD=X','土耳其里拉/美元'],['TRYUSD','土耳其里拉/美元'],
        ['ILSUSD=X','新谢克尔/美元'],['ILSUSD','新谢克尔/美元'],
        ['VNDUSD=X','越南盾/美元'],
        ['MOPUSD=X','澳门元/美元'],
        ['LAKUSD=X','老挝基普/美元'],
        ['KHRUSD=X','柬埔寨瑞尔/美元'],
        ...
        ['CADUSD=X','加拿大元/美元'],['CADUSD','加拿大元/美元'],
        ['^NYICDX','ICE美元指数'],['DX-Y.NYB','ICE美元指数'],
        ['MXNUSD=X','墨西哥比索/美元'],['MXNUSD','墨西哥比索/美元'],
        ['ARSUSD=X','阿根廷比索/美元'],['ARSUSD','阿根廷比索/美元'],
        ['CLPUSD=X','智利比索/美元'],['CLPUSD','智利比索/美元'],
        ['BRLUSD=X','巴西雷亚尔/美元'],['BRLUSD','巴西雷亚尔/美元'],
        
        ['EUR_I','STOOQ欧元指数'],
        ['EURUSD=X','欧元/美元'],['EURUSD','欧元/美元'],
        ['GBPUSD=X','英镑/美元'],['GBPUSD','英镑/美元'],
        ['CHFUSD=X','瑞士法郎/美元'],['CHFUSD','瑞士法郎/美元'],
        ['HUFUSD=X','匈牙利福林/美元'],['HUFUSD','匈牙利福林/美元'],
        ['SEKUSD=X','瑞典克朗/美元'],['SEKUSD','瑞典克朗/美元'],
        ['DKKUSD=X','丹麦克朗/美元'],['DKKUSD','丹麦克朗/美元'],
        ['NOKUSD=X','挪威克朗/美元'],['NOKUSD','挪威克朗/美元'],
        ['RUBUSD=X','俄罗斯卢布/美元'],['RUBUSD','俄罗斯卢布/美元'],
        ['PLNUSD=X','波兰兹罗提/美元'],['PLNUSD','波兰兹罗提/美元'],
        ['RONUSD=X','罗马尼亚列伊/美元'],['RONUSD','罗马尼亚列伊/美元'],
        ['BGNUSD=X','保加利亚列弗/美元'],['BGNUSD','保加利亚列弗/美元'],
        
        ['ZARUSD=X','南非兰特/美元'],['ZARUSD','南非兰特/美元'],
        ['EGPUSD=X','埃及镑/美元'],['EGPUSD','埃及镑/美元'],
        ['MADUSD=X','摩洛哥迪拉姆/美元'],
        ['NGNUSD=X','尼日利亚奈拉/美元'],
        ...
        ['XAFUSD=X','中非法郎/美元'],
        ['XCUUSD=X','安巴东加元/美元'],
        ['XDRUSD=X','IMF特别提款权/美元'],['XDRUSD','IMF特别提款权/美元'],
