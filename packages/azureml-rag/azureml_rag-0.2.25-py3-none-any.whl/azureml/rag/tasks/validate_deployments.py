...
def validate_deployments(
    ...
    if (embeddings_model and embeddings_model.startswith("azure_open_ai")) or (llm_config and llm_config.get("type") == "azure_open_ai"):
    ...
    if (embeddings_model and embeddings_model.startswith("open_ai")) or (llm_config and llm_config.get("type") == "open_ai"):
...
def main(args, activity_logger: Logger):
    ...
    validate_deployments(
        ...
        index_config=json.loads(args.index_config) if args.index_config else None,
