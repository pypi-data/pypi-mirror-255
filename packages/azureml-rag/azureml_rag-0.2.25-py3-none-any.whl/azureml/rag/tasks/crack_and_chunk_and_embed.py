...
from azureml.rag.documents.cracking import crack_documents, file_extension_loaders, files_to_document_source
from azureml.rag.embeddings import DataEmbeddedDocument, EmbeddedDocumentSource, EmbeddingsContainer
from azureml.rag.mlindex import MLIndex
from azureml.rag.tasks.crack_and_chunk import custom_loading, get_activity_logging_filter, str2bool
...
def crack_and_chunk_and_embed(
    ...
    chunked_docs = split_documents(
        cracked_sources, splitter_args=splitter_args, file_extension_splitters=extension_splitters, activity_logger=activity_logger
    )
    ...
    if output_path is not None:
        from azureml.rag.tasks.embed import create_embeddings
