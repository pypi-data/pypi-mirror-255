...
from azureml.rag.indexes.index_stores import INDEX_DELETE_FAILURE_MESSAGE_PREFIX, INDEX_UPLOAD_FAILURE_MESSAGE_PREFIX, AzureCognitiveSearchStore
    ...
    with track_activity(
        ...
        if MLIndex.INDEX_FIELD_MAPPING_KEY not in acs_config:
            ...
            if str(acs_config.get("push_embeddings", "true")).lower() == "true" and emb and emb.kind != "none":
                acs_config[MLIndex.INDEX_FIELD_MAPPING_KEY]["embedding"] = f"contentVector"
