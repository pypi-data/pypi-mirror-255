...
from azureml.rag.documents.chunking import ChunkedDocument, split_documents
from azureml.rag.documents.cracking import (
...
class DocumentChunksIterator(Iterator):
    ...
    def _infer_base_url_from_git(files_source: Union[str, Path]) -> Optional[str]:
        ...
        try:
            ...
            relative_path_to_source = files_source.relative_to(repo_root)
            if str(relative_path_to_source) != ".":
                remote_url = f"{remote_url}{relative_path_to_source}"
