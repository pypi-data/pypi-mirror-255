...
from ver13 import AIUT_Core_Java as AIUT_Java
from ver13 import AIUT_Core_CSharp as AIUT_CSharp
from PIL import ImageTk, Image
import multiprocessing
from ver13 import sub
from ver13 import sub2
import datetime
...
class AboutScreen:
    def __init__(self, root,main_screen):
        ...
        image_path = "about1.png"  # Replace with the path to your image
        image = Image.open(f"about1.png")
...
class Automation:
    def __init__(self,root):
        ...
        self.img = ImageTk.PhotoImage(Image.open(f"logo.png"))
        self.img2 = ImageTk.PhotoImage(Image.open(f"initial1.png"))
        ...
        folder_icon = Image.open("folder_icon.png")  # Replace "folder_icon.png" with your folder image file
