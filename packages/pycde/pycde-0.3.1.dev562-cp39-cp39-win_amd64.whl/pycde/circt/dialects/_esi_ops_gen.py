...
def buffer(output, clk, rst, input, *, stages=None, name=None, loc=None, ip=None) -> _SubClassValueT:
...
def cosim_from_host(from_host, clk, rst, id, *, loc=None, ip=None) -> _SubClassValueT:
...
def pure_module_input(value, name, *, loc=None, ip=None) -> _SubClassValueT:
...
def null(out, *, loc=None, ip=None) -> _SubClassValueT:
...
def bundle_pack(bundle, from_channels, to_channels, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def stage(output, clk, rst, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def service_req(to_client, service_port, app_id, *, loc=None, ip=None) -> _SubClassValueT:
...
class ServiceDeclPortOp(_ods_ir.OpView):
  ...
  def __init__(self, inner_sym, toClientType, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_442')) else
      _ods_ir.AttrBuilder.get('anonymous_442')(toClientType, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class ServiceImplClientRecordOp(_ods_ir.OpView):
  ...
  def __init__(self, relAppIDPath, servicePort, bundleType, implDetails, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_442')) else
      _ods_ir.AttrBuilder.get('anonymous_442')(bundleType, context=_ods_context))
...
class ServiceImplRecordOp(_ods_ir.OpView):
  ...
  def __init__(self, appID, serviceImplName, implDetails, *, service=None, stdService=None, loc=None, ip=None):
    ...
    if stdService is not None: attributes["stdService"] = (stdService if (
        issubclass(type(stdService), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrAttr')) else
...
def service_impl_req_req(to_client, service_port, relative_app_id_path, *, loc=None, ip=None) -> _SubClassValueT:
...
def service_impl_req(outputs, app_id, impl_type, inputs, *, service_symbol=None, std_service=None, impl_opts=None, loc=None, ip=None) -> _SubClassValueT:
...
def service_instance(result, app_id, impl_type, inputs, *, service_symbol=None, impl_opts=None, loc=None, ip=None) -> _SubClassValueT:
...
def bundle_unpack(to_channels, bundle, from_channels, *, loc=None, ip=None) -> _SubClassValueT:
...
def unwrap_fifo(chan_input, rden, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def unwrap_vr(raw_output, valid, chan_input, ready, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def window_unwrap(window, *, loc=None, ip=None) -> _SubClassValueT:
...
def wrap_fifo(chan_output, rden, data, empty, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def wrap_iface(output, interface_sink, *, loc=None, ip=None) -> _SubClassValueT:
...
def wrap_vr(chan_output, ready, raw_input, valid, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def window_wrap(window, frame, *, loc=None, ip=None) -> _SubClassValueT:
