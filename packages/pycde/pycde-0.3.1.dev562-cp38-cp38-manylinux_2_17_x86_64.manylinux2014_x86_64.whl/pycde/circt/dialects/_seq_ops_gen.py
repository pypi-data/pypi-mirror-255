...
def clock_div(clock_in, pow2, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ClockDividerOp(clockIn=clock_in, pow2=pow2, loc=loc, ip=ip))
...
def clock_gate(input, enable, *, test_enable=None, inner_sym=None, loc=None, ip=None) -> _SubClassValueT:
...
def clock_inv(input, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ClockInverterOp(input=input, loc=loc, ip=ip))
...
def clock_mux(cond, true_clock, false_clock, *, loc=None, ip=None) -> _SubClassValueT:
...
def compreg_ce(input, clk, clock_enable, *, name=None, reset=None, reset_value=None, power_on_value=None, inner_sym=None, loc=None, ip=None) -> _SubClassValueT:
...
def compreg(input, clk, *, name=None, reset=None, reset_value=None, power_on_value=None, inner_sym=None, loc=None, ip=None) -> _SubClassValueT:
...
def const_clock(value, *, loc=None, ip=None) -> _SubClassValueT:
...
def fifo(output, full, empty, almost_full, almost_empty, input, rd_en, wr_en, clk, rst, depth, *, almost_full_threshold=None, almost_empty_threshold=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def firmem(memory, read_latency, write_latency, ruw, wuw, *, name=None, inner_sym=None, init=None, prefix=None, output_file=None, loc=None, ip=None) -> _SubClassValueT:
...
def firmem_read_port(memory, address, clk, *, enable=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FirMemReadOp(memory=memory, address=address, clk=clk, enable=enable, loc=loc, ip=ip))
...
def firmem_read_write_port(memory, address, clk, write_data, mode, *, enable=None, mask=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FirMemReadWriteOp(memory=memory, address=address, clk=clk, writeData=write_data, mode=mode, enable=enable, mask=mask, loc=loc, ip=ip))
...
def firmem_write_port(memory, address, clk, data, *, enable=None, mask=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FirMemWriteOp(memory=memory, address=address, clk=clk, data=data, enable=enable, mask=mask, loc=loc, ip=ip))
...
def firreg(next, clk, name, *, inner_sym=None, preset=None, reset=None, reset_value=None, is_async=None, loc=None, ip=None) -> _SubClassValueT:
...
def from_clock(input, *, loc=None, ip=None) -> _SubClassValueT:
...
def hlmem(handle, clk, rst, sym_name, *, loc=None, ip=None) -> _SubClassValueT:
...
def read(read_data, memory, addresses, latency, *, rd_en=None, loc=None, ip=None) -> _SubClassValueT:
...
class ShiftRegOp(_ods_ir.OpView):
  ...
  def __init__(self, numElements, input, clk, clockEnable, *, name=None, reset=None, resetValue=None, powerOnValue=None, inner_sym=None, loc=None, ip=None):
    ...
    issubclass(type(numElements), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('I64Attr')) else
...
def shiftreg(num_elements, input, clk, clock_enable, *, name=None, reset=None, reset_value=None, power_on_value=None, inner_sym=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ShiftRegOp(numElements=num_elements, input=input, clk=clk, clockEnable=clock_enable, name=name, reset=reset, resetValue=reset_value, powerOnValue=power_on_value, inner_sym=inner_sym, loc=loc, ip=ip))
...
def to_clock(input, *, loc=None, ip=None) -> _SubClassValueT:
