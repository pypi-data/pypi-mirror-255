...
serial --speed=115200 --unit=1 --word=8 --parity=no --stop=1 --unit=0
...
menuentry "Install Ubuntu Server" {
        set gfxpayload=keep
        linux   /install/vmlinuz critical keyboard-configuration/layoutcode=us console-setup/ask_detect=false ramdisk_size=16384 root=/dev/ram locale=en_US ipv6.disable=1 file=/cdrom/preseed/dnsops.seed console=ttyS0,115200n8 ---
        initrd  /install/initrd.gz
}

menuentry "Rescue a broken system" {
        set gfxpayload=keep
        linux   /install/vmlinuz  rescue/enable=true console=ttyS0,115200n8 ---
        initrd  /install/initrd.gz
}
grub_platform
