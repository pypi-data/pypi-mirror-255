...
class SeqUtil:
    @staticmethod
    def parse_fasta(
        input_file: Union[str, BufferedReader] = None,
        ...
        if input_file is None:
            if file_name:
                ...
                raise ValueError("input_file must be a file name (str) or a BufferedReader object")
        if isinstance(input_file, str):
            with open(input_file, 'r') as file_handle:
                data = file_handle.read().strip()
        elif isinstance(input_file, BufferedReader):
