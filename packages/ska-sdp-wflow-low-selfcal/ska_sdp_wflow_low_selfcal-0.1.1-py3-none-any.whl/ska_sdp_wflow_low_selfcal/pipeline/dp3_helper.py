...
class Dp3Runner:
    ...
    def predict(  # pylint: disable=R0913
        ...
        self.run_dp3(
            ...
            + applycal_params
            + self.args_predict
            + self.common_args(msin, starttime, ntimes)
        )
    ...
    def calibrate_complexgain(  # pylint: disable=R0913
        ...
        self.run_dp3(
            ...
            + self.calibrate_common_args("solve")
            + self.calibrate_predict_args("solve")
            + self.calibrate_complexgain_args("solve", ntimes)
        )
    ...
    def calibrate_scalarphase_and_complexgain(  # pylint: disable=R0913
        ...
        self.run_dp3(
            ...
            + self.calibrate_complexgain_args("solve_complexgain", ntimes)
        )

    def applybeam(self, msin, msout, ntimes):
        ...
        self.run_dp3(
            ...
            + self.common_args(msin, ntimes=ntimes)
        )

    def common_args(self, msin, starttime=None, ntimes=0):
