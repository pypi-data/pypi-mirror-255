# -*- coding: utf-8 -*-
"""PyIAC/managers/state_machine.py

This module implements Function Manager.
"""
from ..state_machine import PyIACStateMachine
...
class StateMachineManager:
    ...
    def append_machine(self, machine:PyIACStateMachine, interval:float=1, mode:str="async"):
        r"""
        Appends machines to the store

        **Parameters**

        * **machine:** (PyIACStateMachine) instance
    ...
    def get_machine(self, name:str)->PyIACStateMachine:
        r"""
