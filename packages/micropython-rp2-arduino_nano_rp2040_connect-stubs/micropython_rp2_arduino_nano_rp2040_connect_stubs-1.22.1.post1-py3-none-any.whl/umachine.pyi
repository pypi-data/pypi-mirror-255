...
---
Module: 'umachine' on micropython-v1.22.1-rp2-ARDUINO_NANO_RP2040_CONNECT
"""
...
class Pin:
    ...
    class cpu:
        ...
        GPIO2: Pin  ## = Pin(GPIO2, mode=IN, pull=PULL_DOWN)
        ...
        GPIO8: Pin  ## = Pin(GPIO8, mode=ALT, pull=PULL_DOWN, alt=SPI)
        ...
        GPIO3: Pin  ## = Pin(GPIO3, mode=OUT, pull=PULL_DOWN)
        GPIO9: Pin  ## = Pin(GPIO9, mode=OUT, pull=PULL_DOWN)
        EXT_GPIO4: Pin  ## = Pin(EXT_GPIO4, mode=IN)
        EXT_GPIO5: Pin  ## = Pin(EXT_GPIO5, mode=IN)
        EXT_GPIO6: Pin  ## = Pin(EXT_GPIO6, mode=IN)
        GPIO0: Pin  ## = Pin(GPIO0, mode=ALT, pull=PULL_DOWN, alt=31)
        GPIO18: Pin  ## = Pin(GPIO18, mode=ALT, pull=PULL_DOWN, alt=31)
        EXT_GPIO3: Pin  ## = Pin(EXT_GPIO3, mode=IN)
        EXT_GPIO0: Pin  ## = Pin(EXT_GPIO0, mode=IN)
        EXT_GPIO1: Pin  ## = Pin(EXT_GPIO1, mode=IN)
        EXT_GPIO2: Pin  ## = Pin(EXT_GPIO2, mode=IN)
        GPIO14: Pin  ## = Pin(GPIO14, mode=ALT, pull=PULL_DOWN, alt=SPI)
        ...
        GPIO10: Pin  ## = Pin(GPIO10, mode=IN, pull=PULL_DOWN)
        GPIO11: Pin  ## = Pin(GPIO11, mode=ALT, pull=PULL_DOWN, alt=SPI)
        GPIO12: Pin  ## = Pin(GPIO12, mode=ALT, pull=PULL_DOWN, alt=31)
        def __init__(self, *argv, **kwargs) -> None: ...

    class board:
        TX: Pin  ## = Pin(GPIO0, mode=ALT, pull=PULL_DOWN, alt=31)
        D6: Pin  ## = Pin(GPIO18, mode=ALT, pull=PULL_DOWN, alt=31)
        D7: Pin  ## = Pin(GPIO19, mode=ALT, pull=PULL_DOWN, alt=31)
        D8: Pin  ## = Pin(GPIO20, mode=ALT, pull=PULL_DOWN, alt=31)
        D5: Pin  ## = Pin(GPIO17, mode=ALT, pull=PULL_DOWN, alt=31)
        D21: Pin  ## = Pin(EXT_GPIO6, mode=IN)
        D3: Pin  ## = Pin(GPIO15, mode=ALT, pull=PULL_DOWN, alt=31)
        D4: Pin  ## = Pin(GPIO16, mode=ALT, pull=PULL_DOWN, alt=31)
        D9: Pin  ## = Pin(GPIO21, mode=ALT, pull=PULL_DOWN, alt=31)
        RX: Pin  ## = Pin(GPIO1, mode=ALT, pull=PULL_DOWN, alt=31)
        SCL: Pin  ## = Pin(GPIO13, mode=ALT, pull=PULL_DOWN, alt=31)
        SDA: Pin  ## = Pin(GPIO12, mode=ALT, pull=PULL_DOWN, alt=31)
        LED_RED: Pin  ## = Pin(EXT_GPIO0, mode=IN)
        LED: Pin  ## = Pin(GPIO6, mode=ALT, pull=PULL_DOWN, alt=31)
        LED_BLUE: Pin  ## = Pin(EXT_GPIO2, mode=IN)
        LED_GREEN: Pin  ## = Pin(EXT_GPIO1, mode=IN)
        D20: Pin  ## = Pin(EXT_GPIO5, mode=IN)
        A4: Pin  ## = Pin(EXT_GPIO3, mode=IN)
        A5: Pin  ## = Pin(EXT_GPIO4, mode=IN)
        A6: Pin  ## = Pin(EXT_GPIO5, mode=IN)
        A3: Pin  ## = Pin(GPIO29, mode=ALT, pull=PULL_DOWN, alt=31)
        A0: Pin  ## = Pin(GPIO26, mode=ALT, pull=PULL_DOWN, alt=31)
        A1: Pin  ## = Pin(GPIO27, mode=ALT, pull=PULL_DOWN, alt=31)
        A2: Pin  ## = Pin(GPIO28, mode=ALT, pull=PULL_DOWN, alt=31)
        A7: Pin  ## = Pin(EXT_GPIO6, mode=IN)
        D18: Pin  ## = Pin(EXT_GPIO3, mode=IN)
        D19: Pin  ## = Pin(EXT_GPIO4, mode=IN)
        D2: Pin  ## = Pin(GPIO25, mode=ALT, pull=PULL_DOWN, alt=31)
        D13: Pin  ## = Pin(GPIO6, mode=ALT, pull=PULL_DOWN, alt=31)
        D10: Pin  ## = Pin(GPIO5, mode=ALT, pull=PULL_DOWN, alt=31)
        D11: Pin  ## = Pin(GPIO7, mode=ALT, pull=PULL_DOWN, alt=31)
        D12: Pin  ## = Pin(GPIO4, mode=ALT, pull=PULL_DOWN, alt=31)
        def __init__(self, *argv, **kwargs) -> None: ...
