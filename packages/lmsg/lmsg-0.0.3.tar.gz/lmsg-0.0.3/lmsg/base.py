...
class Message(metaclass=MessageMeta):
    ...
    attrs : tuple[str]
        Additional attributes to be added to the class.
    extra : dict
    ...
    def __init__(
        ...
        **kwargs : P.kwargs
        ...
        self.attrs = attrs
        self.extra = self.setext(*args, attrs=attrs, extra=extra, **kwargs)
        ...
        self.extra = self.extras(*args, **kwargs)

    def setext(
        self, *args: P.args, attrs: tuple[str] = (), 
        extra: Mapping[str, object] = dict(), **kwargs: P.kwargs
    ) -> dict:
        attrs = attrs if attrs else getattr(self, 'attrs', tuple())
        extra = extra if extra is not None else getattr(self, 'extra', dict())
        attrs = dict((a, kwargs.get(a, locals().get(a, None))) for a in attrs)
        value = {**extra, **attrs}
