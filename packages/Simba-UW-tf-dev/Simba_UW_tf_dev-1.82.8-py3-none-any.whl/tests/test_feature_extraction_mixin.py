...
# test_windowed_frequentist_distribution_tests()
# test_cdist()
# test_create_shifted_df()
# test_minimum_bounding_rectangle()
# test_framewise_euclidean_distance()
# test_dataframe_gaussian_smoother()
# test_dataframe_gaussian_smoother()