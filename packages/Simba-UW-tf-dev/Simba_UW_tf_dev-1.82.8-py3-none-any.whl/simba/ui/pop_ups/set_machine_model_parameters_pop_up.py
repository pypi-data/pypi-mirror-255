...
class SetMachineModelParameters(PopUpMixin, ConfigReader):
    def __init__(self,
        ...
        for clf_cnt, clf_name in enumerate(self.clf_names):
            ...
            self.clf_data[clf_name]['path'] = FileSelect(self.clf_table_frm, title='Select model (.sav) file', file_types=[('SimBA model SAV file', '.sav')])
...
#_ = SetMachineModelParameters(config_path='/Users/simon/Desktop/envs/troubleshooting/Termites_5/project_folder/project_config.ini')
