...
class CueLightMovementAnalyzer(ConfigReader):
    ...
    def save_results(self):
        ...
        stdout_success(msg='Cue light movement statistics saved in project_folder/logs directory.', source=self.__class__.__name__)
        if self.roi_setting:
            ...
            stdout_success(msg='Cue light ROI statistics saved in project_folder/logs directory.', source=self.__class__.__name__)
