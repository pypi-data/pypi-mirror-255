...
class FSTTCCalculator(ConfigReader, PlottingMixin):
    ...
    def __find_sequences(self):
        ...
        for file_cnt, file_path in enumerate(self.machine_results_paths):
            ...
            check_that_column_exist(df=self.data_df, column_name=self.behavior_lst, file_name=file_path)
    ...
    def run(self):
        ...
        :meth:`~simba.FSTTCPerformer.__find_sequences`.
