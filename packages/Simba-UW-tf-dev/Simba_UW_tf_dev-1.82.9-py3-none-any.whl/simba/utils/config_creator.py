...
class ProjectConfigCreator(object):
    ...
    def __create_directories(self):
        ...
        for folder_path in folder_lst:
            if os.path.isdir(folder_path):
                raise DirectoryExistError(msg=f'SimBA tried to create {folder_path}, but it already exists. Please create your SimBA project in a new path, or move/delete your previous SimBA project', source=self.__class__.__name__)
            else:
    ...
    def __create_configparser_config(self):
        ...
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.RF_MAX_DEPTH.value] = Dtypes.NONE.value
        ...
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.RF_CRITERION.value] = Dtypes.ENTROPY.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.RF_METADATA.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.EX_DECISION_TREE.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.EX_DECISION_TREE_FANCY.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.IMPORTANCE_LOG.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.IMPORTANCE_BAR_CHART.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.PERMUTATION_IMPORTANCE.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.LEARNING_CURVE.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.PRECISION_RECALL.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.IMPORTANCE_BARS_N.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.LEARNING_CURVE_K_SPLITS.value] = Dtypes.NONE.value
        self.config[ConfigKey.CREATE_ENSEMBLE_SETTINGS.value][MLParamKeys.LEARNING_DATA_SPLITS.value] = Dtypes.NONE.value
        ...
        stdout_success(msg=f'Project directory tree and project_config.ini created in {self.project_folder}', elapsed_time=self.timer.elapsed_time_str, source=self.__class__.__name__)