...
class InterpolatePopUp(PopUpMixin, ConfigReader):
    def __init__(self,
        ...
        self.input_dir = FolderSelect(self.main_frm, 'DATA DIRECTORY:', lblwidth=25, initialdir=os.path.join(self.project_path, 'csv'))
...
class SmoothingPopUp(PopUpMixin, ConfigReader):
    def __init__(self,
        ...
        ConfigReader.__init__(self, config_path=config_path)
        self.input_dir = FolderSelect(self.main_frm, 'DATA DIRECTORY:', lblwidth=20,initialdir=os.path.join(self.project_path, 'csv'))
