...
class DataPlotter(ConfigReader):
    ...
    def run(self):
        ...
        stdout_success(msg=f'All data table videos created inside {self.data_table_path}', elapsed_time=self.timer.elapsed_time_str, source=self.__class__.__name__)


# style_attr = {'bg_color': 'White', 'header_color': 'Black', 'font_thickness': 1, 'size': (640, 480), 'data_accuracy': 2}
# body_part_attr = [['Ear_left_1', 'Grey'], ['Nose_2', 'Red']]
