...
class GeometryMixin(object):
    ...
    def bucket_img_into_grid_points(point_distance: int,
        ...
        :example:
        >>> bucket_img_into_grid_points(point_distance=20, px_per_mm=4, img_size=img.shape, border_sites=False)
        """
        ...
        timer.stop_timer()
        stdout_success(msg='Bucket image into grid points complete', elapsed_time=timer.elapsed_time_str)
        return points
