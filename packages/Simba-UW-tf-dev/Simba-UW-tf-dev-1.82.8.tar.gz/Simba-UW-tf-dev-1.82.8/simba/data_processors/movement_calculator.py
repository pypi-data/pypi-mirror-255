...
class MovementCalculator(ConfigReader,
    ...
    :param List[str] or None file_paths: Files to calculate movements for. If None, then all files in ``project_folder/csv/outlier_corrected_movement_location`` directory.
    ...
    def save(self):
        ...
        stdout_success(msg= f'Movement log saved in {self.save_path}', elapsed_time=self.timer.elapsed_time_str, source=self.__class__.__name__)
