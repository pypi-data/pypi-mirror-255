...
class GeometryPlotter(ConfigReader, PlottingMixin):
    ...
    def __init__(self,
                 ...
                 geometries: List[List[Union[Polygon, LineString, MultiLineString]]],
                 video_name: str,
                 core_cnt: int = -1):
    ...
    def run(self):
        ...
        try:
            ...
            data = pd.DataFrame(self.geometries)
        print(data)
...
# df = pd.read_csv('/Users/simon/Desktop/envs/troubleshooting/Rat_NOR/project_folder/csv/machine_results/08102021_DOT_Rat7_8(2).csv', nrows=1000).fillna(0).astype(int)
...
#
#
# config_path = '/Users/simon/Desktop/envs/troubleshooting/Rat_NOR/project_folder/project_config.ini'
#
#
# plotter = GeometryPlotter(config_path=config_path, geometries=geometries, video_name='08102021_DOT_Rat7_8(2)', core_cnt=3)
# plotter.run()
