...
class MarsImporter(object):
    ...
    def __init__(self,
        ...
        if len(self.files_found) == 0:
            raise NoFilesFoundError(msg=f'Zero .json files found in {data_path} directory', source=self.__class__.__name__)
    ...
    def import_data(self):
        ...
        stdout_success(msg=f'{str(len(self.files_found))} data files imported to SimBA project', source=self.__class__.__name__)
