...
class SklearnVisualizationPopUp(PopUpMixin, ConfigReader):
    def __init__(self,
        ...
        self.select_video_file_select = FileSelect(self.run_single_video_frm, '', lblwidth='1', file_types=[('VIDEO FILE', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)], dropdown=self.single_video_dropdown, initialdir=self.video_dir)
