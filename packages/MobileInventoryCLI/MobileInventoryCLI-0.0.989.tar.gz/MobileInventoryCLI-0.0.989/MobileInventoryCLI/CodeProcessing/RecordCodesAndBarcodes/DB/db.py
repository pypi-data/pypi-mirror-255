...
class Entry(BASE):
	...
	def listdisplay(self):
		...
		if len(name) > ma:
			name=name[0:ma]
		msg=f'''NAME={Fore.cyan}{name}{Style.reset} | UPC={Fore.green}{self.Barcode}{Style.reset} | SHELF={Fore.yellow}{self.Code}{Style.reset} | QTY={Fore.violet}{self.ListQty}{Style.reset}'''
		print(msg)
