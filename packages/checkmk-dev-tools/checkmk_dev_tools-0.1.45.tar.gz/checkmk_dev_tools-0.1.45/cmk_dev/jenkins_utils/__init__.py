...
class Build(SimpleBuild):
    ...
    def correct(cls, obj: Json[dict[str, Any]]) -> Json[dict[str, Any]]:
        ...
        assert obj.get("inProgress") == obj.get("building")
    ...
    def completed(self) -> bool:
        """Convenience.."""
        # note: self.result can be defined before build is completed
        assert bool(self.building) == bool(self.inProgress), f"{self.building} {self.inProgress}"
...
class Job(SimpleJob):
    ...
    # is_failing: bool
    # has_recovered: bool
    # started_failing: bool = False
    # fails_since: None | int = None
    # fails_count: int = 0
