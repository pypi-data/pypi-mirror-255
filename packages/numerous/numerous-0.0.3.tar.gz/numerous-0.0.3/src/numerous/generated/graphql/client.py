...
class Client(AsyncBaseClient):
    async def all_elements(self, tool_session_id: str, **kwargs: Any) -> AllElements:
        query = gql(
            ...
            fragment ButtonElementValue on Button {
              buttonValue: value
            }
            ...
            fragment HTMLElementValue on HTMLElement {
              html
            }

            fragment NumberFieldElementValue on NumberField {
              numberValue: value
            }

            fragment TextFieldElementValue on TextField {
              textValue: value
            }
            """
        )
