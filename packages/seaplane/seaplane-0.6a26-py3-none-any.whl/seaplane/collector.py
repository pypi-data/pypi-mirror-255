...
class Collector:
    ...
    def collect_batch(self, msg: Any) -> Generator[Any, None, None]:
        ...
        # TODO: fix this to be more efficient like the dag code below, remove sleep
        stored_keys = [
            x
    ...
    def multiple_in(msg: Any) -> Any:
        ...
        if tasks and input_task:
            ...
            if stored_keys == expected_keys:
                ...
                ret.meta[f"{dag_instance_name}_start"] = start_time
                ret.meta[f"{dag_instance_name}_end"] = time.time()
                yield ret
            else:
                yield
