...
class LoadModel:
    ...
    #                 subject_index = cleaned_text.lower().find('subject')
    #                 if subject_index != -1:
    ...
    #             else:
    #                 # Return message if 'mv' not found in text
    #                 message = "Email doesn't contain MV or M.V. or M/V"
    #                 return message
    #         except Exception as e:
    #             logging.error("Error %s" , e)
