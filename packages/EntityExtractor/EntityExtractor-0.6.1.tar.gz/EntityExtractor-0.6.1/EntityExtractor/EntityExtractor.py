...
class EntityExtractor(LoadModel, LoadSecondModel, LoadThirdModel):
    ...
    def extract_entities(self):
        ...
        with ThreadPoolManager().executor as executor:
            futures = [executor.submit(self.process_nlp, nlp_func, entities_dict) for nlp_func in [self.__nlp_first, self.__nlp_second, self.__nlp_third]]
