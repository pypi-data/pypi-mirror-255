...
class Ui_PresetDockRando(object):
    def setupUi(self, PresetDockRando):
        ...
        self.gridLayout.addWidget(self.multiworld_label, 5, 0, 1, 2)
    ...
    def retranslateUi(self, PresetDockRando):
        ...
        self.multiworld_label.setText(QCoreApplication.translate("PresetDockRando", u"<html><head/><body><p>The selected type is <span style=\" font-weight:700;\">not</span> compatible with multiworld sessions.</p></body></html>", None))
