...
class Ui_SuperCosmeticPatchesDialog(object):
    def setupUi(self, SuperCosmeticPatchesDialog):
        ...
        self.gridLayout_41 = QGridLayout(self.controls_box)
        ...
        self.gridLayout_41.addWidget(self.enable_moonwalk_by_default_checkbox, 2, 0, 1, 1)

        self.label = QLabel(self.controls_box)
        self.label.setObjectName(u"label")
        self.label.setWordWrap(True)

        self.gridLayout_41.addWidget(self.label, 6, 0, 1, 1)
        ...
        self.gridLayout_41.addWidget(self.aim_with_any_button_checkbox, 0, 0, 1, 1)
        ...
        self.gridLayout_41.addWidget(self.aim_with_any_button_label, 1, 0, 1, 1)
