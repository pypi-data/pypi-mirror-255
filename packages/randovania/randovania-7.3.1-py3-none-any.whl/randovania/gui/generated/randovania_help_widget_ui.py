...
class Ui_RandovaniaHelpWidget(object):
    def setupUi(self, RandovaniaHelpWidget):
        ...
        self.multiworld_label.setCursor(QCursor(Qt.IBeamCursor))
        ...
        self.tracker_label.setCursor(QCursor(Qt.IBeamCursor))
        ...
        self.database_viewer_label.setCursor(QCursor(Qt.IBeamCursor))
