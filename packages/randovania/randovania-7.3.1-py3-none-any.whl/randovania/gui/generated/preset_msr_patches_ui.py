...
class Ui_PresetMSRPatches(object):
    def setupUi(self, PresetMSRPatches):
        ...
        self.scroll_contents.setGeometry(QRect(0, -65, 623, 652))
    ...
    def retranslateUi(self, PresetMSRPatches):
        ...
        self.reverse_area8_label.setText(QCoreApplication.translate("PresetMSRPatches", u"Removes the wall between the Queen and Baby, allowing for earlier access into Area 8 by entering the area backwards.", None))
        self.misc_group.setTitle(QCoreApplication.translate("PresetMSRPatches", u"Miscellaneous", None))
        self.charge_door_buff_check.setText(QCoreApplication.translate("PresetMSRPatches", u"Buff Charge Doors", None))
