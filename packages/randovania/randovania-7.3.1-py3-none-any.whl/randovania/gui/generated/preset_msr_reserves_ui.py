...
class Ui_PresetMSRReserves(object):
    def setupUi(self, PresetMSRReserves):
        ...
        self.verticalLayout1 = QVBoxLayout(self.scroll_area_contents)
        ...
        self.verticalLayout1.setContentsMargins(0, 2, 0, 0)
        ...
        self.verticalLayout1.addWidget(self.reserve_tank_description)
        ...
        self.verticalLayout1.addWidget(self.energy_box)

        self.reserve_tank_spacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.verticalLayout1.addItem(self.reserve_tank_spacer)
