...
class Ui_PresetPrimeHints(object):
    def setupUi(self, PresetPrimeHints):
        ...
        self.verticalLayout_91 = QVBoxLayout(self.phazon_suit_hint_group)
        ...
        self.verticalLayout_91.addWidget(self.phazon_suit_hint_label)
        ...
        self.verticalLayout_91.addWidget(self.phazon_suit_hint_combo)
