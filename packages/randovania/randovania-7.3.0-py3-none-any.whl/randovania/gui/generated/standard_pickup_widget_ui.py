...
class Ui_StandardPickupWidget(object):
    def setupUi(self, StandardPickupWidget):
        ...
        self.provided_ammo_label = QLabel(StandardPickupWidget)
        ...
        self.root_layout.addWidget(self.provided_ammo_label, 1, 1, 1, 2)
        ...
        self.root_layout.addWidget(self.provided_ammo_spinbox, 1, 3, 1, 1)
    ...
    def retranslateUi(self, StandardPickupWidget):
        ...
        self.provided_ammo_label.setToolTip(QCoreApplication.translate("StandardPickupWidget", u"<html><head/><body><p>When this item is collected, it also gives this amount of the given ammos.</p><p>This is included in the calculation of how much each pickup of this ammo gives.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.provided_ammo_label.setText(QCoreApplication.translate("StandardPickupWidget", u"<html><head/><body><p>Provided Ammo (XXXX and YYYY)</p></body></html>", None))
