...
class Ui_AM2RCosmeticPatchesDialog(object):
    def setupUi(self, AM2RCosmeticPatchesDialog):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, 0, 423, 676))
    ...
    def retranslateUi(self, AM2RCosmeticPatchesDialog):
        ...
        self.music_sub_label.setText(QCoreApplication.translate("AM2RCosmeticPatchesDialog", u"Changes the way music triggers behave.", None))
        ...
        self.full_music_label.setText(QCoreApplication.translate("AM2RCosmeticPatchesDialog", u"Will shuffle all songs.", None))
    # retranslateUi
