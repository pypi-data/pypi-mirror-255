...
class Ui_NodeDetailsPopup(object):
    def setupUi(self, NodeDetailsPopup):
        ...
        NodeDetailsPopup.resize(556, 846)
        ...
        self.dock_incompatible_box = QGroupBox(self.tab_dock)
        self.dock_incompatible_box.setObjectName(u"dock_incompatible_box")
        self.dock_incompatible_layout = QVBoxLayout(self.dock_incompatible_box)
        self.dock_incompatible_layout.setSpacing(6)
        self.dock_incompatible_layout.setContentsMargins(11, 11, 11, 11)
        self.dock_incompatible_layout.setObjectName(u"dock_incompatible_layout")
        self.dock_incompatible_layout.setContentsMargins(2, 2, 2, 2)
        self.dock_incompatible_list = QListView(self.dock_incompatible_box)
        self.dock_incompatible_list.setObjectName(u"dock_incompatible_list")

        self.dock_incompatible_layout.addWidget(self.dock_incompatible_list)

        self.dock_incompatible_button = QPushButton(self.dock_incompatible_box)
        self.dock_incompatible_button.setObjectName(u"dock_incompatible_button")

        self.dock_incompatible_layout.addWidget(self.dock_incompatible_button)


        self.dock_layout.addWidget(self.dock_incompatible_box, 2, 0, 3, 1)
        ...
        self.dock_layout.addWidget(self.dock_update_name_button, 2, 1, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.dock_layout.addItem(self.verticalSpacer, 4, 1, 1, 1)
        ...
        self.dock_layout.addWidget(self.dock_exclude_lock_rando_check, 3, 1, 1, 1)
    ...
    def retranslateUi(self, NodeDetailsPopup):
        ...
        self.dock_incompatible_button.setText(QCoreApplication.translate("NodeDetailsPopup", u"Remove Selected", None))
