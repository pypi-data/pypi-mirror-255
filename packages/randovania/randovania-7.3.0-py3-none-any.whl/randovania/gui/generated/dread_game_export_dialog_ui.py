...
class Ui_DreadGameExportDialog(object):
    def setupUi(self, DreadGameExportDialog):
        ...
        DreadGameExportDialog.resize(493, 343)
        ...
        self.ryujinx_legacy_radio = QRadioButton(DreadGameExportDialog)
        self.ryujinx_legacy_radio.setObjectName(u"ryujinx_legacy_radio")
        ...
        self.horizontalLayout_2 = QHBoxLayout(self.tab_ryujinx)
...
#if QT_CONFIG(tooltip)
        self.ryujinx_legacy_radio.setToolTip(QCoreApplication.translate("DreadGameExportDialog", u"<html><head/><body><p>Same as Ryujinx, but does not use exlaunch. Use in case the normal option does not work.</p><p>This mode is not compatible with Multiworld or Auto Tracker enabled.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.ryujinx_legacy_radio.setText(QCoreApplication.translate("DreadGameExportDialog", u"Ryujinx (Legacy)", None))
        self.input_file_button.setText(QCoreApplication.translate("DreadGameExportDialog", u"Select File", None))
        self.sd_label.setText(QCoreApplication.translate("DreadGameExportDialog", u"Select the driver letter for your SD Card", None))
