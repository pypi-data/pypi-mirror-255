...
class Ui_PresetAM2RHints(object):
    def setupUi(self, PresetAM2RHints):
        ...
        self.verticalLayout_91 = QVBoxLayout(self.ice_beam_hint_group)
        ...
        self.verticalLayout_91.addWidget(self.ice_beam_hint_label)
        ...
        self.verticalLayout_91.addWidget(self.ice_beam_hint_combo)
