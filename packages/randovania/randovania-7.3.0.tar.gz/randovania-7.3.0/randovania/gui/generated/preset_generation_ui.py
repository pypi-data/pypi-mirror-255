...
class Ui_PresetGeneration(object):
    def setupUi(self, PresetGeneration):
        ...
        self.scroll_contents.setGeometry(QRect(0, -288, 542, 879))
        ...
        self.experimental_generator_line.setFrameShape(QFrame.HLine)
        self.experimental_generator_line.setFrameShadow(QFrame.Sunken)
