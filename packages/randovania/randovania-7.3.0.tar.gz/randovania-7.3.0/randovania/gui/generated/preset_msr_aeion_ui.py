...
class Ui_PresetMSRAeion(object):
    def setupUi(self, PresetMSRAeion):
        ...
        self.aeion_capacity_spacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.aeion_tank_spacer = QSpacerItem(17, 314, QSizePolicy.Minimum, QSizePolicy.Expanding)
