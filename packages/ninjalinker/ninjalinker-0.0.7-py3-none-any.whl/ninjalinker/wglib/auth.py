        ...
        try:
            ...
            if user_response.status_code == 200:
                try:
                    ...
                    gitlabp = Panel("\n".join(gitlabdata),title="SELFMADE-NINJA-ACADEMY-CLI-VPN",style='bold orchid')
            ...
            try:
                ...
                if lab_response.status_code == 200:
                    try:
                        ...
                        labacesspanel = Panel("\n".join(labaccessmessage),title="SELFMADE-NINJA-ACADEMY-CLI-VPN",style='bold orchid')
                    ...
                    noaccesspanel = Panel("\n".join(noaccessmessage),title="SELFMADE-NINJA-ACADEMY-CLI-VPN",style='bold orchid')
