...
class Wireguard:
        ...
        if session is not None:
            try:
                ...
                if 'interface' in output:
                    ...
                    paneconn = Panel("\n".join(connectedmessage), title="SELFMADE-NINJA-ACADEMY-CLI-VPN", style="bold orchid")
                    ...
                    panelissue = Panel("\n".join(wgissuemessage), title="SELFMADE-NINJA-ACADEMY-CLI-VPN", style="bold orchid")
    ...
    def logout(self):
        ...
        if session is not None:
            ...
            git_logout_panel = Panel("\n".join(git_logout_messages), title="SELFMADE-NINJA-ACADEMY-CLI-VPN", style="bold orchid")
            ...
            not_logged_in_panel = Panel("\n".join(not_in_labs), title="SELFMADE-NINJA-ACADEMY-CLI-VPN", style="bold orchid")
    ...
    def addip(self):
        ...
        try:
            ...
            ippanel = Panel("\n".join(ipmoify), title='SELFMADE-NINJA-ACADEMY-CLI-VPN', style='bold orchid')
            console = Console()
