...
class ElementTypeOp(_ods_ir.OpView):
  ...
  def __init__(self, result, type_, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def element_type(result, type_, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ElementTypeOp(result=result, type_=type_, loc=loc, ip=ip))
...
class EncodingTypeOp(_ods_ir.OpView):
  ...
  def __init__(self, result, *, encoding=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def encoding_type(result, *, encoding=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(EncodingTypeOp(result=result, encoding=encoding, loc=loc, ip=ip))
