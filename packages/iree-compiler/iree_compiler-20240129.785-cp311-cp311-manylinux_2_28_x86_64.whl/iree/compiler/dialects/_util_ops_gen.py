...
def buffer_hash(source, source_size, source_offset, length, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferHashOp(source=source, source_size=source_size, source_offset=source_offset, length=length, loc=loc, ip=ip))
...
def call(results_, callee, operands_, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, tied_operands=None, sym_visibility=None, arg_attrs=None, res_attrs=None, inlining_policy=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_572')) else
      _ods_ir.AttrBuilder.get('anonymous_572')(function_type, context=_ods_context))
    if tied_operands is not None: attributes["tied_operands"] = (tied_operands if (
        issubclass(type(tied_operands), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_TiedOpStorageAttr')) else
          _ods_ir.AttrBuilder.get('Util_TiedOpStorageAttr')(tied_operands, context=_ods_context))
...
def func(sym_name, function_type, *, tied_operands=None, sym_visibility=None, arg_attrs=None, res_attrs=None, inlining_policy=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FuncOp(sym_name=sym_name, function_type=function_type, tied_operands=tied_operands, sym_visibility=sym_visibility, arg_attrs=arg_attrs, res_attrs=res_attrs, inlining_policy=inlining_policy, loc=loc, ip=ip))
...
def global_(sym_name, type_, *, sym_visibility=None, is_mutable=None, initial_value=None, inlining_policy=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(GlobalOp(sym_name=sym_name, type_=type_, sym_visibility=sym_visibility, is_mutable=is_mutable, initial_value=initial_value, inlining_policy=inlining_policy, loc=loc, ip=ip))
