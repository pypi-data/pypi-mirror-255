...
class insertokname-authlibBaseError(Exception):
    """Base Exception for all errors in insertokname-authlib."""
...
class insertokname-authlibHTTPError(insertokname-authlibBaseError):
    #: HTTP status code
    status_code = 400
...
class ContinueIteration(insertokname-authlibBaseError):
    pass
