...
from insertokname-authlib.common.errors import ContinueIteration
from insertokname-authlib.consts import default_json_headers
from insertokname-authlib.jose.errors import ExpiredTokenError
from insertokname-authlib.jose.errors import InvalidClaimError
from insertokname-authlib.oauth2.rfc6750.errors import InvalidTokenError
from insertokname-authlib.oauth2.rfc9068.token_validator import JWTBearerTokenValidator


class JWTIntrospectionEndpoint(IntrospectionEndpoint):
    '''
    JWTIntrospectionEndpoint inherits from :ref:`specs/rfc7662`
    :class:`~insertokname-authlib.oauth2.rfc7662.IntrospectionEndpoint` and implements the machinery
    ...
    :param \\*\\*kwargs: Other parameters are inherited from
        :class:`~insertokname-authlib.oauth2.rfc7662.introspection.IntrospectionEndpoint`.
