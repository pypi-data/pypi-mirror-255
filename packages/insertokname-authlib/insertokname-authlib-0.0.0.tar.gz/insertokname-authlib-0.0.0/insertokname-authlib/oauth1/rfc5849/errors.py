"""
    insertokname-authlib.oauth1.rfc5849.errors
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    RFC5849 has no definition on errors. This module is designed by
    insertokname-authlib based on OAuth 1.0a `Section 10`_ with some changes.
...
from insertokname-authlib.common.security import is_secure_transport


class OAuth1Error(insertokname-authlibHTTPError):
