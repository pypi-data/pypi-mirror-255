"""
    insertokname-authlib.oidc.core.grants.code
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
import logging
from insertokname-authlib.oauth2.rfc6749 import OAuth2Request
from .util import (
    is_openid_scope,
    validate_nonce,
...
class OpenIDToken:
    ...
    def generate_user_info(self, user, scope):
        ...
        MUST implement this method in subclass, e.g.::
            ...
            from insertokname-authlib.oidc.core import UserInfo
        ...
        :return: ``insertokname-authlib.oidc.core.UserInfo`` instance
        """
        raise NotImplementedError()
