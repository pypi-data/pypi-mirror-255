...
from insertokname-authlib.oauth2 import (
    AuthorizationServer as _AuthorizationServer,
)
from insertokname-authlib.oauth2.rfc6750 import BearerTokenGenerator
from insertokname-authlib.common.security import generate_token as _generate_token
from insertokname-authlib.common.encoding import json_dumps
...
class AuthorizationServer(_AuthorizationServer):
    """Django implementation of :class:`insertokname-authlib.oauth2.rfc6749.AuthorizationServer`.
    ...
    def __init__(self, client_model, token_model):
        self.config = getattr(settings, 'insertokname-authlib_OAUTH2_PROVIDER', {})
