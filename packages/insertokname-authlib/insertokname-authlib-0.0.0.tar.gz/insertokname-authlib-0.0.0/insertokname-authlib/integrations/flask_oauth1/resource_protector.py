...
from insertokname-authlib.oauth1 import ResourceProtector as _ResourceProtector
...
class ResourceProtector(_ResourceProtector):
    ...
    def acquire_credential(self):
        ...
        g.insertokname-authlib_server_oauth1_credential = req.credential
...
def _get_current_credential():
    return g.get('insertokname-authlib_server_oauth1_credential')
