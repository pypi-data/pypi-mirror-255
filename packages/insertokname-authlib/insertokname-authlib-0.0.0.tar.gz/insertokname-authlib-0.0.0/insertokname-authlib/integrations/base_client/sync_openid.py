from insertokname-authlib.jose import jwt, JsonWebToken, JsonWebKey
from insertokname-authlib.oidc.core import UserInfo, CodeIDToken, ImplicitIDToken
...
class OpenIDMixin:
    ...
    def parse_id_token(self, token, nonce, claims_options=None, leeway=120):
        ...
        # https://github.com/lepture/insertokname-authlib/issues/259
