...
if not openai_err:
    @catalog.register('gen-ai-hub', ChatOpenAI, 'gpt-35-turbo', 'gpt-4', 'gpt-4-32k', 'gpt-35-turbo-16k', 'gpt-4-turbo',
    ...
    @catalog.register('gen-ai-hub', OpenAIEmbeddings, 'text-embedding-ada-002')
