...
import OSCR_django_client.models
from OSCR_django_client import rest
from OSCR_django_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(OSCR_django_client.models, klass)
