...
def generate(question_type: str, question_number: str, type_help: int) -> str:
    ...
    if type_help == 2:
        ...
        return """This guide explains how to utilize the chatbot effectively!
                 Find the question-id in the QUIZ TAB, select the question type and number from the dropdown menu.
                 For instance, 'Int-1' means choosing Int and 1 from the dropdown menu.
                 Then, select either Hint or Explanation for assistance."""
    elif type_help == 1:
