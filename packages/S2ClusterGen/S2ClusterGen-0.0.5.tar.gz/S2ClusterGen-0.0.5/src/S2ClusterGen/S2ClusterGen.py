...
parser.add_argument('--high-availability', "-ha", action=argparse.BooleanOptionalAction, dest="high_availability", help="Cluster is deployed with high availability")
...
def main():
  ...
  if args.high_availability:
    cluster["high_availability"] = "true"
  else:
    cluster["high_availability"] = "false"
