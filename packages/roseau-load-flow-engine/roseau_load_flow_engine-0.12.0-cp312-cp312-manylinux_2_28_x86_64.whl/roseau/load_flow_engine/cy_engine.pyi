...
class CyElement:
    ...
    def get_potentials(self, n: int) -> np.ndarray: ...
    def get_currents(self, n: int) -> np.ndarray: ...
...
class CyBranch(CyElement):
    ...
    def get_currents(self, n1: int, n2: int) -> tuple[np.ndarray, np.ndarray]: ...
...
class CyTransformer(CyBranch):
    def update_transformer_parameters(self, z2: complex, ym: complex, k: float) -> None: ...

class CyExtendedTransformer(CyTransformer):
    def __init__(
        self, n1: int, n2: int, prim: str, sec: str, z2: complex, ym: complex, k: float, orientation: float
    ) -> None: ...

class CyReducedTransformer(CyTransformer):
    def __init__(
        self, n1: int, n2: int, prim: str, sec: str, z2: complex, ym: complex, k: float, orientation: float
    ) -> None: ...
...
class CyControl:
    def __init__(self, t: str, u_min: float, u_down: float, u_up: float, u_max: float, alpha: float) -> None: ...
...
class CyFlexibleLoad(CyLoad):
    ...
    def update_powers(self, powers: np.ndarray) -> None: ...
    def get_powers(self, n: int) -> np.ndarray: ...
...
class CyAbstractNewton(CyAbstractSolver):
    ...
    def analyse_jacobian(self) -> tuple: ...
