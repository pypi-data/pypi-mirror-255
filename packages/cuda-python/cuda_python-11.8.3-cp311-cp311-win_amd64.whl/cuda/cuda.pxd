...
cdef class CUlaunchAttributeValue_union:
    ...
    clusterDim : _CUlaunchAttributeValue_CUlaunchAttributeValue_CUlaunchAttributeValue_union_clusterDim_s

    clusterSchedulingPolicyPreference : CUclusterSchedulingPolicy

    programmaticStreamSerializationAllowed : int

    programmaticEvent : _CUlaunchAttributeValue_CUlaunchAttributeValue_CUlaunchAttributeValue_union_programmaticEvent_s
    ...
    cdef _CUlaunchAttributeValue_CUlaunchAttributeValue_CUlaunchAttributeValue_union_clusterDim_s _clusterDim
