...
PACKAGE_DATA = {
	"orangecontrib.development_tools.widgets": ["icons/*", "dataset_devellopper/*", "widget_designer/*", "kernel_function/*"], # contenu du dossier 'icons' situé dans 'orangecontrib/development_tools/widgets'
}
# /!\ les noms de fichier 'orangecontrib.development_tools.widgets' doivent correspondre à l'arborescence

# Dépendances
INSTALL_REQUIRES = ["QTimer", "PyQt5", "faiss-cpu==1.7.4", "langchain==0.0.244", "sentence-transformers==2.2.2", "gpt4all==2.0.2", "PyMuPDF==1.22.5"]
