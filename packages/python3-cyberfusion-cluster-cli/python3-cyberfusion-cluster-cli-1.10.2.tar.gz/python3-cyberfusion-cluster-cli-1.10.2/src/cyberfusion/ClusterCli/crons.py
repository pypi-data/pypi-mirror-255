...
def list_(
    ...
    """List crons."""
    console.print(
        get_support().get_table(objs=get_support().crons, detailed=detailed)
    )
...
def create(
    ...
    error_count: int = 1,
    random_delay: int = typer.Option(default=10, metavar="SECONDS"),
    timeout: Optional[int] = typer.Option(default=None, metavar="SECONDS"),
