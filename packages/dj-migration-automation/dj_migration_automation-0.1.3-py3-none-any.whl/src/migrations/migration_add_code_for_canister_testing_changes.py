...
def migration_add_codes_for_canister_testing():
    ...
    try:
        ...
        if CodeMaster.table_exists():
            ...
            CodeMaster.insert(id=constants.CANISTER_TESTING_PENDING,
                              group_id=constants.CANISTER_TESTING_GROUP_ID,
                              value="Canister Testing Pending").execute()
...
if __name__ == "__main__":
    migration_add_codes_for_canister_testing()
