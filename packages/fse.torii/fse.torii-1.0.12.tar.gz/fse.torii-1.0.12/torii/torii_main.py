...
class Torii(object):
    ...
    def __init__(self, properties_file=None, login=None, timeout=30,
        ...
        :param http_cookies:     Cookies dict to be appended to http_session
        ...
        self.mongo_database_torii_bo = self.mongo_client.get_database('Torii_BO')
    ...
    def login(self, username=None, password=None, prompt_password=False, retry_prompt=None, timeout=30):
        ...
        if self.properties['use_python_dao']: self.user_manager.update_user()
