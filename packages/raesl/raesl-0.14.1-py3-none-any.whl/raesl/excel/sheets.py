...
def add_component_active_goals_sheet(
    ...
    active_goals = utils.yield_active_functions(function_specifications, component.name)
    goalsdata = [
        data for goal in active_goals for data in utils.build_active_goal_data(graph, goal)
    ]
