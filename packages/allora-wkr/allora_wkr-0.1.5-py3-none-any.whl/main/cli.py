...
for filename in os.listdir(template_path):
    print(os.path.join(template_path, filename))
...
for filename in os.listdir(cwd):
    ...
    if filename == "main":
        # List all files and folders inside "main"
        for sub_filename in os.listdir(os.path.join(cwd, filename)):
            print(f"\t- {sub_filename}")

            # Check if sub_filename is "template"
            if sub_filename == "templates":
                # List all files inside "template"
                for template_filename in os.listdir(os.path.join(cwd, filename, sub_filename)):
                    print(f"\t\t- {template_filename}")

# Optional: Get detailed information
# for filename in os.listdir(cwd):
#     stat = os.stat(filename)
#     print(filename, stat.st_size, stat.st_mtime)
