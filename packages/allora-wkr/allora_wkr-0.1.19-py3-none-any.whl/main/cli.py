...
def deploy():
    ...
    click.echo('3. Ensure you have updated the ./config.yaml file')
    ...
    worker_image_uri = config['deploy']['image_url']
    ...
    if click.confirm('If you have fullfilled the above requirments Enter to proceed', default=True):
        try:
